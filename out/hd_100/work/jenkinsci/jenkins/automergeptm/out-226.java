...
@Extension public class DownloadService extends PageDecorator {
  ...
  public String generateFragment() {
    if (!
<<<<<<< commits-hd_100/jenkinsci/jenkins/67f338507dc5b41c880066276367d9e4023e9f53-8561a13c577b618a514220fafb259679256d6cf8/A.java
    DownloadSettings.get().isUseBrowser()
=======
    DownloadSettings.usePostBack()
>>>>>>> commits-hd_100/jenkinsci/jenkins/67f338507dc5b41c880066276367d9e4023e9f53-8561a13c577b618a514220fafb259679256d6cf8/B.java
    ) {
      return "";
    }
    if (neverUpdate) {
  ...
  /**
     ...
     */
  @Restricted(value = NoExternalUse.class) public static String loadJSON(URL src) throws IOException {
  ...
  public static class Downloadable implements ExtensionPoint {
    ...
    public void doPostBack(StaplerRequest req, StaplerResponse rsp) throws IOException {
      ...
      }long dataTimestamp = System.currentTimeMillis();due = dataTimestamp + getInterval();String json = IOUtils.toString(req.getInputStream(), "UTF-8");FormValidation e = load(json, dataTimestamp);if (e.kind != Kind.OK) {
    ...
    @Restricted(value = NoExternalUse.class) public FormValidation updateNow() throws IOException {
      return load(loadJSON(new URL(getUrl() + "?id=" + URLEncoder.encode(getId(), "UTF-8") + "&version=" + URLEncoder.encode(Jenkins.VERSION, "UTF-8")))System.currentTimeMillis(), System.currentTimeMillis());
    }
    ...
    private static final long DEFAULT_INTERVAL = Long.getLong(Downloadable.class.getName() + ".defaultInterval", DAYS.toMillis(1));
  }
  ...
  /**
     ...
     * @throws IOException if either downloading or processing failed
     */
  @Restricted(value = NoExternalUse.class) public static String loadJSONHTML(URL src) throws IOException {
    InputStream is = ProxyConfiguration.open(src).getInputStream();
    try {
      String jsonp = IOUtils.toString(is, "UTF-8");
