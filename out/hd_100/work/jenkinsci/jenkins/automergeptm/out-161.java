...
public class ApiTokenProperty extends UserProperty {
  ...
  /**
     ...
     * @since 1.638
     */
  @SuppressFBWarnings(value = "MS_SHOULD_BE_FINAL", justification = "Accessible via System Groovy Scripts") private static boolean SHOW_LEGACY_TOKEN_TO_ADMINS = SystemProperties.getBoolean(ApiTokenProperty.class.getName() + ".showTokenToAdmins");
  ...
  /**
     ...
     * @since TODO
     */
  @SuppressFBWarnings(value = "MS_SHOULD_BE_FINAL", justification = "Accessible via System Groovy Scripts") private static boolean ADMIN_CAN_GENERATE_NEW_TOKENS = SystemProperties.getBoolean(ApiTokenProperty.class.getName() + ".adminCanGenerateNewTokens");
  ...
  /**
     ...
     */
  @Nonnull @SuppressFBWarnings(value = "NP_NONNULL_RETURN_VIOLATION") public String getApiToken() {
  ...
  /**
     ...
     */
  @Restricted(value = NoExternalUse.class) public boolean hasLegacyToken() {
    return apiToken != null;
  }

  @Nonnull @Restricted(value = NoExternalUse.class) String getApiTokenInsecure() {
    if (apiToken == null) {
  ...
  @Restricted(value = NoExternalUse.class) public Collection<TokenInfoAndStats> getTokenList() {
  ...
  @Immutable @Restricted(value = NoExternalUse.class) public static class TokenInfoAndStats {
  ...
  /**
     ...
     */
  @Override public UserProperty reconfigure(StaplerRequest req, @CheckForNull JSONObject form) throws FormException {
    if (form == null) {
      return this;
    }
  ...
  @Deprecated private void _changeApiToken() {
  ...
  /**
     ...
     */
  @Restricted(value = NoExternalUse.class) public void deleteApiToken() {
    this.apiToken = null;
  }

  @Restricted(value = NoExternalUse.class) public ApiTokenStore getTokenStore() {
    return tokenStore;
  }

  @Restricted(value = NoExternalUse.class) public ApiTokenStats getTokenStats() {
    return tokenStats;
  }

  @Extension @Symbol(value = "apiToken") public static final class DescriptorImpl extends UserPropertyDescriptor {
    public String getDisplayName() {
      return Messages.ApiTokenProperty_DisplayName();
    }

    @Restricted(value = NoExternalUse.class) public String getNoLegacyToken() {
      return Messages.ApiTokenProperty_NoLegacyToken();
    }
    ...
    @Restricted(value = NoExternalUse.class) public boolean isStatisticsEnabled() {
      return ApiTokenPropertyConfiguration.get().isUsageStatisticsEnabled();
    }

    @Restricted(value = NoExternalUse.class) public boolean mustDisplayLegacyApiToken(User propertyOwner) {
    ...
    @Restricted(value = NoExternalUse.class) public boolean hasCurrentUserRightToGenerateNewToken(User propertyOwner) {
    ...
    /**
         ...
         */
    @Deprecated @RequirePOST public HttpResponse doChangeToken(@AncestorInPath User u, StaplerResponse rsp) throws IOException {
    ...
    @RequirePOST public HttpResponse doGenerateNewToken(@AncestorInPath User u, @QueryParameter String newTokenName) throws IOException {
    ...
    @RequirePOST public HttpResponse doRename(@AncestorInPath User u, @QueryParameter String tokenUuid, @QueryParameter String newName) throws IOException {
      u.checkPermission(Jenkins.ADMINISTER);
    ...
    @RequirePOST public HttpResponse doRevoke(@AncestorInPath User u, @QueryParameter String tokenUuid) throws IOException {
      u.checkPermission(Jenkins.ADMINISTER);
      if (StringUtils.isBlank(tokenUuid)) {
        return HttpResponses.errorWithoutStack(400, "The tokenUuid cannot be empty");
      }
  ...
  /**
     ...
     */
  @Deprecated private static final SecureRandom RANDOM = new SecureRandom();

  /**
     * We don't want an API key that's too long, so cut the length to 16 (which produces 32-letter MAC code in hexdump)
     */
  @
<<<<<<< commits-hd_100/jenkinsci/jenkins/323982abd7d60ce3d8dba155410a17c7104871fb-dd64d0e9d05862d842375c8c4ac4cc2e8fccd83b/A.java
  Deprecated
=======
  Restricted
>>>>>>> commits-hd_100/jenkinsci/jenkins/323982abd7d60ce3d8dba155410a17c7104871fb-dd64d0e9d05862d842375c8c4ac4cc2e8fccd83b/B.java
  (value = NoExternalUse.class) static final public HMACConfidentialKey API_KEY_SEED = new HMACConfidentialKey(ApiTokenProperty.class, "seed", 16);
}