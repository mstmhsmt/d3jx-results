...
public class QueueTest {
  ...
  @Test public void fileItemPersistence() throws Exception {
    ...
    try {
      ...
      @SuppressWarnings(value = { "deprecation" }) HtmlPage p = (HtmlPage) wc.getPage("http://localhost:" + connector.getLocalPort() + '/');
  ...
  @Issue(value = "JENKINS-8790") @Test public void flyweightTasks() throws Exception {
  ...
  @Issue(value = "JENKINS-7291") @Test public void flyweightTasksWithoutMasterExecutors() throws Exception {
  ...
  @Issue(value = "JENKINS-10944") @Test public void flyweightTasksBlockedByShutdown() throws Exception {
  ...
  @Issue(value = "JENKINS-24519") @Test public void flyweightTasksBlockedBySlave() throws Exception {
  ...
  @Issue(value = "JENKINS-27256") @Test public void inQueueTaskLookupByAPI() throws Exception {
    FreeStyleProject p = r.createFreeStyleProject();
  ...
  @Issue(value = "JENKINS-28926") @Test public void upstreamDownstreamCycle() throws Exception {
  ...
  @Issue(value = "JENKINS-27871") @Test public void testBlockBuildWhenUpstreamBuildingLock() throws Exception {
  ...
  @Test public void queueApiOutputShouldBeFilteredByUserPermission() throws Exception {
    ...
    assertEquals("<queue><discoverableItem><task><name>project</name></task></discoverableItem></queue>", p3.getContent());
  }

  @TestExtension(value = "queueApiOutputShouldBeFilteredByUserPermission") public static class MyQueueTaskDispatcher extends QueueTaskDispatcher {
