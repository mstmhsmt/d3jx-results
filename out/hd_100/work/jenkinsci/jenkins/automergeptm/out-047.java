...
public class UserTest {
  ...
  public static class UserPropertyImpl extends UserProperty implements Action {
    ...
    @Override public UserPropertyDescriptor getDescriptor() {
  ...
  @Bug(value = 2331) @Test public void userPropertySummaryAndActionAreShownInUserPage() throws Exception {
  ...
  /**
     ...
     */
  @Bug(value = 7494) @Test public void defaultUserAvatarCanBeFetched() throws Exception {
  ...
  @Test public void caseInsensitivity() {
  ...
  @Test public void caseSensitivityEmail() {
    j.jenkins.setSecurityRealm(new HudsonPrivateSecurityRealm(true, false, null) {
      @Override public IdStrategy getUserIdStrategy() {
  ...
  @Issue(value = "JENKINS-24317") @LocalData @Test public void migration() throws Exception {
  ...
  @Test public void testAddAndGetProperty() throws IOException {
    User user = User.get("John Smith");
  ...
  @Test public void testGetAndGetAll() {
  ...
  @Bug(value = 16332) @Test public void unrecoverableFullName() throws Throwable {
