...
public class UtilTest {
  ...
  @Test public void testTimeSpanString() {
  ...
  /**
     ...
     */
  @Test public void testEncodeSpaces() {
...
<<<<<<< commits-hd_100/jenkinsci/jenkins/9993468ce4bc6ade4302ee4744ac942cf4d80049-d912ab3d74a493dc17831375aba9cffc0485618b/A.java
  /**
     * Test that Strings that contain ampersand are correctly URL encoded.
     */
  @Test public void testEncodeAmpersand() {
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  /**
     ...
     */
  @Test public void testRawEncode() {
    String[] data = { "abcdefghijklmnopqrstuvwxyz", "abcdefghijklmnopqrstuvwxyz", "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "01234567890!@$&*()-_=+\',.", "01234567890!@$&*()-_=+\',.", " \"#%/:;<>?", "%20%22%23%25%2F%3A%3B%3C%3E%3F", "[\\]^`{|}~", "%5B%5C%5D%5E%60%7B%7C%7D%7E", "d\u00e9velopp\u00e9s", "d%C3%A9velopp%C3%A9s" };
  ...
  /**
     ...
     */
  @Test public void testTryParseNumber() {
  ...
  @Test public void testHtmlEscape() {
  ...
  /**
     ...
     * to another digest.
     */
  @Bug(value = 10346) @Test public void testDigestThreadSafety() throws InterruptedException {
    String a = "abcdefgh";
    String b = "123456789";
