...
@ExportedBean public abstract class Run<JobT extends Job<JobT, RunT>, RunT extends Run<JobT, RunT>> extends Actionable implements ExtensionPoint, Comparable<RunT>, AccessControlled, PersistenceRoot, DescriptorByNameOwner, OnMaster {
  ...
  /**
     ...
     */
  @Restricted(value = NoExternalUse.class) protected volatile transient RunT previousBuild;
  ...
  /**
     ...
     */
  @Restricted(value = NoExternalUse.class) protected volatile transient RunT nextBuild;
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "deprecation" }) protected void onLoad() {
  ...
  @SuppressWarnings(value = { "deprecation" }) @Override public void addAction(Action a) {
    super.addAction(a);
    if (a instanceof RunAction2) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) protected RunT _this() {
    return (RunT) this;
  }
  ...
  /**
     ...
     */
  @Exported public @CheckForNull Executor getExecutor() {
  ...
  /**
     ...
     */
  @Exported public List<Artifact> getArtifacts() {
  ...
  @ExportedBean public final class Artifact {
    /**
  ...
  @SuppressWarnings(value = { "unchecked" }) private void removeRunFromParent() {
  ...
  /**
     ...
     */
  @Deprecated public String getLog() throws IOException {
  ...
  /**
     ...
     */
  @RequirePOST public void doDoDelete(StaplerRequest req, StaplerResponse rsp) throws IOException, ServletException {
  ...
  @RequirePOST public HttpResponse doConfigSubmit(StaplerRequest req) throws IOException, ServletException, FormException {
    checkPermission(UPDATE);
  ...
  public static final FeedAdapter<Run> FEED_ADAPTER_LATEST = new DefaultFeedAdapter() {
    /**
         ...
         */
    @Override public String getEntryID(Run e) {
