...
>>>>>>> commits-hd_100/jenkinsci/jenkins/67f338507dc5b41c880066276367d9e4023e9f53-8561a13c577b618a514220fafb259679256d6cf8/B.java
    ...
    @Restricted(value = NoExternalUse.class) public FormValidation updateNow() throws IOException {
      return load(
<<<<<<< commits-hd_100/jenkinsci/jenkins/67f338507dc5b41c880066276367d9e4023e9f53-8561a13c577b618a514220fafb259679256d6cf8/A.java
      loadJSON(new URL(getUrl() + "?id=" + URLEncoder.encode(getId(), "UTF-8") + "&version=" + URLEncoder.encode(Jenkins.VERSION, "UTF-8")))
=======
      loadJSONHTML(new URL(getUrl() + ".html?id=" + URLEncoder.encode(getId(), "UTF-8") + "&version=" + URLEncoder.encode(Jenkins.VERSION, "UTF-8")))
>>>>>>> commits-hd_100/jenkinsci/jenkins/67f338507dc5b41c880066276367d9e4023e9f53-8561a13c577b618a514220fafb259679256d6cf8/B.java
