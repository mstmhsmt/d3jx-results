 ...
 */
@SuppressWarnings(value = { "rawtypes" }) public class Functions {
  ...
  /**
     ...
     */
  public static <B extends java.lang.Object> Class getTypeParameter(Class<? extends B> c, Class<B> base, int n) {
  ...
  @Restricted(value = NoExternalUse.class) public static String[] printLogRecordHtml(LogRecord r, LogRecord prior) {
  ...
  /**
     ...
     * @since 1.525
     */
  public static <T extends java.lang.Object> Iterable<T> reverse(Collection<T> collection) {
  ...
  @Restricted(value = NoExternalUse.class) public static String validateIconSize(String iconSize) throws SecurityException {
  ...
  /**
     ...
     */
  public static <V extends java.lang.Object> SortedMap<Integer, V> filter(SortedMap<Integer, V> map, String from, String to) {
  ...
  /**
     ...
     */
  @Restricted(value = NoExternalUse.class) public static <V extends java.lang.Object> SortedMap<Integer, V> filterExcludingFrom(SortedMap<Integer, V> map, String from, String to) {
    if (from == null && to == null) {
      return map;
    }
    if (to == null) {
  ...
  public static <T extends java.lang.Object> Collection<T> emptyList() {
  ...
  /**
     ...
     * @since 1.150
     */
  public static <T extends java.lang.Object> T defaulted(T value, T defaultValue) {
  ...
  /**
     ...
     */
  public static <T extends java.lang.Object> List<T> subList(List<T> base, int maxSize) {
  ...
  public <T extends java.lang.Object> List<T> singletonList(T t) {
  ...
  @Restricted(value = NoExternalUse.class) public static boolean isContextMenuVisible(Action a) {
