...
public class QueueTest {
    ...
    public final static class FileItemPersistenceTestServlet extends HttpServlet {
    ...
    private static class TestFlyweightTask extends TestTask implements Queue.FlyweightTask {
        ...
        final private Label assignedLabel;
    ...
    private static class TestTask extends AbstractQueueTask {
        ...
        final private AtomicInteger cnt;
    ...
    @Test
    public void pendingsConsistenceAfterErrorDuringMaintain() throws IOException, ExecutionException, InterruptedException {
    ...
    @Test
    @Issue("JENKINS-27871")
    public void testBlockBuildWhenUpstreamBuildingLock() throws Exception {
