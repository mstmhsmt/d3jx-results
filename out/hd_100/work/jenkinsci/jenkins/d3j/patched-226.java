...
<<<<<<< /root/work/jenkinsci/jenkins/d3j/patched-226-0.java
    if (!DownloadSettings.get().isUseBrowser()) {
      return "";
    }
||||||| /root/work/jenkinsci/jenkins/d3j/base-226.java
=======
    if (!DownloadSettings.usePostBack()) {
      return "";
    }
>>>>>>> /root/work/jenkinsci/jenkins/d3j/patched-226-1.java
    if (neverUpdate)
      return "";
...
>>>>>>> /root/work/jenkinsci/jenkins/d3j/patched-226-1.java
    ...
    private FormValidation load(String json, long dataTimestamp)
        throws IOException {
...
<<<<<<< /root/work/jenkinsci/jenkins/d3j/patched-226-0.java
    ...
    public FormValidation updateNow() throws IOException {
      return load(
          loadJSON(new URL(
              getUrl() + "?id=" + URLEncoder.encode(getId(), "UTF-8") +
...
=======
    ...
    public FormValidation updateNow() throws IOException {
      return load(
          loadJSONHTML(new URL(
              getUrl() + ".html?id=" + URLEncoder.encode(getId(), "UTF-8") +
              "&version=" + URLEncoder.encode(Jenkins.VERSION, "UTF-8"))),
          System.currentTimeMillis());
>>>>>>> /root/work/jenkinsci/jenkins/d3j/patched-226-1.java
    }
