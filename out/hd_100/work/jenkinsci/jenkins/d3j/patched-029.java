...
<<<<<<< /root/work/jenkinsci/jenkins/d3j/patched-029-0.java
  @Test
  public void testEncodeAmpersand() {
    final String urlWithAmpersand =
        "http://hudson/job/Hudson-job/label1&&label2";
    String encoded = Util.encode(urlWithAmpersand);
    assertEquals(encoded, "http://hudson/job/Hudson-job/label1%26%26label2");
  }
  @Test
||||||| /root/work/jenkinsci/jenkins/d3j/base-029.java
  public void testEncodeAmpersand() {
    final String urlWithAmpersand =
        "http://hudson/job/Hudson-job/label1&&label2";
    String encoded = Util.encode(urlWithAmpersand);
...
=======
  @Test
>>>>>>> /root/work/jenkinsci/jenkins/d3j/patched-029-1.java
  ...
  public void testTryParseNumber() {
    ...
    assertEquals("Parsing empty string did not return the default value", 10,
                 Util.tryParseNumber("", 10).intValue());
    assertEquals("Parsing null string did not return the default value", 10,
                 Util.tryParseNumber(null, 10).intValue());
  }
  @Test
    ...
    public void run() {
      for (int i = 0; i < 1000; i++) {
        ...
        if (!this.expectedDigest.equals(digest)) {
          this.error =
              "Expected " + this.expectedDigest + ", but got " + digest;
          break;
        }
      }
    }
