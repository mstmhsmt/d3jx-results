...
public class QueryRescorerIT extends ESIntegTestCase {
    ...
    @Test
    public void testRescorePhrase() throws Exception throws Exception {
    ...
    @Test
    public void testMoreDocs() throws Exception throws Exception {
    ...
    @Test
    public void testSmallRescoreWindow() throws Exception throws Exception {
        Builder builder = Settings.builder();
        builder.put("index.analysis.analyzer.synonym.tokenizer", "whitespace");
        builder.putArray("index.analysis.analyzer.synonym.filter", "synonym", "lowercase");
        builder.put("index.analysis.filter.synonym.type", "synonym");
    ...
    @Test
    public void testRescorerMadeScoresWorse() throws Exception throws Exception {
        Builder builder = Settings.builder();
        builder.put("index.analysis.analyzer.synonym.tokenizer", "whitespace");
        builder.putArray("index.analysis.analyzer.synonym.filter", "synonym", "lowercase");
        builder.put("index.analysis.filter.synonym.type", "synonym");
    ...
    @Test
    public void testEquivalence() throws Exception throws Exception {
    ...
    @Test
    public void testExplain() throws Exception throws Exception {
        assertAcked(prepareCreate("test")
                .addMapping(
                        "type1",
                        jsonBuilder().startObject().startObject("type1").startObject("properties").startObject("field1")
    ...
    @Test
    public void testScoring() throws Exception throws Exception {
    ...
    @Test
    public void testMultipleRescores() throws Exception throws Exception {
    ...
    private int indexRandomNumbers(String analyzer) throws Exception throws Exception {
        return indexRandomNumbers(analyzer, -1, true);
    }
    
    private int indexRandomNumbers(String analyzer, int shards, boolean dummyDocs) throws Exception throws Exception {
    ...
    // #11277
    public void testFromSize() throws Exception throws Exception {
