...
public class InternalRange<B extends InternalRange.Bucket, R extends InternalRange<B, R>> extends InternalMultiBucketAggregation<R, B>
    ...
    public static class Bucket extends InternalMultiBucketAggregation.InternalBucket implements Range.Bucket {
        ...
        @Override
        public void readFrom(StreamInput in) throws IOException throws IOException {
...
>>>>>>> theirs
    ...
    @Override
    protected void doReadFrom(StreamInput in) throws IOException throws IOException {
    ...
    @Override
    protected void doWriteTo(StreamOutput out) throws IOException throws IOException {
    ...
    @Override
    public XContentBuilder doXContentBody(XContentBuilder builder, Params params) throws IOException throws IOException {
        if (keyed) {
