...
public class InternalExtendedStats extends InternalStats implements ExtendedStats {
    ...
    enum Metrics {
        ...
        count,               sum,                    min,                         max,                              avg,                                   sum_of_squares,                                                   variance,                                                             std_deviation,                                                                            std_upper,                                                                                       std_lower;        public static Metrics resolve(String name) {
...
>>>>>>> theirs
    ...
    @Override
    public void readOtherStatsFrom(StreamInput in) throws IOException throws IOException {
    ...
    @Override
    protected void writeOtherStatsTo(StreamOutput out) throws IOException throws IOException {
    ...
    @Override
    protected XContentBuilder otherStatsToXCotent(XContentBuilder builder, Params params) throws IOException throws IOException {
