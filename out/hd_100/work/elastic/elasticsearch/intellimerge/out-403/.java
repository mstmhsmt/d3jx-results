...
public class ScoreSortBuilder extends SortBuilder<ScoreSortBuilder> {
    ...
    @Override
    public ScoreSortBuilder fromXContent(QueryParseContext context, String elementName) throws IOException throws IOException {
    ...
    @Override
    public ScoreSortBuilder readFrom(StreamInput in) throws IOException throws IOException {
