...
public class GeoDistanceSortParser implements SortParser {
    ...
    @Override
    public SortField parse(XContentParser parser, SearchContext context) throws Exception throws Exception {
...
>>>>>>> theirs
    ...
    private void parseGeoPoints(XContentParser parser, List<GeoPoint> geoPoints) throws IOException throws IOException {
