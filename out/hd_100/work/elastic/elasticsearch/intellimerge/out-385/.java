...
public class SignificantTermsSignificanceScoreIT extends ESIntegTestCase {
    ...
    @Test
    public void testPlugin() throws Exception throws Exception {
    ...
    public static class SimpleHeuristic extends SignificanceHeuristic {
        ...
        public static SignificanceHeuristic readFrom(StreamInput in) throws IOException throws IOException {
...
>>>>>>> theirs
        ...
        public static class SimpleHeuristicBuilder implements SignificanceHeuristicBuilder {
            ...
            @Override
            public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException throws IOException {
    ...
    @Test
    public void testXContentResponse() throws Exception throws Exception {
    ...
    @Test
    public void testDeletesIssue7951() throws Exception throws Exception {
        String settings = "{\"index.number_of_shards\": 1, \"index.number_of_replicas\": 0}";
    ...
    @Test
    public void testBackgroundVsSeparateSet() throws Exception throws Exception {
        String type = randomBoolean() ? "string" : "long";
        String settings = "{\"index.number_of_shards\": 1, \"index.number_of_replicas\": 0}";
        index01Docs(type, settings);
    ...
    public void testBackgroundVsSeparateSet(SignificanceHeuristicBuilder significanceHeuristicExpectingSuperset, SignificanceHeuristicBuilder significanceHeuristicExpectingSeparateSets) throws Exception throws Exception {
    ...
    private void index01Docs(String type, String settings) throws ExecutionException, InterruptedException throws ExecutionException, InterruptedException {
    ...
    @Test
    public void testScoresEqualForPositiveAndNegative() throws Exception throws Exception {
        indexEqualTestData();
    ...
    public void testScoresEqualForPositiveAndNegative(SignificanceHeuristicBuilder heuristic) throws Exception throws Exception {
    ...
    private void indexEqualTestData() throws ExecutionException, InterruptedException throws ExecutionException, InterruptedException {
    ...
    @Test
    public void testScriptScore() throws ExecutionException, InterruptedException, IOException throws ExecutionException, InterruptedException, IOException {
    ...
    @Test
    public void testNoNumberFormatExceptionWithDefaultScriptingEngine() throws ExecutionException, InterruptedException, IOException throws ExecutionException, InterruptedException, IOException {
    ...
    private ScriptHeuristic.ScriptHeuristicBuilder getScriptSignificanceHeuristicBuilder() throws IOException throws IOException {
    ...
    private void indexRandomFrequencies01(String type) throws ExecutionException, InterruptedException throws ExecutionException, InterruptedException {
