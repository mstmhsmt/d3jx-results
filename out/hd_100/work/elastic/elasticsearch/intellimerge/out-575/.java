...
public final class ShadowIndexShard extends IndexShard {
    ...
    public ShadowIndexShard(ShardRouting shardRouting, IndexSettings indexSettings, ShardPath path, Store store, IndexCache indexCache,
                            ...
                            List<SearchOperationListener> searchOperationListeners) throws IOException throws IOException {
     ...
     */
    @Override
    public void updateRoutingEntry(ShardRouting newRouting, boolean persistState) throws IOException throws IOException {
