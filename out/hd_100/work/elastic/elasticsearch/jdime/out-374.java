...
public class FieldSortBuilderTests extends AbstractSortTestCase<FieldSortBuilder> {
  @Override protected FieldSortBuilder createTestItem() {
  ...
  @Override protected FieldSortBuilder mutate(FieldSortBuilder original) throws IOException {
  ...
  @Override protected void sortFieldAssertions(FieldSortBuilder builder, SortField sortField) throws IOException {
  ...
  @Override protected FieldSortBuilder fromXContent(QueryParseContext context, String fieldName) throws IOException {
