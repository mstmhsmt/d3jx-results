...
public class InternalExtendedStats extends InternalStats implements ExtendedStats {
  ...
  public final static AggregationStreams.Stream STREAM = new AggregationStreams.Stream() {
    @Override public InternalExtendedStats readResult(StreamInput in) throws IOException {
  ...
  @Override public double getStdDeviation() {
    return Math.sqrt(getVariance());
  }

  @Override public double getStdDeviationBound(Bounds bound) {
  ...
  @Override public String getSumOfSquaresAsString() {
    return valueAsString(Metrics.sum_of_squares.name());
  }

  @Override public String getVarianceAsString() {
    return valueAsString(Metrics.variance.name());
  }

  @Override public String getStdDeviationAsString() {
    return valueAsString(Metrics.std_deviation.name());
  }

  @Override public String getStdDeviationBoundAsString(Bounds bound) {
    return bound == Bounds.UPPER ? valueAsString(Metrics.std_upper.name()) : valueAsString(Metrics.std_lower.name());
  }

  @Override public InternalExtendedStats doReduce(ReduceContext reduceContext) {
    double sumOfSqrs = 0;
...
=======
  @Override public InternalExtendedStats reduce(List<InternalAggregation> aggregations, ReduceContext reduceContext) {
    double sumOfSqrs = 0;
...
>>>>>>> commits-hd_100/elastic/elasticsearch/56a37620ed2cffd57b8b3fa6b5dcbf4ee4718df9-9a7006905304f1d6d49a84feaa3adaa44565aefc/B.java


  @Override public void readOtherStatsFrom(StreamInput in) throws IOException {
  ...
  @Override protected void writeOtherStatsTo(StreamOutput out) throws IOException {
  ...
  @Override protected XContentBuilder otherStatsToXCotent(XContentBuilder builder, Params params) throws IOException {
