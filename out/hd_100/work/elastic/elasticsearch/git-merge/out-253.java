...
<<<<<<< commits-hd_100/elastic/elasticsearch/dc998764e86dec9c07fcad241ac821d744857f33-18e6387207c1379e42e321edbc50496d9bb68f70/A.java
            builder.startObject(node.getNode().getId());
            builder.field("name", node.getNode().getName());
||||||| commits-hd_100/elastic/elasticsearch/dc998764e86dec9c07fcad241ac821d744857f33-18e6387207c1379e42e321edbc50496d9bb68f70/O.java
            builder.startObject(node.getNode().id());
            builder.field("name", node.getNode().name());
=======
            builder.startObject(node.getNode().getId());
            builder.field("name", node.getNode().name());
>>>>>>> commits-hd_100/elastic/elasticsearch/dc998764e86dec9c07fcad241ac821d744857f33-18e6387207c1379e42e321edbc50496d9bb68f70/B.java
            builder.endObject();
        }
        builder.endObject();
