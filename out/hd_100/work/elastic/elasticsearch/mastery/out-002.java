...
public class InternalRange<B extends InternalRange.Bucket, R extends InternalRange<B, R>> extends InternalMultiBucketAggregation<R, B> implements Range {
    ...
    static final public Type TYPE = new Type("range");

    static final private AggregationStreams.Stream STREAM = new AggregationStreams.Stream() {
    ...
    static final private BucketStreams.Stream<Bucket> BUCKET_STREAM = new BucketStreams.Stream<Bucket>() {
    ...
    static public void registerStream() {
        AggregationStreams.registerStream(STREAM, TYPE.stream());
        BucketStreams.registerStream(BUCKET_STREAM, TYPE.stream());
    }

    static public class Bucket extends InternalMultiBucketAggregation.InternalBucket implements Range.Bucket {

        final protected transient boolean keyed;

        final protected transient ValueFormatter formatter;
    ...
    static public class Factory<B extends Bucket, R extends InternalRange<B, R>> extends InternalMultiBucketAggregation.Factory<R, B> {
