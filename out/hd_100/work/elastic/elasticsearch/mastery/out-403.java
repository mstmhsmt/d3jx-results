...
public class ScoreSortBuilder extends SortBuilder<ScoreSortBuilder> {
    ...
    static final private SortField SORT_SCORE = new SortField(null, SortField.Type.SCORE);

    static final private SortField SORT_SCORE_REVERSE = new SortField(null, SortField.Type.SCORE, true);
