...
public class InternalExtendedStats extends InternalStats implements ExtendedStats {
    ...
    public InternalExtendedStats(String name, long count, double sum, double min, double max, double sumOfSqrs, double sigma, @Nullable ValueFormatter formatter, List<Reducer> reducers, Map<String, Object> metaData) {
    ...
    public InternalExtendedStats doReduce(List<InternalAggregation> aggregations, ReduceContext reduceContext) {
        ...
        return new InternalExtendedStats(name, stats.getCount(), stats.getSum(), stats.getMin(), stats.getMax(), sumOfSqrs, sigma, valueFormatter, reducers(), getMetaData());
    }
    ...
    static class Fields {
        ...
        public final static XContentBuilderString SUM_OF_SQRS = new XContentBuilderString("sum_of_squares");

        public final static XContentBuilderString SUM_OF_SQRS_AS_STRING = new XContentBuilderString("sum_of_squares_as_string");

        public final static XContentBuilderString VARIANCE = new XContentBuilderString("variance");

        public final static XContentBuilderString VARIANCE_AS_STRING = new XContentBuilderString("variance_as_string");

        public final static XContentBuilderString STD_DEVIATION = new XContentBuilderString("std_deviation");

        public final static XContentBuilderString STD_DEVIATION_AS_STRING = new XContentBuilderString("std_deviation_as_string");

        public final static XContentBuilderString STD_DEVIATION_BOUNDS = new XContentBuilderString("std_deviation_bounds");

        public final static XContentBuilderString STD_DEVIATION_BOUNDS_AS_STRING = new XContentBuilderString("std_deviation_bounds_as_string");

        public final static XContentBuilderString UPPER = new XContentBuilderString("upper");

        public final static XContentBuilderString LOWER = new XContentBuilderString("lower");
    }
