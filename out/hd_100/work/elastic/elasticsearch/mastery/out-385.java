...
public class SignificantTermsSignificanceScoreIT extends ESIntegTestCase {
    ...
    static public class CustomSignificanceHeuristicPlugin extends Plugin {
    ...
    static public class SimpleHeuristic extends SignificanceHeuristic {

        static final protected String[] NAMES = { "simple" };

        static final public SignificanceHeuristicStreams.Stream STREAM = new SignificanceHeuristicStreams.Stream() {
        ...
        static public SignificanceHeuristic readFrom(StreamInput in) throws IOException {
        ...
        static public class SimpleHeuristicParser implements SignificanceHeuristicParser {

            @Override
            public SignificanceHeuristic parse(XContentParser parser, ParseFieldMatcher parseFieldMatcher, SearchContext context) throws IOException, QueryShardException {
                parser.nextToken();
                return new SimpleHeuristic();
            }
        ...
        static public class SimpleHeuristicBuilder implements SignificanceHeuristicBuilder {
