...
public
class ClearRolesCacheResponse
  extends BaseNodesResponse<ClearRolesCacheResponse.Node>
  implements ToXContent
{
   ...
   public
   ClearRolesCacheResponse(ClusterName clusterName, Node[] nodes) {
     super(clusterName,
     nodes);
   }
   @Override
   ...
   public
   static
   class Node extends BaseNodeResponse
   {
      Node() {
      ...
      public
      static
      Node readNodeResponse(StreamInput in) throws IOException {
        Node node = new Node();
        node.readFrom(in);
        return node;
      }
