...
public class S3RepositoryPlugin extends Plugin {
  ...
  public Collection<Class<? extends LifecycleComponent>> nodeServices() {
    return Collections.<Class<? extends LifecycleComponent>>singleton(
        S3Module.getS3ServiceImpl());
  }
  public void onModule(RepositoriesModule repositoriesModule) {
    repositoriesModule.registerRepository(S3Repository.TYPE, S3Repository.class,
                                          BlobStoreIndexShardRepository.class);
  }
<<<<<<< /root/work/elastic/elasticsearch/d3j/patched-713-0.java
  @Override
  public List<Setting<?>> getSettings() {
    return Arrays.asList(
        AwsS3Service.KEY_SETTING, AwsS3Service.SECRET_SETTING,
        AwsS3Service.PROTOCOL_SETTING, AwsS3Service.PROXY_HOST_SETTING,
        AwsS3Service.PROXY_PORT_SETTING, AwsS3Service.PROXY_USERNAME_SETTING,
        AwsS3Service.PROXY_PASSWORD_SETTING, AwsS3Service.SIGNER_SETTING,
        AwsS3Service.REGION_SETTING, AwsS3Service.CLOUD_S3.KEY_SETTING,
...
||||||| /root/work/elastic/elasticsearch/d3j/base-713.java
  public void onModule(SettingsModule settingsModule) {
    ...
    registerSettingIfMissing(settingsModule,
  ...
  private void registerSettingIfMissing(SettingsModule settingsModule,
                                        Setting<?> setting) {
...
=======
  ...
  public List<Setting<?>> getSettings() {
    ...
    settingsModule.registerSetting(
        ...
        S3Repository.Repository.CANNED_ACL_SETTING,
        S3Repository.Repository.BASE_PATH_SETTING);
>>>>>>> /root/work/elastic/elasticsearch/d3j/patched-713-1.java
  }
}