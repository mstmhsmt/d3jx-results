...
public class InternalExtendedStats extends InternalStats implements ExtendedStats {
    public static final Type TYPE = new Type("extended_stats", "estats");
    ...
    public InternalExtendedStats(String name, long count, double sum, double min, double max, double sumOfSqrs, double sigma, @Nullable
    ValueFormatter formatter, List<Reducer> reducers, Map<String, Object> metaData) {
