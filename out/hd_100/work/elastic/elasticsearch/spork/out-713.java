...
public class S3RepositoryPlugin extends Plugin {
    ...
    public List<Setting<?>> getSettings() {
        return // Register global cloud aws settings: cloud.aws (might have been registered in ec2 plugin)
