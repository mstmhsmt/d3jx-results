...
public class GceDiscoveryPlugin extends Plugin {
    ...
    public List<Setting<?>> getSettings() {
        return // Register GCE settings
        Arrays.asList(GceInstancesService.PROJECT_SETTING, GceInstancesService.ZONE_SETTING, GceUnicastHostsProvider.TAGS_SETTING, GceInstancesService.REFRESH_SETTING, GceInstancesService.RETRY_SETTING, GceInstancesService.MAX_WAIT_SETTING);
    }
}
