...
public class InternalRange<B extends InternalRange.Bucket, R extends InternalRange<B, R>> extends InternalMultiBucketAggregation<R, B> implements Range {
  ...
  private final static AggregationStreams.Stream STREAM = new AggregationStreams.Stream() {
    @Override public InternalRange readResult(StreamInput in) throws IOException {
  ...
  private final static BucketStreams.Stream<Bucket> BUCKET_STREAM = new BucketStreams.Stream<Bucket>() {
    @Override public Bucket readResult(StreamInput in, BucketStreamContext context) throws IOException {
      Bucket buckets = new Bucket(context.keyed(), context.formatter());
      buckets.readFrom(in);
      return buckets;
    }

    @Override public BucketStreamContext getBucketStreamContext(Bucket bucket) {
  ...
  public static class Bucket extends InternalMultiBucketAggregation.InternalBucket implements Range.Bucket {
    ...
    @Override public String getKeyAsString() {
      return key;
    }

    @Override public Object getFrom() {
      return from;
    }

    @Override public Object getTo() {
      return to;
    }
    ...
    @Override public String getFromAsString() {
    ...
    @Override public String getToAsString() {
  ...
  public static class Factory<B extends Bucket, R extends InternalRange<B, R>> extends InternalMultiBucketAggregation.Factory<R, B> {
    ...
    public R create(String name, List<B> ranges, @Nullable ValueFormatter formatter, boolean keyed, List<Reducer> reducers, Map<String, Object> metaData) {
    ...
    @Override public R create(List<B> ranges, R prototype) {
      return (R) new InternalRange<>(prototype.name, ranges, prototype.formatter, prototype.keyed, prototype.reducers(), prototype.metaData);
    }

    @Override public B createBucket(InternalAggregations aggregations, B prototype) {
      return (B) new Bucket(prototype.getKey(), prototype.from, prototype.to, prototype.getDocCount(), aggregations, prototype.keyed, prototype.formatter);
    }
  }
  ...
  @Nullable protected ValueFormatter formatter;
  ...
  public InternalRange(String name, List<B> ranges, @Nullable ValueFormatter formatter, boolean keyed, List<Reducer> reducers, Map<String, Object> metaData) {
  ...
  @Override public List<B> getBuckets() {
    return ranges;
  }
  ...
  @Override public R create(List<B> buckets) {
  ...
  @Override public InternalAggregation doReduce(ReduceContext reduceContext) {
    List<InternalAggregation> aggregations = reduceContext.aggregations();
    @SuppressWarnings(value = { "unchecked" }) List<Bucket>[] rangeList = new List[ranges.size()];
  ...
  @Override protected void doReadFrom(StreamInput in) throws IOException {
  ...
  @Override public XContentBuilder doXContentBody(XContentBuilder builder, Params params) throws IOException {
    if (keyed) {
...
=======
  @Override public InternalAggregation reduce(List<InternalAggregation> aggregations, ReduceContext reduceContext) {
    @SuppressWarnings(value = { "unchecked" }) List<Bucket>[] rangeList = new List[ranges.size()];
    for (int i = 0; i < rangeList.length; ++i) {
      rangeList[i] = new ArrayList<Bucket>();
    }
...
>>>>>>> commits-hd_100/elastic/elasticsearch/56a37620ed2cffd57b8b3fa6b5dcbf4ee4718df9-a6f480f9d3e480b90d5080d178f7361cf28ae80b/B.java
}