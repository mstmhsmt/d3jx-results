...
public class InternalMin extends InternalNumericMetricsAggregation.SingleValue implements Min {
  ...
  public final static AggregationStreams.Stream STREAM = new AggregationStreams.Stream() {
    @Override public InternalMin readResult(StreamInput in) throws IOException {
  ...
  @Override public InternalMin doReduce(ReduceContext reduceContext) {
...
=======
  @Override public InternalMin reduce(List<InternalAggregation> aggregations, ReduceContext reduceContext) {
    double min = Double.POSITIVE_INFINITY;
...
>>>>>>> commits-hd_100/elastic/elasticsearch/56a37620ed2cffd57b8b3fa6b5dcbf4ee4718df9-ad9d47a34eef1ad2e3b3e06350233587d432ee83/B.java
}