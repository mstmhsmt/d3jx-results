...
public class ScoreSortBuilder extends SortBuilder<ScoreSortBuilder> {
  ...
  static final public ScoreSortBuilder PROTOTYPE = new ScoreSortBuilder();
  ...
  @Override public ScoreSortBuilder fromXContent(QueryParseContext context, String elementName) throws IOException {
  ...
  @Override public SortField build(QueryShardContext context) {
  ...
  @Override public ScoreSortBuilder readFrom(StreamInput in) throws IOException {
