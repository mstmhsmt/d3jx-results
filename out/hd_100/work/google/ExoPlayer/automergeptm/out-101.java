...
public class PlayerView extends FrameLayout {
  ...
  @IntDef(value = { SHOW_BUFFERING_NEVER, SHOW_BUFFERING_WHEN_PLAYING, SHOW_BUFFERING_ALWAYS }) @Retention(value = RetentionPolicy.SOURCE) public @interface ShowBuffering {
  }
   ...
   */
  @Deprecated public void setShowBuffering(boolean showBuffering) {
  ...
  @Override public boolean dispatchKeyEvent(KeyEvent event) {
    ...
    boolean isDpadWhenControlHidden = isDpadKey(event.getKeyCode()) && useController && !controller.isVisible();
    boolean handled = isDpadWhenControlHidden || dispatchMediaKeyEvent(event) || super.dispatchKeyEvent(event);
    if (handled) {
  ...
  private void updateErrorMessage() {
    if (errorMessageView != null) {
      ...
      if (player != null && player.getPlaybackState() == Player.STATE_IDLE && errorMessageProvider != null) {
  ...
  @TargetApi(value = 23) private static void configureEditModeLogoV23(Resources resources, ImageView logo) {
    logo.setImageDrawable(resources.getDrawable(R.drawable.exo_edit_mode_logo, null));
    logo.setBackgroundColor(resources.getColor(R.color.exo_edit_mode_background_color, null));
  }

  @SuppressWarnings(value = { "deprecation" }) private static void configureEditModeLogo(Resources resources, ImageView logo) {
    logo.setImageDrawable(resources.getDrawable(R.drawable.exo_edit_mode_logo));
    logo.setBackgroundColor(resources.getColor(R.color.exo_edit_mode_background_color));
  }

  @SuppressWarnings(value = { "ResourceType" }) private static void setResizeModeRaw(AspectRatioFrameLayout aspectRatioFrame, int resizeMode) {
  ...
  @SuppressLint(value = "InlinedApi") private boolean isDpadKey(int keyCode) {
  ...
  private final class ComponentListener implements Player.EventListener, TextOutput, VideoListener, OnLayoutChangeListener, SphericalSurfaceView.SurfaceListener {
    ...
    @Override public void onLayoutChange(View view, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
      applyTextureViewRotation((TextureView) view, textureViewRotation);
    }

    @Override public void surfaceChanged(@Nullable Surface surface) {
      if (player != null) {
   ...
   */
  @Deprecated public void setDefaultArtwork(Bitmap defaultArtwork) {
