...
public final class DefaultHlsExtractorFactory implements HlsExtractorFactory {
  ...
  @Override public Result createExtractor(Extractor previousExtractor, Uri uri, Format format, List<Format> muxedCaptionFormats, DrmInitData drmInitData, TimestampAdjuster timestampAdjuster, Map<String, List<String>> responseHeaders, ExtractorInput extractorInput) throws InterruptedException, IOException {
    if (previousExtractor != null) {
      if (isReusable(previousExtractor)) {
        return buildResult(previousExtractor);
      } else 
<<<<<<< commits-hd_100/google/ExoPlayer/5da4c67c8ab3a657047b64aa8beef3213b7dd7cb-8a403c37592b727be25056c85790fc40525d30e1/A.java
      {
...
>>>>>>> commits-hd_100/google/ExoPlayer/5da4c67c8ab3a657047b64aa8beef3213b7dd7cb-8a403c37592b727be25056c85790fc40525d30e1/B.java
    }
        ...
        if (lastPathSegment.endsWith(AC3_FILE_EXTENSION) || lastPathSegment.endsWith(EC3_FILE_EXTENSION)) {
          ...
          if (lastPathSegment.endsWith(AC4_FILE_EXTENSION)) {
            ...
            if (lastPathSegment.endsWith(MP3_FILE_EXTENSION)) {
              ...
              if (lastPathSegment.endsWith(MP4_FILE_EXTENSION) || lastPathSegment.startsWith(M4_FILE_EXTENSION_PREFIX, lastPathSegment.length() - 4) || lastPathSegment.startsWith(MP4_FILE_EXTENSION_PREFIX, lastPathSegment.length() - 5) || lastPathSegment.startsWith(CMF_FILE_EXTENSION_PREFIX, lastPathSegment.length() - 5)) {
  ...
  private static TsExtractor createTsExtractor(@DefaultTsPayloadReaderFactory.Flags int userProvidedPayloadReaderFactoryFlags, Format format, List<Format> muxedCaptionFormats, TimestampAdjuster timestampAdjuster) {
