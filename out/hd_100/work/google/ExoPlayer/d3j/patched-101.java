...
class PlayerView extends FrameLayout
{
   ...
   @IntDef({SHOW_BUFFERING_NEVER, SHOW_BUFFERING_WHEN_PLAYING,
   ...
   private @Nullable ErrorMessageProvider<? super ExoPlaybackException>
   ...
   PlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     if (attrs != null) {
       ...
       try {
         shutterColorSet =
         a.hasValue(R.styleable.PlayerView_shutter_background_color);
         shutterColor =
         a.getColor(R.styleable.PlayerView_shutter_background_color,
           shutterColor);
         playerLayoutId =
         a.getResourceId(R.styleable.PlayerView_player_layout_id,
           playerLayoutId);
         useArtwork =
         a.getBoolean(R.styleable.PlayerView_use_artwork, useArtwork);
         defaultArtworkId =
         a.getResourceId(R.styleable.PlayerView_default_artwork,
           defaultArtworkId);
         useController =
         a.getBoolean(R.styleable.PlayerView_use_controller, useController);
         surfaceType =
         a.getInt(R.styleable.PlayerView_surface_type, surfaceType);
         resizeMode =
         a.getInt(R.styleable.PlayerView_resize_mode, resizeMode);
         controllerShowTimeoutMs =
         a.getInt(R.styleable.PlayerView_show_timeout,
           controllerShowTimeoutMs);
         controllerHideOnTouch =
         a.getBoolean(R.styleable.PlayerView_hide_on_touch,
           controllerHideOnTouch);
         controllerAutoShow =
         a.getBoolean(R.styleable.PlayerView_auto_show, controllerAutoShow);
         showBuffering =
         a.getInteger(R.styleable.PlayerView_show_buffering, showBuffering);
     ...
     if (contentFrame != null && surfaceType != SURFACE_TYPE_NONE) {
       ...
       switch (surfaceType) {
         ...
         case SURFACE_TYPE_MONO360_VIEW:
           ...
           SphericalSurfaceView sphericalSurfaceView =
             new SphericalSurfaceView(context);
     ...
     if (defaultArtworkId != 0) {
       defaultArtwork =
       ContextCompat.getDrawable(getContext(), defaultArtworkId);
     }
     ...
     this.controllerShowTimeoutMs =
     controller != null ? controllerShowTimeoutMs : 0;
   ...
   public
   static
   void switchTargetView(@NonNull Player player, 
   ...
   void setPlayer(Player player) {
     ...
     if (this.player != null) {
       ...
       Player.VideoComponent oldVideoComponent =
         this.player.getVideoComponent();
   ...
   @Deprecated
   public
   void setDefaultArtwork(Bitmap defaultArtwork) {
   ...
   @Deprecated
   public
   void setShowBuffering(boolean showBuffering) {
     setShowBuffering(showBuffering ? SHOW_BUFFERING_WHEN_PLAYING : SHOW_BUFFERING_NEVER);
   }
   public
   void setShowBuffering(@ShowBuffering int showBuffering) {
   ...
   public
   void setErrorMessageProvider(@Nullable ErrorMessageProvider<? super ExoPlaybackException> errorMessageProvider) {
   ...
   public
   void setCustomErrorMessage(@Nullable CharSequence message) {
   ...
   public
   void setControllerVisibilityListener(PlayerControlView.VisibilityListener listener) {
     Assertions.checkState(controller != null);
     controller.setVisibilityListener(listener);
   }
   public
   void setPlaybackPreparer(@Nullable PlaybackPreparer playbackPreparer) {
     Assertions.checkState(controller != null);
     controller.setPlaybackPreparer(playbackPreparer);
   }
   public
   void setControlDispatcher(@Nullable ControlDispatcher controlDispatcher) {
     Assertions.checkState(controller != null);
     controller.setControlDispatcher(controlDispatcher);
   }
   public
   void setRewindIncrementMs(int rewindMs) {
     Assertions.checkState(controller != null);
     controller.setRewindIncrementMs(rewindMs);
   }
   public
   void setFastForwardIncrementMs(int fastForwardMs) {
     Assertions.checkState(controller != null);
     controller.setFastForwardIncrementMs(fastForwardMs);
   }
   public
   void setRepeatToggleModes(@RepeatModeUtil.RepeatToggleModes int repeatToggleModes) {
     Assertions.checkState(controller != null);
   ...
   public
   void setExtraAdGroupMarkers(@Nullable long[] extraAdGroupTimesMs, 
                               @Nullable boolean[] extraPlayedAdGroups) {
     Assertions.checkState(controller != null);
     controller.setExtraAdGroupMarkers(extraAdGroupTimesMs,
       extraPlayedAdGroups);
   }
   public
   ...
   boolean shouldShowControllerIndefinitely() {
     ...
     return controllerAutoShow && (playbackState == Player.STATE_IDLE || playbackState == Player.STATE_ENDED || !
     player.getPlayWhenReady());
   }
   private
   void showController(boolean showIndefinitely) {
     if (!useController) {
       return;
     }
   ...
   private
   void updateForCurrentTrackSelections(boolean isNewPlayer) {
   ...
   private
   boolean setArtworkFromMetadata(Metadata metadata) {
   ...
   private
   boolean setDrawableArtwork(Drawable drawable) {
     if (drawable != null) {
   ...
   private
   static
   void configureEditModeLogoV23(Resources resources, ImageView logo) {
   ...
   private
   static
   void configureEditModeLogo(Resources resources, ImageView logo) {
     logo.setImageDrawable(resources.getDrawable(R.drawable.exo_edit_mode_logo));
     logo.setBackgroundColor(resources.getColor(R.color.exo_edit_mode_background_color));
   }
   ...
   private
   static
   void setResizeModeRaw(AspectRatioFrameLayout aspectRatioFrame, 
                         int resizeMode) {
     aspectRatioFrame.setResizeMode(resizeMode);
   }
   private
   static
   void applyTextureViewRotation(TextureView textureView, 
     ...
     if (textureViewWidth == 0 || textureViewHeight == 0 || textureViewRotation == 0) {
       ...
       RectF originalTextureRect =
         new RectF(0, 0, textureViewWidth, textureViewHeight);
   ...
   class ComponentListener
     implements Player.EventListener, TextOutput, VideoListener, 
                OnLayoutChangeListener, SphericalSurfaceView.SurfaceListener
   {
      ...
      void onVideoSizeChanged(int width, int height, 
        ...
        if (surfaceView instanceof TextureView) {
          ...
          applyTextureViewRotation((TextureView)surfaceView,
            textureViewRotation);
        } else if (surfaceView instanceof SphericalSurfaceView) {
          videoAspectRatio = 0;
        }
      ...
      @Override
      public
      void onTracksChanged(TrackGroupArray tracks, 
      ...
      @Override
      public
      void onLayoutChange(View view, int left, int top, int right, 
