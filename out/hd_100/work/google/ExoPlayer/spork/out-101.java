 ...
 * values are {@code surface_view}, {@code texture_view}, {@code spherical_view} and {@code none}. Using {@code none} is recommended for audio only applications, since creating the
 ...
 * of a custom extension of {@link PlayerControlView}. Note that attributes such as {@code rewind_increment} will not be automatically propagated through to this instance. If a view
 ...
 * PlayerView. This will cause the specified layout to be inflated instead of {@code exo_player_view.xml} for only the instance on which the attribute is set.
 */
public class PlayerView extends FrameLayout {
   ...
   *
   * @param showBuffering
   * 		Whether the buffering icon is displayer
   */
   ...
   *
   * <ul>
   * <li>{@link SurfaceView} by default, or if the {@code surface_type} attribute is set to {@code surface_view}.
