...
public abstract class MediaCodecRenderer extends BaseRenderer {
   ...
   *
   * @param trackType
   * 		The track type that the renderer handles. One of the {@code C.TRACK_TYPE_*}
   ...
   */
  private static boolean isDrmSchemeSupported(DrmSessionManager drmSessionManager, @Nullable
