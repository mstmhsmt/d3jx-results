...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    static public class DecoderInitializationException extends Exception {
        ...
        final public boolean secureDecoderRequired;

        final public String decoderName;

        final public String diagnosticInfo;
    ...
    @Override
    final public int supportsMixedMimeTypeAdaptation() {
        return ADAPTIVE_NOT_SEAMLESS;
    }

    @Override
    final public int supportsFormat(Format format) throws ExoPlaybackException {
        try {
    ...
    final protected void maybeInitCodec() throws ExoPlaybackException {
...
<<<<<<< commits-hd_100/google/ExoPlayer/7a109f741153e2924f7e698dd5554491df10f635-8fb9bc9271c3639806d1e1249e34d9db1556180b/A.java

=======
codecIsAdaptive = decoderInfo.adaptive;
>>>>>>> commits-hd_100/google/ExoPlayer/7a109f741153e2924f7e698dd5554491df10f635-8fb9bc9271c3639806d1e1249e34d9db1556180b/B.java
    ...
    final protected MediaCodec getCodec() {
        return codec;
    }
    ...
    final protected MediaCodecInfo getCodecInfo() {
        return codecInfo;
    }
