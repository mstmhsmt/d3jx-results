...
public abstract class MediaCodecRenderer extends BaseRenderer {
  ...
  @Override
  public final int supportsFormat(Format format) throws ExoPlaybackException throws ExoPlaybackException {
    try {
  ...
  protected MediaCodecInfo getDecoderInfo(MediaCodecSelector mediaCodecSelector,
      Format format, boolean requiresSecureDecoder) throws DecoderQueryException throws DecoderQueryException {
  ...
  protected final void maybeInitCodec() throws ExoPlaybackException throws ExoPlaybackException {
...
>>>>>>> theirs
  ...
  @Override
  protected void onEnabled(boolean joining) throws ExoPlaybackException throws ExoPlaybackException {
    decoderCounters = new DecoderCounters();
  }
  
  @Override
  protected void onPositionReset(long positionUs, boolean joining) throws ExoPlaybackException throws ExoPlaybackException {
  ...
  @Override
  public void render(long positionUs, long elapsedRealtimeUs) throws ExoPlaybackException throws ExoPlaybackException {
  ...
  protected void flushCodec() throws ExoPlaybackException throws ExoPlaybackException {
    codecHotswapDeadlineMs = C.TIME_UNSET;
    inputIndex = C.INDEX_UNSET;
    outputIndex = C.INDEX_UNSET;
    waitingForFirstSyncFrame = true;
   ...
   */
  private boolean feedInputBuffer() throws ExoPlaybackException throws ExoPlaybackException {
  ...
  private boolean shouldWaitForKeys(boolean bufferEncrypted) throws ExoPlaybackException throws ExoPlaybackException {
   ...
   */
  protected void onInputFormatChanged(Format newFormat) throws ExoPlaybackException throws ExoPlaybackException {
   ...
   */
  private void processOutputFormat() throws ExoPlaybackException throws ExoPlaybackException {
   ...
   */
  protected void renderToEndOfStream() throws ExoPlaybackException throws ExoPlaybackException {
    // Do nothing.
  }
   ...
   */
  private void processEndOfStream() throws ExoPlaybackException throws ExoPlaybackException {
