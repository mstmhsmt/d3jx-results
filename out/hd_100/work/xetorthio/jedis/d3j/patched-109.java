...
public
class TransactionCommandsTest extends JedisCommandTestBase
{
   ...
   @Test
   public
   void watch() throws UnknownHostException, IOException {
   ...
   @Test
   public
   void unwatch() throws UnknownHostException, IOException {
     jedis.watch("mykey");
   ...
   @Test
   public
   void transactionResponseBinary() {
     jedis.set("string", "foo");
     jedis.lpush("list", "foo");
     jedis.hset("hash", "foo", "bar");
     jedis.zadd("zset", 1, "foo");
   ...
   @Test(expected=JedisDataException.class)
   public
   void transactionResponseWithinPipeline() {
     jedis.set("string", "foo");
     Transaction t = jedis.multi();
     Response<String> string = t.get("string");
     string.get();
   ...
   @Test
   public
   void transactionResponseWithError() {
     Transaction t = jedis.multi();
     t.set("foo", "bar");
