...
public class JedisSentinelPoolTest extends JedisTestBase {
  ...
  protected static HostAndPort slave2 = HostAndPortUtil.getRedisServers().get(4);
  ...
  @Before public void setUp() throws Exception {
    ...
    slaves.add(slave1);
    slaves.add(slave2);
    JedisSentinelTestUtil.waitForSentinelRecognizeRedisReplication(sentinel1, MASTER_NAME, master, slaves);
    JedisSentinelTestUtil.waitForSentinelRecognizeRedisReplication(sentinel2, MASTER_NAME, master, slaves);
  }

  @Test public void ensureSafeTwiceFailover() throws InterruptedException {
  ...
  private void waitForFailover(JedisSentinelPool pool, HostAndPort oldMaster) throws InterruptedException {
    HostAndPort newMaster = JedisSentinelTestUtil.waitForNewPromotedMaster(sentinel1, MASTER_NAME, oldMaster);
