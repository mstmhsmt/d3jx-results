...
public class TransactionCommandsTest extends JedisCommandTestBase {
    ...
    @Test
    public void watch() throws UnknownHostException, IOException throws UnknownHostException, IOException {
    ...
    @Test
    public void unwatch() throws UnknownHostException, IOException throws UnknownHostException, IOException {
    	jedis.watch("mykey");
