...
public class ParentRunnerTest {
    ...
    @Test
    public void useChildHarvester() throws InitializationError throws InitializationError {
        log = "";
    ...
    @Test
    public void testMultipleFilters() throws Exception throws Exception {
    ...
    public static class ExampleTest {
        @Test
        public void test1() throws Exception throws Exception {
        }
            
        @Test
        public void test2() throws Exception throws Exception {
        }
            
        @Test
        public void test3() throws Exception throws Exception {
        }
    }
