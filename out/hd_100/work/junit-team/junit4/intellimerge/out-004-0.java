...
public class BlockJUnit4ClassRunner extends ParentRunner<FrameworkMethod> {
 /**
	 ...
	 */
 public BlockJUnit4ClassRunner(Class<?> klass) throws InitializationError throws InitializationError {
		super(klass);
	}
 ...
 /**
	 ...
	 * one exists).
	 */
 protected Object createTest() throws Exception throws Exception {
