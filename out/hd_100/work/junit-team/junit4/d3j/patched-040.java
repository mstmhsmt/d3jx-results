...
class ParentRunnerTest
{
   ...
   @Test
   public
   void useChildHarvester() throws InitializationError {
     log = "";
   ...
   void testMultipleFilters() throws Exception {
     ...
     Request requestFilteredFiltered =
       requestFiltered.filterWith(new Exclude("test2"));
     Result result = junitCore.run(requestFilteredFiltered);
     assertThat(result.getFailures(), isEmpty());
     assertEquals(1, result.getRunCount());
   }
   private
   Matcher<List<?>> isEmpty() {
     return new TypeSafeMatcher<List<?>>()
            {
               ...
               @Override
               public
               boolean matchesSafely(List<?> item) {
                 return item.size() == 0;
               }
            };
   }
