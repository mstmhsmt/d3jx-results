...
public class BlockJUnit4ClassRunner extends ParentRunner<FrameworkMethod> {
  ...
  protected void validateZeroArgConstructor(List<Throwable> errors) {
    if (hasOneConstructor() &&
        !(getTestClass().getOnlyConstructor().getParameterTypes().length ==
          0)) {
      String gripe =
...
<<<<<<< /root/work/junit-team/junit4/d3j/patched-004-0.java
                                  Statement statement) {
    List<TestRule> testRules = getTestRules(target);
    return testRules.isEmpty()
        ? statement
        : new RunRules(statement, testRules, describeChild(method));
||||||| /root/work/junit-team/junit4/d3j/base-004.java
                                  Statement result) {
    return TestRule.applyAll(getTestRules(target), result,
...
>>>>>>> /root/work/junit-team/junit4/d3j/patched-004-1.java
  }
