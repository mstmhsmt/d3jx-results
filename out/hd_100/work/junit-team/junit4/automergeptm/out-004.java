...
public class BlockJUnit4ClassRunner extends ParentRunner<FrameworkMethod> {
  ...
  @SuppressWarnings(value = { "deprecation" }) private boolean isMethodRule(Class<?> type) {
  ...
  @SuppressWarnings(value = { "deprecation" }) private Statement withMethodRules(FrameworkMethod method, Object target, Statement result) {
  ...
  @SuppressWarnings(value = { "deprecation" }) private List<org.junit.rules.MethodRule> getMethodRules(Object target) {
  ...
  private Statement withTestRules(FrameworkMethod method, Object target, Statement statement) {
    List<TestRule> testRules = getTestRules(target);return testRules.isEmpty() ? statement : new RunRules(statement, testRules, describeChild(method));
    return 
<<<<<<< commits-hd_100/junit-team/junit4/d6ccf5b0fa4e0d62eac42425a593b870af1247bd-6d443ab3fb882687b37d2b5625dd228c18997e00/A.java
    testRules.isEmpty() ? statement : new RunRules(statement, testRules, describeChild(method))
=======
    result
>>>>>>> commits-hd_100/junit-team/junit4/d6ccf5b0fa4e0d62eac42425a593b870af1247bd-6d443ab3fb882687b37d2b5625dd228c18997e00/B.java
    ;
  }
