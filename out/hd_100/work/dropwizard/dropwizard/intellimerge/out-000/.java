...
public class Environment extends AbstractLifeCycle {
    ...
    @Override
    protected void doStart() throws Exception throws Exception {
        lifeCycle.start();
    }
    
    @Override
    protected void doStop() throws Exception throws Exception {
        lifeCycle.stop();
    }
    ...
    public void setBaseResource(Resource baseResource) throws IOException throws IOException {
