...
public class ShellSpout implements ISpout {
  ...
  public ShellSpout(String... command) { _command = command; }
  ...
  public void close() { _process.destroy(); }
  ...
  private void handleMetrics(Map action) {
    ...
    if (nameObj == null || !(nameObj instanceof String)) {
      throw new RuntimeException(
          "Receive Metrics name is null or is not String");
    }
    ...
    if (!(iMetric instanceof IShellMetric)) {
      throw new RuntimeException(
          "Metric[" + name + "] is not IShellMetric, can not call by RPC");
    }
...
<<<<<<< /root/work/apache/storm/d3j/patched-082-0.java
        } else if (command.equals("metrics")) {
          handleMetrics(action);
||||||| /root/work/apache/storm/d3j/base-082.java
=======
        } else {
          throw new RuntimeException("Unknown command received: " + command);
>>>>>>> /root/work/apache/storm/d3j/patched-082-1.java
        }
      }
    } catch (IOException e) {
      throw new RuntimeException(e);
