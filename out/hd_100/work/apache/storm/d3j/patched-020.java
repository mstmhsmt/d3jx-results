...
<<<<<<< /root/work/apache/storm/d3j/patched-020-0.java
           date = "2015-5-14")
||||||| /root/work/apache/storm/d3j/base-020.java
           date = "2015-4-10")
=======
           date = "2015-9-3")
>>>>>>> /root/work/apache/storm/d3j/patched-020-1.java
public class LocalAssignment
    implements org.apache.thrift
                   .TBase<LocalAssignment, LocalAssignment._Fields>,
               java.io.Serializable, Cloneable, Comparable<LocalAssignment> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
      new org.apache.thrift.protocol.TStruct("LocalAssignment");
  private static final org.apache.thrift.protocol
      .TField TOPOLOGY_ID_FIELD_DESC = new org.apache.thrift.protocol.TField(
      "topology_id", org.apache.thrift.protocol.TType.STRING, (short)1);
  private static final org.apache.thrift.protocol.TField EXECUTORS_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "executors", org.apache.thrift.protocol.TType.LIST, (short)2);
  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes =
      new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class,
                new LocalAssignmentStandardSchemeFactory());
  ...
  .apache.thrift.TFieldIdEnum {
    TOPOLOGY_ID((short)1, "topology_id"), EXECUTORS((short)2, "executors");
  ...
  static {
    Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap =
        new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
            _Fields.class);
    tmpMap.put(_Fields.TOPOLOGY_ID,
               new org.apache.thrift.meta_data.FieldMetaData(
                   "topology_id",
                   org.apache.thrift.TFieldRequirementType.REQUIRED,
                   new org.apache.thrift.meta_data.FieldValueMetaData(
                       org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.EXECUTORS,
               new org.apache.thrift.meta_data.FieldMetaData(
                   "executors",
                   org.apache.thrift.TFieldRequirementType.REQUIRED,
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
        LocalAssignment.class, metaDataMap);
  }
  ...
  public LocalAssignment(LocalAssignment other) {
    ...
    if (other.is_set_executors()) {
      List<ExecutorInfo> __this__executors =
          new ArrayList<ExecutorInfo>(other.executors.size());
  ...
  public LocalAssignment deepCopy() { return new LocalAssignment(this); }
  @Override
  public void clear() {
    this.topology_id = null;
    this.executors = null;
  }
  public String get_topology_id() { return this.topology_id; }
  public void set_topology_id(String topology_id) {
    this.topology_id = topology_id;
  }
  public void unset_topology_id() { this.topology_id = null; }
  public boolean is_set_topology_id() { return this.topology_id != null; }
  ...
  public List<ExecutorInfo> get_executors() { return this.executors; }
  public void set_executors(List<ExecutorInfo> executors) {
    this.executors = executors;
  }
  public void unset_executors() { this.executors = null; }
  public boolean is_set_executors() { return this.executors != null; }
  ...
  public int compareTo(LocalAssignment other) {
    ...
    lastComparison = Boolean.valueOf(is_set_topology_id())
                         .compareTo(other.is_set_topology_id());
    if (lastComparison != 0) {
    ...
    if (is_set_executors()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.executors,
                                                               other.executors);
      if (lastComparison != 0) {
        return lastComparison;
      }
  ...
  public void validate() throws org.apache.thrift.TException {
    if (!is_set_topology_id()) {
      throw new org.apache.thrift.protocol.TProtocolException(
          "Required field 'topology_id' is unset! Struct:" + toString());
    }
    if (!is_set_executors()) {
      throw new org.apache.thrift.protocol.TProtocolException(
          "Required field 'executors' is unset! Struct:" + toString());
    }
  }
  ...
  private static class LocalAssignmentStandardSchemeFactory
      implements SchemeFactory {
    public LocalAssignmentStandardScheme getScheme() {
      return new LocalAssignmentStandardScheme();
    }
  }
  private static class LocalAssignmentStandardScheme
      extends StandardScheme<LocalAssignment> {
    public void read(org.apache.thrift.protocol.TProtocol iprot,
                     LocalAssignment struct)
        throws org.apache.thrift.TException {
...
>>>>>>> /root/work/apache/storm/d3j/patched-020-1.java
  ...
  private static class LocalAssignmentTupleScheme
      extends TupleScheme<LocalAssignment> {
    @Override
...
>>>>>>> /root/work/apache/storm/d3j/patched-020-1.java
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot,
      ...
      {
<<<<<<< /root/work/apache/storm/d3j/patched-020-0.java
        org.apache.thrift.protocol.TList _list567 =
||||||| /root/work/apache/storm/d3j/base-020.java
        org.apache.thrift.protocol.TList _list451 =
=======
        org.apache.thrift.protocol.TList _list479 =
>>>>>>> /root/work/apache/storm/d3j/patched-020-1.java
