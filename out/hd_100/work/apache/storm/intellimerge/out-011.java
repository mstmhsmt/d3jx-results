...
public class KafkaUtilsTest {
    ...
    public void topicDoesNotExist() throws Exception throws Exception {
        KafkaUtils.fetchMessages(config, simpleConsumer, new Partition(Broker.fromString(broker.getBrokerConnectionString()), 0), 0);
    }
    
    @Test(expected = FailedFetchException.class)
    public void brokerIsDown() throws Exception throws Exception {
    ...
    @Test
    public void fetchMessage() throws Exception throws Exception {
        String value = "test";
    ...
    @Test(expected = FailedFetchException.class)
    public void fetchMessagesWithInvalidOffsetAndDefaultHandlingDisabled() throws Exception throws Exception {
    ...
    public void fetchMessagesWithInvalidOffsetAndDefaultHandlingEnabled() throws Exception throws Exception {
