...
public class TopologySummary implements org.apache.thrift.TBase<TopologySummary, TopologySummary._Fields>, java.io.Serializable, Cloneable, Comparable<TopologySummary> {
    ...
    static final public Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
        ...
        static public _Fields findByThriftIdOrThrow(int fieldId) {
        ...
        static public _Fields findByName(String name) {
        ...
        static public _Fields findByThriftId(int fieldId) {
            switch(fieldId) {
                case 1:
                    return ID;
                case 2:
