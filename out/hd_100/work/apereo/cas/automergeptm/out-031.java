...
public class GoogleAccountsService extends AbstractWebApplicationService {
  ...
  /**
     ...
     */
  protected GoogleAccountsService(final String id, final String relayState, final String requestId, final PrivateKey privateKey, final PublicKey publicKey, final ServicesManager servicesManager) {
  ...
  /**
     ...
     * @param servicesManager the services manager
     */
  protected GoogleAccountsService(final String id, final String originalUrl, final String artifactId, final String relayState, final String requestId, final PrivateKey privateKey, final PublicKey publicKey, final ServicesManager servicesManager) {
  ...
  @Override public Response getResponse(final String ticketId) {
    final Map<String, String> parameters = new HashMap<>();
    final String samlResponse = constructSamlResponse();
    final String signedResponse = BUILDER.signSamlResponse(samlResponse, this.privateKey, this.publicKey);
  ...
  /**
     ...
     * @return true if the service is already logged out.
     */
  @Override public boolean isLoggedOutAlready() {
    return true;
  }
  ...
  private String constructSamlResponse() {
    ...
    final org.opensaml.saml.saml2.core.Response response = BUILDER.newResponse(BUILDER.generateSecureRandomId(), currentDateTime, getId(), this);
