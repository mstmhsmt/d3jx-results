...
<<<<<<< /root/work/apereo/cas/d3j/patched-108-0.java
...
||||||| /root/work/apereo/cas/d3j/base-108.java
  @Test
  public void testBadCredentialsOnTicketGrantingTicketCreation() {
    try {
      getCentralAuthenticationService().createTicketGrantingTicket(
...
=======
  ...
  public void testBadCredentialsOnTicketGrantingTicketCreation()
    ...
    getCentralAuthenticationService().createTicketGrantingTicket(
        TestUtils.getCredentialsWithDifferentUsernameAndPassword());
>>>>>>> /root/work/apereo/cas/d3j/patched-108-1.java
  }
  @Test
<<<<<<< /root/work/apereo/cas/d3j/patched-108-0.java
  public void testGoodCredentialsOnTicketGrantingTicketCreation()
      throws Exception {
    assertNotNull(getCentralAuthenticationService().createTicketGrantingTicket(
...
>>>>>>> /root/work/apereo/cas/d3j/patched-108-1.java
  ...
  public void testGrantServiceTicketWithExpiredTicketGrantingTicket()
    ...
    ((CentralAuthenticationServiceImpl)getCentralAuthenticationService())
        .setTicketGrantingTicketExpirationPolicy(new ExpirationPolicy() {
          private static final long serialVersionUID = 1L;
          public boolean isExpired(final TicketState ticket) { return true; }
        });
    final String ticketId =
        getCentralAuthenticationService().createTicketGrantingTicket(
            TestUtils.getCredentialsWithSameUsernameAndPassword());
...
>>>>>>> /root/work/apereo/cas/d3j/patched-108-1.java
  ...
  public void testValidateServiceTicketWithExpires() throws Exception {
    ((CentralAuthenticationServiceImpl)getCentralAuthenticationService())
        .setServiceTicketExpirationPolicy(
            new MultiTimeUseOrTimeoutExpirationPolicy(1, 1100));
    final String ticketGrantingTicket =
        getCentralAuthenticationService().createTicketGrantingTicket(
            TestUtils.getCredentialsWithSameUsernameAndPassword());
  ...
  public void testValidateServiceTicketNonExistantTicket()
      throws TicketException {
    getCentralAuthenticationService().validateServiceTicket(
        "test", TestUtils.getService());
  }
  @Test
  public void testValidateServiceTicketWithoutUsernameAttribute()
      throws Exception {
    UsernamePasswordCredentials cred =
        TestUtils.getCredentialsWithSameUsernameAndPassword();
    final String ticketGrantingTicket =
        getCentralAuthenticationService().createTicketGrantingTicket(cred);
    final String serviceTicket =
        getCentralAuthenticationService().grantServiceTicket(
            ticketGrantingTicket, TestUtils.getService());
  ...
  @Test
  public void testValidateServiceTicketWithDefaultUsernameAttribute()
      throws Exception {
    UsernamePasswordCredentials cred =
        TestUtils.getCredentialsWithSameUsernameAndPassword();
    final String ticketGrantingTicket =
  ...
  @Test
  public void testValidateServiceTicketWithUsernameAttribute()
      throws Exception {
    UsernamePasswordCredentials cred =
        TestUtils.getCredentialsWithSameUsernameAndPassword();
    final String ticketGrantingTicket =
  ...
  @Test
  public void testValidateServiceTicketWithInvalidUsernameAttribute()
      throws Exception {
    UsernamePasswordCredentials cred =
        TestUtils.getCredentialsWithSameUsernameAndPassword();
    final String ticketGrantingTicket =
