...
public
class AbstractRegisteredServiceTests
{
   ...
   private final AbstractRegisteredService r =
     new AbstractRegisteredService()
     {
        ...
        protected
        AbstractRegisteredService newInstance() {
          return this;
        }
        public
   ...
   @Test
   public
   void testAllowToProxyIsFalseByDefault() {
   ...
   void testSettersAndGetters() {
     prepareService();
     assertEquals(ALLOWED_TO_PROXY,
       this.r.getProxyPolicy().isAllowedToProxy());
   ...
   @Test
   public
   void testServiceAttributeFilterAllAttributes() {
     prepareService();
     ...
     final Map<String,Object> attr =
       this.r.getAttributeReleasePolicy().getAttributes(p);
     assertEquals(attr.size(), map.size());
   }
   @Test
   public
   void testServiceAttributeFilterAllowedAttributes() {
     prepareService();
     final ReturnAllowedAttributeReleasePolicy policy =
   ...
   @Test
   public
   void testServiceAttributeFilterMappedAttributes() {
     prepareService();
     final ReturnMappedAttributeReleasePolicy policy =
       new ReturnMappedAttributeReleasePolicy();
