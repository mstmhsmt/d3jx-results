...
public final class OAuth20AuthorizeControllerTests {
  ...
  private static final String CAS_URL =
      CAS_SCHEME + "://" + CAS_SERVER + ":" + CAS_PORT;
  private static final String SERVICE_NAME = "serviceName";
  private static final String STATE = "state";
  @Test
  public void testNoClientId() throws Exception {
    final MockHttpServletRequest mockRequest = new MockHttpServletRequest(
        "GET", CONTEXT + OAuthConstants.AUTHORIZE_URL);
    mockRequest.setParameter(OAuthConstants.REDIRECT_URI, REDIRECT_URI);
    final MockHttpServletResponse mockResponse = new MockHttpServletResponse();
    final OAuth20WrapperController oauth20WrapperController =
        new OAuth20WrapperController();
    oauth20WrapperController.afterPropertiesSet();
<<<<<<< /root/work/apereo/cas/d3j/patched-261-0.java
    final Logger logger = mock(Logger.class);
    OAuth20AuthorizeController.setLogger(logger);
||||||| /root/work/apereo/cas/d3j/base-261.java
    final Logger log = mock(Logger.class);
    OAuth20AuthorizeController.setLogger(log);
=======
>>>>>>> /root/work/apereo/cas/d3j/patched-261-1.java
...
>>>>>>> /root/work/apereo/cas/d3j/patched-261-1.java
  ...
  public void testNoCasService() throws Exception {
    ...
    when(servicesManager.getAllServices())
        .thenReturn(new ArrayList<RegisteredService>());
    final OAuth20WrapperController oauth20WrapperController =
        new OAuth20WrapperController();
...
>>>>>>> /root/work/apereo/cas/d3j/patched-261-1.java
    ...
    assertEquals(OAuthConstants.ERROR_VIEW, modelAndView.getViewName());
<<<<<<< /root/work/apereo/cas/d3j/patched-261-0.java
    verify(logger).error("Unsupported redirectUri : {} for serviceId : {}",
                         REDIRECT_URI, OTHER_REDIRECT_URI);
||||||| /root/work/apereo/cas/d3j/base-261.java
    verify(log).error("Unsupported redirectUri : {} for serviceId : {}",
                      REDIRECT_URI, OTHER_REDIRECT_URI);
=======
>>>>>>> /root/work/apereo/cas/d3j/patched-261-1.java
  }
  ...
  public void testOK() throws Exception {
    ...
    assertEquals(REDIRECT_URI,
                 session.getAttribute(OAuthConstants.OAUTH20_CALLBACKURL));
    assertEquals(SERVICE_NAME,
                 session.getAttribute(OAuthConstants.OAUTH20_SERVICE_NAME));
    final View view = modelAndView.getView();
    assertTrue(view instanceof RedirectView);
    final RedirectView redirectView = (RedirectView)view;
    assertEquals(OAuthUtils.addParameter(
                     CAS_URL, "service",
                     CAS_URL + CONTEXT + OAuthConstants.CALLBACK_AUTHORIZE_URL),
                 redirectView.getUrl());
  }
  @Test
