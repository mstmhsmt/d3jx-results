...
public
class KryoTranscoderTests
{
   private static final String ST_ID =
     "ST-1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890ABCDEFGHIJK";
   private static final String TGT_ID =
     "TGT-1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890ABCDEFGHIJK-cas1";
   ...
   KryoTranscoderTests() {
     ...
     serializerMap.put(MockServiceTicket.class,
       new FieldSerializer(transcoder.getKryo(), MockServiceTicket.class));
     serializerMap.put(MockTicketGrantingTicket.class,
       new FieldSerializer(transcoder.getKryo(),
   ...
   @Test
   public
   void verifyEncodeDecode() throws Exception {
     final ServiceTicket expectedST = new MockServiceTicket(ST_ID);
     assertEquals(expectedST,
       transcoder.decode(transcoder.encode(expectedST)));
     final Credential userPassCredential =
   ...
   private
   void internalProxyTest(final String proxyUrl) throws MalformedURLException {
     ...
     final Credential proxyCredential =
       new HttpBasedServiceCredential(new URL(proxyUrl), svc);
     final TicketGrantingTicket expectedTGT =
   ...
   @Test
   public
   void verifyEncodeDecodeTGTWithUnmodifiableMap() throws Exception {
     final Credential userPassCredential =
       new UsernamePasswordCredential(USERNAME, PASSWORD);
     final TicketGrantingTicket expectedTGT =
       new MockTicketGrantingTicket(TGT_ID, userPassCredential,
   ...
   @Test
   public
   void verifyEncodeDecodeTGTWithUnmodifiableList() throws Exception {
     final Credential userPassCredential =
       new UsernamePasswordCredential(USERNAME, PASSWORD);
   ...
   @Test
   public
   void verifyEncodeDecodeTGTWithLinkedHashMap() throws Exception {
     final Credential userPassCredential =
       new UsernamePasswordCredential(USERNAME, PASSWORD);
     final TicketGrantingTicket expectedTGT =
       new MockTicketGrantingTicket(TGT_ID, userPassCredential,
         new LinkedHashMap<String,Object>(this.principalAttributes));
     expectedTGT.grantServiceTicket(ST_ID, null, null, false);
     assertEquals(expectedTGT,
       transcoder.decode(transcoder.encode(expectedTGT)));
   }
   @Test
   public
   void verifyEncodeDecodeTGTWithListOrderedMap() throws Exception {
     final Credential userPassCredential =
       new UsernamePasswordCredential(USERNAME, PASSWORD);
     @SuppressWarnings("unchecked") final TicketGrantingTicket expectedTGT =
       new MockTicketGrantingTicket(TGT_ID, userPassCredential,
         ListOrderedMap.decorate(this.principalAttributes));
     expectedTGT.grantServiceTicket(ST_ID, null, null, false);
     assertEquals(expectedTGT,
       transcoder.decode(transcoder.encode(expectedTGT)));
   }
   @Test
   public
   void verifyEncodeDecodeTGTWithUnmodifiableSet() throws Exception {
     final Map<String,Object> newAttributes = new HashMap<>();
   ...
   @Test
   public
   void verifyEncodeDecodeTGTWithSingleton() throws Exception {
     final Map<String,Object> newAttributes = new HashMap<>();
   ...
   @Test
   public
   void verifyEncodeDecodeTGTWithSingletonMap() throws Exception {
   ...
   static
   class MockServiceTicket implements ServiceTicket
   {
      ...
      public
      boolean isValidFor(final Service service) {
        return false;
      }
      public
      TicketGrantingTicket grantTicketGrantingTicket(final String id, 
   ...
   static
   class MockTicketGrantingTicket implements TicketGrantingTicket
   {
      ...
      @NotNull private PrincipalFactory principalFactory =
      ...
      public
      MockTicketGrantingTicket(final String id, final Credential credential, 
                               final Map<String,Object> principalAttributes) {
        this.id = id;
        final CredentialMetaData credentialMetaData =
          new BasicCredentialMetaData(credential);
        final AuthenticationBuilder builder = new AuthenticationBuilder();
        builder.setPrincipal(this.principalFactory.createPrincipal(USERNAME,
                               principalAttributes));
        builder.setAuthenticationDate(new Date());
        builder.addCredential(credentialMetaData);
        builder.addAttribute(RememberMeCredential.AUTHENTICATION_ATTRIBUTE_REMEMBER_ME,
          Boolean.TRUE);
        final AuthenticationHandler handler =
          new MockAuthenticationHandler();
        try {
          builder.addSuccess(handler.getName(),
      ...
      @Override
      public
      ServiceTicket grantServiceTicket(final String id, 
      ...
      public
      boolean equals(final Object other) {
        return other instanceof MockTicketGrantingTicket && ((MockTicketGrantingTicket)other).getId().equals(this.id) && 
   ...
   public
   static
   class MockAuthenticationHandler implements AuthenticationHandler
   {
      @Override
      public
      HandlerResult authenticate(final Credential credential)
        throws GeneralSecurityException, PreventedException {
        if (credential instanceof HttpBasedServiceCredential) {
          return new HandlerResult(this,
                   (HttpBasedServiceCredential)credential);
        } else {
          return new HandlerResult(this,
                   new BasicCredentialMetaData(credential));
        }
