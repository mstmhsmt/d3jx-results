...
>>>>>>> theirs
    ...
    @Test
    public void testGoodCredentialsOnTicketGrantingTicketCreation() throws Exception throws Exception {
...
>>>>>>> theirs
    ...
    @Test
    public void testDestroyTicketGrantingTicketWithValidTicket() throws Exception throws Exception {
    ...
    public void testDestroyTicketGrantingTicketWithInvalidTicket() throws Exception throws Exception {
        final String ticketId = getCentralAuthenticationService()
            .createTicketGrantingTicket(
                TestUtils.getCredentialsWithSameUsernameAndPassword());
    ...
    @Test
    public void testGrantServiceTicketWithValidTicketGrantingTicket() throws Exception throws Exception {
        final String ticketId = getCentralAuthenticationService()
            .createTicketGrantingTicket(
                TestUtils.getCredentialsWithSameUsernameAndPassword());
...
>>>>>>> theirs
    ...
    @Test(expected = TicketException.class)
public void testGrantServiceTicketWithExpiredTicketGrantingTicket() throws Exception<<<<<<< ours
     throws Exception {
...
>>>>>>> theirs
    ...
    @Test
    public void testDelegateTicketGrantingTicketWithProperParams() throws Exception throws Exception {
        final String ticketId = getCentralAuthenticationService()
            .createTicketGrantingTicket(
                TestUtils.getCredentialsWithSameUsernameAndPassword());
        final String serviceTicketId = getCentralAuthenticationService()
...
>>>>>>> theirs
    ...
    @Test
    public void testGrantServiceTicketWithValidCredentials() throws Exception throws Exception {
...
>>>>>>> theirs
    ...
    @Test
    public void testGrantServiceTicketWithDifferentCredentials() throws Exception throws Exception {
        final String ticketGrantingTicket = getCentralAuthenticationService()
            .createTicketGrantingTicket(
                TestUtils.getCredentialsWithSameUsernameAndPassword());
            getCentralAuthenticationService().grantServiceTicket(
    ...
    @Test
    public void testValidateServiceTicketWithExpires() throws Exception throws Exception {
    ...
    @Test
    public void testValidateServiceTicketWithValidService() throws Exception throws Exception {
        final String ticketGrantingTicket = getCentralAuthenticationService()
            .createTicketGrantingTicket(
                TestUtils.getCredentialsWithSameUsernameAndPassword());
        final String serviceTicket = getCentralAuthenticationService()
    ...
    public void testValidateServiceTicketWithInvalidService() throws Exception throws Exception {
        final String ticketGrantingTicket = getCentralAuthenticationService()
            .createTicketGrantingTicket(
                TestUtils.getCredentialsWithSameUsernameAndPassword());
        final String serviceTicket = getCentralAuthenticationService()
...
>>>>>>> theirs
    ...
    @Test(expected = TicketException.class)
    public void testValidateServiceTicketNonExistantTicket() throws TicketException throws TicketException {
        getCentralAuthenticationService().validateServiceTicket("test",
                TestUtils.getService());
    }
    
    @Test
    public void testValidateServiceTicketWithoutUsernameAttribute() throws Exception throws Exception {
    ...
    @Test
    public void testValidateServiceTicketWithDefaultUsernameAttribute() throws Exception throws Exception {
        UsernamePasswordCredentials cred =  TestUtils.getCredentialsWithSameUsernameAndPassword();
        final String ticketGrantingTicket = getCentralAuthenticationService().createTicketGrantingTicket(cred);
    ...
    @Test
    public void testValidateServiceTicketWithUsernameAttribute() throws Exception throws Exception {
        UsernamePasswordCredentials cred =  TestUtils.getCredentialsWithSameUsernameAndPassword();
        final String ticketGrantingTicket = getCentralAuthenticationService().createTicketGrantingTicket(cred);
    ...
    @Test
    public void testValidateServiceTicketWithInvalidUsernameAttribute() throws Exception throws Exception {
        UsernamePasswordCredentials cred =  TestUtils.getCredentialsWithSameUsernameAndPassword();
        final String ticketGrantingTicket = getCentralAuthenticationService().createTicketGrantingTicket(cred);
