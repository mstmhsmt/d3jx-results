...
<<<<<<< commits-hd_100/apereo/cas/44e13271b35d009a118fb10b239b73aa55f12e09-424ac7ef2a417dce43157ab33494beb93ccba21d/A.java

=======
@Parameterized.Parameters
    static public List<Object[]> getTestParms() {
...
>>>>>>> commits-hd_100/apereo/cas/44e13271b35d009a118fb10b239b73aa55f12e09-424ac7ef2a417dce43157ab33494beb93ccba21d/B.java
    ...
    static public class MockAuthenticationHandler implements AuthenticationHandler {
    ...
    public void verifyEncodeDecodeTGTWithListOrderedMap() throws Exception {
        ...
        final TicketGrantingTicket expectedTGT = new MockTicketGrantingTicket(TGT_ID, userPassCredential, ListOrderedMap.decorate(this.principalAttributes));
        expectedTGT.grantServiceTicket(ST_ID, null, null, false);
        assertEquals(expectedTGT, transcoder.decode(transcoder.encode(expectedTGT)));
    }
