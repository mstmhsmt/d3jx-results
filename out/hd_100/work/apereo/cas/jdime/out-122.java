 ...
 * @since 3.0.0
 */
@SuppressWarnings(value = { "rawtypes" }) public class KryoTranscoderTests {
...
=======
  @Parameterized.Parameters public static List<Object[]> getTestParms() {
    final List<Object[]> params = new ArrayList<>(6);
    params.add(new Object[] { 1024 });
    params.add(new Object[] { 10 });
    return params;
  }
>>>>>>> commits-hd_100/apereo/cas/44e13271b35d009a118fb10b239b73aa55f12e09-424ac7ef2a417dce43157ab33494beb93ccba21d/B.java


  @Test public void verifyEncodeDecode() throws Exception {
  ...
  @Test public void verifyEncodeDecodeTGTWithUnmodifiableMap() throws Exception {
    final Credential userPassCredential = new UsernamePasswordCredential(USERNAME, PASSWORD);
    final TicketGrantingTicket expectedTGT = new MockTicketGrantingTicket(TGT_ID, userPassCredential, Collections.unmodifiableMap(this.principalAttributes));
    expectedTGT.grantServiceTicket(ST_ID, null, null, false);
    assertEquals(expectedTGT, transcoder.decode(transcoder.encode(expectedTGT)));
  }

  @Test public void verifyEncodeDecodeTGTWithUnmodifiableList() throws Exception {
    final Credential userPassCredential = new UsernamePasswordCredential(USERNAME, PASSWORD);
  ...
  @Test public void verifyEncodeDecodeTGTWithLinkedHashMap() throws Exception {
    final Credential userPassCredential = new UsernamePasswordCredential(USERNAME, PASSWORD);
    final TicketGrantingTicket expectedTGT = new MockTicketGrantingTicket(TGT_ID, userPassCredential, new LinkedHashMap<String, Object>(this.principalAttributes));
    expectedTGT.grantServiceTicket(ST_ID, null, null, false);
    assertEquals(expectedTGT, transcoder.decode(transcoder.encode(expectedTGT)));
  }

  @Test public void verifyEncodeDecodeTGTWithListOrderedMap() throws Exception {
    final Credential userPassCredential = new UsernamePasswordCredential(USERNAME, PASSWORD);
    @SuppressWarnings(value = { "unchecked" }) final TicketGrantingTicket expectedTGT = new MockTicketGrantingTicket(TGT_ID, userPassCredential, ListOrderedMap.decorate(this.principalAttributes));
    expectedTGT.grantServiceTicket(ST_ID, null, null, false);
    assertEquals(expectedTGT, transcoder.decode(transcoder.encode(expectedTGT)));
  }

  @Test public void verifyEncodeDecodeTGTWithUnmodifiableSet() throws Exception {
    final Map<String, Object> newAttributes = new HashMap<>();
  ...
  @Test public void verifyEncodeDecodeTGTWithSingleton() throws Exception {
    final Map<String, Object> newAttributes = new HashMap<>();
  ...
  @Test public void verifyEncodeDecodeTGTWithSingletonMap() throws Exception {
  ...
  static class MockTicketGrantingTicket implements TicketGrantingTicket {
    ...
    @NotNull private PrincipalFactory principalFactory = new DefaultPrincipalFactory();
...
>>>>>>> commits-hd_100/apereo/cas/44e13271b35d009a118fb10b239b73aa55f12e09-424ac7ef2a417dce43157ab33494beb93ccba21d/B.java
    ...
    @Override public List<Authentication> getSupplementalAuthentications() {
      return Collections.emptyList();
    }

    @Override public ServiceTicket grantServiceTicket(final String id, final Service service, final ExpirationPolicy expirationPolicy, final boolean credentialsProvided) {
      this.usageCount++;
      return new MockServiceTicket(id);
    }

    @Override public Map<String, Service> getServices() {
      return Collections.emptyMap();
    }

    @Override public void removeAllServices() {
    }

    @Override public void markTicketExpired() {
    }
    ...
    @Override public TicketGrantingTicket getRoot() {
      return this;
    }

    @Override public List<Authentication> getChainedAuthentications() {
      return Collections.emptyList();
    }
    ...
    @Override public TicketGrantingTicket getGrantingTicket() {
      return this;
    }
    ...
    @Override public int getCountOfUses() {
      return this.usageCount;
    }

    @Override public boolean equals(final Object other) {
      return other instanceof MockTicketGrantingTicket && ((MockTicketGrantingTicket) other).getId().equals(this.id) && ((MockTicketGrantingTicket) other).getCountOfUses() == this.usageCount && ((MockTicketGrantingTicket) other).getCreationTime() == this.creationDate.getTime() && ((MockTicketGrantingTicket) other).getAuthentication().equals(this.authentication);
    }

    @Override public int hashCode() {
      final HashCodeBuilder bldr = new HashCodeBuilder(17, 33);
      return bldr.append(this.id).append(this.usageCount).append(this.creationDate.getTime()).append(this.authentication).toHashCode();
    }
  }

  public static class MockAuthenticationHandler implements AuthenticationHandler {
    @Override public HandlerResult authenticate(final Credential credential) throws GeneralSecurityException, PreventedException {
    ...
    @Override public boolean supports(final Credential credential) {
      return true;
    }
