 ...
 * @since 2.0.0
 */
@Configuration(proxyBeanMethods = false) @EnableConfigurationProperties(value = LogFileWebEndpointProperties.class) public @ConditionalOnEnabledEndpoint(endpoint = LogFileWebEndpoint.class) class LogFileWebEndpointAutoConfiguration {
