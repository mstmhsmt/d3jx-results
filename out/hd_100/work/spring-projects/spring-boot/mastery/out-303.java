...
SslContextBuilder builder = SslContextBuilder.forClient().sslProvider(SslProvider.JDK).trustManager(InsecureTrustManagerFactory.INSTANCE).keyManager(clientKeyManagerFactory);HttpClient client = HttpClient.create().wiretap(true).secure((sslContextSpec) -> sslContextSpec.sslContext(builder));
=======
...
>>>>>>> commits-hd_100/spring-projects/spring-boot/4e734669fee9f770d6cc30cabfbf6931847a1dab-0fdf46acd9b4b5a0fb9708fa70320eb93ade5ae4/B.java
    ...
    protected static class CharsHandler implements HttpHandler {
        ...
        final static private DefaultDataBufferFactory factory = new DefaultDataBufferFactory();

        final private DataBuffer bytes;
