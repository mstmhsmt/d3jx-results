...
public class TomcatEmbeddedServletContainerFactory extends AbstractEmbeddedServletContainerFactory implements ResourceLoaderAware {
    ...
    static final public String DEFAULT_PROTOCOL = "org.apache.coyote.http11.Http11NioProtocol";
    ...
    private void configureSslKeyStore(AbstractHttp11JsseProtocol<?> protocol, Ssl ssl) {
        try {
            ...
            throw new EmbeddedServletContainerException("Could load key store: " + ex.getMessage(), ex);
        }
    ...
    private void configureSslTrustStore(AbstractHttp11JsseProtocol<?> protocol, Ssl ssl) {
        if (ssl.getTrustStore() != null) {
            try {
                ...
                throw new EmbeddedServletContainerException("Could load trust store: " + ex.getMessage(), ex);
            }
        }
    ...
    protected File createTempDir(String prefix) {
        try {
            ...
            throw new EmbeddedServletContainerException("Unable to create Tomcat tempdir. java.io.tmpdir is set to " + System.getProperty("java.io.tmpdir"), ex);
        }
    }
    ...
    private void customizeCompression(Connector connector) {
        ...
        if (handler instanceof AbstractHttp11Protocol) {
            ...
            protocol.setCompressableMimeTypes(StringUtils.arrayToCommaDelimitedString(compression.getMimeTypes()));
