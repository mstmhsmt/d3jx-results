...
public class DispatcherServletAutoConfiguration {
    ...
    static protected class DispatcherServletConfiguration {

        final private WebMvcProperties webMvcProperties;
    ...
    static protected class DispatcherServletRegistrationConfiguration {

        final private WebMvcProperties webMvcProperties;

        final private MultipartConfigElement multipartConfig;
        ...
        public DispatcherServletPathProvider dispatcherServletPathProvider() {
            return () -> Collections.singleton(DispatcherServletRegistrationConfiguration.this.webMvcProperties.getServlet().getPath());
        }
    }

    @Order(Ordered.LOWEST_PRECEDENCE - 10)
    static private class DefaultDispatcherServletCondition extends SpringBootCondition {
    ...
    @Order(Ordered.LOWEST_PRECEDENCE - 10)
    static private class DispatcherServletRegistrationCondition extends SpringBootCondition {
