...
public class ManagementSecurityAutoConfiguration {
    ...
    @Configuration
    static protected class ManagementSecurityPropertiesConfiguration implements SecurityPrequisite {
    ...
    @EnableWebSecurity
    static protected class WebSecurityEnabler extends AuthenticationManagerConfiguration {
    }
    ...
    static protected class ManagementWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
