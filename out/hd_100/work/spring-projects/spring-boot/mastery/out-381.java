...
static private final Set<String> IN_MEMORY_DRIVER_CLASS_NAMES = new HashSet<>(Arrays.asList("org.apache.derby.jdbc.EmbeddedDriver", "org.h2.Driver", "org.h2.jdbcx.JdbcDataSource", "org.hsqldb.jdbcDriver", "org.hsqldb.jdbc.JDBCDriver", "org.hsqldb.jdbc.pool.JDBCXADataSource"));
=======

>>>>>>> commits-hd_100/spring-projects/spring-boot/8c785b214bf87ea8888f84b3499565f56ff334f3-2c867b501353a7c313de789c24612aacc27f6c13/B.java
        ...
        static private enum InMemoryDatabase {

            DERBY(null, "org.apache.derby.jdbc.EmbeddedDriver"), H2("jdbc:h2:mem:", "org.h2.Driver", "org.h2.jdbcx.JdbcDataSource"), HQSQLDB("jdbc:hsqldb:mem:", "org.hsqldb.jdbcDriver", "org.hsqldb.jdbc.JDBCDriver", "org.hsqldb.jdbc.pool.JDBCXADataSource");
