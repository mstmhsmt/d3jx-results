...
public enum DatabaseDriver {
	...
	private DatabaseDriver(String id, String name, String driverClassName) {
		this(id, name, driverClassName, null);
	}

	private DatabaseDriver(String id, String name, String driverClassName, String xaDataSourceClassName) {
		this(id, name, driverClassName, xaDataSourceClassName, null);
	}

	private DatabaseDriver(String id, String productName, String driverClassName, String xaDataSourceClassName, String validationQuery) {
		this.id = id;
