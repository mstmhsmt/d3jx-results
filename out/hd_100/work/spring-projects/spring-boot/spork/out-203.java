 ...
 */
@EmbeddedServletContainerTest(launchers = { BootRunApplicationLauncher.class, IdeApplicationLauncher.class }, name = "jar")
public class EmbeddedServletContainerJarDevelopmentIntegrationTests {
	...
	public void metaInfResourceFromDependencyIsAvailableViaHttp(RestTemplate rest) {
		ResponseEntity<String> entity = rest.getForEntity("/nested-meta-inf-resource.txt", java.lang.String.class);
	...
	public void metaInfResourceFromDependencyIsAvailableViaServletContext(RestTemplate rest) {
		ResponseEntity<String> entity = rest.getForEntity("/servletContext?/nested-meta-inf-resource.txt", java.lang.String.class);
		assertThat(entity.getStatusCode()).isEqualTo(HttpStatus.OK);
	}
}
