...
@Conditional(DevToolsDataSourceAutoConfiguration.DevToolsDataSourceCondition.class)
@Configuration
public class DevToolsDataSourceAutoConfiguration {
	...
	static final class NonEmbeddedInMemoryDatabaseShutdownExecutor implements DisposableBean {
		...
		private static final enum InMemoryDatabase {
			...
			private InMemoryDatabase(String urlPrefix, String... driverClassNames) {
