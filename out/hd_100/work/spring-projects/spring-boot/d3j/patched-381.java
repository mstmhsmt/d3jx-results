...
@Configuration
public
class DevToolsDataSourceAutoConfiguration
{
   @Bean
   ...
   static
   final
   class NonEmbeddedInMemoryDatabaseShutdownExecutor
     implements DisposableBean
   {
      ...
      private
      boolean dataSourceRequiresShutdown() {
      ...
      enum InMemoryDatabase
      {
         ...
         InMemoryDatabase(String urlPrefix, String... driverClassNames) {
           ...
           new HashSet<>(Arrays.asList(driverClassNames));
         }
   ...
   static
   class DevToolsDataSourceCondition extends SpringBootCondition
     implements ConfigurationCondition
   {
      ...
      ConditionOutcome getMatchOutcome(ConditionContext context, 
        ...
        ConditionMessage.Builder message =
          ConditionMessage.forCondition("DevTools DataSource Condition");
        String[] dataSourceBeanNames =
          context.getBeanFactory().getBeanNamesForType(DataSource.class);
        ...
        BeanDefinition dataSourceDefinition =
          context.getRegistry().getBeanDefinition(dataSourceBeanNames[0]);
        ...
        ((AnnotatedBeanDefinition)dataSourceDefinition).getFactoryMethodMetadata().getDeclaringClassName().startsWith(
