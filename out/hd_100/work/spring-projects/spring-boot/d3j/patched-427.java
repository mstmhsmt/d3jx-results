...
<<<<<<< /root/work/spring-projects/spring-boot/d3j/patched-427-0.java
    this.rootJarFileUrl = this.rootJarFile.toURI().toString();
    System.out.println(this.rootJarFileUrl);
||||||| /root/work/spring-projects/spring-boot/d3j/base-427.java
    this.rootJarFileUrl = rootJarFile.toURI().toString();
    System.out.println(rootJarFileUrl);
=======
    this.rootJarFileUrl = this.rootJarFile.toURI().toString();
>>>>>>> /root/work/spring-projects/spring-boot/d3j/patched-427-1.java
  ...
  public void getManifest() throws Exception {
    assertThat(
        this.archive.getManifest().getMainAttributes().getValue("Built-By"),
        equalTo("j1"));
  }
  @Test
  ...
  @Test
  public void unpackedLocationsFromSameArchiveShareSameParent()
      throws Exception {
    setup(true);
    File nested = new File(
        this.archive
            .getNestedArchive(getEntriesMap(this.archive).get("nested.jar"))
            .getUrl()
            .toURI());
    File anotherNested =
        new File(this.archive
                     .getNestedArchive(
  ...
  public void getFilteredArchive() throws Exception {
    Archive filteredArchive =
        this.archive.getFilteredArchive(new Archive.EntryRenameFilter() {
          @Override
