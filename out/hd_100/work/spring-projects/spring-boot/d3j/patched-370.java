...
class EmbeddedServletContainerAutoConfiguration
{
   ...
   public
   DefaultServletContainerCustomizer serverPropertiesServletContainerCustomizer(
     ...
     implements ImportBeanDefinitionRegistrar, BeanFactoryAware
   {
      ...
      void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, 
        ...
        if (ObjectUtils.isEmpty(this.beanFactory.getBeanNamesForType(EmbeddedServletContainerCustomizerBeanPostProcessor.class,
                                  true, false))) {
        ...
        if (ObjectUtils.isEmpty(this.beanFactory.getBeanNamesForType(ErrorPageRegistrarBeanPostProcessor.class,
                                  true, false))) {
          RootBeanDefinition beanDefinition =
            new RootBeanDefinition(ErrorPageRegistrarBeanPostProcessor.class);
          beanDefinition.setSynthetic(true);
