...
public class TestEntityManagerTests {
  ...
  public void getIdForTypeWhenTypeIsWrongShouldThrowException()
    ...
    TestEntity entity = new TestEntity();
    given(this.persistenceUnitUtil.getIdentifier(entity)).willReturn(123);
<<<<<<< /root/work/spring-projects/spring-boot/d3j/patched-077-0.java
    this.thrown.expectMessage("ID mismatch: java.lang.Integer");
||||||| /root/work/spring-projects/spring-boot/d3j/base-077.java
...
>>>>>>> /root/work/spring-projects/spring-boot/d3j/patched-077-1.java
