...
<<<<<<< /root/work/spring-projects/spring-boot/d3j/patched-419-0.java
import org.springframework.boot.autoconfigure.web.ErrorController;
import org.springframework.boot.autoconfigure.web.ServerProperties;
||||||| /root/work/spring-projects/spring-boot/d3j/base-419.java
=======
import org.springframework.boot.autoconfigure.web.ServerProperties;
import org.springframework.boot.autoconfigure.web.ErrorController;
>>>>>>> /root/work/spring-projects/spring-boot/d3j/patched-419-1.java
...
public class ManagementSecurityAutoConfiguration {
  ...
  protected static class ManagementSecurityPropertiesConfiguration
    ...
    public void init() {
      if (this.management != null && this.security != null) {
        this.security.getUser().getRole().add(
  ...
  private static class IgnoredPathsWebSecurityConfigurerAdapter
    ...
    public void init(WebSecurity builder) throws Exception {
      ...
      ignored.addAll(
          Arrays.asList(getEndpointPaths(this.endpointHandlerMapping, false)));
      if (!this.management.getSecurity().isEnabled()) {
        ignored.addAll(
            Arrays.asList(getEndpointPaths(this.endpointHandlerMapping, true)));
      }
...
=======
      String[] paths = this.server.getPathsArray(ignored);
      ignored ignoring.antMatchers(paths);
>>>>>>> /root/work/spring-projects/spring-boot/d3j/patched-419-1.java
    }
  ...
  getEndpointPaths(EndpointHandlerMapping endpointHandlerMapping,
                   boolean secure) {
    if (endpointHandlerMapping == null) {
      return NO_PATHS;
    }
    Set<? extends MvcEndpoint> endpoints =
