...
public class LiquibaseAutoConfigurationTests {
  ...
  @Before public void init() {
    EnvironmentTestUtils.addEnvironment(this.context, "spring.datasource.name:liquibasetest");
  ...
  @Test public void testXmlChangeLog() throws Exception {
  ...
  @Test public void testJsonChangeLog() throws Exception {
  ...
  @Test public void testSqlChangeLog() throws Exception {
  ...
  @Test public void testOverrideLabels() throws Exception {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) public void testOverrideParameters() throws Exception {
  ...
  @Test public void testRollbackFile() throws Exception {
  ...
  @Test public void testLiquibaseDateSource() {
  ...
  @Configuration static class LiquibaseDataSourceConfiguration {
    ...
    @LiquibaseDataSource @Bean public DataSource liquibaseDataSource() {
