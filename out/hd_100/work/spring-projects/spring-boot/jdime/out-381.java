 ...
 * @since 1.3.3
 */
@AutoConfigureAfter(value = DataSourceAutoConfiguration.class) @Conditional(value = DevToolsDataSourceCondition.class) @Configuration public class DevToolsDataSourceAutoConfiguration {
  @Bean NonEmbeddedInMemoryDatabaseShutdownExecutor inMemoryDatabaseShutdownExecutor(DataSource dataSource, DataSourceProperties dataSourceProperties) {
    return new NonEmbeddedInMemoryDatabaseShutdownExecutor(dataSource, dataSourceProperties);
  }

  @Configuration @ConditionalOnClass(value = LocalContainerEntityManagerFactoryBean.class) @ConditionalOnBean(value = AbstractEntityManagerFactoryBean.class) static class DatabaseShutdownExecutorJpaDependencyConfiguration extends EntityManagerFactoryDependsOnPostProcessor {
...
<<<<<<< commits-hd_100/spring-projects/spring-boot/8c785b214bf87ea8888f84b3499565f56ff334f3-2c867b501353a7c313de789c24612aacc27f6c13/A.java
    private static final Set<String> IN_MEMORY_DRIVER_CLASS_NAMES = new HashSet<>(Arrays.asList("org.apache.derby.jdbc.EmbeddedDriver", "org.h2.Driver", "org.h2.jdbcx.JdbcDataSource", "org.hsqldb.jdbcDriver", "org.hsqldb.jdbc.JDBCDriver", "org.hsqldb.jdbc.pool.JDBCXADataSource"));
=======
>>>>>>> Unknown file: This is a bug in JDime.
    ...
    private static enum InMemoryDatabase {
      ...
      HQSQLDB("jdbc:hsqldb:mem:", "org.hsqldb.jdbcDriver", "org.hsqldb.jdbc.JDBCDriver", "org.hsqldb.jdbc.pool.JDBCXADataSource")
      ;
