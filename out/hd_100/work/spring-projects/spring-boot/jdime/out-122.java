 ...
 */
@ClassPathExclusions(value = "spring-webmvc-*") class JerseyChildManagementContextConfigurationTests {
  ...
  @Test void autoConfigurationIsConditionalOnServletWebApplication() {
  ...
  @Test void autoConfigurationIsConditionalOnClassResourceConfig() {
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Test void jerseyApplicationPathIsAutoConfigured() {
  ...
  @Test @SuppressWarnings(value = { "unchecked" }) void servletRegistrationBeanIsAutoConfigured() {
    this.contextRunner.run((context) -> {
  ...
  @Test void resourceConfigCustomizerBeanIsNotRequired() {
    this.contextRunner.run((context) -> assertThat(context).hasSingleBean(ResourceConfig.class));
  }


<<<<<<< commits-hd_100/spring-projects/spring-boot/262eb686d02edd03afe438e54d8bf20bf6de25ea-895d76e5921d368bd698a012fed465b077b44b8c/A.java
  @Configuration(proxyBeanMethods = false) static class CustomizerConfiguration {
