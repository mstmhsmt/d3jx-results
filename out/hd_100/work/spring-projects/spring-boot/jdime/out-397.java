 ...
 * @see ShellProperties
 */
@Configuration @ConditionalOnClass(value = { PluginLifeCycle.class }) @EnableConfigurationProperties(value = { ShellProperties.class }) @AutoConfigureAfter(value = { SecurityAutoConfiguration.class, ManagementSecurityAutoConfiguration.class }) public class CrshAutoConfiguration {
  @Autowired private ShellProperties properties;

  @Bean @ConditionalOnExpression(value = "\'${shell.auth:simple}\' == \'jaas\'") @ConditionalOnMissingBean(value = { CrshShellAuthenticationProperties.class }) public CrshShellAuthenticationProperties jaasAuthenticationProperties() {
    return new JaasAuthenticationProperties();
  }

  @Bean @ConditionalOnExpression(value = "\'${shell.auth:simple}\' == \'key\'") @ConditionalOnMissingBean(value = { CrshShellAuthenticationProperties.class }) public CrshShellAuthenticationProperties keyAuthenticationProperties() {
    return new KeyAuthenticationProperties();
  }

  @Bean @ConditionalOnExpression(value = "\'${shell.auth:simple}\' == \'simple\'") @ConditionalOnMissingBean(value = { CrshShellAuthenticationProperties.class }) public CrshShellAuthenticationProperties simpleAuthenticationProperties() {
    return new SimpleAuthenticationProperties();
  }

  @Bean @ConditionalOnMissingBean(value = { PluginLifeCycle.class }) public PluginLifeCycle shellBootstrap() {
  ...
  @Configuration @ConditionalOnBean(value = { AuthenticationManager.class }) @AutoConfigureAfter(value = CrshAutoConfiguration.class) public static class AuthenticationManagerAdapterAutoConfiguration {
    @Autowired(required = false) private ManagementServerProperties management;

    @Bean public CRaSHPlugin<?> shellAuthenticationManager() {
      return new AuthenticationManagerAdapter();
    }

    @Bean @ConditionalOnExpression(value = "\'${shell.auth:spring}\' == \'spring\'") @ConditionalOnMissingBean(value = { CrshShellAuthenticationProperties.class }) public CrshShellAuthenticationProperties springAuthenticationProperties() {
  ...
  @SuppressWarnings(value = { "rawtypes" }) private static class AuthenticationManagerAdapter extends CRaSHPlugin<AuthenticationPlugin> implements AuthenticationPlugin<String> {
    ...
    @Autowired(required = false) private AccessDecisionManager accessDecisionManager;

    private String[] roles = new String[] { "ADMIN" };

    @Override public boolean authenticate(String username, String password) throws Exception {
    ...
    @Override public Class<String> getCredentialType() {
      return String.class;
    }

    @Override public AuthenticationPlugin<String> getImplementation() {
      return this;
    }
    ...
    @Override protected Iterable<PropertyDescriptor<?>> createConfigurationCapabilities() {
  ...
  private static class BeanFactoryFilteringPluginDiscovery extends ServiceLoaderDiscovery {
    ...
    @Override @SuppressWarnings(value = { "rawtypes" }) public Iterable<CRaSHPlugin<?>> getPlugins() {
  ...
  private static class SimpleFileSystemDriver extends AbstractFSDriver<ResourceHandle> {
    ...
    @Override public Iterable<ResourceHandle> children(ResourceHandle handle) throws IOException {
    ...
    @Override public long getLastModified(ResourceHandle handle) throws IOException {
    ...
    @Override public boolean isDir(ResourceHandle handle) throws IOException {
      return handle instanceof DirectoryHandle;
    }

    @Override public String name(ResourceHandle handle) throws IOException {
      return handle.getName();
    }

    @Override public Iterator<InputStream> open(ResourceHandle handle) throws IOException {
      if (handle instanceof FileHandle) {
    ...
    @Override public ResourceHandle root() throws IOException {
      return this.root;
    }
  }
