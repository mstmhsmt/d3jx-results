...
public class TestEntityManagerTests {
  ...
  @Test public void createWhenEntityManagerIsNullShouldThrowException() throws Exception {
    this.thrown.expect(IllegalArgumentException.class);
    this.thrown.expectMessage("EntityManagerFactory must not be null");
    new TestEntityManager(null);
  }

  @Test public void persistAndGetIdShouldPersistAndGetId() throws Exception {
    bindEntityManager();
  ...
  @Test public void persistAndGetIdForTypeShouldPersistAndGetId() throws Exception {
    bindEntityManager();
    TestEntity entity = new TestEntity();
    given(this.persistenceUnitUtil.getIdentifier(entity)).willReturn(123);
  ...
  @Test public void persistShouldPersist() throws Exception {
    bindEntityManager();
    TestEntity entity = new TestEntity();
  ...
  @Test public void persistAndFlushShouldPersistAndFlush() throws Exception {
    bindEntityManager();
    TestEntity entity = new TestEntity();
  ...
  @Test public void persistFlushFindShouldPersistAndFlushAndFind() throws Exception {
    bindEntityManager();
    TestEntity entity = new TestEntity();
  ...
  @Test public void mergeShouldMerge() throws Exception {
    bindEntityManager();
    TestEntity entity = new TestEntity();
  ...
  @Test public void removeShouldRemove() throws Exception {
    bindEntityManager();
    TestEntity entity = new TestEntity();
  ...
  @Test public void findShouldFind() throws Exception {
    bindEntityManager();
    TestEntity entity = new TestEntity();
  ...
  @Test public void flushShouldFlush() throws Exception {
    bindEntityManager();
    this.testEntityManager.flush();
    verify(this.entityManager).flush();
  }

  @Test public void refreshShouldRefresh() throws Exception {
    bindEntityManager();
    TestEntity entity = new TestEntity();
  ...
  @Test public void clearShouldClear() throws Exception {
    bindEntityManager();
    this.testEntityManager.clear();
    verify(this.entityManager).clear();
  }

  @Test public void detachShouldDetach() throws Exception {
    bindEntityManager();
    TestEntity entity = new TestEntity();
  ...
  @Test public void getIdForTypeShouldGetId() throws Exception {
    TestEntity entity = new TestEntity();
    given(this.persistenceUnitUtil.getIdentifier(entity)).willReturn(123);
  ...
  @Test public void getIdForTypeWhenTypeIsWrongShouldThrowException() throws Exception {
    TestEntity entity = new TestEntity();
    given(this.persistenceUnitUtil.getIdentifier(entity)).willReturn(123);
    this.thrown.expectMessage(
<<<<<<< commits-hd_100/spring-projects/spring-boot/923393d5af80077c558b5b1bdc5cc882a12334a0-727fbe8cbd84657d81114e99dddeede8af4285c7/A.java
    "ID mismatch: java.lang.Integer"
=======
    "ID mismatch: Object of class [java.lang.Integer] " + "must be an instance of class java.lang.Long"
>>>>>>> commits-hd_100/spring-projects/spring-boot/923393d5af80077c558b5b1bdc5cc882a12334a0-727fbe8cbd84657d81114e99dddeede8af4285c7/B.java
    );
    this.testEntityManager.getId(entity, Long.class);
  }

  @Test public void getIdShouldGetId() throws Exception {
    TestEntity entity = new TestEntity();
    given(this.persistenceUnitUtil.getIdentifier(entity)).willReturn(123);
  ...
  @Test public void getEntityManagerShouldGetEntityManager() throws Exception {
    bindEntityManager();
    assertThat(this.testEntityManager.getEntityManager()).isEqualTo(this.entityManager);
  }

  @Test public void getEntityManagerWhenNotSetShouldThrowException() throws Exception {
