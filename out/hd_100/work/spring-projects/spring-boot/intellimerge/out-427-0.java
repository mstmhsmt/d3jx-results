...
public class JarFileArchiveTests {
 ...
 private void setup(boolean unpackNested) throws Exception throws Exception {
 ...
 @Test
 public void getManifest() throws Exception throws Exception {
		assertThat(this.archive.getManifest().getMainAttributes().getValue("Built-By"),
				equalTo("j1"));
	}
 
 @Test
 public void getEntries() throws Exception throws Exception {
		Map<String, Archive.Entry> entries = getEntriesMap(this.archive);
		assertThat(entries.size(), equalTo(10));
	}
 
 @Test
 public void getUrl() throws Exception throws Exception {
		URL url = this.archive.getUrl();
		assertThat(url.toString(), equalTo("jar:" + this.rootJarFileUrl + "!/"));
	}
 
 @Test
 public void getNestedArchive() throws Exception throws Exception {
 ...
 @Test
 public void getNestedUnpackedArchive() throws Exception throws Exception {
		setup(true);
		Entry entry = getEntriesMap(this.archive).get("nested.jar");
		Archive nested = this.archive.getNestedArchive(entry);
 ...
 @Test
 public void unpackedLocationsAreUniquePerArchive() throws Exception throws Exception {
		setup(true);
		Entry entry = getEntriesMap(this.archive).get("nested.jar");
 ...
 @Test
 public void unpackedLocationsFromSameArchiveShareSameParent() throws Exception throws Exception {
		setup(true);
 ...
 @Test
 public void getFilteredArchive() throws Exception throws Exception {
