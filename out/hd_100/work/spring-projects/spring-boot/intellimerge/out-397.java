...
public class CrshAutoConfiguration {
 ...
 public CrshShellAuthenticationProperties.class })
	public CrshShellAuthenticationProperties jaasAuthenticationProperties() {shell.auth:simple}' == 'jaas'")
	@ConditionalOnMissingBean({ CrshShellAuthenticationProperties.class })
 ...
 @ConditionalOnMissingBean({ CrshShellAuthenticationProperties.class })
 public CrshShellAuthenticationProperties.class })
	public CrshShellAuthenticationProperties keyAuthenticationProperties() {shell.auth:simple}' == 'key'")
	@ConditionalOnMissingBean({ CrshShellAuthenticationProperties.class })
 ...
 @ConditionalOnMissingBean({ CrshShellAuthenticationProperties.class })
 public CrshShellAuthenticationProperties.class })
	public CrshShellAuthenticationProperties simpleAuthenticationProperties() {shell.auth:simple}' == 'simple'")
	@ConditionalOnMissingBean({ CrshShellAuthenticationProperties.class })
 ...
 public PluginLifeCycle.class })
	public PluginLifeCycle shellBootstrap() { PluginLifeCycle.class })
 ...
 public static class AuthenticationManagerAdapterAutoConfiguration {
  ...
  @ConditionalOnMissingBean({ CrshShellAuthenticationProperties.class })
  public CrshShellAuthenticationProperties.class })
		public CrshShellAuthenticationProperties springAuthenticationProperties() {shell.auth:spring}' == 'spring'")
		@ConditionalOnMissingBean({ CrshShellAuthenticationProperties.class })
...
>>>>>>> theirs
 ...
 private static class AuthenticationManagerAdapter extends
  ...
  @Override
  public boolean authenticate(String username, String password) throws Exception throws Exception {
 ...
 private static class SimpleFileSystemDriver extends AbstractFSDriver<ResourceHandle> {
  ...
  @Override
  public long getLastModified(ResourceHandle handle) throws IOException throws IOException {
  ...
  @Override
  public boolean isDir(ResourceHandle handle) throws IOException throws IOException {
			return handle instanceof DirectoryHandle;
		}
   
  @Override
  public String name(ResourceHandle handle) throws IOException throws IOException {
			return handle.getName();
		}
   
  @Override
  public Iterator<InputStream> open(ResourceHandle handle) throws IOException throws IOException {
			if (handle instanceof FileHandle) {
  ...
  @Override
  public ResourceHandle root() throws IOException throws IOException {
			return this.root;
		}
 ...
 private static class DirectoryHandle extends ResourceHandle {
  ...
  public List<ResourceHandle> members() throws IOException throws IOException {
 ...
 private static class FileHandle extends ResourceHandle {
  ...
  public InputStream openStream() throws IOException throws IOException {
