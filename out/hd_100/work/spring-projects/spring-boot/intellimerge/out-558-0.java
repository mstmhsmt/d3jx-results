...
public class LogbackLoggingSystemTests extends AbstractLoggingSystemTests {
 ...
 @Test
 public void noFile() throws Exception throws Exception {
 ...
 @Test
 public void withFile() throws Exception throws Exception {
		this.loggingSystem.beforeInitialize();
		this.logger.info("Hidden");
 ...
 @Test
 public void testBasicConfigLocation() throws Exception throws Exception {
		this.loggingSystem.beforeInitialize();
 ...
 @Test
 public void testNonDefaultConfigLocation() throws Exception throws Exception {
		this.loggingSystem.beforeInitialize();
 ...
 public void testNonexistentConfigLocation() throws Exception throws Exception {
		this.loggingSystem.beforeInitialize();
		this.loggingSystem.initialize("classpath:logback-nonexistent.xml", null);
	}
 
 @Test
 public void setLevel() throws Exception throws Exception {
		this.loggingSystem.beforeInitialize();
		this.loggingSystem.initialize(null, null);
