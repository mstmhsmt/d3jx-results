...
public class TestEntityManagerTests {
 ...
 @Test
 public void persistAndGetIdShouldPersistAndGetId() throws Exception throws Exception {
		bindEntityManager();
 ...
 @Test
 public void persistAndGetIdForTypeShouldPersistAndGetId() throws Exception throws Exception {
		bindEntityManager();
		TestEntity entity = new TestEntity();
		given(this.persistenceUnitUtil.getIdentifier(entity)).willReturn(123);
 ...
 @Test
 public void persistShouldPersist() throws Exception throws Exception {
		bindEntityManager();
		TestEntity entity = new TestEntity();
 ...
 @Test
 public void persistAndFlushShouldPersistAndFlush() throws Exception throws Exception {
		bindEntityManager();
		TestEntity entity = new TestEntity();
 ...
 @Test
 public void persistFlushFindShouldPersistAndFlushAndFind() throws Exception throws Exception {
		bindEntityManager();
		TestEntity entity = new TestEntity();
 ...
 @Test
 public void mergeShouldMerge() throws Exception throws Exception {
		bindEntityManager();
		TestEntity entity = new TestEntity();
 ...
 @Test
 public void removeShouldRemove() throws Exception throws Exception {
		bindEntityManager();
		TestEntity entity = new TestEntity();
 ...
 @Test
 public void findShouldFind() throws Exception throws Exception {
		bindEntityManager();
		TestEntity entity = new TestEntity();
 ...
 @Test
 public void flushShouldFlush() throws Exception throws Exception {
		bindEntityManager();
 ...
 @Test
 public void refreshShouldRefresh() throws Exception throws Exception {
		bindEntityManager();
		TestEntity entity = new TestEntity();
 ...
 @Test
 public void clearShouldClear() throws Exception throws Exception {
		bindEntityManager();
 ...
 @Test
 public void detachShouldDetach() throws Exception throws Exception {
		bindEntityManager();
		TestEntity entity = new TestEntity();
 ...
 @Test
 public void getIdForTypeShouldGetId() throws Exception throws Exception {
		TestEntity entity = new TestEntity();
		given(this.persistenceUnitUtil.getIdentifier(entity)).willReturn(123);
 ...
 @Test
 public void getIdShouldGetId() throws Exception throws Exception {
		TestEntity entity = new TestEntity();
		given(this.persistenceUnitUtil.getIdentifier(entity)).willReturn(123);
 ...
 @Test
 public void getEntityManagerShouldGetEntityManager() throws Exception throws Exception {
		bindEntityManager();
