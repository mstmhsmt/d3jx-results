...
<<<<<<< commits-hd_100/skylot/jadx/84cb6b9569d998548b333e0d388c14d0a75aeb6e-0b9970fd0d87bdae091f9588653e22ebda3bdea9/A.java
 ...
 */
@JadxVisitor(name = "ModVisitor", desc = "Modify method instructions", runBefore = CodeShrinkVisitor.class) public class ModVisitor extends AbstractVisitor {
    ...
    for (BlockNode block : mth.getBasicBlocks()) {
      ...
      for (int i = 0; i < size; i++) {
        ...
        switch (insn.getType()) {
          ...
          if (!ArgType.isCastNeeded(mth.dex(), castArg.getType(), castType) || isCastDuplicate((IndexInsnNode) insn)) {
  ...
  private static Map<InsnArg, FieldNode> getArgsToFieldsMapping(MethodNode callMthNode, ConstructorInsn co) {
    ...
    for (int i = startArg; i < argsCount; i++) {
      ...
      if (useInsn.getType() == InsnType.IPUT) {
        ...
        if (useInsn.getType() == InsnType.CONSTRUCTOR) {
  ...
  private static InsnNode makeFilledArrayInsn(MethodNode mth, NewArrayNode newArrayNode, FillArrayNode insn) {
    ...
    if (!elType.equals(insnElementType) && !insnArrayType.equals(ArgType.OBJECT)) {
      ErrorsCounter.methodWarn(mth, "Incorrect type for fill-array insn " + InsnUtils.formatOffset(insn.getOffset()) + ", element type: " + elType + ", insn element type: " + insnElementType);
    }
...
>>>>>>> commits-hd_100/skylot/jadx/84cb6b9569d998548b333e0d388c14d0a75aeb6e-0b9970fd0d87bdae091f9588653e22ebda3bdea9/B.java
