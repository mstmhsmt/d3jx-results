...
class ConsoleScreen extends CoreScreenLayer
{
   ...
   public
   void initialise() {
     final ScrollableArea scrollArea =
       find("scrollArea", ScrollableArea.class);
     ...
     commandLine.subscribe(new ActivateEventListener()
                           {
                              ...
                              void onActivated(UIWidget widget) {
                                console.execute(commandLine.getText(),
     ...
     history.bindText(new ReadOnlyBinding<String>()
                      {
                         ...
                         String get() {
                           ...
                           Iterator<Message> messageIterator =
                             console.getMessages().iterator();
                           while (messageIterator.hasNext()) {
                             Message message = messageIterator.next();
                             messageList.append(FontColor.getColored(
                                                  message.getMessage(),
                                                  message.getType().getColor()));
                             messageList.append("\n");
   ...
   @Override
   protected
   InteractionListener getScreenListener() {
