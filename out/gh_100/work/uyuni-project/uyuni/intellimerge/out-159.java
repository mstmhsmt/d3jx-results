...
public class ConfigTest extends RhnBaseTestCase {
     ...
     */
    public void testOverride() throws Exception throws Exception {
     ...
     */
    public void testOverride1() throws Exception throws Exception {
     ...
     * Accessed fully qualified.
     */
    public void testOverride2() throws Exception throws Exception {
     ...
     * Accessed by property name only.
     */
    public void testOverride3() throws Exception throws Exception {
    ...
    public void testGetStringArray1Elem() throws Exception throws Exception {
        String[] elems = c.getStringArray("prefix.array_one_element");
        assertEquals(1, elems.length);
        assertEquals("some value", elems[0]);
    }
    
    public void testGetStringArrayNull() throws Exception throws Exception {
     ...
     */
    public void testGetBoolean() throws Exception throws Exception {
     ...
     * Test -10, 0, 100, y
     */
    public void testGetInt() throws Exception throws Exception {
    ...
    public void testGetInteger() throws Exception throws Exception {
     ...
     */
    public void testGetStringArrayMultElem() throws Exception throws Exception {
    ...
    public void testSetBoolean() throws Exception throws Exception {
    ...
    public void testSetString() throws Exception throws Exception {
    ...
    public void testGetUndefinedInt() throws Exception throws Exception {
    ...
    public void testNamespaceProperties() throws Exception throws Exception {
