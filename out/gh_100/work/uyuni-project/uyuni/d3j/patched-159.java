...
public
class ConfigTest extends RhnBaseTestCase
{
   ...
   public
   void testOverride1() throws Exception {
     assertEquals("keep", c.getString("to_override"));
   }
   public
   void testOverride2() throws Exception {
     assertEquals("1", c.getString("web.fq_to_override"));
   }
   public
   void testOverride3() throws Exception {
   ...
   public
   void testGetStringArrayMultElem() throws Exception {
   ...
   public
   void testGetUndefinedInt() throws Exception {
   ...
   public
   void testNamespaceProperties() throws Exception {
   ...
   void testDefaultValueQuoteQuote() {
     ...
     String somevalue =
       Config.get().getString("somevalue8923984", "xmlrpc.rhn.redhat.com");
