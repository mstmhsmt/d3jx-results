...
public
class ErrataFactory extends HibernateFactory
{
   ...
   public static final String ERRATA_TYPE_ENHANCEMENT =
   ...
   public
   static
   List<Long> listErrataChannelPackages(Long cid, Long eid) {
     Map<String,Object> params = new HashMap<String,Object>();
     params.put("channel_id", cid);
     params.put("errata_id", eid);
     DataResult<ErrataPackageFile> dr =
       executeSelectMode("ErrataCache_queries",
   ...
   public
   static
   List lookupByIdentifier(String identifier, Org org) {
     Long eid = null;
     ...
     if (eid != null) {
       ...
       if (errata == null) {
         ...
         if ((prefix.equals("CVE") || prefix.equals("CAN")) && identifier.length() > 7 && 
         identifier.indexOf('-') == -1) {
           identifier =
           identifier.substring(0, 3) + "-" + identifier.substring(3, 7) + "-" + 
   ...
   public
   static
   Errata publish(Errata unpublished) {
     ...
     try {
       ...
       throw new HibernateRuntimeException("Errors occurred while publishing errata",
               e);
     } 
     return published;
   }
   public
   static
   List<Errata> publishToChannel(List<Errata> errataList, Channel chan, 
   ...
   List<Errata> publishToChannel(List<Errata> errataList, Channel chan, 
     ...
     List<com.redhat.rhn.domain.errata.Errata> toReturn =
       new ArrayList<Errata>();
     for (Errata errata : errataList) {
       ...
       for (PackageOverview packOver : packs) {
         Package pack =
           PackageFactory.lookupByIdAndUser(packOver.getId().longValue(),
             user);
         packagesToPush.add(pack);
       }
       Errata e =
         publishErrataPackagesToChannel(errata, chan, user, packagesToPush);
       toReturn.add(e);
     }
   ...
   public
   static
   Errata publishToChannel(Errata errata, Channel chan, User user, 
   ...
   private
   static
   void postPublishActions(Channel chan, User user) {
     ChannelManager.refreshWithNewestPackages(chan,
       "java::publishErrataPackagesToChannel");
   }
   private
   static
   Errata publishErrataPackagesToChannel(Errata errata, Channel chan, 
     ...
     for (Package pack : packages) {
       List<ErrataFile> publishedFiles =
         ErrataFactory.lookupErrataFile(errata, pack);
       ...
       if (publishedFiles.size() == 0) {
         ...
         ErrataFile publishedFile =
           ErrataFactory.createPublishedErrataFile(ErrataFactory.lookupErrataFileType("RPM"),
             pack.getChecksum().getChecksum(), path);
         ...
         for (ErrataFile publishedFile : publishedFiles) {
           String fileName =
             publishedFile.getFileName().substring(publishedFile.getFileName().lastIndexOf("/") + 1);
   ...
   public
   static
   Errata createClone(Org org, Errata e) {
   ...
   private
   static
   void copyDetails(Errata copy, Errata original, boolean clone) {
     if (!clone) {
     ...
     while (bugsItr.hasNext()) {
       ...
       if (copy.isPublished()) {
         cloneB =
         ErrataManager.createNewPublishedBug(bugIn.getId(),
           bugIn.getSummary(), bugIn.getUrl());
       } else {
         cloneB =
         ErrataManager.createNewUnpublishedBug(bugIn.getId(),
           bugIn.getSummary(), bugIn.getUrl());
       }
       copy.addBug(cloneB);
     }
   ...
   public
   static
   Errata createPublishedErrata() {
     return new PublishedErrata();
   }
   public
   static
   Errata createUnpublishedErrata() {
     return new UnpublishedErrata();
   }
   public
   static
   Bug createUnpublishedBug(Long id, String summary, String url) {
   ...
   public
   static
   Bug createPublishedBug(Long id, String summary, String url) {
   ...
   public
   static
   ErrataFile createUnpublishedErrataFile(ErrataFileType ft, String cs, 
                                          String name, Set packages) {
   ...
   public
   static
   ErrataFile createPublishedErrataFile(ErrataFileType ft, String cs, 
                                        String name) {
   ...
   public
   static
   ErrataFileType lookupErrataFileType(String label) {
     Session session = null;
     ErrataFileType retval = null;
     try {
       session = HibernateFactory.getSession();
       retval =
       (ErrataFileType)session.getNamedQuery("ErrataFileType.findByLabel").setString("label",
                         label).setCacheable(true).uniqueResult();
     } catch (HibernateException e) {
   ...
   public
   static
   List lookupErrataFilesByErrataAndFileType(Long errataId, String fileType) {
     Session session = null;
     List retval = null;
     try {
       session = HibernateFactory.getSession();
       Query q =
         session.getNamedQuery("PublishedErrataFile.listByErrataAndFileType");
       q.setLong("errata_id", errataId.longValue());
       q.setString("file_type", fileType.toUpperCase());
       retval = q.list();
       if (retval == null) {
         q =
         session.getNamedQuery("UnpublishedErrataFile.listByErrataAndFileType");
         q.setLong("errata_id", errataId.longValue());
         q.setString("file_type", fileType.toUpperCase());
         retval = q.list();
       }
   ...
   public
   static
   List lookupErratasByAdvisoryType(String advisoryType) {
     Session session = null;
     List retval = null;
     try {
       session = HibernateFactory.getSession();
       retval =
       session.getNamedQuery("PublishedErrata.findByAdvisoryType").setString("type",
         advisoryType).setCacheable(true).list();
   ...
   public
   static
   Errata lookupPublishedErrataById(Long id) {
     Session session = null;
     Errata retval = null;
     try {
       session = HibernateFactory.getSession();
       retval =
       (Errata)session.getNamedQuery("PublishedErrata.findById").setLong("id",
   ...
   public
   static
   Errata lookupByAdvisory(String advisory, Org org) {
     Session session = null;
     Errata retval = null;
     session = HibernateFactory.getSession();
     retval =
     (Errata)session.getNamedQuery("PublishedErrata.findByAdvisoryName").setParameter("advisory",
               advisory).setParameter("org", org).uniqueResult();
     if (retval == null) {
       retval =
       (Errata)session.getNamedQuery("UnpublishedErrata.findByAdvisoryName").setParameter("advisory",
                 advisory).setParameter("org", org).uniqueResult();
     }
     return retval;
   }
   public
   static
   Errata lookupByAdvisoryId(String advisoryId, Org org) {
     Session session = null;
     Errata retval = null;
     try {
       session = HibernateFactory.getSession();
       retval =
       (Errata)session.getNamedQuery("PublishedErrata.findByAdvisory").setParameter("advisory",
                 advisoryId).setParameter("org", org).uniqueResult();
       if (retval == null) {
         retval =
         (Errata)session.getNamedQuery("UnpublishedErrata.findByAdvisory").setParameter("advisory",
                   advisoryId).setParameter("org", org).uniqueResult();
       }
     } catch (HibernateException e) {
   ...
   public
   static
   List lookupByCVE(String cve) {
     List retval = new LinkedList();
     SelectMode mode =
       ModeFactory.getMode("Errata_queries", "erratas_for_cve");
     Map<String,Object> params = new HashMap<String,Object>();
     params.put("cve", cve);
   ...
   public
   static
   List lookupByOriginal(Org org, Errata original) {
     Session session = null;
     List retval = null;
     try {
       session = HibernateFactory.getSession();
       retval =
       session.getNamedQuery("UnpublishedClonedErrata.findByOriginal").setParameter("original",
         original).setParameter("org", org).list();
       if (retval == null) {
   ...
   public
   static
   List lookupPublishedByOriginal(Org org, Errata original) {
     Session session = null;
     List retval = null;
     try {
       session = HibernateFactory.getSession();
       retval =
       session.getNamedQuery("PublishedClonedErrata.findByOriginal").setParameter("original",
         original).setParameter("org", org).list();
     } catch (HibernateException e) {
       throw new HibernateRuntimeException("Error looking up errata by original errata");
     } 
   ...
   public
   static
   List listSamePublishedInChannels(Org org, Channel channelFrom, 
                                    Channel channelTo) {
     Session session = null;
     List retval = null;
     try {
       session = HibernateFactory.getSession();
       retval =
       session.getNamedQuery("PublishedErrata.findSameInChannels").setParameter("channel_from",
         channelFrom).setParameter("channel_to", channelTo).list();
     } catch (HibernateException e) {
       throw new HibernateRuntimeException("Error looking up errata by original errata");
     } 
     return retval;
   ...
   public
   static
   List listPublishedBrothersInChannels(Org org, Channel channelFrom, 
                                        Channel channelTo) {
     Session session = null;
     List retval = null;
     try {
       session = HibernateFactory.getSession();
       retval =
       session.getNamedQuery("PublishedClonedErrata.findBrothersInChannel").setParameter("channel_from",
         channelFrom).setParameter("channel_to", channelTo).list();
     } catch (HibernateException e) {
       throw new HibernateRuntimeException("Error looking up errata by original errata");
     } 
   ...
   public
   static
   List listPublishedClonesInChannels(Org org, Channel channelFrom, 
                                      Channel channelTo) {
     Session session = null;
     List retval = null;
     try {
       session = HibernateFactory.getSession();
       retval =
       session.getNamedQuery("PublishedErrata.findClonesInChannel").setParameter("channel_from",
         channelFrom).setParameter("channel_to", channelTo).list();
     } catch (HibernateException e) {
       throw new HibernateRuntimeException("Error looking up errata by original errata");
     } 
   ...
   public
   static
   void save(Errata errataIn) {
     singleton.saveObject(errataIn);
   }
   public
   static
   void removeBug(Bug deleteme) {
     singleton.removeObject(deleteme);
   }
   public
   static
   void remove(Keyword deleteme) {
     singleton.removeObject(deleteme);
   }
   public
   static
   void removeFile(ErrataFile deleteme) {
     singleton.removeObject(deleteme);
   }
   public
   static
   List lookupByChannelSorted(Org org, Channel channel) {
     return HibernateFactory.getSession().getNamedQuery("PublishedErrata.lookupSortedByChannel").setParameter("org",
              org).setParameter("channel", channel).list();
   }
   public
   static
   List<Errata> lookupByChannelBetweenDates(Org org, Channel channel, 
                                            String startDate, String endDate) {
     return HibernateFactory.getSession().getNamedQuery("PublishedErrata.lookupByChannelBetweenDates").setParameter("org",
              org).setParameter("channel", channel).setParameter("start_date",
              startDate).setParameter("end_date", endDate).list();
   }
   public
   static
   List<ErrataFile> lookupErrataFile(Errata errata, Package pack) {
     Map<String,Object> params = new HashMap<String,Object>();
     params.put("errata", errata);
     params.put("package", pack);
     return singleton.listObjectsByNamedQuery("PublishedErrataFile.lookupByErrataAndPackage",
              params);
   }
   public
   static
   List<ErrataOverview> search(List eids, Org org) {
     Map<String,Object> params = new HashMap<String,Object>();
     params.put("eids", eids);
     params.put("org_id", org.getId());
     List results =
       singleton.listObjectsByNamedQuery("PublishedErrata.searchById",
         params);
   ...
   public
   static
   List<ErrataOverview> searchByPackageIds(List pids) {
     Map<String,Object> params = new HashMap<String,Object>();
     ...
     List results =
       singleton.listObjectsByNamedQuery("PublishedErrata.searchByPackageIds",
         params);
     if (log.isDebugEnabled()) {
   ...
   public
   static
   List<ErrataOverview> searchByPackageIdsWithOrg(List pids, Org org) {
     Map<String,Object> params = new HashMap<String,Object>();
     params.put("pids", pids);
     params.put("org_id", org.getId());
     if (log.isDebugEnabled()) {
     ...
     List results =
       singleton.listObjectsByNamedQuery("PublishedErrata.searchByPackageIdsWithOrg",
         params);
     if (log.isDebugEnabled()) {
   ...
   public
   static
   void syncErrataDetails(PublishedClonedErrata cloned) {
     copyDetails(cloned, cloned.getOriginal(), true);
   }
   public
   static
   List<Errata> listErrata(Collection<Long> ids) {
     return singleton.listObjectsByNamedQuery("PublishedErrata.listByIds",
              new HashMap(), ids, "list");
   }
   public
   static
   DataResult<ErrataOverview> relevantToOneChannelButNotAnother(Long fromCid, 
                                                                Long toCid) {
     SelectMode mode =
       ModeFactory.getMode("Errata_queries",
   ...
   public
   static
   DataResult<OwnedErrata> listPublishedOwnedUnmodifiedClonedErrata(Long orgId) {
     SelectMode mode =
       ModeFactory.getMode("Errata_queries",
   ...
   public
   static
   Set<String> listAdvisoriesEndingWith(String ending) {
     SelectMode mode =
       ModeFactory.getMode("Errata_queries", "advisories_ending_with");
     Map<String,Object> params = new HashMap<String,Object>();
   ...
   public
   static
   Set<String> listAdvisoryNamesEndingWith(String ending) {
     SelectMode mode =
       ModeFactory.getMode("Errata_queries", "advisory_names_ending_with");
     Map<String,Object> params = new HashMap<String,Object>();
     params.put("ending", "%" + ending);
     List<Map<String,Object>> results = mode.execute(params);
     Set<String> ret = new HashSet<String>();
   ...
   public
   static
   ErrataOverview getOverviewById(Long eid) {
     SelectMode mode =
       ModeFactory.getMode("Errata_queries", "overview_by_id");
     Map<String,Object> params = new HashMap<String,Object>();
     params.put("eid", eid);
     DataResult<ErrataOverview> results = mode.execute(params);
     if (results.size() == 0) {
   ...
   public
   static
   ErrataOverview getOverviewByAdvisory(String advisory) {
     SelectMode mode =
       ModeFactory.getMode("Errata_queries", "overview_by_advisory");
     Map<String,Object> params = new HashMap<String,Object>();
   ...
   public
   static
   ErrataOverview cloneErratum(Long originalEid, String advisory, 
                               String advisoryName, Long orgId) {
     WriteMode m =
       ModeFactory.getWriteMode("Errata_queries", "clone_erratum");
     Map<String,Object> params = new HashMap<String,Object>();
