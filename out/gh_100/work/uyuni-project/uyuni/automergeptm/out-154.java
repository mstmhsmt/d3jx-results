...
public class ErrataFactory extends HibernateFactory {
  ...
  /**
     ...
     */
  public static List<Errata> publishToChannel(List<Errata> errataList, Channel chan, User user, boolean inheritPackages) {
  ...
  /**
     ...
     * @return the published errata
     */
  public static List<Errata> publishToChannel(List<Errata> errataList, Channel chan, User user, boolean inheritPackages, boolean performPostActions) {
  ...
  /**
     ...
     * @return the published errata
     */
  public static Errata publishToChannel(Errata errata, Channel chan, User user, Set<Package> packages) {
    if (!errata.isPublished()) {
      errata = publish(errata);
    }
    errata.addChannel(chan);
  ...
  /**
     ...
     */
  public static ErrataFile createUnpublishedErrataFile(ErrataFileType ft, String cs, String name, Set packages) {
  ...
  /**
     ...
     */
  public static ErrataFile createPublishedErrataFile(ErrataFileType ft, String cs, String name) {
  ...
  /**
     ...
     * @return new Published Errata File
     */
  public static ErrataFile createPublishedErrataFile(ErrataFileType ft, String cs, String name, Set packages) {
  ...
  /**
     ...
     */
  public static List listSamePublishedInChannels(Org org, Channel channelFrom, Channel channelTo) {
    Session session = null;
    List retval = null;
    try {
      session = HibernateFactory.getSession();
  ...
  /**
     ...
     * @return list of errata
     */
  public static List listPublishedBrothersInChannels(Org org, Channel channelFrom, Channel channelTo) {
    Session session = null;
    List retval = null;
    try {
      session = HibernateFactory.getSession();
  ...
  /**
     ...
     * @return list of errata
     */
  public static List listPublishedClonesInChannels(Org org, Channel channelFrom, Channel channelTo) {
    Session session = null;
    List retval = null;
    try {
      session = HibernateFactory.getSession();
  ...
  /**
     ...
     */
  public static DataResult<OwnedErrata> listPublishedOwnedUnmodifiedClonedErrata(Long orgId) {
