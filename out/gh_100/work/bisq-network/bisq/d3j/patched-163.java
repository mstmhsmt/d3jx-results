...
@Slf4j
public
class AppSetupWithP2P extends AppSetup
{
   ...
   @Inject
   public
   AppSetupWithP2P(P2PService p2PService, 
                   TradeStatisticsManager tradeStatisticsManager, 
                   AccountAgeWitnessService accountAgeWitnessService, 
                   SignedWitnessService signedWitnessService, 
                   FilterManager filterManager, TorSetup torSetup, 
                   Config config) {
     super(config);
   ...
   void initBasicServices() {
     ...
     p2PService.getP2PDataStorage().readFromResources(postFix,
       this::startInitP2PNetwork);
   }
   private
   void startInitP2PNetwork() {
   ...
   private
   BooleanProperty initP2PNetwork() {
     ...
     p2PService.getNetworkNode().addConnectionListener(new ConnectionListener()
                                                       {
                                                          ...
                                                          Connection connection) {
                                                            if (connection.getPeerType() == Connection.PeerType.SEED_NODE && closeConnectionReason == CloseConnectionReason.RULE_VIOLATION) {
                                                              ...
                                                              log.warn("RULE_VIOLATION onDisconnect connection={}",
                                                                connection);
                                                            }
                                                          }
                                                          @Override
     ...
     final BooleanProperty p2pNetworkInitialized =
   ...
   protected
   void onBasicServicesInitialized() {
