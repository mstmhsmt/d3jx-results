...
@Slf4j public class AppSetupWithP2P extends AppSetup {
  ...
  @Inject public AppSetupWithP2P(P2PService p2PService, TradeStatisticsManager tradeStatisticsManager, AccountAgeWitnessService accountAgeWitnessService, SignedWitnessService signedWitnessService, FilterManager filterManager, TorSetup torSetup, Config config) {
    super(config);
  ...
  @Override public void initPersistedDataHosts() {
  ...
  @Override protected void initBasicServices() {
  ...
  private BooleanProperty initP2PNetwork() {
    ...
    p2PService.getNetworkNode().addConnectionListener(new ConnectionListener() {
      ...
      @Override public void onDisconnect(CloseConnectionReason closeConnectionReason, Connection connection) {
    ...
    p2PService.start(new P2PServiceListener() {
      @Override public void onTorNodeReady() {
      }
      ...
      @Override public void onNoSeedNodeAvailable() {
        log.info("onNoSeedNodeAvailable");
        p2pNetworkInitialized.set(true);
      }

      @Override public void onNoPeersAvailable() {
        log.info("onNoPeersAvailable");
        p2pNetworkInitialized.set(true);
      }

      @Override public void onUpdatedDataReceived() {
        log.info("onUpdatedDataReceived");
      }

      @Override public void onSetupFailed(Throwable throwable) {
        log.error(throwable.toString());
      }

      @Override public void onRequestCustomBridges() {
      }
    });
