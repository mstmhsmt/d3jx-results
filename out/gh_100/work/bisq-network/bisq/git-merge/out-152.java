...
<<<<<<< commits-gh_100/bisq-network/bisq/6b3a002b1cbb1ceebe0a2d3a664e677a23651c5a/BisqExecutable-aa40dad.java
                        PersistenceManager.flushAllDataToDisk(() -> {
                            log.info("Graceful shutdown completed. Exiting now.");
                            resultHandler.handleResult();
                            UserThread.runAfter(() -> System.exit(EXIT_SUCCESS), 1);
                        });
||||||| commits-gh_100/bisq-network/bisq/779c059a518c08ac09f1d5854448792641c0326d/BisqExecutable-b96ca3c.java
                        PersistenceManager.flushAllDataToDisk(() -> {
                            log.info("Graceful shutdown completed. Exiting now.");
                            resultHandler.handleResult();
                            System.exit(EXIT_SUCCESS);
...
>>>>>>> commits-gh_100/bisq-network/bisq/94453cf27c311c0002d21ee2f84454cdd952d371/BisqExecutable-264298c.java
                    });
                });
