...
public class AppSetupWithP2P extends AppSetup {
    ...
    final private SignedWitnessService signedWitnessService;

    protected final FilterManager filterManager;

    final private TorSetup torSetup;
    ...
    @Inject
    public AppSetupWithP2P(P2PService p2PService, TradeStatisticsManager tradeStatisticsManager, AccountAgeWitnessService accountAgeWitnessService, SignedWitnessService signedWitnessService, FilterManager filterManager, TorSetup torSetup, Config config) {
        super(config);
