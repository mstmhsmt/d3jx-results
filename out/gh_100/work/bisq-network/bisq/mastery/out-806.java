...
@Slf4j
final public class BuyerAsTakerTrade extends BuyerTrade implements TakerTrade {
    ...
    static public Tradable fromProto(PB.BuyerAsTakerTrade proto, Storage<? extends TradableList> storage, BtcWalletService btcWalletService) {
