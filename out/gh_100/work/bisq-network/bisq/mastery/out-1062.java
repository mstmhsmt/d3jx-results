...
public class PendingTradesDataModel extends ActivatableDataModel {
    ...
    final private TradeWalletService tradeWalletService;

    final private FeeService feeService;
    ...
    final private P2PService p2PService;

    public final Navigation navigation;

    public final WalletPasswordWindow walletPasswordWindow;

    final private NotificationCenter notificationCenter;

    final ObservableList<PendingTradesListItem> list = FXCollections.observableArrayList();

    final private ListChangeListener<Trade> tradesListChangeListener;
    ...
    @Inject
    public PendingTradesDataModel(TradeManager tradeManager, BtcWalletService btcWalletService, TradeWalletService tradeWalletService, FeeService feeService, User user, KeyRing keyRing, DisputeManager disputeManager, Preferences preferences, P2PService p2PService, Navigation navigation, WalletPasswordWindow walletPasswordWindow, NotificationCenter notificationCenter) {
