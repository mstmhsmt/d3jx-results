...
public class ProposalsView extends ActivatableView<GridPane, Void> implements BsqBalanceListener, DaoStateListener {
    ...
    @Inject
    private ProposalsView(DaoFacade daoFacade, BsqWalletService bsqWalletService, PhasesView phasesView, DaoStateService daoStateService, BsqFormatter bsqFormatter, BSFormatter btcFormatter) {
    ...
    @Override
    public void onUpdateBalances(Coin confirmedBalance, Coin availableNonBsqBalance, Coin pendingBalance, Coin lockedForVotingBalance, Coin lockupBondsBalance, Coin unlockingBondsBalance) {
    ...
    private void createProposalColumns() {
        ...
        column.setCellFactory(new Callback<TableColumn<ProposalsListItem, ProposalsListItem>, TableCell<ProposalsListItem, ProposalsListItem>>() {
            ...
            @Override
            public TableCell<ProposalsListItem, ProposalsListItem> call(TableColumn<ProposalsListItem, ProposalsListItem> column) {
