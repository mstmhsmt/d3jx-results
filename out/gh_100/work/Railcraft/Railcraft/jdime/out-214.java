...
public class SignalBlockRelay extends SignalBlock {
  ...
  @Override protected void updateSignalAspect() {
  ...
  @Override public SignalAspect getSignalAspect() {
  ...
  @Override protected SignalAspect getSignalAspectForPair(WorldCoordinate otherCoord) {
    SignalAspect aspect = SignalAspect.GREEN;
