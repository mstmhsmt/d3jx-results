...
public class VisualModeChunk {
  ...
  private Element createSummary() {
    ...
    for (String line : StringUtil.getLineIterator(contents)) {
      ...
      } else // If this is the magic comment indicating a Quarto label, extract the label
