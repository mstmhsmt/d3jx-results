...
@Singleton public class AceThemes {
  @Inject public AceThemes(ThemeServerOperations themeServerOperations, final Provider<UIPrefs> prefs, EventBus events) {
  ...
  public void getThemes(Consumer<HashMap<String, AceTheme>> themeConsumer) {
    themeServerOperations_.getThemes(new ServerRequestCallback<JsArray<AceTheme>>() {
      @Override public void onResponseReceived(JsArray<AceTheme> jsonThemeArray) {
