...
@SuppressWarnings(value = { "UnusedDeclaration" }) @SuppressFBWarnings(value = { "UWF_UNWRITTEN_PUBLIC_OR_PROTECTED_FIELD", "UWF_UNWRITTEN_FIELD", "NP_UNWRITTEN_FIELD" }, justification = "JSON API") public class GHRepository extends GHObject {
  ...
  /**
     ...
     *             the io exception
     */
  @SuppressFBWarnings(value = { "EI_EXPOSE_REP" }, justification = "Expected behavior") public GHUser getOwner() throws IOException {
  ...
  /**
     ...
     * @return the paged iterable
     */
  @Deprecated public PagedIterable<GHIssue> listIssues(final GHIssueState state) {
  ...
  /**
     ...
     */
  @Preview(value = NEBULA) public Visibility getVisibility() {
    if (visibility == null) {
      try {
        populate();
  ...
  /**
     ...
     * @return the boolean
     */
  @Preview(value = BAPTISTE) public boolean isTemplate() {
    if (isTemplate == null) {
      try {
        populate();
      } catch (IOException e) {
  ...
  /**
     ...
     *             the io exception
     */
  @Preview(value = NEBULA) public void setVisibility(final Visibility value) throws IOException {
  ...
  /**
     ...
     */
  @Preview(value = ANTIOPE) public PagedIterable<GHCheckRun> getCheckRuns(String ref) throws IOException {
  ...
  /**
     ...
     */
  @Preview(value = ANTIOPE) public @NonNull GHCheckRunBuilder createCheckRun(@NonNull String name, @NonNull String headSHA) {
  ...
  /**
     ...
     * @return a builder which you should customize, then call {@link GHCheckRunBuilder#create}
     */
  @Preview(value = BAPTISTE) public @NonNull GHCheckRunBuilder updateCheckRun(long checkId) {
  ...
  /**
     ...
     */
  @SuppressFBWarnings(value = { "DMI_COLLECTION_OF_URLS", "EI_EXPOSE_REP" }, justification = "It causes a performance degradation, but we have already exposed it to the API") @Deprecated public Set<URL> getPostCommitHooks() {
    synchronized (this) {
  ...
  /**
     ...
     */
  @SuppressFBWarnings(value = "DMI_COLLECTION_OF_URLS", justification = "It causes a performance degradation, but we have already exposed it to the API") @SkipFromToString private transient Set<URL> postCommitHooks;
  ...
  /**
     ...
     */
  @SuppressFBWarnings(value = { "EI_EXPOSE_REP" }, justification = "Expected behavior") public GHRepository getSource() throws IOException {
    if (fork && source == null) {
      populate();
    }
    if (source == null) {
  ...
  /**
     ...
     */
  @SuppressFBWarnings(value = { "EI_EXPOSE_REP" }, justification = "Expected behavior") public GHRepository getParent() throws IOException {
    if (fork && parent == null) {
      populate();
    }
    if (parent == null) {
  ...
  /**
     ...
     */
  public <T extends java.lang.Object> T readZip(InputStreamFunction<T> streamFunction, String ref) throws IOException {
  ...
  /**
     ...
     * @return the result of reading the stream.
     */
  public <T extends java.lang.Object> T readTar(InputStreamFunction<T> streamFunction, String ref) throws IOException {
  ...
  /**
     ...
     *             the io exception
     */
  public <T extends java.lang.Object> void dispatch(String eventType, @Nullable T clientPayload) throws IOException {
  ...
  private <T extends java.lang.Object> T downloadArchive(@Nonnull String type, @CheckForNull String ref, @Nonnull InputStreamFunction<T> streamFunction) throws IOException {
  ...
  @BetaApi public static class Updater extends GHRepositoryBuilder<Updater> {
  ...
  @BetaApi public static class Setter extends GHRepositoryBuilder<GHRepository> {
