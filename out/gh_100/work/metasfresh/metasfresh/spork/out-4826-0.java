...
public final enum WFDurationUnit implements ReferenceListAwareEnum {
	...
	WFDurationUnit(@NonNull
	final String code, @NonNull
	final Duration duration, @NonNull
	...
	public Duration toDuration(@NonNull
	final BigDecimal durationBD) {
