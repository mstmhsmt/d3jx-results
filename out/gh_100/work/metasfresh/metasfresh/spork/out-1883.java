...
public class CacheInvalidateRequest {
	...
	@JsonCreator
	private CacheInvalidateRequest(@JsonProperty("rootTableName")
	final String rootTableName, @JsonProperty("rootRecordId")
	final int rootRecordId, @JsonProperty("childTableName")
	final String childTableName, @JsonProperty("childRecordId")
	final int childRecordId, @JsonProperty("debugFrom")
	final String debugFrom) {
	...
	public static final class Builder {
		...
		public Builder rootRecord(@NonNull
		...
		public Builder childRecord(@NonNull
		final String tableName, final int recordId) {
			Check.assume(recordId >= 0, "recordId >= 0");
