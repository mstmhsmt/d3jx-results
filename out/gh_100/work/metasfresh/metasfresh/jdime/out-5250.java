...
public final class ProductsProposalRowsLoader {
  ...
  @Builder private ProductsProposalRowsLoader(@NonNull final BPartnerProductStatsService bpartnerProductStatsService, @Nullable final CampaignPriceProvider campaignPriceProvider, @NonNull @Singular final ImmutableSet<PriceListVersionId> priceListVersionIds, @Nullable final Order order, @NonNull final BPartnerId bpartnerId, @NonNull final SOTrx soTrx, @Nullable final Set<ProductId> productIdsToExclude) {
