...
>>>>>>> commits-gh_100/metasfresh/metasfresh/80ec87e0315e0cecd3444c112aa30356128dee77/BPartnerCompositeSaver-74330b8.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  private void saveBPartnerLocation(@NonNull final BPartnerId bpartnerId, @NonNull final BPartnerLocation bpartnerLocation, @Nullable final OrgId orgId) {
    try (MDCCloseable bpartnerLocationRecordMDC = TableRecordMDC.putTableRecordReference(I_C_BPartner_Location.Table_Name, bpartnerLocation.getId())) {
  ...
  private void saveBPartnerContact(@NonNull final BPartnerId bpartnerId, @NonNull final BPartnerContact bpartnerContact, @Nullable final OrgId orgId) {
    try (MDCCloseable bpartnerContactRecordMDC = TableRecordMDC.putTableRecordReference(I_AD_User.Table_Name, bpartnerContact.getId())) {
  ...
  private void saveBPartnerBankAccount(@NonNull final BPartnerId bpartnerId, @NonNull final BPartnerBankAccount bankAccount, @Nullable final OrgId orgId) {
    try (MDCCloseable bankAccountRecordMDC = TableRecordMDC.putTableRecordReference(I_C_BP_BankAccount.Table_Name, bankAccount.getId())) {
