...
<<<<<<< /root/work/metasfresh/metasfresh/d3j/patched-4293-0.java
  @Nullable private String phone;
...
||||||| /root/work/metasfresh/metasfresh/d3j/base-4293.java
=======
  @Nullable private String mobile;
  @Nullable private String fax;
  @Nullable final String setupPlaceNo;
  ...
  final boolean replicationLookupDefault;
  final boolean visitorsAddress;
>>>>>>> /root/work/metasfresh/metasfresh/d3j/patched-4293-1.java
  ...
  private BPartnerLocation(
      ...
      @Nullable final ExternalId externalId, @Nullable final GLN gln,
      @Nullable final Boolean active, @Nullable final String name,
      @Nullable final String bpartnerName,
      @Nullable final LocationId existingLocationId,
      @Nullable final String address1, @Nullable final String address2,
      @Nullable final String address3, @Nullable final String address4,
      @Nullable final String postal, @Nullable final String poBox,
      @Nullable final String district, @Nullable final String region,
      @Nullable final String city, @Nullable final String countryCode,
      @Nullable final String phone, @Nullable final String email,
      @Nullable final BPartnerLocationType locationType,
      @Nullable final RecordChangeLog changeLog,
<<<<<<< /root/work/metasfresh/metasfresh/d3j/patched-4293-0.java
      @Nullable final OrgMappingId orgMappingId, @Nullable final String phone,
      @Nullable final String mobile, @Nullable final String fax,
      @Nullable final String email, @Nullable final String setupPlaceNo,
      @Nullable final Boolean remitTo, @Nullable final Boolean handOverLocation,
...
=======
      @Nullable final OrgMappingId orgMappingId, @Nullable final String mobile,
      @Nullable final String fax, @Nullable final String setupPlaceNo,
      @Nullable final Boolean remitTo, @Nullable final Boolean handOverLocation,
      @Nullable final Boolean replicationLookupDefault,
      @Nullable final Boolean visitorsAddress) {
>>>>>>> /root/work/metasfresh/metasfresh/d3j/patched-4293-1.java
    ...
    this.replicationLookupDefault =
        replicationLookupDefault != null ? replicationLookupDefault : false;
  ...
  public ImmutableList<ITranslatableString> validate() {
    ...
    final ImmutableList.Builder<ITranslatableString> result =
        ImmutableList.builder();
    if (!isAddressSpecifiedByExistingLocationIdOnly()) {
      if (isBlank(countryCode)) {
        result.add(
            TranslatableStrings.constant("Missing location.countryCode"));
      }
      if (!isBlank(district) && isBlank(postal)) {
        result.add(TranslatableStrings.constant(
            "Missing location.postal (required if location.district is set)"));
      }
    }
    return result.build();
  }
  ...
  public void addHandle(@NonNull final String handle) { handles.add(handle); }
  ...
  public void
  setFromAddress(@NonNull final BPartnerLocationAddressPart address) {
