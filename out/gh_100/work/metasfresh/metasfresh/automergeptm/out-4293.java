...
@Data @JsonPropertyOrder(alphabetic = true) public class BPartnerLocation {
  ...
  @Nullable private BPartnerLocationId id;
  ...
  @Nullable private GLN gln;

  @Nullable private String name;

  @Nullable private String bpartnerName;
  ...
  /**
	 ...
	 */
  @Nullable private LocationId existingLocationId;

  @Nullable private String address1;

  @Nullable private String address2;

  @Nullable private String address3;

  @Nullable private String address4;

  @Nullable private String poBox;

  @Nullable private String postal;
  ...
  @Nullable private BPartnerLocationType locationType;

  @Nullable private final RecordChangeLog changeLog;

  @Nullable private OrgMappingId orgMappingId;
  ...
  @Nullable final public static String setupPlaceNo;
...
>>>>>>> commits-gh_100/metasfresh/metasfresh/73d7a3715892d0aa1d6d45aed209b2ca4e49f07e/BPartnerLocation-1d9c984.java
  ...
  @JsonIgnore public boolean isAddressSpecifiedByExistingLocationIdOnly() {
