...
public enum WFDurationUnit implements ReferenceListAwareEnum {
    ...
    static public WFDurationUnit ofCode(@NonNull final String code) {
        return typesByCode.ofCode(code);
    }

    @SuppressWarnings("unused")
    static public WFDurationUnit ofTemporalUnit(@NonNull final TemporalUnit temporalUnit) {
