...
public class CacheInvalidateRequest {
    ...
    static final private int RECORD_ID_ALL = -1;

    static final private CacheInvalidateRequest ALL = new CacheInvalidateRequest(null, RECORD_ID_ALL, null, RECORD_ID_ALL, "ALL");

    @JsonProperty("rootTableName")
    final private String rootTableName;

    @JsonProperty("rootRecordId")
    final private int rootRecordId;

    @JsonProperty("childTableName")
    final private String childTableName;

    @JsonProperty("childRecordId")
    final private int childRecordId;

    @JsonProperty("debugFrom")
    final String debugFrom;

    @JsonCreator
    private CacheInvalidateRequest(@JsonProperty("rootTableName") final String rootTableName, @JsonProperty("rootRecordId") final int rootRecordId, @JsonProperty("childTableName") final String childTableName, @JsonProperty("childRecordId") final int childRecordId, @JsonProperty("debugFrom") final String debugFrom) {
