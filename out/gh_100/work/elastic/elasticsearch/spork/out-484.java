...
public abstract class BlobStoreRepository extends AbstractLifecycleComponent implements Repository {
     ...
     *
     * @param metadata
     * 		The metadata for this repository including name and settings
    ...
    private class Context {
         ...
         * @param fileListGeneration
         * 		the generation number of the snapshot index file
         * @param blobs
         * 		list of blobs in the container
         * @param reason
         * 		a reason explaining why the shard index file is written
         */
         ...
         *
         * @param blobs
         * 		list of blobs in the repository
    ...
    private class SnapshotContext extends Context {
         ...
         *
         * @param shard
         * 		shard to be snapshotted
         * @param snapshotId
         * 		snapshot id
         * @param indexId
         * 		the id of the index being snapshotted
         * @param snapshotStatus
         * 		snapshot status to report progress
         */
        ...
        public void snapshot(final IndexCommit snapshotIndexCommit) {
            ...
            final BlobStoreIndexShardSnapshot snapshot = // snapshotStatus.startTime() is assigned on the same machine,
            // so it's safe to use with VLong
            new BlobStoreIndexShardSnapshot(snapshotId.getName(), lastSnapshotStatus.getIndexVersion(), indexCommitPointFiles, lastSnapshotStatus.getStartTime(), System.currentTimeMillis() - lastSnapshotStatus.getStartTime(), lastSnapshotStatus.getIncrementalFileCount(), lastSnapshotStatus.getIncrementalSize());
    ...
    private class RestoreContext extends Context {
         ...
         *
         * @param shard
         * 		shard to restore into
         * @param snapshotId
         * 		snapshot id
         * @param indexId
         * 		id of the index being restored
