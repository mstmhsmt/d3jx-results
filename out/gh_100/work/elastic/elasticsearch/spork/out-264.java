...
public class MetaData implements Iterable<IndexMetaData> , Diffable<MetaData> , ToXContentFragment {
     ...
     */
    public static EnumSet<XContentContext> ALL_CONTEXTS = EnumSet.allOf(MetaData.XContentContext.class);
    ...
    private static class MetaDataDiff implements Diff<MetaData> {
        ...
        MetaDataDiff(StreamInput in) throws IOException {
            ...
            if (in.getVersion().onOrAfter(Version.V_7_0_0)) {
                // TODO revisit after Zen2 BWC is implemented
            ...
            while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                if (token == XContentParser.Token.FIELD_NAME) {
                    ...
                    if ("cluster_coordination".equals(currentFieldName)) {
                        ...
                        try {
                            Custom custom = parser.namedObject(MetaData.Custom.class, currentFieldName, null);
