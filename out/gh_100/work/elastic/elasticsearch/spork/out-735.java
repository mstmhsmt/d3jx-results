...
public class RecoverySourceHandler {
    ...
    private final CancellableThreads cancellableThreads = new CancellableThreads() {
        @Override
        protected void onCancel(String reason, @Nullable
    ...
    public RecoveryResponse recoverToTarget() throws IOException {
        ...
        try (Closeable ignored = shard.acquireTranslogRetentionLock()) {
            ...
            try (final Translog.Snapshot snapshot = translog.newSnapshotFrom(startingSeqNo)) {
    ...
    boolean isTranslogReadyForSequenceNumberBasedRecovery() throws IOException {
        ...
        if ((startingSeqNo - 1) <= localCheckpoint) {
            ...
            try (final Translog.Snapshot snapshot = shard.getTranslog().newSnapshotFrom(startingSeqNo)) {
