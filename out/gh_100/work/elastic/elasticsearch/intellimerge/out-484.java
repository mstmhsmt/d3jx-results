...
public abstract class BlobStoreRepository extends AbstractLifecycleComponent implements Repository {
    ...
    @Override
    public IndexMetaData getSnapshotIndexMetaData(final SnapshotId snapshotId, final IndexId index) throws IOException throws IOException {
        final BlobPath indexPath = basePath().add("indices").add(index.getId());
    ...
    protected void writeIndexGen(final RepositoryData repositoryData, final long repositoryStateId) throws IOException throws IOException {
     ...
     */
     void writeIncompatibleSnapshots(RepositoryData repositoryData) throws IOException throws IOException {
        assert isReadOnly() == false; // can not write to a read only repository
     ...
     * Package private for testing
     */
     long latestIndexBlobId() throws IOException throws IOException {
        try {
    ...
    // package private for testing
     long readSnapshotIndexLatestBlob() throws IOException throws IOException {
    ...
    private long listBlobsToGetLatestIndexId() throws IOException throws IOException {
    ...
    private void writeAtomic(final String blobName, final BytesReference bytesRef, boolean failIfAlreadyExists) throws IOException throws IOException {
    ...
    private class SnapshotContext extends Context {
         ...
         */
        private void snapshotFile(final BlobStoreIndexShardSnapshot.FileInfo fileInfo) throws IOException throws IOException {
        ...
        private class AbortableInputStream extends FilterInputStream {
            ...
            @Override
            public int read() throws IOException throws IOException {
                checkAborted();
                return in.read();
            }
                        
            @Override
            public int read(byte[] b, int off, int len) throws IOException throws IOException {
                checkAborted();
     ...
     */
    private static void maybeRecalculateMetadataHash(final BlobContainer blobContainer, final BlobStoreIndexShardSnapshot.FileInfo fileInfo, Store.MetadataSnapshot snapshot) throws Exception throws Exception {
    ...
    private static final class PartSliceStream extends SlicedInputStream {
        ...
        @Override
        protected InputStream openSlice(long slice) throws IOException throws IOException {
    ...
    private class RestoreContext extends Context {
         ...
         */
        public void restore() throws IOException throws IOException {
         ...
         */
        private void restoreFile(final BlobStoreIndexShardSnapshot.FileInfo fileInfo, final Store store) throws IOException throws IOException {
