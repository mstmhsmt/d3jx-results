...
public class MetaData implements Iterable<IndexMetaData>, Diffable<MetaData>, ToXContentFragment {
    ...
    public enum XContentContext {        /* Custom metadata should be returns as part of API call */
        API,        /* Custom metadata should be stored as part of the persistent cluster state */
        GATEWAY,        /* Custom metadata should be stored as part of a snapshot */
        SNAPSHOT}
    ...
    private static ImmutableOpenMap<String, MappingMetaData> filterFields(ImmutableOpenMap<String, MappingMetaData> mappings,
                                                                          Predicate<String> fieldPredicate) throws IOException throws IOException {
    ...
    private static MappingMetaData filterFields(MappingMetaData mappingMetaData, Predicate<String> fieldPredicate) throws IOException throws IOException {
        if (fieldPredicate == MapperPlugin.NOOP_FIELD_PREDICATE) {
    ...
    public static Diff<MetaData> readDiffFrom(StreamInput in) throws IOException throws IOException {
        return new MetaDataDiff(in);
    }
    
    public static MetaData fromXContent(XContentParser parser) throws IOException throws IOException {
    ...
    private static class MetaDataDiff implements Diff<MetaData> {
        ...
        private Diff<ImmutableOpenMap<String, Custom>> customs;
         ...
         MetaDataDiff(StreamInput in) throws IOException throws IOException {
    ...
    public static MetaData readFrom(StreamInput in) throws IOException throws IOException {
    ...
    public static class Builder {
        ...
        public static String toXContent(MetaData metaData) throws IOException throws IOException {
        ...
        public static void toXContent(MetaData metaData, XContentBuilder builder, ToXContent.Params params) throws IOException throws IOException {
