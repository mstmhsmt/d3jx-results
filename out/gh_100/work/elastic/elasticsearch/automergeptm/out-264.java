...
public class MetaData implements Iterable<IndexMetaData>, Diffable<MetaData>, ToXContentFragment {
  ...
  @SuppressWarnings(value = { "unchecked" }) private static MappingMetaData filterFields(MappingMetaData mappingMetaData, Predicate<String> fieldPredicate) throws IOException {
    if (fieldPredicate == MapperPlugin.NOOP_FIELD_PREDICATE) {
  ...
  @SuppressWarnings(value = { "unchecked" }) private static boolean filterFields(String currentPath, Map<String, Object> fields, Predicate<String> fieldPredicate) {
  ...
  @Override public Iterator<IndexMetaData> iterator() {
  ...
  @Override public Diff<MetaData> diff(MetaData previousState) {
  ...
  private static class MetaDataDiff implements Diff<MetaData> {
    ...
    @Override public MetaData apply(MetaData part) {
