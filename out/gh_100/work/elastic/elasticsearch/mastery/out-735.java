...
public class RecoverySourceHandler {
    ...
    final private IndexShard shard;

    final private int shardId;

    final private StartRecoveryRequest request;

    final private int chunkSizeInBytes;

    final private RecoveryTargetHandler recoveryTarget;

    protected final RecoveryResponse response;

    final private CancellableThreads cancellableThreads = new CancellableThreads() {
    ...
    final class RecoveryOutputStream extends OutputStream {
        ...
        final private StoreFileMetaData md;

        final private Supplier<Integer> translogOps;
