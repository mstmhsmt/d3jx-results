...
public class MetaData implements Iterable<IndexMetaData>, Diffable<MetaData>, ToXContentFragment {
    ...
    static final public String ALL = "_all";
    ...
    static public EnumSet<XContentContext> API_ONLY = EnumSet.of(XContentContext.API);

    static public EnumSet<XContentContext> API_AND_GATEWAY = EnumSet.of(XContentContext.API, XContentContext.GATEWAY);

    static public EnumSet<XContentContext> API_AND_SNAPSHOT = EnumSet.of(XContentContext.API, XContentContext.SNAPSHOT);

    static public EnumSet<XContentContext> ALL_CONTEXTS = EnumSet.allOf(XContentContext.class);

    public interface Custom extends ToXContentFragment, NamedDiffable<Custom>, ClusterState.FeatureAware {

        EnumSet<XContentContext> context();
    }

    static final public Setting<Integer> SETTING_CLUSTER_MAX_SHARDS_PER_NODE = Setting.intSetting("cluster.max_shards_per_node", 1000, 1, Property.Dynamic, Property.NodeScope);

    static final public Setting<Boolean> SETTING_READ_ONLY_SETTING = Setting.boolSetting("cluster.blocks.read_only", false, Property.Dynamic, Property.NodeScope);

    static final public ClusterBlock CLUSTER_READ_ONLY_BLOCK = new ClusterBlock(6, "cluster read-only (api)", false, false, false, RestStatus.FORBIDDEN, EnumSet.of(ClusterBlockLevel.WRITE, ClusterBlockLevel.METADATA_WRITE));

    static final public Setting<Boolean> SETTING_READ_ONLY_ALLOW_DELETE_SETTING = Setting.boolSetting("cluster.blocks.read_only_allow_delete", false, Property.Dynamic, Property.NodeScope);

    static final public ClusterBlock CLUSTER_READ_ONLY_ALLOW_DELETE_BLOCK = new ClusterBlock(13, "cluster read-only / allow delete (api)", false, false, true, RestStatus.FORBIDDEN, EnumSet.of(ClusterBlockLevel.WRITE, ClusterBlockLevel.METADATA_WRITE));

    static final public MetaData EMPTY_META_DATA = builder().build();

    static final public String CONTEXT_MODE_PARAM = "context_mode";

    static final public String CONTEXT_MODE_SNAPSHOT = XContentContext.SNAPSHOT.toString();

    static final public String CONTEXT_MODE_GATEWAY = XContentContext.GATEWAY.toString();

    static final public String GLOBAL_STATE_FILE_PREFIX = "global-";
    ...
    static public boolean isAllTypes(String[] types) {
        return types == null || types.length == 0 || isExplicitAllType(types);
    }

    static public boolean isExplicitAllType(String[] types) {
    ...
    static public boolean isGlobalStateEquals(MetaData metaData1, MetaData metaData2) {
    ...
    static public Diff<MetaData> readDiffFrom(StreamInput in) throws IOException {
        return new MetaDataDiff(in);
    }

    static public MetaData fromXContent(XContentParser parser) throws IOException {
    ...
    static public MetaData readFrom(StreamInput in) throws IOException {
    ...
    static public Builder builder(MetaData metaData) {
    ...
    static public class Builder {
        ...
        public MetaData build() {
            ...
            return new MetaData(clusterUUID, version, coordinationMetaData, transientSettings, persistentSettings, indices.build(), templates.build(), customs.build(), allIndicesArray, allOpenIndicesArray, allClosedIndicesArray, aliasAndIndexLookup);
        }
        ...
        static public String toXContent(MetaData metaData) throws IOException {
        ...
        static public void toXContent(MetaData metaData, XContentBuilder builder, ToXContent.Params params) throws IOException {
    ...
    static final public MetaDataStateFormat<MetaData> FORMAT = new MetaDataStateFormat<MetaData>(GLOBAL_STATE_FILE_PREFIX) {
