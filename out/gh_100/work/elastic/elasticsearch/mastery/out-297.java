...
abstract public class TransportReplicationAction<Request extends ReplicationRequest<Request>, ReplicaRequest extends ReplicationRequest<ReplicaRequest>, Response extends ReplicationResponse> extends TransportAction<Request, Response> {
    ...
    final private boolean syncGlobalCheckpointAfterOperation;
    ...
    class AsyncPrimaryAction extends AbstractRunnable implements ActionListener<PrimaryShardReference> {
        ...
        final private String targetAllocationID;

        final private long primaryTerm;

        final private TransportChannel channel;

        final private ReplicationTask replicationTask;
    ...
    protected static class PrimaryResult<ReplicaRequest extends ReplicationRequest<ReplicaRequest>, Response extends ReplicationResponse> implements ReplicationOperation.PrimaryResult<ReplicaRequest> {
        ...
        final public Response finalResponseIfSuccessful;

        final public Exception finalFailure;
    ...
    public class ReplicaOperationTransportHandler implements TransportRequestHandler<ConcreteReplicaRequest<ReplicaRequest>> {
        ...
        @Override
        public void messageReceived(final ConcreteReplicaRequest<ReplicaRequest> replicaRequest, final TransportChannel channel, final Task task) throws Exception {
    ...
    final private class AsyncReplicaAction extends AbstractRunnable implements ActionListener<Releasable> {

        final private ReplicaRequest request;

        final private String targetAllocationID;

        final private long primaryTerm;

        final private long globalCheckpoint;

        final private long maxSeqNoOfUpdatesOrDeletes;

        final private TransportChannel channel;

        final private IndexShard replica;

        final private ReplicationTask task;

        final private ClusterStateObserver observer = new ClusterStateObserver(clusterService, null, logger, threadPool.getThreadContext());
        ...
        private class ResponseListener implements ActionListener<TransportResponse.Empty> {
            ...
            final private ReplicaResponse replicaResponse;
    ...
    final class ReroutePhase extends AbstractRunnable {
        ...
        final private ClusterStateObserver observer;
    ...
    class ShardReference implements Releasable {
        ...
        final private Releasable operationLock;
    ...
    protected class ReplicasProxy implements ReplicationOperation.Replicas<ReplicaRequest> {
        ...
        @Override
        public void performOn(final ShardRouting replica, final ReplicaRequest request, final long globalCheckpoint, final long maxSeqNoOfUpdatesOrDeletes, final ActionListener<ReplicationOperation.ReplicaResponse> listener) {
    ...
    protected final static class ConcreteReplicaRequest<R extends TransportRequest> extends ConcreteShardRequest<R> {
