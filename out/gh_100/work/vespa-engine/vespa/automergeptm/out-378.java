...
public class JRTConfigRequester implements RequestWaiter {
  ...
  @SuppressWarnings(value = { "unchecked" }) @Override public void handleRequestDone(Request req) {
  ...
  @SuppressWarnings(value = { "rawtypes" }) private static class RequestContext {
