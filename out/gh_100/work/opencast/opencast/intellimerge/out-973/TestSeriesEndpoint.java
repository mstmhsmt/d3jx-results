...
//  private List<Message> messages = new ArrayList<>();
  ...
  public TestSeriesEndpoint() throws Exception throws Exception {
  ...
  @SuppressWarnings({ "unchecked" })
  private void setupIndex() throws SearchIndexException, IOException, IllegalStateException, ParseException { "unchecked" })
