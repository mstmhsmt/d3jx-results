...
public class ComposerServiceImpl extends AbstractJobProducer implements ComposerService, ManagedService {
  ...
  private enum Operation {    Caption,             Encode,                     Image,                            ImageConversion,                                             Mux,                                                  Trim,                                                        Watermark,                                                                   Composite,                                                                              Concat,                                                                                      ImageToVideo,                                                                                                    ParallelEncode}
   ...
   */
  @Override
  public Job encode(Track sourceTrack, String profileId) throws EncoderException, MediaPackageException throws EncoderException, MediaPackageException {
    try {
  ...
  protected Option<Track> encode(final Job job, Track videoTrack, Track audioTrack, String profileId,
          Map<String, String> properties) throws EncoderException, MediaPackageException throws EncoderException, MediaPackageException {
    if (job == null)
   ...
   *           if encoding fails
   */
  protected List<Track> parralelEncode(Job job, Track mediaTrack, String profileId, Map<String, String> properties) throws EncoderException, MediaPackageException throws EncoderException, MediaPackageException {
    if (job == null) {
   ...
   */
  @Override
  public Job parallelEncode(Track sourceTrack, String profileId) throws EncoderException, MediaPackageException throws EncoderException, MediaPackageException {
    try {
   ...
   */
  @Override
  public Job mux(Track videoTrack, Track audioTrack, String profileId) throws EncoderException, MediaPackageException throws EncoderException, MediaPackageException {
    try {
      return serviceRegistry.createJob(
              JOB_TYPE,
  ...
  protected Option<Track> mux(Job job, Track videoTrack, Track audioTrack, String profileId) throws EncoderException,
          MediaPackageException throws EncoderException,
  ...
  public Job composite(Dimension compositeTrackSize, LaidOutElement<Track> upperTrack,
          ...
          String background) throws EncoderException, MediaPackageException throws EncoderException, MediaPackageException {
  ...
  protected Option<Track> composite(Job job, Dimension compositeTrackSize, LaidOutElement<Track> lowerLaidOutElement,
          ...
          String profileId, String backgroundColor) throws EncoderException, MediaPackageException throws EncoderException, MediaPackageException {
    if (job == null)
      throw new EncoderException("The Job parameter must not be null");
   ...
   */
  @Override
  public Job image(Track sourceTrack, String profileId, double... times) throws EncoderException, MediaPackageException throws EncoderException, MediaPackageException {
    if (sourceTrack == null)
  ...
  private void validateVideoStream(Job job, Track sourceTrack) throws EncoderException throws EncoderException {
    // make sure there is a video stream in the track
    if (sourceTrack != null && !sourceTrack.hasVideo()) {
      Map<String, String> params = new HashMap<String, String>();
      params.put("track-id", sourceTrack.getIdentifier());
   ...
   */
  @Override
  public Job convertImage(Attachment image, String profileId) throws EncoderException, MediaPackageException throws EncoderException, MediaPackageException {
    if (image == null)
   ...
   */
  @Override
  public Job captions(final Track mediaTrack, final Catalog[] captions) throws EmbedderException, MediaPackageException throws EmbedderException, MediaPackageException {
  ...
  protected Track captions(Job job, Track mediaTrack, Catalog[] captions) throws EmbedderException throws EmbedderException {
    try {
   ...
   */
  @Override
  protected String process(Job job) throws Exception throws Exception {
    Operation op = null;
  ...
  protected Job inspect(Job job, URI workspaceURI) throws EncoderException throws EncoderException {
    Job inspectionJob;
    try {
  ...
  @SuppressWarnings("unchecked")
  private EncoderEngine getEncoderEngine(Job job, final EncodingProfile profile) throws EncoderException throws EncoderException {
    final EncoderEngine encoderEngine = encoderEngineFactory.newEncoderEngine(profile);
    if (encoderEngine == null) {
  ...
  @SuppressWarnings("unchecked")
  private EncodingProfile getProfile(Job job, String profileId) throws EncoderException throws EncoderException {
    final EncodingProfile profile = profileScanner.getProfile(profileId);
    if (profile == null) {
  ...
  private URI putToCollection(Job job, File output, String description) throws EncoderException throws EncoderException {
    URI returnURL = null;
    InputStream in = null;
    try {
      in = new FileInputStream(output);
  ...
  @Override
  public void updated(Dictionary properties) throws ConfigurationException throws ConfigurationException {
