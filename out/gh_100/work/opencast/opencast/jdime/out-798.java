...
public class JobTest {
  ...
  @SuppressWarnings(value = { "unused" }) private ServiceRegistrationJpaImpl regType2Remotehost = null;
  ...
  @Test public void testGetJob() throws Exception {
  ...
  @Test public void testGetChildJobs() throws Exception {
  ...
  private static Fn<Job, Boolean> matchesId(final Job j) {
    return new Fn<Job, Boolean>() {
      @Override public Boolean ap(Job job) {
  ...
  @Test public void testCount() throws Exception {
    serviceRegistry.createJob(regType1Localhost.getHost(), regType1Localhost.getServiceType(), OPERATION_NAME, null, null, false, null);
    serviceRegistry.createJob(regType1Remotehost.getHost(), regType1Remotehost.getServiceType(), OPERATION_NAME, null, null, false, null);
  ...
  @Test public void testCountByOperation() throws Exception {
    serviceRegistry.createJob(regType1Localhost.getHost(), regType1Localhost.getServiceType(), OPERATION_NAME, null, null, false, null);
    serviceRegistry.createJob(regType1Remotehost.getHost(), regType1Remotehost.getServiceType(), OPERATION_NAME, null, null, false, null);
    assertEquals(2, serviceRegistry.countByOperation(JOB_TYPE_1, OPERATION_NAME, Status.INSTANTIATED));
  }

  @Test public void testGetHostsCountWithNoJobs() throws Exception {
  ...
  @Test public void testNoJobServiceRegistrations() throws Exception {
  ...
  @Test public void testGetHostsCount() throws Exception {
  ...
  @Test public void testCountPerHostService() throws Exception {
    testGetHostsCount();
    ...
    final Monadics.ListMonadic<String> jpql = resultToString(new Function.X<EntityManager, List<Object[]>>() {
      @Override public List<Object[]> xapply(EntityManager em) throws Exception {
  ...
  private Monadics.ListMonadic<String> resultToString(final Function<EntityManager, List<Object[]>> q) {
    return penv.tx(new Function.X<EntityManager, Monadics.ListMonadic<String>>() {
      @Override protected Monadics.ListMonadic<String> xapply(EntityManager em) throws Exception {
        return mlist(q.apply(em)).map(new Function<Object[], String>() {
          @Override public String apply(Object[] a) {
            return mkString(a, ",");
          }
        });
      }
  ...
  @Test public void testHandlerRegistration() throws Exception {
  ...
  @Test public void testDuplicateHandlerRegistrations() throws Exception {
    String url = "http://type1handler:8080";
    serviceRegistry.registerHost(url, "127.0.0.1", 1024, 1, 1);
  ...
  @Test public void testMarshallingWithJsonPayload() throws Exception {
  ...
  @Test public void testMarshallingWithXmlPayload() throws Exception {
  ...
  @Test public void testVersionIncrements() throws Exception {
  ...
  @Test public void testJobsQueuedOnServiceUnregistration() throws Exception {
  ...
  @Test public void testMaxLoad() throws Exception {
  ...
  @Test public void testServiceUnregistration() throws Exception {
  ...
  @Test public void testHostUnregistration() throws Exception {
    Job job = serviceRegistry.createJob(JOB_TYPE_1, "some operation", null, null, false);
    job.setStatus(Status.RUNNING);
    job.setDispatchable(true);
    job.setJobType(regType1Localhost.getServiceType());
  ...
  @Test public void testRemoveJobsWithoutParent() throws Exception {
