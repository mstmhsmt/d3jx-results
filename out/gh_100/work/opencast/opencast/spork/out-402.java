...
public class MoodleUserProviderInstance implements UserProvider , RoleProvider , CachingUserProviderMXBean {
   ...
   * @param client
   * 		The Moodle web serivce client.
   * @param organization
   * 		The organization.
   * @param coursePattern
   * 		The pattern of a Moodle course ID.
   * @param userPattern
   * 		The pattern of a Moodle user ID.
   * @param groupRoles
   * 		Whether to activate groupRoles
   * @param cacheSize
