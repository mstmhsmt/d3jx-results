...
public class StreamingDistributionRestService extends AbstractJobProducerEndpoint {
  ...
  public Response distribute(@FormParam("mediapackage")
  String mediaPackageXml, @FormParam("channelId")
  String channelId, @FormParam("elementIds")
  ...
  public Response retract(@FormParam("mediapackage")
  String mediaPackageXml, @FormParam("channelId")
  String channelId, @FormParam("elementIds")
  String elementIds) throws Exception {
    Job job = null;
