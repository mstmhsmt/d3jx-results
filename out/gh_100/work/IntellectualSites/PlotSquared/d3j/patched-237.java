...
class Permissions
{
   public
   static
   boolean hasPermission(PlotPlayer<?> player, Captions caption, 
                         boolean notify) {
   ...
   public
   static
   boolean hasPermission(PlotPlayer<?> player, String permission) {
   ...
   public
   static
   boolean hasPermission(PermissionHolder caller, String permission) {
     ...
     permission =
     permission.toLowerCase().replaceAll("^[^a-z|0-9|\\.|_|-]", "");
   ...
   public
   static
   int hasPermissionRange(PlotPlayer<?> player, Captions perm, int range) {
     return hasPermissionRange(player, perm.getTranslated(), range);
   }
   public
   static
   int hasPermissionRange(PlotPlayer<?> player, String stub, int range) {
