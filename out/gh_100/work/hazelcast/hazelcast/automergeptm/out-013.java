...
public class HazelcastClientInstanceImpl implements HazelcastInstance, SerializationServiceSupport {
  ...
  public HazelcastClientInstanceImpl(String instanceName, ClientConfig clientConfig, ClientFailoverConfig clientFailoverConfig, ClientConnectionManagerFactory clientConnectionManagerFactory, AddressProvider externalAddressProvider) {
    ...
    this.loggingService = new ClientLoggingService(config.getClusterName(), loggingType, BuildInfoProvider.getBuildInfo(), instanceName, detailsEnabled);
    if (clientConfig != null) {
      ...
      for (ClientConfig failoverClientConfig : clientFailoverConfig.getClientConfigs()) {
        MetricsConfigHelper.overrideClientMetricsConfig(failoverClientConfig, getLoggingService().getLogger(MetricsConfigHelper.class));
      }
    }
  ...
  private ClusterDiscoveryService initClusterDiscoveryService(AddressProvider externalAddressProvider) {
    ...
    ClusterDiscoveryServiceBuilder builder = new ClusterDiscoveryServiceBuilder(tryCount, configs, loggingService, externalAddressProvider, properties, clientExtension, getLifecycleService());
  ...
  private MetricsRegistryImpl initMetricsRegistry() {
    ...
    return new MetricsRegistryImpl(getName(), logger, clientMetricsLevel(properties, loggingService.getLogger(MetricsConfigHelper.class)));
  }
  ...
  private ClientExecutionServiceImpl initExecutionService() {
    return new ClientExecutionServiceImpl(instanceName, config.getClassLoader(), properties, loggingService);
  }
  ...
  @Nonnull @Override public HazelcastXAResource getXAResource() {
  ...
  @Nonnull @Override public <E extends java.lang.Object> IQueue<E> getQueue(@Nonnull String name) {
  ...
  @Nonnull @Override public <E extends java.lang.Object> ITopic<E> getTopic(@Nonnull String name) {
  ...
  @Nonnull @Override public <E extends java.lang.Object> ISet<E> getSet(@Nonnull String name) {
  ...
  @Nonnull @Override public <E extends java.lang.Object> IList<E> getList(@Nonnull String name) {
  ...
  @Nonnull @Override public <K extends java.lang.Object, V extends java.lang.Object> IMap<K, V> getMap(@Nonnull String name) {
  ...
  @Nonnull @Override public <K extends java.lang.Object, V extends java.lang.Object> MultiMap<K, V> getMultiMap(@Nonnull String name) {
  ...
  @Nonnull @Override public <K extends java.lang.Object, V extends java.lang.Object> ReplicatedMap<K, V> getReplicatedMap(@Nonnull String name) {
  ...
  @Nonnull @Override public <E extends java.lang.Object> ITopic<E> getReliableTopic(@Nonnull String name) {
    checkNotNull(name, "Retrieving a topic instance with a null name is not allowed!");
    return getDistributedObject(ReliableTopicService.SERVICE_NAME, name);
  }

  @Nonnull @Override public <E extends java.lang.Object> Ringbuffer<E> getRingbuffer(@Nonnull String name) {
  ...
  @Override public ClientICacheManager getCacheManager() {
    return hazelcastCacheManager;
  }

  @Nonnull @Override public Cluster getCluster() {
    return new ClientClusterProxy(clusterService);
  }

  @Nonnull @Override public Client getLocalEndpoint() {
    return clusterService.getLocalClient();
  }

  @Nonnull @Override public IExecutorService getExecutorService(@Nonnull String name) {
  ...
  @Nonnull @Override public DurableExecutorService getDurableExecutorService(@Nonnull String name) {
  ...
  @Override public <T extends java.lang.Object> T executeTransaction(@Nonnull TransactionalTask<T> task) throws TransactionException {
    return transactionManager.executeTransaction(task);
  }

  @Override public <T extends java.lang.Object> T executeTransaction(@Nonnull TransactionOptions options, @Nonnull TransactionalTask<T> task) throws TransactionException {
    return transactionManager.executeTransaction(options, task);
  }

  @Override public TransactionContext newTransactionContext() {
    return transactionManager.newTransactionContext();
  }

  @Override public TransactionContext newTransactionContext(@Nonnull TransactionOptions options) {
  ...
  @Nonnull @Override public FlakeIdGenerator getFlakeIdGenerator(@Nonnull String name) {
  ...
  @Nonnull @Override public CardinalityEstimator getCardinalityEstimator(@Nonnull String name) {
  ...
  @Nonnull @Override public PNCounter getPNCounter(@Nonnull String name) {
  ...
  @Nonnull @Override public IScheduledExecutorService getScheduledExecutorService(@Nonnull String name) {
  ...
  @Override public UUID addDistributedObjectListener(@Nonnull DistributedObjectListener distributedObjectListener) {
  ...
  @Override public boolean removeDistributedObjectListener(@Nonnull UUID registrationId) {
  ...
  @Nonnull @Override public PartitionService getPartitionService() {
    return new PartitionServiceProxy(partitionService, listenerService, clusterService);
  }

  @Nonnull @Override public SplitBrainProtectionService getSplitBrainProtectionService() {
    throw new UnsupportedOperationException();
  }

  @Nonnull @Override public ClientService getClientService() {
    throw new UnsupportedOperationException();
  }

  @Nonnull @Override public LoggingService getLoggingService() {
    return loggingService;
  }

  @Nonnull @Override public LifecycleService getLifecycleService() {
    return lifecycleService;
  }

  @Nonnull @Override public <T extends DistributedObject> T getDistributedObject(@Nonnull String serviceName, @Nonnull String name) {
  ...
  @Nonnull @Override public CPSubsystem getCPSubsystem() {
    return cpSubsystem;
  }

  @Nonnull @Override public ConcurrentMap<String, Object> getUserContext() {
    return userContext;
  }
  ...
  @Override public InternalSerializationService getSerializationService() {
  ...
  @Nonnull @Override public SqlService getSql() {
    return sqlService;
  }
  ...
  private void addClientConfigAddedListeners(Collection<EventListener> configuredListeners) {
    configuredListeners.stream().filter((listener) -> listener instanceof DistributedObjectListener).forEach((listener) -> proxyManager.addDistributedObjectListener((DistributedObjectListener) listener));
    configuredListeners.stream().filter((listener) -> listener instanceof PartitionLostListener).forEach((listener) -> getPartitionService().addPartitionLostListener((PartitionLostListener) listener));
    configuredListeners.stream().filter((listener) -> listener instanceof CPMembershipListener).forEach((listener) -> getCPSubsystem().addMembershipListener((CPMembershipListener) listener));
    configuredListeners.stream().filter((listener) -> listener instanceof CPGroupAvailabilityListener).forEach((listener) -> getCPSubsystem().addGroupAvailabilityListener((CPGroupAvailabilityListener) listener));
  }
}