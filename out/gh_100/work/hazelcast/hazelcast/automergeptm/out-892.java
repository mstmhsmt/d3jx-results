...
public abstract class AbstractXmlConfigHelper {
  ...
  protected long getLongValue(final String parameterName, final String value, final long defaultValue) {
    try {
      ...
      LOGGER.info(parameterName + " parameter value, [" + value + "], is not a proper long. Default value, [" + defaultValue + "], will be used!");
      LOGGER.warning(e);
      return defaultValue;
    }
  }
...
<<<<<<< commits-gh_100/hazelcast/hazelcast/5252266a599d14e2977b7363a9df6ac73024bfb7/AbstractXmlConfigHelper-0e664f6.java
  @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "DM_BOXED_PRIMITIVE_FOR_PARSING") protected void fillOffHeapMemoryConfig(Node node, OffHeapMemoryConfig offHeapMemoryConfig) {
    final NamedNodeMap atts = node.getAttributes();
    final Node enabledNode = atts.getNamedItem("enabled");
    final boolean enabled = enabledNode != null && checkTrue(getTextContent(enabledNode).trim());
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "DM_BOXED_PRIMITIVE_FOR_PARSING") protected void fillNativeMemoryConfig(Node node, NativeMemoryConfig nativeMemoryConfig) {
    final NamedNodeMap atts = node.getAttributes();
    final Node enabledNode = atts.getNamedItem("enabled");
    final boolean enabled = enabledNode != null && checkTrue(getTextContent(enabledNode).trim());
