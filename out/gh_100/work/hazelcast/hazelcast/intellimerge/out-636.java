...
public class PutAllOperation extends MapOperation implements PartitionAwareOperation,
    ...
    @Override
    protected void writeInternal(ObjectDataOutput out) throws IOException throws IOException {
    ...
    @Override
    protected void readInternal(ObjectDataInput in) throws IOException throws IOException {
