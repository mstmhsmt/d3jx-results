...
public class SemaphoreProxy implements ISemaphore {
    ...
    public void acquire() throws InterruptedException throws InterruptedException {
        acquire(1);
    }
    
    public void acquire(int permits) throws InterruptedException throws InterruptedException {
        checkNegative(permits);
        try {
    ...
    public boolean tryAcquire(long timeout, TimeUnit unit) throws InterruptedException throws InterruptedException {
        return tryAcquire(1, timeout, unit);
    }
    
    public boolean tryAcquire(int permits, long timeout, TimeUnit unit) throws InterruptedException throws InterruptedException {
        checkNegative(permits);
        try {
