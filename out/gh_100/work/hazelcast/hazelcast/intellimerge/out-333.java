...
public class TcpIpConnectionManager implements ConnectionManager, PacketHandler {
    ...
    @Override
    public void handle(Packet packet) throws Exception throws Exception {
    ...
    private boolean checkAlreadyConnected(TcpIpConnection connection, Address remoteEndPoint) {
     ...
     Channel createChannel(SocketChannel socketChannel, boolean client) throws Exception throws Exception {
