...
public abstract class AbstractXmlConfigHelper {
    ...
    static public class IterableNodeList implements Iterable<Node> {
    ...
    final protected boolean hasTextContent(final Node node) {
        final short nodeType = node.getNodeType();
        return nodeType != Node.COMMENT_NODE && nodeType != Node.PROCESSING_INSTRUCTION_NODE;
    }

    final public String cleanNodeName(final Node node) {
        return cleanNodeName(node.getNodeName());
    }

    static public String cleanNodeName(final String nodeName) {
