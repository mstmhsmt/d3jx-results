...
public class TcpIpConnectionManager implements ConnectionManager, PacketHandler {
    ...
    private final ConcurrentHashMap<Address, TcpIpConnectionErrorHandler> monitors = new ConcurrentHashMap<Address, TcpIpConnectionErrorHandler>(100);
    ...
    @Probe(level = MANDATORY, name = "acceptedSocketCount")
    private final Set<Channel> acceptedSockets = Collections.newSetFromMap(new ConcurrentHashMap<Channel, Boolean>());

    @Probe(level = MANDATORY, name = "activeCount")
    ...
    @Probe(level = MANDATORY, name = "textCount")
    ...
    @Probe(level = MANDATORY, name = "clientCount")
    @Override
