...
public
class ExistsQueryParser extends BaseQueryParserTemp
{
       ...
       if (token == XContentParser.Token.FIELD_NAME) {
         ...
         if ("field".equals(currentFieldName)) {
           ...
           throw new QueryParsingException(parseContext,
                   "[exists] query does not support [" + currentFieldName + "]");
         }
       }
     }
   ...
   public
   static
   Query newFilter(QueryParseContext parseContext, String fieldPattern, 
                   String queryName) {
     final FieldNamesFieldMapper fieldNamesMapper =
       (FieldNamesFieldMapper)parseContext.mapperService().fullName(FieldNamesFieldMapper.NAME);
     ...
     List<String> fields =
       parseContext.simpleMatchToIndexNames(fieldPattern);
     if (fields.isEmpty()) {
