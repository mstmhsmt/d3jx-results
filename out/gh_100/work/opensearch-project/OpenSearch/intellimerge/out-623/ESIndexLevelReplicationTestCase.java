...
public abstract class ESIndexLevelReplicationTestCase extends IndexShardTestCase {
    ...
    protected ReplicationGroup createGroup(int replicas) throws IOException throws IOException {
        IndexMetaData metaData = buildIndexMetaData(replicas);
        return new ReplicationGroup(metaData);
    }
    
    protected IndexMetaData buildIndexMetaData(int replicas) throws IOException throws IOException {
        return buildIndexMetaData(replicas, indexMapping);
    }
    
    protected IndexMetaData buildIndexMetaData(int replicas, Map<String, String> mappings) throws IOException throws IOException {
    ...
    protected class ReplicationGroup implements AutoCloseable, Iterable<IndexShard> {
        ...
        private final PrimaryReplicaSyncer primaryReplicaSyncer = new PrimaryReplicaSyncer(Settings.EMPTY,
         ...
         ReplicationGroup(final IndexMetaData indexMetaData) throws IOException throws IOException {
        ...
        public int indexDocs(final int numOfDoc) throws Exception throws Exception {
        ...
        public int appendDocs(final int numOfDoc) throws Exception throws Exception {
            for (int doc = 0; doc < numOfDoc; doc++) {
        ...
        public BulkItemResponse index(IndexRequest indexRequest) throws Exception throws Exception {
        ...
        public synchronized void startAll() throws IOException throws IOException {
            startReplicas(replicas.size());
        }
            
        public synchronized int startReplicas(int numOfReplicasToStart) throws IOException throws IOException {
        ...
        public void startPrimary() throws IOException throws IOException {
        ...
        public IndexShard addReplica() throws IOException throws IOException {
        ...
        public synchronized void addReplica(IndexShard replica) throws IOException throws IOException {
        ...
        public synchronized IndexShard addReplicaWithExistingPath(final ShardPath shardPath, final String nodeId) throws IOException throws IOException {
         ...
         */
        public synchronized Future<PrimaryReplicaSyncer.ResyncTask> promoteReplicaToPrimary(IndexShard replica) throws IOException throws IOException {
        ...
        public synchronized boolean removeReplica(IndexShard replica) throws IOException throws IOException {
        ...
        public void recoverReplica(IndexShard replica) throws IOException throws IOException {
        ...
        public void recoverReplica(
            ...
            boolean markAsRecovering) throws IOException throws IOException {
        ...
        public Future<Void> asyncRecoverReplica(
                final IndexShard replica, final BiFunction<IndexShard, DiscoveryNode, RecoveryTarget> targetSupplier) throws IOException throws IOException {
        ...
        public synchronized void assertAllEqual(int expectedCount) throws IOException throws IOException {
        ...
        @Override
        public synchronized void close() throws Exception throws Exception {
            if (closed == false) {
                closed = true;
                closeShards(this);
            } else {
        ...
        private void updateAllocationIDsOnPrimary() throws IOException throws IOException {
    ...
    abstract class ReplicationAction<Request extends ReplicationRequest<Request>,
        ...
        class PrimaryRef implements ReplicationOperation.Primary<Request, ReplicaRequest, PrimaryResult> {
            ...
            @Override
            public PrimaryResult perform(Request request) throws Exception throws Exception {
    ...
    class IndexingAction extends ReplicationAction<BulkShardRequest, BulkShardRequest, BulkShardResponse> {
        ...
        @Override
        protected PrimaryResult performOnPrimary(IndexShard primary, BulkShardRequest request) throws Exception throws Exception {
        ...
        @Override
        protected void performOnReplica(BulkShardRequest request, IndexShard replica) throws Exception throws Exception {
            executeShardBulkOnReplica(replica, request);
        }
    }
    
    private TransportWriteAction.WritePrimaryResult<BulkShardRequest, BulkShardResponse> executeShardBulkOnPrimary(IndexShard primary, BulkShardRequest request) throws Exception throws Exception {
    ...
    private void executeShardBulkOnReplica(IndexShard replica, BulkShardRequest request) throws Exception throws Exception {
     ...
     */
     BulkShardRequest indexOnPrimary(IndexRequest request, IndexShard primary) throws Exception throws Exception {
     ...
     */
     void indexOnReplica(BulkShardRequest request, IndexShard replica) throws Exception throws Exception {
        executeShardBulkOnReplica(replica, request);
    }
    ...
    class GlobalCheckpointSync extends ReplicationAction<
        ...
        protected PrimaryResult performOnPrimary(
                final IndexShard primary, final GlobalCheckpointSyncAction.Request request) throws Exception throws Exception {
            primary.getTranslog().sync();
            return new PrimaryResult(request, new ReplicationResponse());
        }
            
        @Override
        protected void performOnReplica(final GlobalCheckpointSyncAction.Request request, final IndexShard replica) throws IOException throws IOException {
    ...
    class ResyncAction extends ReplicationAction<ResyncReplicationRequest, ResyncReplicationRequest, ResyncReplicationResponse> {
        ...
        @Override
        protected PrimaryResult performOnPrimary(IndexShard primary, ResyncReplicationRequest request) throws Exception throws Exception {
        ...
        @Override
        protected void performOnReplica(ResyncReplicationRequest request, IndexShard replica) throws Exception throws Exception {
    ...
    private TransportWriteAction.WritePrimaryResult<ResyncReplicationRequest, ResyncReplicationResponse> executeResyncOnPrimary(
        IndexShard primary, ResyncReplicationRequest request) throws Exception throws Exception {
        final TransportWriteAction.WritePrimaryResult<ResyncReplicationRequest, ResyncReplicationResponse> result =
    ...
    private void executeResyncOnReplica(IndexShard replica, ResyncReplicationRequest request) throws Exception throws Exception {
