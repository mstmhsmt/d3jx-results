...
public class SearchService extends AbstractLifecycleComponent<SearchService> implements IndexEventListener {
    ...
    private void loadOrExecuteQueryPhase(final ShardSearchRequest request, final SearchContext context,
            final QueryPhase queryPhase) throws Exception throws Exception {
    ...
    private SearchContext findContext(long id) throws SearchContextMissingException throws SearchContextMissingException {
    ...
    private void parseSource(DefaultSearchContext context, SearchSourceBuilder source) throws SearchContextException throws SearchContextException {
        // nothing to parse...
        if (source == null) {
            return;
        }
