...
public class SearchService extends AbstractLifecycleComponent<SearchService> implements IndexEventListener {
  ...
  static class NormsWarmer implements IndicesWarmer.Listener {
    ...
    @Override public TerminationHandle warmNewReaders(final IndexShard indexShard, final Engine.Searcher searcher) {
    ...
    @Override public TerminationHandle warmTopReader(IndexShard indexShard, final Engine.Searcher searcher) {
  ...
  static class FieldDataWarmer implements IndicesWarmer.Listener {
    ...
    @Override public TerminationHandle warmTopReader(final IndexShard indexShard, final Engine.Searcher searcher) {
      final MapperService mapperService = indexShard.mapperService();
