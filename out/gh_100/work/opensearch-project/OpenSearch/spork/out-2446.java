...
public class UnassignedInfoTests extends ESAllocationTestCase {
    ...
    public void testUnassignedDelayedOnlyOnNodeLeft() throws Exception {
        ...
        long delay = // add 1 tick delay
        unassignedInfo.updateDelay(unassignedInfo.getUnassignedTimeInNanos() + 1, Settings.builder().put(UnassignedInfo.INDEX_DELAYED_NODE_LEFT_TIMEOUT_SETTING.getKey(), "10h").build(), Settings.EMPTY);
