...
public class ChangeSet implements Conditional , LiquibaseSerializable {
    ...
    public void load(ParsedNode node, ResourceAccessor resourceAccessor) throws ParsedNodeException {
        this.id = node.getChildValue(null, "id", java.lang.String.class);
        this.author = node.getChildValue(null, "author", java.lang.String.class);
        ...
        this.contexts = new ContextExpression(node.getChildValue(null, "context", java.lang.String.class));
        this.labels = new Labels(StringUtils.trimToNull(node.getChildValue(null, "labels", java.lang.String.class)));
        setDbms(node.getChildValue(null, "dbms", java.lang.String.class));
        ...
        String objectQuotingStrategyString = StringUtils.trimToNull(node.getChildValue(null, "objectQuotingStrategy", java.lang.String.class));
        if (changeLog != null) {
        ...
        this.filePath = StringUtils.trimToNull(node.getChildValue(null, "logicalFilePath", java.lang.String.class));
        if (filePath == null) {
            filePath = changeLog.getFilePath();
        }
        this.setFailOnError(node.getChildValue(null, "failOnError", java.lang.Boolean.class));
