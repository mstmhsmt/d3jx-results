...
public class DatabaseChangeLog implements Comparable<DatabaseChangeLog> , Conditional {
    ...
    public void load(ParsedNode parsedNode, ResourceAccessor resourceAccessor) throws ParsedNodeException, SetupException {
        setLogicalFilePath(parsedNode.getChildValue(null, "logicalFilePath", java.lang.String.class));
        setContexts(new ContextExpression(parsedNode.getChildValue(null, "context", java.lang.String.class)));
        String objectQuotingStrategy = parsedNode.getChildValue(null, "objectQuotingStrategy", java.lang.String.class);
    ...
    protected void handleChildNode(ParsedNode node, ResourceAccessor resourceAccessor) throws ParsedNodeException, SetupException {
        ...
        switch (nodeName) {
            case "changeSet" :
                if (isDbmsMatch(node.getChildValue(null, "dbms", java.lang.String.class))) {
                    this.addChangeSet(createChangeSet(node, resourceAccessor));
                }
                break;
            case "include" :
                {
                    String path = node.getChildValue(null, "file", java.lang.String.class);
                    if (path == null) {
                        throw new UnexpectedLiquibaseException("No 'file' attribute on 'include'");
                    }
                    path = path.replace('\\', '/');
                    ContextExpression includeContexts = new ContextExpression(node.getChildValue(null, "context", java.lang.String.class));
                    LabelExpression labelExpression = new LabelExpression(node.getChildValue(null, "labels", java.lang.String.class));
                    Boolean ignore = node.getChildValue(null, "ignore", java.lang.Boolean.class);
                    try {
                        include(path, node.getChildValue(null, "relativeToChangelogFile", false), resourceAccessor, includeContexts, labelExpression, ignore, true);
            ...
            case "includeAll" :
                {
                    String path = node.getChildValue(null, "path", java.lang.String.class);
                    String resourceFilterDef = node.getChildValue(null, "filter", java.lang.String.class);
                    if (resourceFilterDef == null) {
                        resourceFilterDef = node.getChildValue(null, "resourceFilter", java.lang.String.class);
                    }
                    ...
                    String resourceComparatorDef = node.getChildValue(null, "resourceComparator", java.lang.String.class);
                    ...
                    if (resourceComparatorDef != null) {
                        ...
                        //take default comparator
                            Scope.getCurrentScope().getLog(getClass()).info(LogType.LOG, "no resourceComparator defined - taking default " + "implementation");
                    ...
                    includeAll(path, node.getChildValue(null, "relativeToChangelogFile", false), resourceFilter, node.getChildValue(null, "errorIfMissingOrEmpty", true), resourceComparator, resourceAccessor, includeContexts, labelExpression, ignore);
                    break;
                }
            case "preConditions" :
                {
            ...
            case "property" :
                {
                    try {
                        String context = node.getChildValue(null, "context", java.lang.String.class);
                        String dbms = node.getChildValue(null, "dbms", java.lang.String.class);
                        String labels = node.getChildValue(null, "labels", java.lang.String.class);
                        Boolean global = node.getChildValue(null, "global", java.lang.Boolean.class);
                        if (global == null) {
                            // okay behave like liquibase < 3.4 and set global == true
                            global = true;
                        }
                        String file = node.getChildValue(null, "file", java.lang.String.class);
                        if (file == null) {
                            // direct referenced property, no file
                            String name = node.getChildValue(null, "name", java.lang.String.class);
                            String value = node.getChildValue(null, "value", java.lang.String.class);
    ...
    public boolean include(String fileName, boolean isRelativePath, ResourceAccessor resourceAccessor, ContextExpression includeContexts, LabelExpression labelExpression, Boolean ignore, boolean logEveryUnknownFileFormat) throws LiquibaseException {
        ...
        try {
            ...
            if (matchesFileExtension || logEveryUnknownFileFormat) {
                Scope.getCurrentScope().getLog(getClass()).warning(LogType.LOG, ((("included file " + relativeBaseFileName) + "/") + fileName) + " is not a recognized file type");
            }
            return false;
        }
