...
public class Main {
    ...
    static protected class CodePointCheck {
    ...
    static public int run(String[] args) throws Exception {
    ...
    static protected void setLogLevel(LogService logService, java.util.logging.Logger rootLogger, java.util.logging.Logger liquibaseLogger, Level level) {
    ...
    private void checkForUnexpectedCommandParameter(List<String> messages) {
        ...
        } else if (COMMANDS.STATUS.equalsIgnoreCase(command) || COMMANDS.UNEXPECTED_CHANGESETS.equalsIgnoreCase(command)) {
            if ((!commandParams.isEmpty()) && !commandParams.iterator().next().equalsIgnoreCase("--" + OPTIONS.VERBOSE)) {
                messages.add(coreBundle.getString(ERRORMSG_UNEXPECTED_PARAMETERS) + commandParams);
            }
        } else if (COMMANDS.DIFF.equalsIgnoreCase(command) || COMMANDS.DIFF_CHANGELOG.equalsIgnoreCase(command)) {
        ...
        } else if ((COMMANDS.SNAPSHOT.equalsIgnoreCase(command) || COMMANDS.GENERATE_CHANGELOG.equalsIgnoreCase(command)) && (!commandParams.isEmpty())) {
            for (String cmdParm : commandParams) {
    ...
    private void checkForMalformedCommandParameters(final List<String> messages) {
        ...
        } else if (COMMANDS.DIFF_CHANGELOG.equalsIgnoreCase(command) && (diffTypes != null) && diffTypes.toLowerCase().contains("data")) {
    ...
    static protected CodePointCheck checkArg(String arg) {
    ...
    static public class SecureLogFilter implements Filter {
