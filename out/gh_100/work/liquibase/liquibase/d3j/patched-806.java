...
public
class ConstraintsConfig extends AbstractLiquibaseSerializable
{
   ...
   public
   ConstraintsConfig setNotNullConstraintName(String notNullConstraintName) {
   ...
   public
   ConstraintsConfig setShouldValidateNullable(String validateNullable) {
     this.validateNullable = parseBoolean(validateNullable);
     return this;
   }
   public
   Boolean shouldValidateNullable() {
     return validateNullable;
   }
   public
   ConstraintsConfig setShouldValidateNullable(Boolean validateNullable) {
     this.validateNullable = validateNullable;
     return this;
   }
   public
   ConstraintsConfig setShouldValidateUnique(String validateUnique) {
     this.validateUnique = parseBoolean(validateUnique);
     return this;
   }
   public
   Boolean shouldValidateUnique() {
     return validateUnique;
   }
   public
   ConstraintsConfig setShouldValidateUnique(Boolean validateUnique) {
     this.validateUnique = validateUnique;
     return this;
   }
   public
   ConstraintsConfig setShouldValidatePrimaryKey(String validatePrimaryKey) {
     this.validatePrimaryKey = parseBoolean(validatePrimaryKey);
     return this;
   }
   public
   Boolean shouldValidatePrimaryKey() {
     return validatePrimaryKey;
   }
   public
   ConstraintsConfig setShouldValidatePrimaryKey(Boolean validatePrimaryKey) {
     this.validatePrimaryKey = validatePrimaryKey;
     return this;
   }
   public
   ConstraintsConfig setShouldValidateForeignKey(String validateForeignKey) {
     this.validateForeignKey = parseBoolean(validateForeignKey);
     return this;
   }
   public
   Boolean shouldValidateForeignKey() {
     return validateForeignKey;
   }
   public
   ConstraintsConfig setShouldValidateForeignKey(Boolean validateForeignKey) {
