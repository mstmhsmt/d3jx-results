...
public class Main {
     ...
     */
    public static int run(String[] args) throws Exception throws Exception {
    ...
    private static boolean setupNeeded(Main main) throws CommandLineParsingException throws CommandLineParsingException {
    ...
    private static String[] splitArg(String arg) throws CommandLineParsingException throws CommandLineParsingException {
        String[] splitArg = arg.split("=", 2);
        if (splitArg.length < 2) {
    ...
    private static void addWarFileClasspathEntries(File classPathFile, List<URL> urls) throws IOException throws IOException {
     ...
     */
    private static File extract(JarFile jar, JarEntry entry) throws IOException throws IOException {
     ...
     */
    protected void parseDefaultPropertyFiles() throws CommandLineParsingException throws CommandLineParsingException {
    ...
    private void parseDefaultPropertyFileFromResource(File potentialPropertyFile) throws IOException,
            CommandLineParsingException throws IOException,
     ...
     */
    protected void parseOptions(String[] paramArgs) throws CommandLineParsingException throws CommandLineParsingException {
     ...
     */
    private void parseOptionArgument(String arg, boolean okIfNotAField) throws CommandLineParsingException throws CommandLineParsingException {
    ...
    private Field getDeclaredField(String attributeName) throws NoSuchFieldException throws NoSuchFieldException {
    ...
    protected ClassLoader configureClassLoader() throws CommandLineParsingException throws CommandLineParsingException {
     ...
     * @throws Exception
     */
    protected void doMigration() throws Exception throws Exception {
    ...
    private void executeSyncHub(Database database, Liquibase liquibase) throws CommandLineParsingException, LiquibaseException, liquibase.command.CommandExecutionException throws CommandLineParsingException, LiquibaseException, liquibase.command.CommandExecutionException {
        Map<String, Object> argsMap = new HashMap<>();
    ...
    private void loadChangeSetInfoToMap(Map<String, Object> argsMap) throws CommandLineParsingException throws CommandLineParsingException {
    ...
    private boolean isFormattedDiff() throws CommandLineParsingException throws CommandLineParsingException {
        String formatValue = getCommandParam(OPTIONS.FORMAT, "txt");
        return ! formatValue.equalsIgnoreCase("txt") && ! formatValue.isEmpty();
    }
    
    private String getSchemaParams(Database database) throws CommandLineParsingException throws CommandLineParsingException {
     ...
     */
    private String getCommandParam(String paramName, String defaultValue) throws CommandLineParsingException throws CommandLineParsingException {
        for (String param : commandParams) {
            if (!param.contains("=")) {
                continue;
            }
    ...
    private OutputStream getOutputStream() throws IOException throws IOException {
        if (outputFile != null) {
    ...
    private Writer getOutputWriter() throws IOException throws IOException {
