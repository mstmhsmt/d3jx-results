...
public class DatabaseChangeLog implements Comparable<DatabaseChangeLog>, Conditional {
    ...
    public void validate(Database database, String... contexts) throws LiquibaseException throws LiquibaseException {
    ...
    protected ChangeSet createChangeSet(ParsedNode node, ResourceAccessor resourceAccessor) throws ParsedNodeException throws ParsedNodeException {
