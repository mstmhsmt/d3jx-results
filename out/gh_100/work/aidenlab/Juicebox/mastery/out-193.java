...
public class MainWindow extends JFrame {
    ...
    static public Color RULER_LINE_COLOR = new Color(0, 0, 0, 100);
    ...
    static public Cursor fistCursor;

    static final public int BIN_PIXEL_WIDTH = 1;
    ...
    static public void main(String[] args) throws IOException, InvocationTargetException, InterruptedException {
        initApplication();
    ...
    static public synchronized MainWindow getInstance() {
        if (theInstance == null) {
            try {
    ...
    static public MainWindow createMainWindow() throws IOException {
    ...
    private class SaveImageDialog extends JFileChooser {
        ...
        private void saveImage(File file, final int w, final int h) throws IOException {
            ...
            if (ind != -1) {
                ...
                for (String aStr : strs) if (ext.equals(aStr))
                    fmt = ext;
            }
    ...
    abstract class RecentMenu extends JMenu {
        ...
        private static final String HIC_RECENT = "hicRecent";
