...
public class MainWindow extends JFrame {
    ...
    enum MatrixType {
        OBSERVED("Observed"),        OE("OE"),        PEARSON("Pearson"),        EXPECTED("Expected"),        RATIO("Observed / Control"),        CONTROL("Control");        private String value;
    ...
    public static void main(String[] args) throws IOException, InvocationTargetException, InterruptedException throws IOException, InvocationTargetException, InterruptedException {
        initApplication();
    ...
    private MainWindow() throws IOException throws IOException {
    ...
    public static MainWindow createMainWindow() throws IOException throws IOException {
...
//        //======== yPlotPanel ========
    ...
    private JMenuBar createMenuBar() throws BackingStoreException throws BackingStoreException {
    ...
    private void loadNormalizationVector(File file) throws IOException throws IOException {
    ...
    private class DumpDialog extends JFileChooser {
        ...
        protected JDialog createDialog(Component component) throws HeadlessException throws HeadlessException {
    ...
    private class SaveImageDialog extends JFileChooser {
        ...
        private void saveImage(File file, final int w, final int h) throws IOException throws IOException {
    ...
    abstract class RecentMenu extends JMenu
    {
        ...
        public RecentMenu(int count) throws BackingStoreException throws BackingStoreException {
            super();
            this.setText("Recent");
            this.setMnemonic('R');
