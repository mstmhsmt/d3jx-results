...
public class MainWindow extends JFrame {
    ...
    private void load(final List<String> files, final boolean control) {
        ...
        if (file.equals(currentlyLoadedFile)) {
            JOptionPane.showMessageDialog(this, "File already loaded");
            return;
        } else {
    ...
    class FileDropTargetListener implements DropTargetListener {
        ...
        public void drop(DropTargetDropEvent event) {
            ...
            try {
                // Transferable when called with DataFlavor javaFileList is guaranteed to retunr a File List.
...
======== fileMenu ========
    ...
    private class QCDialog extends JDialog {
        ...
        public QCDialog(Dataset dataset) {
            ...
            if (graphs != null) {
                ...
                final JFreeChart readTypeChart = // chart title
                // domain axis label
                // range axis label
                // data
                // include legend
                ChartFactory.createXYLineChart("Types of reads vs distance", "Distance (log)", "Binned Reads (log)", readTypeCollection, PlotOrientation.VERTICAL, true, true, false);
                ...
                final JFreeChart reChart = // chart title
                // domain axis label
                // range axis label
                // data
                // include legend
                ChartFactory.createXYLineChart("Distance from closest RE site", "Distance (bp)", "Fraction of Reads (log)", reCollection, PlotOrientation.VERTICAL, true, true, false);
                ...
                final JFreeChart intraChart = // chart title
                // domain axis label
                // range axis label
                // data
                // include legend
                ChartFactory.createXYLineChart("Intra reads vs distance", "Distance (log)", "Cumulative Sum of Binned Reads (log)", intraCollection, PlotOrientation.VERTICAL, true, true, false);
                ...
                final JFreeChart mapqChart = // chart title
                // domain axis label
                // range axis label
                // data
                // include legend
                // include tooltips
                ChartFactory.createXYLineChart("MapQ Threshold Count", "MapQ threshold", "Count", mapqCollection, PlotOrientation.VERTICAL, true, true, false);
            ...
            if (df != null) {
                ...
                // data
                // include legend
                ChartFactory.createXYLineChart(title, "Distance between reads (log)", "Genome-wide expected (log)", collection, PlotOrientation.VERTICAL, false, true, false);
                final XYPlot readTypePlot = readTypeChart.getXYPlot();
                ...
                public void stateChanged(ChangeEvent e) {
                    ...
                    if (!resolutionSlider.getValueIsAdjusting()) {
                        ...
                        if (hic.getXContext() != null) {
                            ...
                            } else if (hic.setZoom(zoom, xGenome, yGenome)) {
    ...
    abstract class RecentMenu extends JMenu {
         ...
         *
         * @param savedMap
         * 		url and title of map.
         * @param updateFile
         * 		also save to file, Constructor call with false - no need to re-write.
         */
    ...
    public class JSplitButton extends AbstractButton implements Accessible {
         ...
         *
         * @param text
         * 		the text displayed on this JSplitButton
         */
         ...
         *
         * @param action
         * 		used to specify the properties of this JSplitButton
         */
         ...
         *
         * @param alwaysShowPopup
         * 		true if this JSplitButton shows the popup menu
         * 		for every click
