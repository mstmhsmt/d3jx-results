...
public class AnnotatedTypeFactory implements AnnotationProvider {
  ...
  @SideEffectFree @Override public String toString() {
  ...
  @Override public AnnotationMirror getAnnotationMirror(Tree tree, Class<? extends Annotation> target) {
        ...
        if (decl instanceof ClassTree) {
          ...
          if (decl instanceof VariableTree) {
            ...
            if (decl instanceof MethodTree) {
              ...
              if (decl.getKind() == Tree.Kind.TYPE_PARAMETER) {
  ...
  protected static class InheritedFromClassAnnotator extends AnnotatedTypeScanner<Void, AnnotatedTypeFactory> {
    ...
    @Override public Void visitExecutable(AnnotatedExecutableType type, AnnotatedTypeFactory p) {
    ...
    @Override public Void visitDeclared(AnnotatedDeclaredType type, AnnotatedTypeFactory p) {
    ...
    private final Map<TypeParameterElement, AnnotatedTypeVariable> visited = new HashMap<TypeParameterElement, AnnotatedTypeVariable>();

    @Override public Void visitTypeVariable(AnnotatedTypeVariable type, AnnotatedTypeFactory p) {
  ...
  private final Element getMostInnerClassOrMethod(Tree tree) {
    ...
    for (Tree pathTree : path) {
      if (pathTree instanceof MethodTree) {
        ...
        if (pathTree instanceof ClassTree) {
  ...
  /**
     ...
     */
  public static <K extends java.lang.Object, V extends java.lang.Object> Map<K, V> createLRUCache(final int size) {
  ...
  /**
     ...
     */
  @Override public AnnotationMirror getDeclAnnotation(Element elt, Class<? extends Annotation> anno) {
