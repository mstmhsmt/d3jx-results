...
public abstract class BaseTypeChecker extends SourceChecker {
  ...
  @Override public void initChecker() {
    super.initChecker();
  ...
  /**
     ...
     */
  @Override protected SourceVisitor<?, ?> createSourceVisitor(CompilationUnitTree root) {
  ...
  /**
     ...
     */
  @Override public AnnotatedTypeFactory createFactory(CompilationUnitTree root) {
    Class<?> checkerClass = this.getClass();
    while (checkerClass != BaseTypeChecker.class) {
  ...
  /**
     ...
     * FLOW_BY_DEFAULT.
     */
  @Override public Set<String> getSupportedLintOptions() {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> T invokeConstructorFor(String name, Class<?>[] paramTypes, Object[] args) {
    Class<T> cls = null;
    try {
...
<<<<<<< commits-gh_100/typetools/checker-framework/58e3519d91ad24fdd408c46212745eddf7a78553/BaseTypeChecker-f6b2dab.java
      if (t instanceof InvocationTargetException) {
        ...
        SourceChecker.errorAbort("Unexpected " + t.getClass().getSimpleName() + " for " + "class " + name + " when invoking the constructor; parameter types: " + Arrays.toString(paramTypes), t);
      }
=======
      ErrorReporter.errorAbort("Unexpected " + t.getClass().getSimpleName() + " for " + "class name " + name + " when invoking the constructor; parameter types: " + Arrays.toString(paramTypes), t);
>>>>>>> commits-gh_100/typetools/checker-framework/ecf4a69227eea9c324f980d1f6ffd107a8012afc/BaseTypeChecker-5c0a4b2.java
