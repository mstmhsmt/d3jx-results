 ...
 */
public class FileUtilsImpl implements org.mskcc.cbio.importer.FileUtils {    // used in unzip method
 ...
 public void setLiftOverBinary(String property) {liftover_binary}")
 ...
 public void setLiftOverChain(String property) {liftover_chain_file}")
 ...
 @Override
 public String getMD5Digest(File file) throws Exception throws Exception {
 ...
 @Override
 public String getPrecomputedMD5Digest(File file) throws Exception throws Exception {
    ...
    @Override
    public void makeDirectory(File directory) throws Exception throws Exception {
            
        org.apache.commons.io.FileUtils.forceMkdir(directory);
    }
    
 @Override
 public boolean directoryIsEmpty(File directory) throws Exception throws Exception {
		return (listFiles(directory, null, true).isEmpty());
	}
 
    @Override
    public void deleteDirectory(File directory) throws Exception throws Exception {
    
        org.apache.commons.io.FileUtils.deleteDirectory(directory);
    }
    
    @Override
    public void deleteFile(File file) throws Exception throws Exception {
    		if (file.exists()) org.apache.commons.io.FileUtils.forceDelete(file);
    	}
    
    @Override
    public Collection<File> listFiles(File directory, String[] extensions, boolean recursive) throws Exception throws Exception {
    
        return org.apache.commons.io.FileUtils.listFiles(directory, extensions, recursive);
    }
    
    @Override
    public Collection<String> listFiles(File directory, String wildcard) throws Exception throws Exception
    {
    ...
    @Override
    public List<DataMatrix> getDataMatrices(ImportDataRecord importDataRecord, DataMatrix methylationCorrelation) throws Exception throws Exception {
 ...
 @Override
 public List<String> getMissingCaseListFilenames(String rootDirectory, CancerStudyMetadata cancerStudyMetadata) throws Exception throws Exception {
 ...
 @Override
 public void generateCaseLists(boolean overwrite, boolean strict, String stagingDirectory, CancerStudyMetadata cancerStudyMetadata) throws Exception throws Exception {
 ...
 @Override
 public List<String> getCaseListFromStagingFile(boolean strict, CaseIDs caseIDs, CancerStudyMetadata cancerStudyMetadata, String stagingDirectory, String stagingFilename) throws Exception throws Exception {
 ...
 @Override
 public File createTmpFileWithContents(String filename, String fileContent) throws Exception throws Exception {
 ...
 @Override
 public File createFileWithContents(String filename, String fileContent) throws Exception throws Exception {
 ...
 @Override
 public File createFileFromStream(String filename, InputStream is) throws Exception throws Exception {
 ...
 @Override
 public void downloadFile(String urlSource, String urlDestination) throws Exception throws Exception {
 ...
 @Override
 public LineIterator getFileContents(String urlFile) throws Exception throws Exception {
		return org.apache.commons.io.FileUtils.lineIterator(new File(new URL(urlFile).getFile()));
	}
 
 @Override
 public void writeCancerStudyMetadataFile(String stagingDirectory, CancerStudyMetadata cancerStudyMetadata, int numCases) throws Exception throws Exception {
 ...
 public void writeMetadataFile(String stagingDirectory,
			...
			int numCases) throws Exception throws Exception
	{
 ...
 public void writeMetadataFile(String stagingDirectory, CancerStudyMetadata cancerStudyMetadata,
								   DatatypeMetadata datatypeMetadata, DataMatrix dataMatrix) throws Exception throws Exception {
 ...
 public boolean writeZScoresStagingFile(String stagingDirectory, CancerStudyMetadata cancerStudyMetadata,
                                           DatatypeMetadata datatypeMetadata, DatatypeMetadata[] dependencies) throws Exception throws Exception {
 ...
 @Override
 public File getOverrideFile(PortalMetadata portalMetadata, CancerStudyMetadata cancerStudyMetadata, String filename) throws Exception throws Exception {
 ...
 public void applyOverride(String overrideDirectory, String stagingDirectory, CancerStudyMetadata cancerStudyMetadata,
							  String overrideFilename, String stagingFilename) throws Exception throws Exception {
 ...
 @Override
 public void writeCaseListFile(String stagingDirectory, CancerStudyMetadata cancerStudyMetadata, CaseListMetadata caseListMetadata, String[] caseList) throws Exception throws Exception {
 ...
 /**
	 ...
	 */
 @Override
 public void oncotateAllMAFs(DataSourcesMetadata dataSourcesMetadata) throws Exception throws Exception {
 ...
 @Override
 public void oncotateMAF(String inputMAFURL, String outputMAFURL) throws Exception throws Exception {
 ...
 /**
	 ...
	 */
 @Override
 public void copySegFiles(PortalMetadata portalMetadata, DatatypeMetadata datatypeMetadata, String remoteUserName) throws Exception throws Exception {
     ...
     * @return InputStream
     */
    private List<DataMatrix> getDataMatricesFromArchive(ImportDataRecord importDataRecord, DataMatrix methylationCorrelation) throws Exception throws Exception {
     ...
     * @return DataMatrix
     */
    private DataMatrix getDataMatrix(String dataFilename, InputStream data, DataMatrix methylationCorrelation) throws Exception throws Exception {
 ...
 /**
	 ...
	 */
 private static void gunzip(String gzipFile) throws Exception throws Exception {
 ...
 private List<String> getCaseListFromSequencedSamplesFile(File sequencedSamplesFile) throws Exception throws Exception {
