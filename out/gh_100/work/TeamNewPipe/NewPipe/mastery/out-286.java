...
public abstract class BasePlayer implements Player.EventListener, PlaybackListener, ImageLoadingListener {
    ...
    static final protected float[] PLAYBACK_SPEEDS = { 0.5f, 0.75f, 1f, 1.25f, 1.5f, 1.75f, 2f };
    ...
    static final protected int PLAY_PREV_ACTIVATION_LIMIT_MILLIS = 5000;

    static final protected int PROGRESS_LOOP_INTERVAL_MILLIS = 500;

    static final protected int RECOVERY_SKIP_THRESHOLD_MILLIS = 3000;
    ...
    @Override
    public void onTimelineChanged(Timeline timeline, Object manifest, @Player.TimelineChangeReason final int reason) {
        if (DEBUG)
