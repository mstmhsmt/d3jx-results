...
class BootstrapPropertiesTest
{
   ...
   private String UNREADABLE_PROPS_RESOURCE =
     "bootstrap/unreadable.properties";
   private String INCOMPLETE_STD_PROPS_RESOURCE =
     "bootstrap/incomplete.properties";
   private String OVERRIDE_PROPS_LOC =
   ...
   private static final Map<String,Object> expectedProps =
     Map.ofEntries(entry("bootstrap.feeSchedulesJson.resource",
                     "FeeSchedule.json"),
       entry("bootstrap.genesisB64Keystore.keyName", "START_ACCOUNT"),
       entry("bootstrap.genesisB64Keystore.path",
         "data/onboard/StartUpAccount.txt"),
       entry("bootstrap.genesisPemPassphrase.path", "TBD"),
       entry("bootstrap.genesisPem.path", "TBD"),
       entry("bootstrap.hapiPermissions.path",
       ...
       entry("bootstrap.networkProperties.path",
       ...
       entry("files.exchangeRates", 112L), entry("files.feeSchedules", 111L),
       entry("files.hapiPermissions", 122L),
       entry("files.nodeDetails", 102L),
       entry("files.softwareUpdateZip", 150L), entry("grpc.port", 50211),
   ...
   void logsLoadedPropsOnInit() {
     ...
     BootstrapProperties.log =
     LogManager.getLogger(BootstrapProperties.class);
   }
}