...
<<<<<<< commits-rmx_100/iFixit/iFixitAndroid/31b86a685edbca33d633ac258bf9a896c2d67a39/GuideListItem-fa70d29.java
          itemMenu.show()
=======
          Api.call(mActivity, ApiCall.publishGuide(mGuideInfo.mGuideid, mGuideInfo.mRevisionid))
>>>>>>> commits-rmx_100/iFixit/iFixitAndroid/1a3f4c62a827120e6396f79d48265a219167fbf1/GuideListItem-fffedfd.java
          ;
        } else {
          AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
          builder.setItems(MainApplication.get().getSite().isIfixit() ? R.array.step_list_item_options : R.array.guide_list_item_options_with_delete, new DialogInterface.OnClickListener() {
...
>>>>>>> commits-rmx_100/iFixit/iFixitAndroid/1a3f4c62a827120e6396f79d48265a219167fbf1/GuideListItem-fffedfd.java
  ...
  private void publishGuide() {
    ...
    if (!mGuideInfo.mPublic) {
      APIService.call(mActivity, APIService.getPublishGuideAPICall(mGuideInfo.mGuideid, mGuideInfo.mRevisionid));
    } else {
      APIService.call(mActivity, APIService.getUnPublishGuideAPICall(mGuideInfo.mGuideid, mGuideInfo.mRevisionid));
    }
  }
  ...
  public void setRowData(GuideInfo guideInfo) {
    ...
    if (mThumbnail != null) {
      ...
      if (mGuideInfo.hasImage()) {
        picasso.load(mGuideInfo.getImagePath(".standard")).noFade().fit().transform(transform).error(R.drawable.no_image).into(mThumbnail);
      } else {
  ...
  public void setPublished(boolean published) {
    if (published) {
      buildPublishView(R.drawable.ic_list_item_unpublish, Color.rgb(0, 191, 0), R.string.published, mGuideInfo.mIsPublishing ? R.string.unpublishing : R.string.unpublish);
    } else {
      buildPublishView(R.drawable.ic_list_item_publish, Color.RED, R.string.unpublished, mGuideInfo.mIsPublishing ? R.string.publishing : R.string.publish);
    }
  }
