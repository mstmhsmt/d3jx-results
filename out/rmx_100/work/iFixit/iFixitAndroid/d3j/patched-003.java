...
public
class GuideListItem extends TouchableRelativeLayout
{
   ...
   public
   GuideListItem(Context context, Activity activity) {
     super(context);
     mActivity = activity;
     mContext = context;
     ...
     mPublishText =
     (TextView)findViewById(R.id.guide_create_item_publish_status);
                                      ...
                                      void onClick(View v) {
                                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                                          ...
                                          MenuInflater menuInflater =
                                            itemMenu.getMenuInflater();
                                          menuInflater.inflate(R.menu.guide_item_popup,
                                            itemMenu.getMenu());
                                          ...
                                          builder.setItems(MainApplication.get().getSite().isIfixit() ? R.array.step_list_item_options : R.array.guide_list_item_options_with_delete,
   ...
   private
   void publishGuide() {
     MainApplication.getGaTracker().send(MapBuilder.createEvent("ui_action",
                                           "button_press", "publish_guide",
                                           null).build());
   ...
   void setPublished(boolean published) {
     if (published) {
       buildPublishView(R.drawable.ic_list_item_unpublish,
         Color.rgb(0, 191, 0), R.string.published,
         mGuideInfo.mIsPublishing ? R.string.unpublishing : R.string.unpublish);
     } else {
       buildPublishView(R.drawable.ic_list_item_publish, Color.RED,
         R.string.unpublished,
         mGuideInfo.mIsPublishing ? R.string.publishing : R.string.publish);
     }
   }
   private
   void editGuide() {
     MainApplication.getGaTracker().send(MapBuilder.createEvent("ui_action",
                                           "button_press", "edit_guide",
                                           null).build());
     ...
     mActivity.startActivityForResult(intent,
       GuideCreateActivity.GUIDE_STEP_LIST_REQUEST);
   }
   private
