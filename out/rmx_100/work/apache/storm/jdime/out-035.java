...
public class Utils {
  ...
  public static <T extends java.lang.Object> String join(Iterable<T> coll, String sep) {
  ...
  public static <S extends java.lang.Object, T extends java.lang.Object> T get(Map<S, T> m, S key, T def) {
    T ret = m.get(key);
    if (ret == null) {
      ret = def;
    }
  ...
  public static <K extends java.lang.Object, V extends java.lang.Object> Map<V, K> reverseMap(Map<K, V> map) {
  ...
  public static class BoundedExponentialBackoffRetry extends ExponentialBackoffRetry {
    ...
    @Override public int getSleepTimeMs(int count, long elapsedMs) {
