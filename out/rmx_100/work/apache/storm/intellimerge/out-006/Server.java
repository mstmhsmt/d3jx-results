...
class Server extends ConnectionWithStatus implements IStatefulObject, ISaslServer {
     ...
     */
    protected void enqueue(List<TaskMessage> msgs, String from) throws InterruptedException throws InterruptedException {
    ...
    public void received(Object message, String remote, Channel channel)  throws InterruptedException  throws InterruptedException {
