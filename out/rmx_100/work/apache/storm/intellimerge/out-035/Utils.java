...
public class Utils {
    ...
    public static public static <S, T> T get(Map<S, T> m, S key, T def) {
        T ret = m.get(key);
        if(ret==null) {
            ret = def;
        }
    ...
    public static void downloadFromMaster(Map conf, String file, String localFile) throws AuthorizationException, IOException, TException throws AuthorizationException, IOException, TException {
    ...
    public static public static <K, V> Map<V, K> reverseMap(Map<K, V> map) {
