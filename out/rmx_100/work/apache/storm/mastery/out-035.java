...
public class Utils {
    ...
    static private Object normalizeConf(Object conf) {
        if (conf == null)
            return new HashMap();
...
<<<<<<< commits-rmx_100/apache/storm/6592b8209c49a98db15b3d6d228f488aa6c2e623/Utils-c28d93a.java
...
>>>>>>> commits-rmx_100/apache/storm/c89fb820861427b5be0a204bc3ab7a89d67a97de/Utils-6a0a447.java
    ...
    public static class BoundedExponentialBackoffRetry extends ExponentialBackoffRetry {
        ...
        final protected int maxRetryInterval;
    ...
    public static boolean isZkAuthenticationConfiguredStormServer(Map conf) {
        return null != System.getProperty("java.security.auth.login.config") || (conf != null && conf.get(Config.STORM_ZOOKEEPER_AUTH_SCHEME) != null && !((String) conf.get(Config.STORM_ZOOKEEPER_AUTH_SCHEME)).isEmpty());
    }
    ...
    static protected void setupBuilder(CuratorFrameworkFactory.Builder builder, String zkStr, Map conf, ZookeeperAuthInfo auth) {
