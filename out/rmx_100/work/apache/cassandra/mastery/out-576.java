...
public class Server implements CassandraDaemon.Server {
    ...
    static final public int VERSION_3 = 3;

    static final public int CURRENT_VERSION = VERSION_4;
    ...
    static public class ConnectionTracker implements Connection.Tracker {

        final public ChannelGroup allChannels = new DefaultChannelGroup(GlobalEventExecutor.INSTANCE);
...
<<<<<<< commits-rmx_100/apache/cassandra/fc675450e9569a1555faa43c126cd0e5d91862e0/Server-72a1b60.java
...
>>>>>>> commits-rmx_100/apache/cassandra/f6cab37d5ee42313c7a5618c5d0694f312c9c194/Server-c21a669.java
...
>>>>>>> commits-rmx_100/apache/cassandra/f6cab37d5ee42313c7a5618c5d0694f312c9c194/Server-c21a669.java
        ...
        public void onCreateAggregate(String ksName, String aggregateName, List<AbstractType<?>> argTypes) {
            server.connectionTracker.send(new Event.SchemaChange(Event.SchemaChange.Change.CREATED, Event.SchemaChange.Target.AGGREGATE, ksName, aggregateName, AbstractType.asCQLTypeStringList(argTypes)));
        }

        public void onUpdateAggregate(String ksName, String aggregateName, List<AbstractType<?>> argTypes) {
            server.connectionTracker.send(new Event.SchemaChange(Event.SchemaChange.Change.UPDATED, Event.SchemaChange.Target.AGGREGATE, ksName, aggregateName, AbstractType.asCQLTypeStringList(argTypes)));
        }
        ...
        public void onDropAggregate(String ksName, String aggregateName, List<AbstractType<?>> argTypes) {
            server.connectionTracker.send(new Event.SchemaChange(Event.SchemaChange.Change.DROPPED, Event.SchemaChange.Target.AGGREGATE, ksName, aggregateName, AbstractType.asCQLTypeStringList(argTypes)));
        }

        public void onCreateFunction(String ksName, String functionName, List<AbstractType<?>> argTypes) {
            server.connectionTracker.send(new Event.SchemaChange(Event.SchemaChange.Change.CREATED, Event.SchemaChange.Target.FUNCTION, ksName, functionName, AbstractType.asCQLTypeStringList(argTypes)));
        }
        ...
        public void onUpdateFunction(String ksName, String functionName, List<AbstractType<?>> argTypes) {
            server.connectionTracker.send(new Event.SchemaChange(Event.SchemaChange.Change.UPDATED, Event.SchemaChange.Target.FUNCTION, ksName, functionName, AbstractType.asCQLTypeStringList(argTypes)));
        }

        public void onDropFunction(String ksName, String functionName, List<AbstractType<?>> argTypes) {
            server.connectionTracker.send(new Event.SchemaChange(Event.SchemaChange.Change.DROPPED, Event.SchemaChange.Target.FUNCTION, ksName, functionName, AbstractType.asCQLTypeStringList(argTypes)));
        }
    }

    static final public int VERSION_4 = 4;

    static final public int VERSION_2 = 2;

    static final public int VERSION_1 = 1;

    private static class LatestEvent {

        final public Event.StatusChange.Status status;

        final public Event.TopologyChange.Change topology;
        ...
        static public LatestEvent forStatusChange(Event.StatusChange.Status status, LatestEvent prev) {
            return new LatestEvent(status, prev == null ? null : prev.topology);
        }

        static public LatestEvent forTopologyChange(Event.TopologyChange.Change change, LatestEvent prev) {
