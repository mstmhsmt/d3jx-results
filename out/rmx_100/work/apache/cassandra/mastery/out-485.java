...
public class ActiveRepairService implements IEndpointStateChangeSubscriber, IFailureDetectionEventListener {
    ...
    static final public ActiveRepairService instance = new ActiveRepairService(FailureDetector.instance, Gossiper.instance);

    static final public long UNREPAIRED_SSTABLE = 0;
    ...
    static public Set<InetAddress> getNeighbors(String keyspaceName, Collection<Range<Token>> keyspaceLocalRanges, Range<Token> toRepair, Collection<String> dataCenters, Collection<String> hosts) {
    ...
    static public class ParentRepairSession {

        private final Map<UUID, ColumnFamilyStore> columnFamilyStores = new HashMap<>();

        private final Collection<Range<Token>> ranges;

        final public Map<UUID, Set<String>> sstableMap = new HashMap<>();

        final public long repairedAt;

        final public InetAddress coordinator;
...
<<<<<<< commits-rmx_100/apache/cassandra/225232a9ea8945c85ae4f9cac3b97e003c9e9035/ActiveRepairService-e111155.java
...
>>>>>>> commits-rmx_100/apache/cassandra/9358e589e292a2c851d069aebd36819f8e767f5b/ActiveRepairService-4ca1e42.java
        ...
        private Set<SSTableReader> getSSTablesForSnapshotRepair(UUID cfId, UUID parentSessionId) {
            ...
            for (SSTableReader sstable : cfs.select(ColumnFamilyStore.CANONICAL_SSTABLES).sstables) if (snapshotGenerations.contains(sstable.descriptor.generation))
                activeSSTables.add(sstable);
            return activeSSTables;
        }
    }
    ...
    static public CassandraVersion SUPPORTS_GLOBAL_PREPARE_FLAG_VERSION = new CassandraVersion("2.2.1");
