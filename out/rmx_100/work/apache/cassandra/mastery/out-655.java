...
public class DatabaseDescriptor {
    ...
    @VisibleForTesting
    static public Config loadConfig() throws ConfigurationException {
...
<<<<<<< commits-rmx_100/apache/cassandra/ac9ccfdf7c1d06cf01eeb84561a7c514674cc3b8/DatabaseDescriptor-35ce728.java
if (addrs.hasMoreElements())
                throw new ConfigurationException("Configured " + configName + " \"" + intf + "\" can't have more than one address", false);
=======

>>>>>>> commits-rmx_100/apache/cassandra/89cdfd8e075d8883d776d7f881735f1c25e3cb54/DatabaseDescriptor-65cec9c.java
...
if (conf.broadcast_rpc_address != null) {
            ...
            if (rpcAddress.isAnyLocalAddress())
                throw new ConfigurationException("If rpc_address is set to a wildcard address (" + conf.rpc_address + "), then " + "you must set broadcast_rpc_address to a value other than " + conf.rpc_address, false);
...
>>>>>>> commits-rmx_100/apache/cassandra/89cdfd8e075d8883d776d7f881735f1c25e3cb54/DatabaseDescriptor-65cec9c.java
    ...
    static public IAuthenticator getAuthenticator() {
        return authenticator;
    }

    static public IAuthorizer getAuthorizer() {
        return authorizer;
    }

    static public int getPermissionsValidity() {
        return conf.permissions_validity_in_ms;
    }

    static public void setPermissionsValidity(int timeout) {
        conf.permissions_validity_in_ms = timeout;
    }

    static public int getPermissionsCacheMaxEntries() {
        return conf.permissions_cache_max_entries;
    }

    static public int getPermissionsUpdateInterval() {
        return conf.permissions_update_interval_in_ms == -1 ? conf.permissions_validity_in_ms : conf.permissions_update_interval_in_ms;
    }

    static public void setPermissionsUpdateInterval(int updateInterval) {
        conf.permissions_update_interval_in_ms = updateInterval;
    }

    static public int getThriftFramedTransportSize() {
        return conf.thrift_framed_transport_size_in_mb * 1024 * 1024;
    }

    static public void createAllDirectories() {
        try {
    ...
    static public IPartitioner getPartitioner() {
        return partitioner;
    }

    static public String getPartitionerName() {
        return paritionerName;
    }

    static public void setPartitioner(IPartitioner newPartitioner) {
        partitioner = newPartitioner;
    }

    static public IEndpointSnitch getEndpointSnitch() {
        return snitch;
    }

    static public void setEndpointSnitch(IEndpointSnitch eps) {
        snitch = eps;
    }

    static public IRequestScheduler getRequestScheduler() {
        return requestScheduler;
    }

    static public RequestSchedulerOptions getRequestSchedulerOptions() {
        return requestSchedulerOptions;
    }

    static public RequestSchedulerId getRequestSchedulerId() {
        return requestSchedulerId;
    }

    static public int getColumnIndexSize() {
        return conf.column_index_size_in_kb * 1024;
    }

    static public int getBatchSizeWarnThreshold() {
        return conf.batch_size_warn_threshold_in_kb * 1024;
    }

    static public Collection<String> getInitialTokens() {
        return tokensFromString(System.getProperty("cassandra.initial_token", conf.initial_token));
    }

    static public Collection<String> tokensFromString(String tokenString) {
    ...
    static public Integer getNumTokens() {
        return conf.num_tokens;
    }

    static public InetAddress getReplaceAddress() {
        try {
    ...
    static public Collection<String> getReplaceTokens() {
        return tokensFromString(System.getProperty("cassandra.replace_token", null));
    }

    static public UUID getReplaceNode() {
        try {
    ...
    static public boolean isReplacing() {
    ...
    static public String getClusterName() {
        return conf.cluster_name;
    }

    static public int getMaxStreamingRetries() {
        return conf.max_streaming_retries;
    }

    static public int getStoragePort() {
        return Integer.parseInt(System.getProperty("cassandra.storage_port", conf.storage_port.toString()));
    }

    static public int getSSLStoragePort() {
        return Integer.parseInt(System.getProperty("cassandra.ssl_storage_port", conf.ssl_storage_port.toString()));
    }

    static public int getRpcPort() {
        return Integer.parseInt(System.getProperty("cassandra.rpc_port", conf.rpc_port.toString()));
    }

    static public int getRpcListenBacklog() {
        return conf.rpc_listen_backlog;
    }

    static public long getRpcTimeout() {
        return conf.request_timeout_in_ms;
    }

    static public void setRpcTimeout(Long timeOutInMillis) {
        conf.request_timeout_in_ms = timeOutInMillis;
    }

    static public long getReadRpcTimeout() {
        return conf.read_request_timeout_in_ms;
    }

    static public void setReadRpcTimeout(Long timeOutInMillis) {
        conf.read_request_timeout_in_ms = timeOutInMillis;
    }

    static public long getRangeRpcTimeout() {
        return conf.range_request_timeout_in_ms;
    }

    static public void setRangeRpcTimeout(Long timeOutInMillis) {
        conf.range_request_timeout_in_ms = timeOutInMillis;
    }

    static public long getWriteRpcTimeout() {
        return conf.write_request_timeout_in_ms;
    }

    static public void setWriteRpcTimeout(Long timeOutInMillis) {
        conf.write_request_timeout_in_ms = timeOutInMillis;
    }

    static public long getCounterWriteRpcTimeout() {
        return conf.counter_write_request_timeout_in_ms;
    }

    static public void setCounterWriteRpcTimeout(Long timeOutInMillis) {
        conf.counter_write_request_timeout_in_ms = timeOutInMillis;
    }

    static public long getCasContentionTimeout() {
        return conf.cas_contention_timeout_in_ms;
    }

    static public void setCasContentionTimeout(Long timeOutInMillis) {
        conf.cas_contention_timeout_in_ms = timeOutInMillis;
    }

    static public long getTruncateRpcTimeout() {
        return conf.truncate_request_timeout_in_ms;
    }

    static public void setTruncateRpcTimeout(Long timeOutInMillis) {
        conf.truncate_request_timeout_in_ms = timeOutInMillis;
    }

    static public boolean hasCrossNodeTimeout() {
        return conf.cross_node_timeout;
    }

    static public long getTimeout(MessagingService.Verb verb) {
        switch(verb) {
            case READ:
    ...
    static public long getMinRpcTimeout() {
    ...
    static public double getPhiConvictThreshold() {
        return conf.phi_convict_threshold;
    }

    static public void setPhiConvictThreshold(double phiConvictThreshold) {
        conf.phi_convict_threshold = phiConvictThreshold;
    }

    static public int getConcurrentReaders() {
        return conf.concurrent_reads;
    }

    static public int getConcurrentWriters() {
        return conf.concurrent_writes;
    }

    static public int getConcurrentCounterWriters() {
        return conf.concurrent_counter_writes;
    }

    static public int getFlushWriters() {
        return conf.memtable_flush_writers;
    }

    static public int getConcurrentCompactors() {
        return conf.concurrent_compactors;
    }

    static public int getCompactionThroughputMbPerSec() {
        return conf.compaction_throughput_mb_per_sec;
    }

    static public void setCompactionThroughputMbPerSec(int value) {
        conf.compaction_throughput_mb_per_sec = value;
    }

    static public boolean getDisableSTCSInL0() {
        return Boolean.getBoolean("cassandra.disable_stcs_in_l0");
    }

    static public int getStreamThroughputOutboundMegabitsPerSec() {
        return conf.stream_throughput_outbound_megabits_per_sec;
    }

    static public void setStreamThroughputOutboundMegabitsPerSec(int value) {
        conf.stream_throughput_outbound_megabits_per_sec = value;
    }

    static public int getInterDCStreamThroughputOutboundMegabitsPerSec() {
        return conf.inter_dc_stream_throughput_outbound_megabits_per_sec;
    }

    static public void setInterDCStreamThroughputOutboundMegabitsPerSec(int value) {
        conf.inter_dc_stream_throughput_outbound_megabits_per_sec = value;
    }

    static public String[] getAllDataFileLocations() {
        return conf.data_file_directories;
    }

    static public String getCommitLogLocation() {
        return conf.commitlog_directory;
    }

    static public int getTombstoneWarnThreshold() {
        return conf.tombstone_warn_threshold;
    }

    static public void setTombstoneWarnThreshold(int threshold) {
        conf.tombstone_warn_threshold = threshold;
    }

    static public int getTombstoneFailureThreshold() {
        return conf.tombstone_failure_threshold;
    }

    static public void setTombstoneFailureThreshold(int threshold) {
        conf.tombstone_failure_threshold = threshold;
    }

    static public int getCommitLogSegmentSize() {
        return conf.commitlog_segment_size_in_mb * 1024 * 1024;
    }

    static public String getSavedCachesLocation() {
        return conf.saved_caches_directory;
    }

    static public Set<InetAddress> getSeeds() {
        return ImmutableSet.<InetAddress>builder().addAll(seedProvider.getSeeds()).build();
    }

    static public InetAddress getListenAddress() {
    ...
    static public IInternodeAuthenticator getInternodeAuthenticator() {
        return internodeAuthenticator;
    }

    static public void setBroadcastAddress(InetAddress broadcastAdd) {
        broadcastAddress = broadcastAdd;
    }

    static public boolean startRpc() {
        return conf.start_rpc;
    }

    static public InetAddress getRpcAddress() {
        return rpcAddress;
    }

    static public void setBroadcastRpcAddress(InetAddress broadcastRPCAddr) {
        broadcastRpcAddress = broadcastRPCAddr;
    }

    static public InetAddress getBroadcastRpcAddress() {
        return broadcastRpcAddress;
    }

    static public String getRpcServerType() {
        return conf.rpc_server_type;
    }

    static public boolean getRpcKeepAlive() {
        return conf.rpc_keepalive;
    }

    static public Integer getRpcMinThreads() {
        return conf.rpc_min_threads;
    }

    static public Integer getRpcMaxThreads() {
        return conf.rpc_max_threads;
    }

    static public Integer getRpcSendBufferSize() {
        return conf.rpc_send_buff_size_in_bytes;
    }

    static public Integer getRpcRecvBufferSize() {
        return conf.rpc_recv_buff_size_in_bytes;
    }

    static public Integer getInternodeSendBufferSize() {
        return conf.internode_send_buff_size_in_bytes;
    }

    static public Integer getInternodeRecvBufferSize() {
        return conf.internode_recv_buff_size_in_bytes;
    }

    static public boolean startNativeTransport() {
        return conf.start_native_transport;
    }

    static public int getNativeTransportPort() {
        return Integer.parseInt(System.getProperty("cassandra.native_transport_port", conf.native_transport_port.toString()));
    }

    static public Integer getNativeTransportMaxThreads() {
        return conf.native_transport_max_threads;
    }

    static public int getNativeTransportMaxFrameSize() {
        return conf.native_transport_max_frame_size_in_mb * 1024 * 1024;
    }

    static public Long getNativeTransportMaxConcurrentConnections() {
        return conf.native_transport_max_concurrent_connections;
    }

    static public void setNativeTransportMaxConcurrentConnections(long nativeTransportMaxConcurrentConnections) {
        conf.native_transport_max_concurrent_connections = nativeTransportMaxConcurrentConnections;
    }

    static public Long getNativeTransportMaxConcurrentConnectionsPerIp() {
        return conf.native_transport_max_concurrent_connections_per_ip;
    }

    static public void setNativeTransportMaxConcurrentConnectionsPerIp(long native_transport_max_concurrent_connections_per_ip) {
        conf.native_transport_max_concurrent_connections_per_ip = native_transport_max_concurrent_connections_per_ip;
    }

    static public double getCommitLogSyncBatchWindow() {
        return conf.commitlog_sync_batch_window_in_ms;
    }

    static public int getCommitLogSyncPeriod() {
        return conf.commitlog_sync_period_in_ms;
    }

    static public int getCommitLogPeriodicQueueSize() {
        return conf.commitlog_periodic_queue_size;
    }

    static public Config.CommitLogSync getCommitLogSync() {
        return conf.commitlog_sync;
    }

    static public Config.DiskAccessMode getDiskAccessMode() {
        return conf.disk_access_mode;
    }

    static public Config.DiskAccessMode getIndexAccessMode() {
        return indexAccessMode;
    }

    static public void setDiskFailurePolicy(Config.DiskFailurePolicy policy) {
        conf.disk_failure_policy = policy;
    }

    static public Config.DiskFailurePolicy getDiskFailurePolicy() {
        return conf.disk_failure_policy;
    }

    static public void setCommitFailurePolicy(Config.CommitFailurePolicy policy) {
        conf.commit_failure_policy = policy;
    }

    static public Config.CommitFailurePolicy getCommitFailurePolicy() {
        return conf.commit_failure_policy;
    }

    static public boolean isSnapshotBeforeCompaction() {
        return conf.snapshot_before_compaction;
    }

    static public boolean isAutoSnapshot() {
        return conf.auto_snapshot;
    }

    @VisibleForTesting
    static public void setAutoSnapshot(boolean autoSnapshot) {
        conf.auto_snapshot = autoSnapshot;
    }

    static public boolean isAutoBootstrap() {
        return Boolean.parseBoolean(System.getProperty("cassandra.auto_bootstrap", conf.auto_bootstrap.toString()));
    }

    static public void setHintedHandoffEnabled(boolean hintedHandoffEnabled) {
        conf.hinted_handoff_enabled_global = hintedHandoffEnabled;
        conf.hinted_handoff_enabled_by_dc.clear();
    }

    static public void setHintedHandoffEnabled(final String dcNames) {
    ...
    static public boolean hintedHandoffEnabled() {
        return conf.hinted_handoff_enabled_global;
    }

    static public Set<String> hintedHandoffEnabledByDC() {
        return Collections.unmodifiableSet(conf.hinted_handoff_enabled_by_dc);
    }

    static public boolean shouldHintByDC() {
        return !conf.hinted_handoff_enabled_by_dc.isEmpty();
    }

    static public boolean hintedHandoffEnabled(final String dcName) {
        return conf.hinted_handoff_enabled_by_dc.contains(dcName);
    }

    static public void setMaxHintWindow(int ms) {
        conf.max_hint_window_in_ms = ms;
    }

    static public int getMaxHintWindow() {
        return conf.max_hint_window_in_ms;
    }

    static public File getSerializedCachePath(String ksName, String cfName, UUID cfId, CacheService.CacheType cacheType, String version) {
    ...
    static public int getDynamicUpdateInterval() {
        return conf.dynamic_snitch_update_interval_in_ms;
    }

    static public void setDynamicUpdateInterval(Integer dynamicUpdateInterval) {
        conf.dynamic_snitch_update_interval_in_ms = dynamicUpdateInterval;
    }

    static public int getDynamicResetInterval() {
        return conf.dynamic_snitch_reset_interval_in_ms;
    }

    static public void setDynamicResetInterval(Integer dynamicResetInterval) {
        conf.dynamic_snitch_reset_interval_in_ms = dynamicResetInterval;
    }

    static public double getDynamicBadnessThreshold() {
        return conf.dynamic_snitch_badness_threshold;
    }

    static public void setDynamicBadnessThreshold(Double dynamicBadnessThreshold) {
        conf.dynamic_snitch_badness_threshold = dynamicBadnessThreshold;
    }

    static public ServerEncryptionOptions getServerEncryptionOptions() {
        return conf.server_encryption_options;
    }

    static public ClientEncryptionOptions getClientEncryptionOptions() {
        return conf.client_encryption_options;
    }

    static public int getHintedHandoffThrottleInKB() {
        return conf.hinted_handoff_throttle_in_kb;
    }

    static public int getBatchlogReplayThrottleInKB() {
        return conf.batchlog_replay_throttle_in_kb;
    }

    static public void setHintedHandoffThrottleInKB(Integer throttleInKB) {
        conf.hinted_handoff_throttle_in_kb = throttleInKB;
    }

    static public int getMaxHintsThread() {
        return conf.max_hints_delivery_threads;
    }

    static public boolean isIncrementalBackupsEnabled() {
        return conf.incremental_backups;
    }

    static public void setIncrementalBackupsEnabled(boolean value) {
        conf.incremental_backups = value;
    }

    static public int getFileCacheSizeInMB() {
        return conf.file_cache_size_in_mb;
    }

    static public long getTotalCommitlogSpaceInMB() {
        return conf.commitlog_total_space_in_mb;
    }

    static public int getSSTablePreempiveOpenIntervalInMB() {
        return conf.sstable_preemptive_open_interval_in_mb;
    }

    static public boolean getTrickleFsync() {
        return conf.trickle_fsync;
    }

    static public int getTrickleFsyncIntervalInKb() {
        return conf.trickle_fsync_interval_in_kb;
    }

    static public long getKeyCacheSizeInMB() {
        return keyCacheSizeInMB;
    }

    static public long getIndexSummaryCapacityInMB() {
        return indexSummaryCapacityInMB;
    }

    static public int getKeyCacheSavePeriod() {
        return conf.key_cache_save_period;
    }

    static public void setKeyCacheSavePeriod(int keyCacheSavePeriod) {
        conf.key_cache_save_period = keyCacheSavePeriod;
    }

    static public int getKeyCacheKeysToSave() {
        return conf.key_cache_keys_to_save;
    }

    static public void setKeyCacheKeysToSave(int keyCacheKeysToSave) {
        conf.key_cache_keys_to_save = keyCacheKeysToSave;
    }

    static public long getRowCacheSizeInMB() {
        return conf.row_cache_size_in_mb;
    }

    static public int getRowCacheSavePeriod() {
        return conf.row_cache_save_period;
    }

    static public void setRowCacheSavePeriod(int rowCacheSavePeriod) {
        conf.row_cache_save_period = rowCacheSavePeriod;
    }

    static public int getRowCacheKeysToSave() {
        return conf.row_cache_keys_to_save;
    }

    static public long getCounterCacheSizeInMB() {
        return counterCacheSizeInMB;
    }

    static public int getCounterCacheSavePeriod() {
        return conf.counter_cache_save_period;
    }

    static public void setCounterCacheSavePeriod(int counterCacheSavePeriod) {
        conf.counter_cache_save_period = counterCacheSavePeriod;
    }

    static public int getCounterCacheKeysToSave() {
        return conf.counter_cache_keys_to_save;
    }

    static public void setCounterCacheKeysToSave(int counterCacheKeysToSave) {
        conf.counter_cache_keys_to_save = counterCacheKeysToSave;
    }

    static public void setRowCacheKeysToSave(int rowCacheKeysToSave) {
        conf.row_cache_keys_to_save = rowCacheKeysToSave;
    }

    static public int getStreamingSocketTimeout() {
        return conf.streaming_socket_timeout_in_ms;
    }

    static public String getLocalDataCenter() {
        return localDC;
    }

    static public Comparator<InetAddress> getLocalComparator() {
        return localComparator;
    }

    static public Config.InternodeCompression internodeCompression() {
        return conf.internode_compression;
    }

    static public boolean getInterDCTcpNoDelay() {
        return conf.inter_dc_tcp_nodelay;
    }

    static public MemtablePool getMemtableAllocatorPool() {
    ...
    static public int getIndexSummaryResizeIntervalInMinutes() {
        return conf.index_summary_resize_interval_in_minutes;
    }

    static public boolean hasLargeAddressSpace() {
    ...
    static public int getRolesValidity() {
        return conf.roles_validity_in_ms;
    }

    static public int getRolesCacheMaxEntries() {
        return conf.roles_cache_max_entries;
    }

    static public int getRolesUpdateInterval() {
        return conf.roles_update_interval_in_ms == -1 ? conf.roles_validity_in_ms : conf.roles_update_interval_in_ms;
    }

    static public SSTableFormat.Type getSSTableFormat() {
        return sstable_format;
    }

    static public IRoleManager getRoleManager() {
        return roleManager;
    }

    static public int getBatchSizeFailThresholdInKB() {
        return conf.batch_size_fail_threshold_in_kb;
    }

    static public void forceStaticInitialization() {
    }

    static public long getBatchSizeFailThreshold() {
        return conf.batch_size_fail_threshold_in_kb * 1024L;
    }

    static public void setBatchSizeFailThresholdInKB(int threshold) {
        conf.batch_size_fail_threshold_in_kb = threshold;
    }

    static public int getTracetypeRepairTTL() {
        return conf.tracetype_repair_ttl;
    }

    static public int getTracetypeQueryTTL() {
        return conf.tracetype_query_ttl;
    }

    private static IRoleManager roleManager = new CassandraRoleManager();

    static public String getRowCacheClassName() {
