...
public class SelectStatement implements CQLStatement {
    ...
    static final public int DEFAULT_PAGE_SIZE = 10000;
    ...
    public SelectStatement(TableMetadata table, int boundTerms, Parameters parameters, Selection selection, StatementRestrictions restrictions, boolean isReversed, AggregationSpecification aggregationSpec, Comparator<List<ByteBuffer>> orderingComparator, Term limit, Term perPartitionLimit) {
        this.table = table;
    ...
    static SelectStatement forSelection(TableMetadata table, Selection selection) {
        return new SelectStatement(table, 0, defaultParameters, selection, StatementRestrictions.empty(StatementType.SELECT, table), false, null, null, null, null);
    }
    ...
    private static abstract class Pager {
        ...
        static public Pager forInternalQuery(QueryPager pager, ReadExecutionController executionController) {
            return new InternalPager(pager, executionController);
        }

        static public Pager forDistributedQuery(QueryPager pager, ConsistencyLevel consistency, ClientState clientState) {
        ...
        static public class NormalPager extends Pager {
        ...
        static public class InternalPager extends Pager {
    ...
    private ReadQuery getRangeCommand(QueryOptions options, ColumnFilter columnFilter, DataLimits limit, int nowInSec) {
        ...
        if (keyBounds == null)
            return ReadQuery.EMPTY;
        PartitionRangeReadCommand command = PartitionRangeReadCommand.create(table, nowInSec, columnFilter, rowFilter, limit, new DataRange(keyBounds, clusteringIndexFilter));
    ...
    private Slices makeSlices(QueryOptions options) throws InvalidRequestException {
        ...
        if (startBounds.size() == 1) {
            ...
            return table.comparator.compare(start, end) > 0 ? Slices.NONE : Slices.with(table.comparator, Slice.make(start, end));
        }
    ...
    static public ByteBuffer[] getComponents(TableMetadata metadata, DecoratedKey dk) {
    ...
    static public class RawStatement extends CFStatement {
        ...
        final public List<RawSelector> selectClause;

        final public WhereClause whereClause;

        final public Term.Raw limit;

        final public Term.Raw perPartitionLimit;
...
<<<<<<< commits-rmx_100/apache/cassandra/09f3c969bc7a77f5e78a6d0cc28751c4b664f72e/SelectStatement-8272eb5.java
...
public ParsedStatement.Prepared prepare(boolean forView, ClientState clientState) throws InvalidRequestException {
            ...
            AggregationSpecification aggregationSpec = getAggregationSpecification(cfm, selection, restrictions, parameters.isDistinct);
            ...
            SelectStatement stmt = new SelectStatement(cfm, boundNames.size(), parameters, selection, restrictions, isReversed, aggregationSpec, orderingComparator, prepareLimit(boundNames, limit, keyspace(), limitReceiver()), prepareLimit(boundNames, perPartitionLimit, keyspace(), perPartitionLimitReceiver()));
            return new ParsedStatement.Prepared(stmt, boundNames, boundNames.getPartitionKeyBindIndexes(cfm));
        }
>>>>>>> commits-rmx_100/apache/cassandra/95cfee623456f1df51ce548cc6cf42fe5a78050c/SelectStatement-348fa52.java
        ...
        private Selection prepareSelection(TableMetadata table, List<Selectable> selectables, VariableSpecifications boundNames, Set<ColumnMetadata> resultSetOrderingColumns, StatementRestrictions restrictions) {
            ...
            if (selectables.isEmpty()) {
                return hasGroupBy ? Selection.wildcardWithGroupBy(table, boundNames, parameters.isJson) : Selection.wildcard(table, parameters.isJson);
            }
            return Selection.fromSelectors(table, selectables, boundNames, resultSetOrderingColumns, restrictions.nonPKRestrictedColumns(false), hasGroupBy, parameters.isJson);
        }
        ...
        private Comparator<List<ByteBuffer>> getOrderingComparator(TableMetadata metadata, Selection selection, StatementRestrictions restrictions, 
<<<<<<< commits-rmx_100/apache/cassandra/09f3c969bc7a77f5e78a6d0cc28751c4b664f72e/SelectStatement-8272eb5.java
...
>>>>>>> commits-rmx_100/apache/cassandra/95cfee623456f1df51ce548cc6cf42fe5a78050c/SelectStatement-348fa52.java
            ...
            if (!restrictions.keyIsInRelation())
                return null;
            Map<ColumnDefinition, Integer> orderingIndexes = getOrderingIndex(metadata, selection, 
<<<<<<< commits-rmx_100/apache/cassandra/09f3c969bc7a77f5e78a6d0cc28751c4b664f72e/SelectStatement-8272eb5.java
orderingColumns
=======
isJson
>>>>>>> commits-rmx_100/apache/cassandra/95cfee623456f1df51ce548cc6cf42fe5a78050c/SelectStatement-348fa52.java
        ...
        private Map<ColumnDefinition, Integer> getOrderingIndex(TableMetadata table, Selection selection, 
<<<<<<< commits-rmx_100/apache/cassandra/09f3c969bc7a77f5e78a6d0cc28751c4b664f72e/SelectStatement-8272eb5.java
Map<ColumnMetadata, Boolean> orderingColumns
=======
boolean isJson
...
>>>>>>> commits-rmx_100/apache/cassandra/95cfee623456f1df51ce548cc6cf42fe5a78050c/SelectStatement-348fa52.java
        ...
        public String toString() {
            return MoreObjects.toStringHelper(this).add("name", cfName).add("selectClause", selectClause).add("whereClause", whereClause).add("isDistinct", parameters.isDistinct).toString();
        }
        ...
        public ParsedStatement.Prepared prepare(boolean forView) throws InvalidRequestException {
            ...
            Selection selection = prepareSelection(table, selectables, boundNames, resultSetOrderingColumns, restrictions);
            if (parameters.isDistinct) {
                checkNull(perPartitionLimit, "PER PARTITION LIMIT is not allowed with SELECT DISTINCT queries");
            ...
            checkNeedsFiltering(restrictions);
            SelectStatement stmt = new SelectStatement(table, boundNames.size(), parameters, selection, restrictions, isReversed, aggregationSpec, orderingComparator, prepareLimit(boundNames, limit, keyspace(), limitReceiver()), prepareLimit(boundNames, perPartitionLimit, keyspace(), perPartitionLimitReceiver()));
    ...
    static public class Parameters {
        ...
        final public boolean allowFiltering;

        final public boolean isJson;

        final public Map<ColumnMetadata.Raw, Boolean> orderings;

        final public List<ColumnMetadata.Raw> groups;

        public Parameters(Map<ColumnMetadata.Raw, Boolean> orderings, List<ColumnMetadata.Raw> groups, boolean isDistinct, boolean allowFiltering, boolean isJson) {
    ...
    private static abstract class ColumnComparator<T> implements Comparator<T> {
        ...
        final protected int compare(Comparator<ByteBuffer> comparator, ByteBuffer aValue, ByteBuffer bValue) {
            if (aValue == null)
    ...
    final public TableMetadata table;
