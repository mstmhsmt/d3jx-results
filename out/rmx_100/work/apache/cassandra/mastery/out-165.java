...
=======
new HashCodeBuilder().append(estimatedPartitionSize).append(estimatedColumnCount).append(commitLogIntervals).append(minTimestamp).append(maxTimestamp).append(minLocalDeletionTime).append(maxLocalDeletionTime).append(minTTL).append(maxTTL).append(compressionRatio).append(estimatedTombstoneDropTime).append(sstableLevel).append(repairedAt).append(maxClusteringValues).append(minClusteringValues).append(hasLegacyCounterShards).append(totalColumnsSet).append(totalRows).append(originatingHostId).build()
>>>>>>> commits-rmx_100/apache/cassandra/d6ff4c4a35c9e587f24edd8936182cdd3e12feb1/StatsMetadata-2196ecf.java
;
    }
    ...
    public static class StatsMetadataSerializer implements IMetadataComponentSerializer<StatsMetadata> {
        ...
        static final private Logger logger = LoggerFactory.getLogger(StatsMetadataSerializer.class);
...
<<<<<<< commits-rmx_100/apache/cassandra/7e4c77c96887ac6f99b044b759495121024b582b/StatsMetadata-e985f40.java
UUID pendingRepair = null;if (version.hasPendingRepair() && in.readByte() != 0) {
                pendingRepair = UUIDSerializer.serializer.deserialize(in, 0);
            }
=======
UUID originatingHostId = null;if (version.hasOriginatingHostId() && in.readByte() != 0)
