...
public final class KSMetaData {
    ...
    final private Map<String, CFMetaData> cfMetaData;
    ...
    public boolean equals(Object obj) {
        ...
        return other.name.equals(name) && ObjectUtils.equals(other.strategyClass, strategyClass) && ObjectUtils.equals(other.strategyOptions, strategyOptions) && other.cfMetaData.equals(cfMetaData) && other.durableWrites == durableWrites;
    }
    ...
    public String toString() {
        ...
        sb.append(name).append(", rep strategy:").append(strategyClass.getSimpleName()).append("{").append(StringUtils.join(cfMetaData.values(), ", ")).append("}").append(", durable_writes: ").append(durableWrites);
        return sb.toString();
    }
    ...
    public static KSMetaData fromThrift(KsDef ksd, CFMetaData... cfDefs) throws ConfigurationException {
        return new KSMetaData(ksd.name, AbstractReplicationStrategy.getClass(ksd.strategy_class), ksd.strategy_options == null ? Collections.<String, String>emptyMap() : ksd.strategy_options, ksd.durable_writes, Arrays.asList(cfDefs));
    }
...
<<<<<<< commits-rmx_100/apache/cassandra/3db0a75d5bc971b219d08d0d514c97d6ac9c7aaf/KSMetaData-0d8d2aa.java
List<RowMutation> mutations = new ArrayList<RowMutation>(cfMetaData.size());
=======

>>>>>>> commits-rmx_100/apache/cassandra/ccb0028931c9de665d521b4798a9f63f7dee7497/KSMetaData-5b9d5ba.java
    ...
    public static Map<String, CFMetaData> deserializeColumnFamilies(Row row) {
        ...
        for (CFMetaData cfm : cfms.values()) {
            ...
            for (ColumnDefinition cd : ColumnDefinition.fromSchema(columnRow, cfm.comparator)) cfm.column_metadata.put(cd.name, cd);
        }
        return cfms;
    }
    ...
    public static KSMetaData fromSchema(Row row, Iterable<CFMetaData> cfms) throws IOException {
        ...
        try {
            return new KSMetaData(result.getString("name"), AbstractReplicationStrategy.getClass(result.getString("strategy_class")), fromJsonMap(result.getString("strategy_options")), result.getBoolean("durable_writes"), cfms);
