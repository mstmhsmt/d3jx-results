...
public class BufferPool {
    ...
    static final private Logger logger = LoggerFactory.getLogger(BufferPool.class);

    static final private NoSpamLogger noSpamLogger = NoSpamLogger.getLogger(logger, 15L, TimeUnit.MINUTES);

    static final private ByteBuffer EMPTY_BUFFER = ByteBuffer.allocateDirect(0);

    final private FastThreadLocal<LocalPool> localPool = new FastThreadLocal<LocalPool>() {
...
<<<<<<< commits-rmx_100/apache/cassandra/e9b411e3e04708b74c5d40a3b8b6f89073fda7a2/BufferPool-531b492.java

=======
void check() {
            for (Chunk chunk : allChunks) assert chunk.lastRecycled >= chunk.lastAcquired;
            recycleRound++;
        }
>>>>>>> commits-rmx_100/apache/cassandra/dc2acba043c6978b32a9556e0d610251d5535ce6/BufferPool-557b275.java
    ...
    final class GlobalPool implements Supplier<Chunk>, Recycler {
        ...
        final private Queue<Chunk> macroChunks = new ConcurrentLinkedQueue<>();

        final private Queue<Chunk> chunks = new ConcurrentLinkedQueue<>();
...
>>>>>>> commits-rmx_100/apache/cassandra/dc2acba043c6978b32a9556e0d610251d5535ce6/BufferPool-557b275.java
        ...
        final private Object readableMemoryUsage = new Object() {
        ...
        final private Queue<Chunk> partiallyFreedChunks = new ConcurrentLinkedQueue<>();
        ...
        final private String READABLE_MACRO_CHUNK_SIZE = prettyPrintMemory(MACRO_CHUNK_SIZE);
    ...
    public final class LocalPool implements Recycler {
        ...
        final private MicroQueueOfChunks chunks = new MicroQueueOfChunks();

        final private int tinyLimit;
        ...
        final private Supplier<Chunk> parent;

        final private Queue<ByteBuffer> reuseObjects;
        ...
        final private LocalPoolRef leakRef;
    ...
    static final private class LocalPoolRef extends PhantomReference<LocalPool> {

        final private MicroQueueOfChunks chunks;
    ...
    final private ReferenceQueue<Object> localPoolRefQueue = new ReferenceQueue<>();
    ...
    static private ByteBuffer allocateDirectAligned(int capacity) {
    ...
    static final class Chunk {
        ...
        static final private AtomicLongFieldUpdater<Chunk> freeSlotsUpdater = AtomicLongFieldUpdater.newUpdater(Chunk.class, "freeSlots");
...
>>>>>>> commits-rmx_100/apache/cassandra/dc2acba043c6978b32a9556e0d610251d5535ce6/BufferPool-557b275.java
        ...
        final private Recycler recycler;

        static final private AtomicReferenceFieldUpdater<Chunk, Status> statusUpdater = AtomicReferenceFieldUpdater.newUpdater(Chunk.class, Status.class, "status");
    ...
    static private class MicroQueueOfChunks {
        ...
        static private void forEach(Consumer<Chunk> consumer, int count, Chunk chunk0, Chunk chunk1, Chunk chunk2) {
            switch(count) {
                case 3:
    ...
    final private boolean recyclePartially;
    ...
    final private long memoryUsageThreshold;
    ...
    final private AtomicLong memoryAllocated = new AtomicLong();
    ...
    final private LongAdder memoryInUse = new LongAdder();

    final private LongAdder overflowMemoryUsage = new LongAdder();
    ...
    final protected BufferPoolMetrics metrics;
    ...
    final private Set<LocalPoolRef> localPoolReferences = Collections.newSetFromMap(new ConcurrentHashMap<>());
    ...
    final private InfiniteLoopExecutor localPoolCleaner;

    final private GlobalPool globalPool;

    final private String readableMemoryUsageThreshold;
