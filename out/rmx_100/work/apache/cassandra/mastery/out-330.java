...
public class MetadataCollector implements PartitionStatisticsCollector {
    ...
    final protected MinMaxLongTracker timestampTracker = new MinMaxLongTracker();

    final protected MinMaxIntTracker localDeletionTimeTracker = new MinMaxIntTracker(Cell.NO_DELETION_TIME, Cell.NO_DELETION_TIME);

    final protected MinMaxIntTracker ttlTracker = new MinMaxIntTracker(Cell.NO_TTL, Cell.NO_TTL);
    ...
    final private ClusteringComparator comparator;
    ...
    static private ByteBuffer maybeMinimize(ByteBuffer buffer) {
        return buffer == null ? null : ByteBufferUtil.minimalBufferFor(buffer);
    }

    static private ByteBuffer min(ByteBuffer b1, ByteBuffer b2, AbstractType<?> comparator) {
        if (b1 == null)
            return b2;
        if (b2 == null)
            return b1;
    ...
    static private ByteBuffer max(ByteBuffer b1, ByteBuffer b2, AbstractType<?> comparator) {
        if (b1 == null)
            return b2;
        if (b2 == null)
            return b1;
...
>>>>>>> commits-rmx_100/apache/cassandra/e04efab3f9a60e5e8c34c845548b6ab6d0570376/MetadataCollector-437d80f.java
    ...
    public static class MinMaxLongTracker {
        ...
        final private long defaultMin;

        final private long defaultMax;
    ...
    public static class MinMaxIntTracker {
        ...
        final private int defaultMin;

        final private int defaultMax;
    ...
    static final private ByteBuffer[] EMPTY_CLUSTERING = new ByteBuffer[0];
