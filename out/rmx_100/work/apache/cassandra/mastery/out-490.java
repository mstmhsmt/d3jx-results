...
public class CommitLog implements CommitLogMBean {
    ...
    static final public CommitLog instance = CommitLog.construct();

    private final long MAX_MUTATION_SIZE = DatabaseDescriptor.getMaxMutationSize();

    final public CommitLogSegmentManager allocator;

    final public CommitLogArchiver archiver;

    final CommitLogMetrics metrics;

    final AbstractCommitLogService executor;

    static final public class Configuration {
    ...
    public List<String> getActiveSegmentNames() {
        ...
        for (CommitLogSegment segment : allocator.getActiveSegments()) segmentNames.add(segment.getName());
        return segmentNames;
    }
    ...
    public Map<String, Double> getActiveSegmentCompressionRatios() {
        ...
        for (CommitLogSegment segment : allocator.getActiveSegments()) segmentRatios.put(segment.getName(), 1.0 * segment.onDiskSize() / segment.contentSize());
    ...
    @VisibleForTesting
    static public boolean handleCommitError(String message, Throwable t) {
