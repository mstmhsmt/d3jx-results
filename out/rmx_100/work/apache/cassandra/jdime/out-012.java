...
public class Dispatcher implements CQLMessageHandler.MessageConsumer<Message.Request> {
  private @VisibleForTesting static final 
<<<<<<< commits-rmx_100/apache/cassandra/17418a2ba071c02de67f66e6edc1db71b28a2976/Dispatcher-97b63f0.java
  Logger
=======
  LocalAwareExecutorService
>>>>>>> commits-rmx_100/apache/cassandra/8ea70cd1f0ba0a52cf4b19af9fac4c4289663270/Dispatcher-e1318d1.java
   
<<<<<<< commits-rmx_100/apache/cassandra/17418a2ba071c02de67f66e6edc1db71b28a2976/Dispatcher-97b63f0.java
  logger = LoggerFactory.getLogger(Dispatcher.class)
=======
  authExecutor = SHARED.newExecutor(Math.max(1, DatabaseDescriptor.getNativeTransportMaxAuthThreads()), DatabaseDescriptor::setNativeTransportMaxAuthThreads, "transport", "Native-Transport-Auth-Requests")
>>>>>>> commits-rmx_100/apache/cassandra/8ea70cd1f0ba0a52cf4b19af9fac4c4289663270/Dispatcher-e1318d1.java
  ;

  @VisibleForTesting static final LocalAwareExecutorPlus requestExecutor = SHARED.newExecutor(DatabaseDescriptor.getNativeTransportMaxThreads(), DatabaseDescriptor::setNativeTransportMaxThreads, "transport", "Native-Transport-Requests");
  ...
  @Override public void dispatch(Channel channel, Message.Request request, FlushItemConverter forFlusher, Overload backpressure) {
  ...
  public class RequestProcessor implements DebuggableTask.RunnableDebuggableTask {
    ...
    @Override public long creationTimeNanos() {
  ...
  /**
     ...
     */
  @Override public boolean hasQueueCapacity() {
