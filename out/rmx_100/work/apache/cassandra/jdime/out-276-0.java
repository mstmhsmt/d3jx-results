...
public class Instance extends IsolatedExecutor implements IInvokableInstance {
  ...
  public Future<Void> shutdown(boolean graceful) {
    ...
    Future<?> future = async((ExecutorService executor) -> {
      ...
      error = parallelRun(error, executor, () -> Gossiper.instance.stopShutdownAndWait(1L, MINUTES), CompactionManager.instance::forceShutdown, 
      BatchlogManager.instance::shutdown
      , 
      HintsService.instance::shutdownBlocking
      , 
      SecondaryIndexManager::shutdownExecutors
      , () -> IndexSummaryManager.instance.shutdownAndWait(1L, MINUTES), () -> ColumnFamilyStore.shutdownExecutorsAndWait(1L, MINUTES), () -> PendingRangeCalculatorService.instance.shutdownExecutor(1L, MINUTES), () -> StorageService.instance.shutdownBGMonitorAndWait(1L, MINUTES), 
      BufferPool::shutdownLocalCleaner
      , () -> Memtable.MEMORY_POOL.shutdownAndWait(1L, MINUTES), () -> SSTableReader.shutdownBlocking(1L, MINUTES), () -> ScheduledExecutors.shutdownAndWait(1L, MINUTES));
