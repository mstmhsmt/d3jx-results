...
>>>>>>> commits-rmx_100/apache/cassandra/89cdfd8e075d8883d776d7f881735f1c25e3cb54/DatabaseDescriptor-65cec9c.java
  ...
  @VisibleForTesting static void applyAddressConfig(Config config) throws ConfigurationException {
    listenAddress = null;
    rpcAddress = null;
    ...
    if (config.listen_address != null && config.listen_interface != null) {
      ...
      if (config.listen_address != null) {
        ...
        if (config.listen_interface != null) {
  ...
  private static void applyConfig(Config config) throws ConfigurationException {
    ...
    if (FBUtilities.isWindows()) {
      ...
      if (conf.disk_access_mode == Config.DiskAccessMode.auto) {
        ...
        if (conf.disk_access_mode == Config.DiskAccessMode.mmap_index_only) {
          conf.disk_access_mode = Config.DiskAccessMode.standard;
