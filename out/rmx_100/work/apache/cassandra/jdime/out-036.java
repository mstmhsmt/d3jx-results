...
public class BatchStatement implements CQLStatement {
  ...
  @Override public Iterable<org.apache.cassandra.cql3.functions.Function> getFunctions() {
  ...
  @VisibleForTesting public List<? extends IMutation> getMutations(ClientState state, BatchQueryOptions options, boolean local, long batchTimestamp, long nowInSeconds, Dispatcher.RequestTime requestTime) {
  ...
  public static class Parsed extends QualifiedStatement {
    ...
    @Override public boolean isFullyQualified() {
    ...
    @Override public void setKeyspace(ClientState state) throws InvalidRequestException {
      for (ModificationStatement.Parsed statement : parsedStatements) {
        statement.setKeyspace(state);
      }
    }

    @Override public String keyspace() {
      return null;
    }
