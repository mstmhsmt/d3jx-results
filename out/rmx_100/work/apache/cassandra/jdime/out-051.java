...
@Ignore public abstract class AbstractReadRepairTest {
  static Keyspace ks;
...
>>>>>>> commits-rmx_100/apache/cassandra/c2041ba45b036e1d5963f8166f517c6d95d4eab1/AbstractReadRepairTest-83865b1.java
  ...
  @SuppressWarnings(value = { "resource" }) static Message<ReadResponse> msg(InetAddressAndPort from, Cell<?>... cells) {
    UnfilteredPartitionIterator iter = new SingletonUnfilteredPartitionIterator(update(cells).unfilteredIterator());
  ...
  static class ResultConsumer implements Consumer<PartitionIterator> {
    ...
    @Override public void accept(PartitionIterator partitionIterator) {
...
>>>>>>> commits-rmx_100/apache/cassandra/c2041ba45b036e1d5963f8166f517c6d95d4eab1/AbstractReadRepairTest-83865b1.java
    .
<<<<<<< commits-rmx_100/apache/cassandra/5f63b0ade1fe2d9fbd0cb475da936e27ec3ed64e/AbstractReadRepairTest-bb10c67.java
    announceNewKeyspace(ksm)
=======
    setEndpointSnitch(new AbstractNetworkTopologySnitch() {
...
>>>>>>> commits-rmx_100/apache/cassandra/c2041ba45b036e1d5963f8166f517c6d95d4eab1/AbstractReadRepairTest-83865b1.java
    ...
    target3 = 
<<<<<<< commits-rmx_100/apache/cassandra/5f63b0ade1fe2d9fbd0cb475da936e27ec3ed64e/AbstractReadRepairTest-bb10c67.java
    cfs.additionalWriteLatencyMicros
=======
...
>>>>>>> commits-rmx_100/apache/cassandra/c2041ba45b036e1d5963f8166f517c6d95d4eab1/AbstractReadRepairTest-83865b1.java
    ...
    String ksName = "ks";
    String ddl = String.format("CREATE TABLE tbl (k int primary key, v text) WITH read_repair=\'%s\'", repairStrategy.toString().toLowerCase());
  ...
  /**
     ...
     */
  @Test public void readSpeculationCycle() {
  ...
  /**
     ...
     */
  @Test public void noSpeculationRequired() {
    InstrumentedReadRepair repair = createInstrumentedReadRepair(ReplicaPlan.shared(replicaPlan(replicas, EndpointsForRange.of(replica1, replica2))));
    ResultConsumer consumer = new ResultConsumer();
    Assert.assertEquals(epSet(), repair.getReadRecipients());
    repair.startRepair(null, consumer);
