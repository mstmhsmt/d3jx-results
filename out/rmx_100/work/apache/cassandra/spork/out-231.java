...
public abstract interface StorageProxyMBean {
    ...
    @Deprecated
    public abstract int getOtcBacklogExpirationInterval();

    @Deprecated
    public abstract void setOtcBacklogExpirationInterval(int intervalInMillis);

    /** Returns each live node's schema version */
    @Deprecated
    public abstract Map<String, List<String>> getSchemaVersions();
