...
public class ColumnFamilyStore implements ColumnFamilyStoreMBean {
    ...
    public synchronized void loadNewSSTables() {
        ...
        for (Map.Entry<Descriptor, Set<Component>> entry : lister.list().entrySet()) {
            ...
            do {
                newDescriptor = new Descriptor(descriptor.version, descriptor.directory, descriptor.ksname, descriptor.cfname, fileIndexGenerator.incrementAndGet(), Descriptor.Type, descriptor.formatType);
    ...
    private String getTempSSTablePath(File directory, Version version, SSTableFormat.Type format) {
        Descriptor desc = new Descriptor(version, directory, keyspace.getName(), name, fileIndexGenerator.incrementAndGet(), Descriptor.Type, format);
    ...
    private void writeSnapshotManifest(final JSONArray filesJSONArr, final String snapshotName) {
        ...
        try {
            ...
            try (final PrintStream out = new PrintStream(manifestFile)) {
