...
public final class CFMetaData {
    ...
    public static final SpeculativeRetry DEFAULT_SPECULATIVE_RETRY = new SpeculativeRetry(SpeculativeRetry.RetryType.NONE, 0);
...
<<<<<<< LEFT
    compile("CREATE TABLE " + SystemKeyspace.SCHEMA_COLUMNFAMILIES_CF + " ("
                                                                    + "keyspace_name text,"
...
=======
    compile(9, "CREATE TABLE " + SystemTable.SCHEMA_COLUMNFAMILIES_CF + "("
                                                                       + "keyspace_name text,"
                                                                       + "columnfamily_name text,"
                                                                       + "id int,"
                                                                       + "type text,"
...
>>>>>>> RIGHT;
    ...
    public AbstractCompactionStrategy createCompactionStrategyInstance(ColumnFamilyStore cfs) {
        try {
            Constructor<? extends AbstractCompactionStrategy> constructor = compactionStrategyClass.getConstructor(new Class[]{ ColumnFamilyStore.class, Map.class// options
             });
    ...
    static CFMetaData fromSchemaNoColumnsNoTriggers(UntypedResultSet.Row result) {
        try {
            ...
            } else if (DatabaseDescriptor.getIndexInterval() != null) {
