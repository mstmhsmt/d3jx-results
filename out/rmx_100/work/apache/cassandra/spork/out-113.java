...
public class BufferPool {
    ...
    abstract static interface Debug {
        ...
        public abstract void registerNormal(Chunk chunk);

        public abstract void recycleNormal(Chunk oldVersion, Chunk newVersion);
...
<<<<<<< LEFT
        setDebug != null
=======
        chunk.lastRecycled >= chunk.lastAcquired
>>>>>>> RIGHT;
        this.debug = setDebug;
    }

    abstract static interface Recycler {
        /**
         ...
         */
        public abstract void recyclePartially(Chunk chunk);
    }
    ...
    private static class MicroQueueOfChunks {
        ...
        private <T> void removeIf(BiPredicate<Chunk, T> predicate, T value) {
            ...
            Chunk toRelease0 = null;
            Chunk toRelease1 = null;
            Chunk toRelease2 = null;
            try {
                switch (count) {
                    case 3 :
