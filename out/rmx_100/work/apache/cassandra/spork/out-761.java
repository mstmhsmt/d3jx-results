...
public class CassandraAuthorizer implements IAuthorizer {
    ...
    public Set<Permission> authorize(AuthenticatedUser user, IResource resource) {
        ...
        try {
            ResultMessage.Rows rows = authorizeStatement.execute(QueryState.forInternalCalls(), new QueryOptions(ConsistencyLevel.LOCAL_ONE, Lists.newArrayList(ByteBufferUtil.bytes(user.getName()), ByteBufferUtil.bytes(resource.getName()))));
