...
send
>>>>>>> RIGHT
            (endpoint, Event.TopologyChange.newNode(getRpcAddress(endpoint), server.socket.getPort()));
        }
...
send
>>>>>>> RIGHT
            (endpoint, Event.TopologyChange.removedNode(getRpcAddress(endpoint), server.socket.getPort()));
        }
...
send
>>>>>>> RIGHT
            (endpoint, Event.TopologyChange.movedNode(getRpcAddress(endpoint), server.socket.getPort()));
        }
...
send
>>>>>>> RIGHT
            (endpoint, Event.StatusChange.nodeUp(getRpcAddress(endpoint), server.socket.getPort()));
        }
...
send
>>>>>>> RIGHT
            (endpoint, Event.StatusChange.nodeDown(getRpcAddress(endpoint), server.socket.getPort()));
        }
