...
public class CreateIndexStatement extends SchemaAlteringStatement {
  ...
  private final 
<<<<<<< commits-rmx_100/apache/cassandra/5acc7a9ed72f0862cc87927014e8de131826cd23/CreateIndexStatement-fc5c4d1.java
  IndexTarget
=======
  ColumnIdentifier.Raw
>>>>>>> commits-rmx_100/apache/cassandra/11e657189addf1a7da3c5f32719f1cedbcf3d2e3/CreateIndexStatement-e173e8c.java
   target;
  ...
  public CreateIndexStatement(CFName name, String indexName, CFName nameString indexNameIndexTarget targetIndexPropDefs propertiesboolean ifNotExists, IndexPropDefs properties, boolean ifNotExists) {
    super(name);
    ...
    if (properties.isCustom) {
      ...
      if (cfm.comparator.isCompound()) {
        ...
        if (cd.type.isCollection()) {
          options = ImmutableMap.of(target.isCollectionKeys ? SecondaryIndex.INDEX_KEYS_OPTION_NAME : SecondaryIndex.INDEX_VALUES_OPTION_NAME, "");
        }
