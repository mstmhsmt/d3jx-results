  ...
  public void indexRow(ByteBuffer key, ColumnFamily cf, OpOrder.Group opGroup) {
    ...
    for (SecondaryIndex index : allIndexes) {
      if (index instanceof PerRowSecondaryIndex) {
        ...
        for (Cell cell : cf) {
          if (
<<<<<<< commits-rmx_100/apache/cassandra/f1f5f5fd3ac9bcf20fd68bae2f639ab12e2c360d/SecondaryIndexManager-8290996.java
          index.indexes(cell.name())
=======
          column.isLive(System.currentTimeMillis()) && index.indexes(column.name())
>>>>>>> commits-rmx_100/apache/cassandra/8aa3c3a6a36d4fd308e5a7b518871ec72fa632fe/SecondaryIndexManager-b75f917.java
          ) {
