...
public class BufferPool
{
    ...
    private void cleanupOneReference() throws InterruptedException throws InterruptedException
    {
    ...
    final static class Chunk
    {
        ...
        {            /** The slab is serving or ready to serve requests */
            IN_USE,            /** The slab is not serving requests and ready for partial recycle*/
            EVICTED}
    ...
    @VisibleForTesting
    public void shutdownLocalCleaner(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException throws InterruptedException, TimeoutException
    {
