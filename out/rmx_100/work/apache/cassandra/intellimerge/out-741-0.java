...
public abstract class SchemaAlteringStatement extends CFStatement implements CQLStatement
{
    ...
    @Override
    public void prepareKeyspace(ClientState state) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    public ResultMessage execute(QueryState state, QueryOptions options) throws RequestValidationException throws RequestValidationException
    {
