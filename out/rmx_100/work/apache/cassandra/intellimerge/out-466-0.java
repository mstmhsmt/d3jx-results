...
public class SinglePartitionReadCommand extends ReadCommand
{
    ...
    public PartitionIterator execute(ConsistencyLevel consistency, ClientState clientState, long queryStartNanoTime) throws RequestExecutionException throws RequestExecutionException
    {
    ...
    protected UnfilteredPartitionIterator ctor cannot fail)
    ...
    protected void serializeSelection(DataOutputPlus out, int version) throws IOException throws IOException
    {
