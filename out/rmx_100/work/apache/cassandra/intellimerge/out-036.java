...
public class BatchStatement implements CQLStatement
{
    ...
    public void authorize(ClientState state) throws InvalidRequestException, UnauthorizedException throws InvalidRequestException, UnauthorizedException
    {
        for (ModificationStatement statement : statements)
    ...
    public void validate() throws InvalidRequestException throws InvalidRequestException
    {
...
>>>>>>> theirs
     ...
     */
    private static void verifyBatchSize(Collection<? extends IMutation> mutations) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private void executeWithoutConditions(List<? extends IMutation> mutations, ConsistencyLevel cl, Dispatcher.RequestTime requestTime) throws RequestExecutionException, RequestValidationException throws RequestExecutionException, RequestValidationException
    {
...
>>>>>>> theirs
    ...
    public ResultMessage executeLocally(QueryState queryState, QueryOptions options) throws RequestValidationException, RequestExecutionException throws RequestValidationException, RequestExecutionException
    {
    ...
    public static class Parsed extends QualifiedStatement
    {
        ...
        @Override
        public void setKeyspace(ClientState state) throws InvalidRequestException throws InvalidRequestException
        {
            for (ModificationStatement.Parsed statement : parsedStatements)
