...
public class ColumnFamilyStore implements ColumnFamilyStoreMBean
{
    ...
    public static void shutdownPostFlushExecutor() throws InterruptedException throws InterruptedException
    {
     ...
     void maybeRemoveUnreadableSSTables(File directory)
    {
     ...
     void unregisterMBean() throws MalformedObjectNameException, InstanceNotFoundException, MBeanRegistrationException throws MalformedObjectNameException, InstanceNotFoundException, MBeanRegistrationException
    {
        MBeanServer mbs = ManagementFactory.getPlatformMBeanServer();
        ObjectName nameObj = new ObjectName(mbeanName);
    ...
    public CompactionManager.AllSSTableOpStatus forceCleanup() throws ExecutionException, InterruptedException throws ExecutionException, InterruptedException
    {
        return CompactionManager.instance.performCleanup(ColumnFamilyStore.this);
    }
    
    public CompactionManager.AllSSTableOpStatus scrub(boolean disableSnapshot, boolean skipCorrupted) throws ExecutionException, InterruptedException throws ExecutionException, InterruptedException
    {
    ...
    public CompactionManager.AllSSTableOpStatus sstablesRewrite(boolean excludeCurrentVersion) throws ExecutionException, InterruptedException throws ExecutionException, InterruptedException
    {
    ...
    public List<SSTableReader> getSnapshotSSTableReader(String tag) throws IOException throws IOException
    {
    ...
    public void forceMajorCompaction() throws InterruptedException, ExecutionException throws InterruptedException, ExecutionException
    {
