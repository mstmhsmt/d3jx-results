...
public class CreateIndexStatement extends SchemaAlteringStatement
{
    ...
    public void checkAccess(ClientState state) throws UnauthorizedException, InvalidRequestException throws UnauthorizedException, InvalidRequestException
    {
        state.hasColumnFamilyAccess(keyspace(), columnFamily(), Permission.ALTER);
    }
    
    public void validate(ClientState state) throws RequestValidationException throws RequestValidationException
    {
    ...
    public boolean announceMigration(boolean isLocalOnly) throws RequestValidationException throws RequestValidationException
    {
