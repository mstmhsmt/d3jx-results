...
public class CassandraServer implements Cassandra.Iface
{
    ...
    private void doInsert(ConsistencyLevel consistency_level, List<? extends IMutation> mutations) throws UnavailableException, TimedOutException, InvalidRequestException throws UnavailableException, TimedOutException, InvalidRequestException
    {
    ...
    public KsDef describe_keyspace(String table) throws NotFoundException, InvalidRequestException throws NotFoundException, InvalidRequestException
    {
    ...
    public List<KsDef> describe_keyspaces() throws TException, InvalidRequestException throws TException, InvalidRequestException
    {
        state().hasKeyspaceSchemaAccess(Permission.READ);
    ...
    public String describe_cluster_name() throws TException throws TException
    {
        return DatabaseDescriptor.getClusterName();
    }
    
    public String describe_version() throws TException throws TException
    {
        return Constants.VERSION;
    }
    
    public List<TokenRange> describe_ring(String keyspace)throws InvalidRequestExceptionthrows InvalidRequestException
    {
    ...
    public String describe_partitioner() throws TException throws TException
    {
        return StorageService.getPartitioner().getClass().getName();
    }
    
    public String describe_snitch() throws TException throws TException
    {
    ...
    public void login(AuthenticationRequest auth_request) throws AuthenticationException, AuthorizationException, TException throws AuthenticationException, AuthorizationException, TException
    {
     ...
     */
    private void schedule(long timeoutMS) throws TimeoutException throws TimeoutException
    {
    ...
    private void validateSchemaAgreement() throws SchemaDisagreementException throws SchemaDisagreementException
    {
    ...
    public void truncate(String cfname) throws InvalidRequestException, UnavailableException, TException throws InvalidRequestException, UnavailableException, TException
    {
    ...
    public void set_keyspace(String keyspace) throws InvalidRequestException, TException throws InvalidRequestException, TException
    {
    ...
    public Map<String, List<String>> describe_schema_versions() throws TException, InvalidRequestException throws TException, InvalidRequestException
    {
