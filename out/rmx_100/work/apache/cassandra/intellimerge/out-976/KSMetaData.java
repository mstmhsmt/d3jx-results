...
public final class KSMetaData
{
    ...
    public static KSMetaData fromThrift(KsDef ksd, CFMetaData... cfDefs) throws ConfigurationException throws ConfigurationException
    {
    ...
    public KSMetaData reloadAttributes() throws IOException throws IOException
    {
...
>>>>>>> theirs
     ...
     */
    public static KSMetaData fromSchema(Row row, Iterable<CFMetaData> cfms) throws IOException throws IOException
    {
     ...
     * @throws IOException if deserialization failed
     */
    public static KSMetaData fromSchema(Row serializedKs, Row serializedCFs) throws IOException throws IOException
    {
