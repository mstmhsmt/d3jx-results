...
public class CommitLog implements CommitLogMBean
{
     ...
     */
    public int recover() throws IOException throws IOException
    {
     ...
     * @return the number of mutations replayed
     */
    public int recover(File... clogs) throws IOException throws IOException
    {
     ...
     */
    public void recover(String path) throws IOException throws IOException
    {
        CommitLogReplayer recovery = CommitLogReplayer.construct(this);
     ...
     */
    public void shutdownBlocking() throws InterruptedException throws InterruptedException
    {
        executor.shutdown();
     ...
     */
    public int resetUnsafe(boolean deleteSegments) throws IOException throws IOException
    {
     ...
     * FOR TESTING PURPOSES.  See CommitLogAllocator
     */
    public int restartUnsafe() throws IOException throws IOException
    {
        allocator.start();
