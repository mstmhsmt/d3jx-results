...
public class StatsMetadata extends MetadataComponent
{
    ...
    public static class StatsMetadataSerializer implements IMetadataComponentSerializer<StatsMetadata>
    {
        ...
        public int serializedSize(Version version, StatsMetadata component) throws IOException throws IOException
        {
            int size = 0;
        ...
        public void serialize(Version version, StatsMetadata component, DataOutputPlus out) throws IOException throws IOException
        {
        ...
        public StatsMetadata deserialize(Version version, DataInputPlus in) throws IOException throws IOException
        {
