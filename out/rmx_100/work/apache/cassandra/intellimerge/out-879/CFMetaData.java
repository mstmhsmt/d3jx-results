...
>>>>>>> theirs
    ...
    public enum Caching
    {
        ...
        ALL,             KEYS_ONLY,                        ROWS_ONLY,                                   NONE;        public static Caching fromString(String cache) throws ConfigurationException throws ConfigurationException
        {
            try
            {
    ...
    public static class SpeculativeRetry
    {
        ...
        public static SpeculativeRetry fromString(String retry) throws ConfigurationException throws ConfigurationException
        {
    ...
    public static CFMetaData fromThrift(org.apache.cassandra.thrift.CfDef cf_def) throws InvalidRequestException, ConfigurationException throws InvalidRequestException, ConfigurationException
    {
     ...
     */
    public void apply(CFMetaData cfm) throws ConfigurationException throws ConfigurationException
    {
    ...
    public void validateCompatility(CFMetaData cfm) throws ConfigurationException throws ConfigurationException
    {
        // validate
    ...
    public static void validateCompactionOptions(Class<? extends AbstractCompactionStrategy> strategyClass, Map<String, String> options) throws ConfigurationException throws ConfigurationException
    {
        try
        {
            if (options == null)
    ...
    public static Class<? extends AbstractCompactionStrategy> createCompactionStrategy(String className) throws ConfigurationException throws ConfigurationException
    {
     ...
     */
    public void addDefaultIndexNames() throws ConfigurationException throws ConfigurationException
    {
    ...
    public CFMetaData validate() throws ConfigurationException throws ConfigurationException
    {
        rebuild();
    ...
    private static void validateAlias(ColumnDefinition alias, String msg) throws ConfigurationException throws ConfigurationException
    {
        try
        {
    ...
    private void validateCompactionThresholds() throws ConfigurationException throws ConfigurationException
    {
     ...
     */
    public RowMutation toSchema(long timestamp) throws ConfigurationException throws ConfigurationException
    {
        RowMutation rm = new RowMutation(Keyspace.SYSTEM_KS, SystemKeyspace.getSchemaKSKey(ksName));
    ...
    public void addColumnDefinition(ColumnDefinition def) throws ConfigurationException throws ConfigurationException
    {
    ...
    public void addTriggerDefinition(TriggerDefinition def) throws ConfigurationException throws ConfigurationException
    {
    ...
    public void renameColumn(ByteBuffer from, String strFrom, ByteBuffer to, String strTo) throws InvalidRequestException throws InvalidRequestException
    {
