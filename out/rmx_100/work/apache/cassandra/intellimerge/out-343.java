...
public class SelectStatement implements CQLStatement
{
    ...
    public ResultMessage.Rows execute(QueryState state, QueryOptions options, long queryStartNanoTime) throws RequestExecutionException, RequestValidationException throws RequestExecutionException, RequestValidationException
    {
    ...
    public ReadQuery getQuery(QueryOptions options, int nowInSec) throws RequestValidationException throws RequestValidationException
    {
        Selectors selectors = selection.newSelectors(options);
    ...
    private ResultMessage.Rows execute(ReadQuery query,
                                       ...
                                       Selectors selectors,
                                       int nowInSec,
                                       int userLimit, long queryStartNanoTime) throws RequestValidationException, RequestExecutionException throws RequestValidationException, RequestExecutionException
    {
    ...
    private ResultMessage.Rows execute(Pager pager,
                                       ...
                                       int nowInSec,
                                       int userLimit,
                                       long queryStartNanoTime) throws RequestValidationException, RequestExecutionException throws RequestValidationException, RequestExecutionException
    {
    ...
    private ResultMessage.Rows processResults(PartitionIterator partitions,
                                              ...
                                              Selectors selectors,
                                              int nowInSec,
                                              int userLimit) throws RequestValidationException throws RequestValidationException
    {
    ...
    public ResultMessage.Rows executeInternal(QueryState state, QueryOptions options, int nowInSec, long queryStartNanoTime) throws RequestExecutionException, RequestValidationException throws RequestExecutionException, RequestValidationException
    {
        int userLimit = getLimit(options);
        int userPerPartitionLimit = getPerPartitionLimit(options);
        int pageSize = options.getPageSize();
    ...
    public ResultSet process(PartitionIterator partitions, int nowInSec) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private NavigableSet<Clustering> getRequestedRows(QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
     ...
     * May be used by custom QueryHandler implementations
     */
    public RowFilter getRowFilter(QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private ResultSet process(PartitionIterator partitions,
                              ...
                              Selectors selectors,
                              int nowInSec,
                              int userLimit) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    public static class RawStatement extends CFStatement
    {
        ...
        public ParsedStatement.Prepared prepare(boolean forView) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private StatementRestrictions prepareRestrictions(TableMetadata metadata,
                                                          ...
                                                          boolean forView) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private Term prepareLimit(VariableSpecifications boundNames, Term.Raw limit,
                                  String keyspace, ColumnSpecification limitReceiver) throws InvalidRequestException throws InvalidRequestException
        {
            if (limit == null)
                return null;
        ...
        private static void verifyOrderingIsAllowed(StatementRestrictions restrictions) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private boolean isReversed(TableMetadata table, Map<ColumnMetadata, Boolean> orderingColumns, StatementRestrictions restrictions) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private void checkNeedsFiltering(StatementRestrictions restrictions) throws InvalidRequestException throws InvalidRequestException
        {
