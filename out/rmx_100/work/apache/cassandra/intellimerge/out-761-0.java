...
public class CassandraAuthorizer implements IAuthorizer
{
    ...
    private void modify(Set<Permission> permissions, IResource resource, String user, String op) throws RequestExecutionException throws RequestExecutionException
    {
    ...
    public void validateConfiguration() throws ConfigurationException throws ConfigurationException
    {
    }
    ...
    private static UntypedResultSet process(String query) throws RequestExecutionException throws RequestExecutionException
    {
