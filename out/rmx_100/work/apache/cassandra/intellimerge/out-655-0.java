...
public class DatabaseDescriptor
{
    ...
    @VisibleForTesting
    public static Config loadConfig() throws ConfigurationException throws ConfigurationException
    {
    ...
    private static InetAddress getNetworkInterfaceAddress(String intf, String configName, boolean preferIPv6) throws ConfigurationException throws ConfigurationException
    {
        try
        {
    ...
    @VisibleForTesting
    static void applyAddressConfig(Config config) throws ConfigurationException throws ConfigurationException
    {
        listenAddress = null;
        rpcAddress = null;
    ...
    private static void applyConfig(Config config) throws ConfigurationException throws ConfigurationException
    {
        conf = config;
    ...
    private static IEndpointSnitch createEndpointSnitch(String snitchClassName) throws ConfigurationException throws ConfigurationException
    {
