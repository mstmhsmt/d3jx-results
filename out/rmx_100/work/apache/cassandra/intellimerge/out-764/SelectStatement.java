...
public class SelectStatement implements CQLStatement, MeasurableForPreparedCache
{
    ...
    public void checkAccess(ClientState state) throws InvalidRequestException, UnauthorizedException throws InvalidRequestException, UnauthorizedException
    {
        state.hasColumnFamilyAccess(keyspace(), columnFamily(), Permission.SELECT);
    }
    
    public void validate(ClientState state) throws InvalidRequestException throws InvalidRequestException
    {
        // Nothing to do, all validation has been done by RawStatement.prepare()
    }
    
    public ResultMessage.Rows execute(QueryState state, QueryOptions options) throws RequestExecutionException, RequestValidationException throws RequestExecutionException, RequestValidationException
    {
    ...
    private Pageable getPageableCommand(QueryOptions options, int limit, long now) throws RequestValidationException throws RequestValidationException
    {
    ...
    public Pageable getPageableCommand(QueryOptions options) throws RequestValidationException throws RequestValidationException
    {
        return getPageableCommand(options, getLimit(options), System.currentTimeMillis());
    }
    
    private ResultMessage.Rows execute(Pageable command, QueryOptions options, int limit, long now) throws RequestValidationException, RequestExecutionException throws RequestValidationException, RequestExecutionException
    {
        List<Row> rows;
        if (command == null)
        {
    ...
    private ResultMessage.Rows pageCountQuery(QueryPager pager, QueryOptions options, int pageSize, long now, int limit) throws RequestValidationException, RequestExecutionException throws RequestValidationException, RequestExecutionException
    {
        int count = 0;
    ...
    public ResultMessage.Rows processResults(List<Row> rows, QueryOptions options, int limit, long now) throws RequestValidationException throws RequestValidationException
    {
    ...
    public ResultMessage.Rows executeInternal(QueryState state, QueryOptions options) throws RequestExecutionException, RequestValidationException throws RequestExecutionException, RequestValidationException
    {
        int limit = getLimit(options);
        long now = System.currentTimeMillis();
        Pageable command = getPageableCommand(options, limit, now);
    ...
    public ResultSet process(List<Row> rows) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private List<ReadCommand> getSliceCommands(QueryOptions options, int limit, long now) throws RequestValidationException throws RequestValidationException
    {
    ...
    private RangeSliceCommand getRangeCommand(QueryOptions options, int limit, long now) throws RequestValidationException throws RequestValidationException
    {
        IDiskAtomFilter filter = makeFilter(options, limit);
        if (filter == null)
            return null;
    ...
    private AbstractBounds<RowPosition> getKeyBounds(QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private int getLimit(QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private Collection<ByteBuffer> getKeys(final QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private ByteBuffer getKeyBound(Bound b, QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private Token getTokenBound(Bound b, QueryOptions options, IPartitioner<?> p) throws InvalidRequestException throws InvalidRequestException
    {
        assert onToken;
    ...
    private SortedSet<CellName> getRequestedColumns(QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private static List<Composite> buildBound(Bound bound,
                                              ...
                                              boolean isReversed,
                                              CType type,
                                              QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private static ByteBuffer getSliceValue(Restriction r, Bound b, QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private List<Composite> getRequestedBound(Bound b, QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
        assert isColumnRange();
        return buildBound(b, cfm.clusteringColumns(), columnRestrictions, isReversed, cfm.comparator, options);
    }
    
    public List<IndexExpression> getIndexExpressions(QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private static ByteBuffer validateIndexedValue(ColumnDefinition def, ByteBuffer value) throws InvalidRequestException throws InvalidRequestException
    {
        if (value == null)
    ...
    private Iterator<Cell> applySliceRestriction(final Iterator<Cell> cells, final QueryOptions options) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    private ResultSet process(List<Row> rows, QueryOptions options, int limit, long now) throws InvalidRequestException throws InvalidRequestException
    {
     ...
     */
    private void orderResults(ResultSet cqlRows) throws InvalidRequestException throws InvalidRequestException
    {
    ...
    public static class RawStatement extends CFStatement
    {
        ...
        public ParsedStatement.Prepared prepare() throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private boolean[] processRelationEntity(SelectStatement stmt, Relation relation, ColumnIdentifier entity, ColumnDefinition def) throws InvalidRequestException throws InvalidRequestException
        {
            if (def == null)
        ...
        private void handleUnrecognizedEntity(ColumnIdentifier entity, Relation relation) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private Term prepareLimit(VariableSpecifications boundNames) throws InvalidRequestException throws InvalidRequestException
        {
            if (limit == null)
                return null;
        ...
        private void updateRestrictionsForRelation(SelectStatement stmt, List<ColumnDefinition> defs, MultiColumnRelation relation, VariableSpecifications boundNames) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private void updateRestrictionsForRelation(SelectStatement stmt, ColumnDefinition def, SingleColumnRelation relation, VariableSpecifications names) throws InvalidRequestException throws InvalidRequestException
        {
            switch (def.kind)
            {
                case PARTITION_KEY:
         ...
         Restriction updateSingleColumnRestriction(ColumnDefinition def, Restriction existingRestriction, SingleColumnRelation newRel, VariableSpecifications boundNames) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private void processPartitionKeyRestrictions(SelectStatement stmt, boolean hasQueriableIndex, CFMetaData cfm) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private void processColumnRestrictions(SelectStatement stmt, boolean hasQueriableIndex, CFMetaData cfm) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private void validateSecondaryIndexSelections(SelectStatement stmt) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private void verifyOrderingIsAllowed(SelectStatement stmt) throws InvalidRequestException throws InvalidRequestException
        {
            if (stmt.usesSecondaryIndexing)
        ...
        private void handleUnrecognizedOrderingColumn(ColumnIdentifier column) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private void processOrderingClause(SelectStatement stmt, CFMetaData cfm) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private boolean isReversed(SelectStatement stmt, CFMetaData cfm) throws InvalidRequestException throws InvalidRequestException
        {
        ...
        private void checkNeedsFiltering(SelectStatement stmt) throws InvalidRequestException throws InvalidRequestException
        {
