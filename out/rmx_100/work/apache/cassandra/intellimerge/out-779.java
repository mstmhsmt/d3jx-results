...
{    // operations corresponding to the ones in NavigableSet
    ...
    {        // the least element greater than or equal to the given element
        CEIL,        // the greatest element less than or equal to the given element
        FLOOR,        // the least element strictly greater than the given element
        HIGHER,        // the greatest element strictly less than the given element
        LOWER}
