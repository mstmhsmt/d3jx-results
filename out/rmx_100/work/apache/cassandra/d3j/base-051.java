...
public abstract class AbstractReadRepairTest {
  ...
  static void configureClass(ReadRepairStrategy repairStrategy)
    ...
    KeyspaceMetadata ksm = KeyspaceMetadata.create(
        ksName, KeyspaceParams.simple(3), Tables.of(cfm));
  ...
  repairPlan(ReplicaPlan.ForRangeRead readPlan) {
    return repairPlan(readPlan, readPlan.candidates());
  }
  static ReplicaPlan.ForTokenWrite repairPlan(EndpointsForRange liveAndDown,
  ...
  static ReplicaPlan.ForTokenWrite repairPlan(ReplicaPlan.ForRangeRead readPlan,
    ...
    return ReplicaPlans.forWrite(
        readPlan.keyspace(), ConsistencyLevel.TWO, liveAndDown.forToken(token),
        pending, replica -> true, ReplicaPlans.writeReadRepair(readPlan));
  }
