...
public
abstract
class SchemaAlteringStatement extends CFStatement implements CQLStatement
{
   ...
   @Override
   public
   void prepareKeyspace(ClientState state) throws InvalidRequestException {
   ...
   public
   abstract
   boolean announceMigration(boolean isLocalOnly)
     throws RequestValidationException;
   public
   ResultMessage execute(QueryState state, QueryOptions options)
     throws RequestValidationException {
