...
class Connection
{
   ...
   public
   Connection(Channel channel, ProtocolVersion version, Tracker tracker) {
   ...
   public
   void setTransformer(FrameBodyTransformer transformer) {
     this.transformer = transformer;
   }
   public
   FrameBodyTransformer getTransformer() {
     return transformer;
   }
   public
   void setThrowOnOverload(boolean throwOnOverload) {
     this.throwOnOverload = throwOnOverload;
   }
   public
   boolean isThrowOnOverload() {
