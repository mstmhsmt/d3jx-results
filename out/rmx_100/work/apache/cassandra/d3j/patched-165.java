...
public class StatsMetadata extends MetadataComponent {
  public static final IMetadataComponentSerializer serializer =
      new StatsMetadataSerializer();
  public static final ISerializer<IntervalSet<CommitLogPosition>>
      commitLogPositionSetSerializer =
          IntervalSet.serializer(CommitLogPosition.serializer);
  ...
  public StatsMetadata(EstimatedHistogram estimatedPartitionSize,
                       ...
                       int minLocalDeletionTime, int maxLocalDeletionTime,
                       int minTTL, int maxTTL, double compressionRatio,
                       TombstoneHistogram estimatedTombstoneDropTime,
                       int sstableLevel, List<ByteBuffer> minClusteringValues,
                       List<ByteBuffer> maxClusteringValues,
                       boolean hasLegacyCounterShards, long repairedAt,
<<<<<<< /root/work/apache/cassandra/d3j/patched-165-0.java
                       long totalColumnsSet, long totalRows, UUID pendingRepair,
                       boolean isTransient) {
||||||| /root/work/apache/cassandra/d3j/base-165.java
                       long totalColumnsSet, long totalRows) {
=======
                       long totalColumnsSet, long totalRows,
                       UUID originatingHostId, boolean isTransient) {
>>>>>>> /root/work/apache/cassandra/d3j/patched-165-1.java
...
<<<<<<< /root/work/apache/cassandra/d3j/patched-165-0.java
    ...
    this.encodingStats =
        new EncodingStats(minTimestamp, minLocalDeletionTime, minTTL);
||||||| /root/work/apache/cassandra/d3j/base-165.java
=======
    this.originatingHostId = originatingHostId;
>>>>>>> /root/work/apache/cassandra/d3j/patched-165-1.java
  }
  public MetadataType getType() { return MetadataType.STATS; }
...
<<<<<<< /root/work/apache/cassandra/d3j/patched-165-0.java
        estimatedPartitionSize, estimatedCellPerPartitionCount,
        commitLogIntervals, minTimestamp, maxTimestamp, minLocalDeletionTime,
        maxLocalDeletionTime, minTTL, maxTTL, compressionRatio,
        estimatedTombstoneDropTime, newLevel, minClusteringValues,
        maxClusteringValues, hasLegacyCounterShards, repairedAt,
        totalColumnsSet, totalRows, pendingRepair, isTransient);
||||||| /root/work/apache/cassandra/d3j/base-165.java
        estimatedPartitionSize, estimatedColumnCount, commitLogIntervals,
        minTimestamp, maxTimestamp, minLocalDeletionTime, maxLocalDeletionTime,
        minTTL, maxTTL, compressionRatio, estimatedTombstoneDropTime, newLevel,
        minClusteringValues, maxClusteringValues, hasLegacyCounterShards,
...
=======
        ...
        estimatedTombstoneDropTime, newLevel, minClusteringValues,
        maxClusteringValues, hasLegacyCounterShards, repairedAt,
        totalColumnsSet, totalRows, originatingHostId, isTransient);
>>>>>>> /root/work/apache/cassandra/d3j/patched-165-1.java
  }
  public StatsMetadata mutateRepairedMetadata(long newRepairedAt,
                                              UUID newPendingRepair,
...
<<<<<<< /root/work/apache/cassandra/d3j/patched-165-0.java
        ...
        commitLogIntervals, minTimestamp, maxTimestamp, minLocalDeletionTime,
        maxLocalDeletionTime, minTTL, maxTTL, compressionRatio,
        estimatedTombstoneDropTime, sstableLevel, minClusteringValues,
        maxClusteringValues, hasLegacyCounterShards, newRepairedAt,
        totalColumnsSet, totalRows, newPendingRepair, newIsTransient);
||||||| /root/work/apache/cassandra/d3j/base-165.java
        estimatedPartitionSize, estimatedColumnCount, commitLogIntervals,
        minTimestamp, maxTimestamp, minLocalDeletionTime, maxLocalDeletionTime,
        minTTL, maxTTL, compressionRatio, estimatedTombstoneDropTime,
        sstableLevel, minClusteringValues, maxClusteringValues,
        hasLegacyCounterShards, newRepairedAt, totalColumnsSet, totalRows);
=======
        estimatedPartitionSize, estimatedCellPerPartitionCount,
        commitLogIntervals, minTimestamp, maxTimestamp, minLocalDeletionTime,
        maxLocalDeletionTime, minTTL, maxTTL, compressionRatio,
        estimatedTombstoneDropTime, sstableLevel, minClusteringValues,
        maxClusteringValues, hasLegacyCounterShards, newRepairedAt,
        totalColumnsSet, totalRows, originatingHostId, newIsTransient);
>>>>>>> /root/work/apache/cassandra/d3j/patched-165-1.java
  }
  @Override
...
>>>>>>> /root/work/apache/cassandra/d3j/patched-165-1.java
  ...
  public static class StatsMetadataSerializer
    ...
    public int serializedSize(Version version, StatsMetadata component)
        throws IOException {
      int size = 0;
      size += EstimatedHistogram.serializer.serializedSize(
          component.estimatedPartitionSize);
      size += EstimatedHistogram.serializer.serializedSize(
          component.estimatedCellPerPartitionCount);
      size += CommitLogPosition.serializer.serializedSize(
          component.commitLogIntervals.upperBound().orElse(
              CommitLogPosition.NONE));
      size += 8 + 8 + 4 + 4 + 4 + 4 + 8 + 8;
      size += TombstoneHistogram.serializer.serializedSize(
          component.estimatedTombstoneDropTime);
      ...
      if (version.hasCommitLogLowerBound())
        size += CommitLogPosition.serializer.serializedSize(
            component.commitLogIntervals.lowerBound().orElse(
                CommitLogPosition.NONE));
      if (version.hasCommitLogIntervals())
        size += commitLogPositionSetSerializer.serializedSize(
            component.commitLogIntervals);
<<<<<<< /root/work/apache/cassandra/d3j/patched-165-0.java
      if (version.hasPendingRepair()) {
        size += 1;
        if (component.pendingRepair != null)
          size += UUIDSerializer.serializer.serializedSize(
              component.pendingRepair, 0);
      }
...
>>>>>>> /root/work/apache/cassandra/d3j/patched-165-1.java
    ...
    public void serialize(Version version, StatsMetadata component,
      ...
      EstimatedHistogram.serializer.serialize(component.estimatedPartitionSize,
                                              out);
      EstimatedHistogram.serializer.serialize(
          component.estimatedCellPerPartitionCount, out);
      CommitLogPosition.serializer.serialize(
          component.commitLogIntervals.upperBound().orElse(
              CommitLogPosition.NONE),
          out);
      ...
      TombstoneHistogram.serializer.serialize(
          component.estimatedTombstoneDropTime, out);
      ...
      if (version.hasCommitLogLowerBound())
        CommitLogPosition.serializer.serialize(
            ...
            out);
      if (version.hasCommitLogIntervals())
        commitLogPositionSetSerializer.serialize(component.commitLogIntervals,
                                                 out);
      if (version.hasOriginatingHostId()) {
        if (component.originatingHostId != null) {
          out.writeByte(1);
          UUIDSerializer.serializer.serialize(component.originatingHostId, out,
                                              0);
        } else {
          out.writeByte(0);
        }
    ...
    public StatsMetadata deserialize(Version version, DataInputPlus in)
      ...
      if (partitionSizes.isOverflowed()) {
        logger.warn("Deserialized partition size histogram with {} values " +
      ...
      if (version.hasCommitLogIntervals())
        ...
        commitLogIntervals = new IntervalSet<CommitLogPosition>(
...
>>>>>>> /root/work/apache/cassandra/d3j/patched-165-1.java
      return new StatsMetadata(
          partitionSizes, columnCounts, commitLogIntervals, minTimestamp,
          maxTimestamp, minLocalDeletionTime, maxLocalDeletionTime, minTTL,
          maxTTL, compressionRatio, tombstoneHistogram, sstableLevel,
          minClusteringValues, maxClusteringValues, hasLegacyCounterShards,
<<<<<<< /root/work/apache/cassandra/d3j/patched-165-0.java
          repairedAt, totalColumnsSet, totalRows, pendingRepair, isTransient);
||||||| /root/work/apache/cassandra/d3j/base-165.java
          repairedAt, totalColumnsSet, totalRows);
=======
          repairedAt, totalColumnsSet, totalRows, originatingHostId,
          isTransient);
>>>>>>> /root/work/apache/cassandra/d3j/patched-165-1.java
    }
  }
