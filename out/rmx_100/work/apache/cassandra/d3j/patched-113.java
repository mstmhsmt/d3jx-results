...
<<<<<<< /root/work/apache/cassandra/d3j/patched-113-0.java
...
||||||| /root/work/apache/cassandra/d3j/base-113.java
  @VisibleForTesting
...
=======
  ...
  public long usedSizeInBytes() {
    return memoryInUse.longValue() + overflowMemoryUsage.longValue();
>>>>>>> /root/work/apache/cassandra/d3j/patched-113-1.java
  }
<<<<<<< /root/work/apache/cassandra/d3j/patched-113-0.java
...
=======
  ...
  static final class Debug {
    ...
    final Queue<Chunk> allChunks = new ConcurrentLinkedQueue<>();
    void recyclePartial(Chunk chunk);
    void acquire(Chunk chunk) { chunk.lastAcquired = recycleRound; }
    void recycle(Chunk chunk) { chunk.lastRecycled = recycleRound; }
    void check() {
      for (Chunk chunk : allChunks)
