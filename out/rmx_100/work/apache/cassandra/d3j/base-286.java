    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf buffer,
      ...
      if (version < Server.MIN_SUPPORTED_VERSION ||
        ...
        throw new ProtocolException(
            String.format(
                "Invalid or unsupported protocol version (%d); the lowest " +
                "supported version is %d and the greatest is %d",
      ...
      if (connection == null) {
        ...
        throw ErrorMessage.wrap(
            new ProtocolException(
                String.format("Invalid message version. Got %d but previous " +
