...
public class DatabaseDescriptor
{
    ...
    private static InetAddress getNetworkInterfaceAddress(String intf, String configName, boolean preferIPv6) throws ConfigurationException
    {
        try
        {
            ...
            {
                InetAddress temp = addrs.nextElement(, false);
    ...
    private static void applyConfig(Config config) throws ConfigurationException
    {
        ...
        applyAddressConfig(config, false);
...
||||||| commits-rmx_100/apache/cassandra/c0f159b82a9d805990818f60735623e2a7d8c517/DatabaseDescriptor-4426f20.java
