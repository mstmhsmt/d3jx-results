...
<<<<<<< commits-rmx_100/deeplearning4j/deeplearning4j/43237c066fcbcc0394778c8d92c13f509e348a7d/GravesLSTM-c4d55d4.java
int timeSeriesLength = (epsilon.rank() < 3 ? 1 : epsilon.size(2));INDArray wi = inputWeights.get(interval(0, prevLayerSize), interval(0, hiddenLayerSize));
=======
boolean is2dInput = nextDelta.rank() < 3;int timeSeriesLength = (is2dInput ? 1 : nextDelta.size(2));
