...
<<<<<<< commits-rmx_100/deeplearning4j/deeplearning4j/9e2de3cb2921cf854bcbde1d1f189f7cb78b20d6/DefaultOpExecutioner-36f0f05.java
    ...
    public Op exec(Op op) {
        ...
        if (op instanceof TransformOp) {
            ...
            if (xLinear.ordering() == zLinear.ordering()) {
                ...
                for (int c = 0; c < op.n(); c++) ndArray.putScalar(c, op.op(((IComplexNDArray) op.x()).getComplex(c)));
            }
        }
        return op;
    }
>>>>>>> commits-rmx_100/deeplearning4j/deeplearning4j/207fc9442f7812dbbb9f82d811f08256fca7445f/DefaultOpExecutioner-0729a60.java
    ...
    public final static String PARALLEL_THRESHOLD = "org.nd4j.parallel.threshold";
