...
public class GradientCheckTestsComputationGraph {
    ...
    static final private boolean RETURN_ON_FIRST_FAILURE = false;

    static final private double DEFAULT_EPS = 1e-6;

    static final private double DEFAULT_MAX_REL_ERROR = 1e-3;

    static final private double DEFAULT_MIN_ABS_ERROR = 1e-10;
