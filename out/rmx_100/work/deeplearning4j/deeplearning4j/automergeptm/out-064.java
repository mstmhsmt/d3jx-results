...
public class MultiLayerNetwork implements Serializable, Classifier {
  ...
  /**
     ...
     */
  @Override public INDArray transform(INDArray data) {
    return output(data);
  }
  ...
  /**
     ...
     */
  @Deprecated protected void applyDropConnectIfNecessary(INDArray input) {
  ...
  @Override public MultiLayerNetwork clone() {
  ...
  /**
     ...
     */
  @Override public double score(org.nd4j.linalg.dataset.api.DataSet data) {
  ...
  protected List<Pair<Pair<INDArray, INDArray>, Pair<INDArray, INDArray>>> backPropGradient2() {
    ...
    for (int l = 0; l < deltas.size(); l++) {
      ...
      if (l < layers.length && deltaColumnSums.length() != layers[l].getParam(DefaultParamInitializer.BIAS_KEY).length()) {
        ...
        if (l == getLayers().length && deltaColumnSums.length() != getOutputLayer().getParam(DefaultParamInitializer.BIAS_KEY).length()) {
          throw new IllegalStateException("Bias change not equal to weight change");
        }
      }
    }
  ...
  @Override public void fit(DataSetIterator iter) {
    if (layerWiseConfigurations.isPretrain()) {
      pretrain(iter);
      iter.reset();
      finetune(iter);
...
<<<<<<< commits-rmx_100/deeplearning4j/deeplearning4j/c5fe3e4a7bfef336ced98e09ac7e8c547c49a319/MultiLayerNetwork-dd55f6e.java
    Pair<Gradient, INDArray> pair = outputLayer.backwardGradient(null, null);
=======
    Gradient nextGradients;
>>>>>>> commits-rmx_100/deeplearning4j/deeplearning4j/844c90c1f351b63ca1b776b1ae6e8fdc399e9a9f/MultiLayerNetwork-6119885.java
...
=======
      output
>>>>>>> commits-rmx_100/deeplearning4j/deeplearning4j/844c90c1f351b63ca1b776b1ae6e8fdc399e9a9f/MultiLayerNetwork-6119885.java
      .backwardGradient(pair.getFirst()pair.getSecond());
  ...
  /**
     ...
     */
  @Override public int[] predict(INDArray d) {
  ...
  /**
     ...
     */
  @Override public INDArray labelProbabilities(INDArray examples) {
  ...
  /**
     ...
     */
  @Override public void fit(INDArray data, INDArray labels) {
    setInput(data.dup());
    if (layerWiseConfigurations.isPretrain()) {
      pretrain(getInput());
      finetune(labels);
  ...
  /**
     ...
     * @param data the examples to classify (one example in each row)
     */
  @Override public void fit(INDArray data) {
    pretrain(data);
  }

  @Override public void iterate(INDArray input) {
    pretrain(input);
  }
  ...
  /**
     ...
     */
  @Override public void fit(org.nd4j.linalg.dataset.api.DataSet data) {
  ...
  /**
     ...
     */
  @Override public void fit(INDArray examples, int[] labels) {
  ...
  /**
     ...
     * @return the score for the given input,label pairs
     */
  @Override public double score(INDArray input, INDArray labels) {
    feedForward(input);
    setLabels(labels);
  ...
  @Override public void computeGradientAndScore() {
  }

  @Override public void accumulateScore(double accum) {
  }
