...
public class AbstractCache<T extends SequenceElement> implements VocabCache<T> {
  ...
  /**
     ...
     */
  @Override public void loadVocab() {
  }
  ...
  /**
     ...
     * @return
     */
  @Override public boolean vocabExists() {
  ...
  /**
     ...
     *
     */
  @Override public void saveVocab() {
  }
  ...
  /**
     ...
     * @return
     */
  @Override public Collection<String> words() {
  ...
  /**
     ...
     */
  @Override public void incrementWordCount(String word) {
  ...
  /**
     ...
     */
  @Override public void incrementWordCount(String word, int increment) {
    T element = vocabulary.get(word);
    if (
<<<<<<< commits-rmx_100/deeplearning4j/deeplearning4j/5f711a1332dadce71fe4a63102f0fd210a03555d/AbstractCache-fc14661.java
    extendedVocabulary.containsKey(word)
=======
    element != null
>>>>>>> commits-rmx_100/deeplearning4j/deeplearning4j/0824916e35885ac57caf61af7857ae7e6efc5607/AbstractCache-e690e9d.java
    ) {
...
>>>>>>> commits-rmx_100/deeplearning4j/deeplearning4j/0824916e35885ac57caf61af7857ae7e6efc5607/AbstractCache-e690e9d.java
  ...
  /**
     ...
     * @return
     */
  @Override public int wordFrequency(@NonNull String word) {
    T element = vocabulary.get(word);
    if (
<<<<<<< commits-rmx_100/deeplearning4j/deeplearning4j/5f711a1332dadce71fe4a63102f0fd210a03555d/AbstractCache-fc14661.java
    extendedVocabulary.containsKey(word)
...
>>>>>>> commits-rmx_100/deeplearning4j/deeplearning4j/0824916e35885ac57caf61af7857ae7e6efc5607/AbstractCache-e690e9d.java
      ...
      return (int) 
<<<<<<< commits-rmx_100/deeplearning4j/deeplearning4j/5f711a1332dadce71fe4a63102f0fd210a03555d/AbstractCache-fc14661.java
      extendedVocabulary.get(word).getElementFrequency()
=======
...
>>>>>>> commits-rmx_100/deeplearning4j/deeplearning4j/0824916e35885ac57caf61af7857ae7e6efc5607/AbstractCache-e690e9d.java
  ...
  /**
     ...
     * @return
     */
  @Override public boolean containsWord(String word) {
  ...
  /**
     ...
     * @return
     */
  @Override public String wordAtIndex(int index) {
  ...
  /**
     ...
     * @return
     */
  @Override public T elementAtIndex(int index) {
  ...
  /**
     ...
     * @return
     */
  @Override public Collection<T> vocabWords() {
  ...
  /**
     ...
     * @return
     */
  @Override public long totalWordOccurrences() {
  ...
  /**
     ...
     * @return
     */
  @Override public T wordFor(@NonNull String label) {
    return extendedVocabulary.get(label);
  }

  @Override public T wordFor(long id) {
  ...
  /**
     ...
     * @param label
     */
  @Override public void addWordToIndex(int index, String label) {
  ...
  @Override public void addWordToIndex(int index, long elementId) {
    if (index >= 0) {
      idxMap.put(index, tokenFor(elementId));
    }
  }

  @Override @Deprecated public void putVocabWord(String word) {
  ...
  /**
     ...
     * @param howMuch
     */
  @Override public void incrementDocCount(String word, long howMuch) {
    if (extendedVocabulary.containsKey(word)) {
  ...
  /**
     ...
     */
  @Override public void setCountForDoc(String word, long count) {
    if (extendedVocabulary.containsKey(word)) {
  ...
  /**
     ...
     * @return
     */
  @Override public long totalNumberOfDocs() {
  ...
  /**
     ...
     */
  @Override public void incrementTotalDocCount() {
  ...
  /**
     ...
     */
  @Override public void incrementTotalDocCount(long by) {
  ...
  /**
     ...
     */
  @Override public Collection<T> tokens() {
    return vocabWords();
  }
  ...
  /**
     ...
     */
  @Override public void addToken(T element) {
  ...
  /**
     ...
     * @return
     */
  @Override public T tokenFor(String label) {
    return wordFor(label);
  }

  @Override public T tokenFor(long id) {
    return vocabulary.get(id);
  }
  ...
  /**
     ...
     * @return
     */
  @Override public boolean hasToken(String label) {
  ...
  @Override public void updateWordsOccurencies() {
  ...
  @Override public void removeElement(String label) {
  ...
  @Override public void removeElement(T element) {
