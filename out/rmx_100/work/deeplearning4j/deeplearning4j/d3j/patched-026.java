...
<<<<<<< /root/work/deeplearning4j/deeplearning4j/d3j/patched-026-0.java
import org.apache.commons.io.IOUtils;
import lombok.extern.slf4j.Slf4j;
||||||| /root/work/deeplearning4j/deeplearning4j/d3j/base-026.java
import org.apache.commons.lang3.NotImplementedException;
=======
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.io.IOUtils;
>>>>>>> /root/work/deeplearning4j/deeplearning4j/d3j/patched-026-1.java
...
||||||| /root/work/deeplearning4j/deeplearning4j/d3j/base-026.java
  public static MultiLayerConfiguration
  importSequentialModelConfig(String configJson) throws IOException {
    Map<String, Object> kerasConfig = parseJsonString(configJson);
    MultiLayerConfiguration modelConfig =
        importSequentialModelConfig(kerasConfig);
    return modelConfig;
  }
=======
  @Deprecated
...
||||||| /root/work/deeplearning4j/deeplearning4j/d3j/base-026.java
  importFunctionalApiConfig(String configJson) throws IOException {
    Map<String, Object> kerasConfig = parseJsonString(configJson);
    ComputationGraphConfiguration modelConfig =
        importFunctionalApiConfig(kerasConfig);
    return modelConfig;
  }
  ...
  importFunctionalApiConfig(Map<String, Object> kerasConfig)
      throws IOException, NotImplementedException,
             IncompatibleKerasConfigurationException {
    throw new NotImplementedException(
        "Import of Keras Functional API model configs not supported.");
  }
  public static Map<String, Object>
  extractWeightsMetadataFromConfig(String configJson) throws IOException {
    ...
    List<Map<String, Object>> layers =
        (List<Map<String, Object>>)kerasConfig.get("config");
    for (Map<String, Object> layer : layers) {
      Map<String, Object> layerConfig =
          (Map<String, Object>)layer.get("config");
      if (layerConfig.containsKey("dim_ordering") &&
          !weightsMetadata.containsKey("keras_backend"))
