...
public class ModelConfiguration {
  ...
  importSequentialModelConfigFromFile(String configJsonFilename)
      throws IOException {
    String configJson =
        new String(Files.readAllBytes(Paths.get(configJsonFilename)));
    return importSequentialModelConfig(configJson);
  }
  public static ComputationGraphConfiguration
  importFunctionalApiConfigFromFile(String configJsonFilename)
      throws IOException {
    String configJson =
        new String(Files.readAllBytes(Paths.get(configJsonFilename)));
