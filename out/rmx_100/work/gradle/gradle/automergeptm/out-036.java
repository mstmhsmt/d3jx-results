...
class DependencyManagementBuildScopeServices {
  ...
  DefaultProjectDependencyFactory createProjectDependencyFactory(Instantiator instantiator, StartParameter startParameter, ImmutableAttributesFactory attributesFactory, Instantiator instantiatorStartParameter startParameterImmutableAttributesFactory attributesFactoryTaskDependencyFactory taskDependencyFactory) {
