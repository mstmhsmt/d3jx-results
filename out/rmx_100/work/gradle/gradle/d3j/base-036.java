...
class DependencyManagementBuildScopeServices {
  ...
  createProjectDependencyFactory(Instantiator instantiator,
    ...
    return new DefaultProjectDependencyFactory(
        ...
        capabilityNotationParser, attributesFactory);
  }
  ...
  createDependencyFactory(Instantiator instantiator,
    ...
    return new DefaultDependencyFactory(
        ...
        DependencyNotationParser.create(
            ...
            attributesFactory, capabilityNotationParser),
  ...
  DependenciesAccessors createDependenciesAccessorGenerator(
    ...
    return new DefaultDependenciesAccessors(
        registry, workspace, factory, featurePreviews, executionEngine,
        fileCollectionFactory, inputFingerprinter);
  }
  ExecutionEngine createExecutionEngine(
      ...
      InputFingerprinter inputFingerprinter, ListenerManager listenerManager,
  ...
  private static class NoOpCachingStateStep<C extends ValidationFinishedContext>
    ...
    public CachingResult execute(UnitOfWork work,
      ...
      UpToDateResult result = delegate.execute(work, new CachingContext() {
        ...
        @Override
        public ImmutableSortedMap<String, CurrentFileCollectionFingerprint>
