...
public class ManipulationSteps {
    ...
    public void whenIsTheStringIsParsedByTheJavaParser(String value) throws ParseException throws ParseException {
        blockStmt = JavaParser.parseBlock(value);
    }
    
    @When("is the String \"$value\" is parsed by the JavaParser using parseStatement")
    public void whenIsTheStringIsParsedByTheJavaParserUsingParseStatement(String value) throws ParseException throws ParseException {
...
>>>>>>> theirs
    ...
    public void is added to class $position in the compilation unit")
...
>>>>>>> theirs
    ...
    public void whenTheCompilationUnitIsCloned() throws CloneNotSupportedException throws CloneNotSupportedException {
        CompilationUnit compilationUnit = (CompilationUnit) state.get("cu1");
