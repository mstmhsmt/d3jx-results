...
public class ManipulationSteps {
  ...
  private AddNewIntParameterCalledValueVisitor
      addNewIntParameterCalledValueVisitor;
  private Map<String, Object> state;
  public ManipulationSteps(Map<String, Object> state) { this.state = state; }
  @Given("a BlockStmt")
  ...
  public void givenAChangeNameToUpperCaseVisitor() {
    changeMethodNameToUpperCaseVisitor =
        new ChangeMethodNameToUpperCaseVisitor();
  }
  @Given("a AddNewIntParameterCalledValueVisitor")
  public void givenAAddNewParameterCalledValueVisitor() {
    addNewIntParameterCalledValueVisitor =
        new AddNewIntParameterCalledValueVisitor();
  }
  ...
  @When("is the String \"$value\" is parsed by the JavaParser using " +
        "parseStatement")
  public void
  whenIsTheStringIsParsedByTheJavaParserUsingParseStatement(String value)
      throws ParseException {
  ...
  public void whenAClassCalledIsAddedToTheCompilationUnit(String className) {
    CompilationUnit compilationUnit = (CompilationUnit)state.get("cu1");
<<<<<<< /root/work/javaparser/javaparser/d3j/patched-026-0.java
    TypeDeclaration<?> type = new ClassOrInterfaceDeclaration(
        ModifierSet.PUBLIC, false, "CreateClass");
||||||| /root/work/javaparser/javaparser/d3j/base-026.java
    TypeDeclaration type = new ClassOrInterfaceDeclaration(
        ModifierSet.PUBLIC, false, "CreateClass");
=======
    TypeDeclaration<?> type = new ClassOrInterfaceDeclaration(
        EnumSet.of(Modifier.PUBLIC), false, "CreateClass");
>>>>>>> /root/work/javaparser/javaparser/d3j/patched-026-1.java
    compilationUnit.setTypes(Arrays.asList(type));
    state.put("cu1", compilationUnit);
  }
  @When("a public static method called \"$methodName\" returning void is " +
        "added to class $position in the compilation unit")
  public void
  whenAStaticMethodCalledReturningIsAddedToClassInTheCompilationUnit(
      String methodName, int position) {
    CompilationUnit compilationUnit = (CompilationUnit)state.get("cu1");
    TypeDeclaration<?> type = compilationUnit.getTypes().get(position - 1);
    EnumSet<Modifier> modifiers = EnumSet.of(Modifier.PUBLIC);
    MethodDeclaration method =
        new MethodDeclaration(modifiers, new VoidType(), methodName);
    modifiers.add(Modifier.STATIC);
    method.setModifiers(modifiers);
    ASTHelper.addMember(type, method);
    state.put("cu1", compilationUnit);
  }
  @When("$typeName varargs called \"$parameterName\" are added to method " +
        "$methodPosition in class $classPosition")
  public void
  whenVarargsCalledAreAddedToMethodInClass(String typeName,
                                           String parameterName,
                                           int methodPosition,
                                           int classPosition) {
    CompilationUnit compilationUnit = (CompilationUnit)state.get("cu1");
    MethodDeclaration method = getMethodByPositionAndClassPosition(
        compilationUnit, methodPosition, classPosition);
    Parameter param = ASTHelper.createParameter(
        ASTHelper.createReferenceType(typeName, 0), parameterName);
    param.setVarArgs(true);
    ASTHelper.addParameter(method, param);
  }
  @When(
      "a BlockStmt is added to method $methodPosition in class $classPosition")
  public void
  whenABlockStmtIsAddedToMethodInClass(int methodPosition, int classPosition) {
    CompilationUnit compilationUnit = (CompilationUnit)state.get("cu1");
    MethodDeclaration method = getMethodByPositionAndClassPosition(
        compilationUnit, methodPosition, classPosition);
    method.setBody(new BlockStmt());
  }
  @When("$className.$fieldName.$methodName(\"$stringValue\"); is added to " +
        "the body of method $methodPosition in class $classPosition")
  public void
  whenHelloWorldIsAddedToTheBodyOfMethodInClass(
      String className, String fieldName, String methodName, String stringValue,
  ...
  @When("method $methodPosition in class $classPosition has it's name " +
        "converted to uppercase")
  public void
  whenMethodInClassHasItsNameConvertedToUppercase(int methodPosition,
                                                  int classPosition) {
    CompilationUnit compilationUnit = (CompilationUnit)state.get("cu1");
    MethodDeclaration method = getMethodByPositionAndClassPosition(
        compilationUnit, methodPosition, classPosition);
  ...
  @When("method $methodPosition in class $classPosition has an int parameter " +
        "called \"$paramName\" added")
  public void
  whenMethodInClassHasAnIntArgumentCalledAdded(int methodPosition,
                                               int classPosition,
                                               String paramName) {
    CompilationUnit compilationUnit = (CompilationUnit)state.get("cu1");
    MethodDeclaration method = getMethodByPositionAndClassPosition(
    ...
    ASTHelper.addParameter(
        method, ASTHelper.createParameter(ASTHelper.INT_TYPE, paramName));
  }
  ...
  public void
  whenTheAddNewParameterCalledValueVisitorVisitsToCompilationUnit() {
    CompilationUnit compilationUnit = (CompilationUnit)state.get("cu1");
  ...
  @Then("method $methodPosition in class $classPosition has the name " +
        "\"$expectedName\"")
  public void
  thenMethodInClassHasTheName(int methodPosition, int classPosition,
                              String expectedName) {
    CompilationUnit compilationUnit = (CompilationUnit)state.get("cu1");
    MethodDeclaration method = getMethodByPositionAndClassPosition(
        compilationUnit, methodPosition, classPosition);
  ...
  @Then("method $methodPosition in class $classPosition has $expectedCount " +
        "parameters")
  @Alias("method $methodPosition in class $classPosition has $expectedCount " +
         "parameter")
  public void
  thenMethodInClassHasArguments(int methodPosition, int classPosition,
                                int expectedCount) {
    CompilationUnit compilationUnit = (CompilationUnit)state.get("cu1");
    MethodDeclaration method = getMethodByPositionAndClassPosition(
        compilationUnit, methodPosition, classPosition);
  ...
  @Then("method $methodPosition in class $classPosition parameter " +
        "$parameterPosition is type int called \"$expectedName\"")
  public void
  thenMethodInClassParameterIsTypeIntCalled(int methodPosition,
                                            int classPosition,
  ...
  private static class ChangeMethodNameToUpperCaseVisitor
  ...
  private static class AddNewIntParameterCalledValueVisitor
      extends VoidVisitorAdapter<Void> {
    @Override
    public void visit(MethodDeclaration n, Void arg) {
      ASTHelper.addParameter(
          n, ASTHelper.createParameter(ASTHelper.INT_TYPE, "value"));
    }
  }
}