...
public class DefaultPrettyPrinterVisitor implements VoidVisitor<Void> {
  ...
  protected void printMembers(final NodeList<BodyDeclaration<?>> members,
                              final Void arg) {
  ...
  protected void
  printMemberAnnotations(final NodeList<AnnotationExpr> annotations,
                         final Void arg) {
  ...
  protected void printAnnotations(final NodeList<AnnotationExpr> annotations,
                                  boolean prefixWithASpace, final Void arg) {
    if (annotations.isEmpty()) {
      return;
    }
    if (prefixWithASpace) {
  ...
  protected void
  printTypeArgs(final NodeWithTypeArguments<?> nodeWithTypeArguments,
                final Void arg) {
    NodeList<Type> typeArguments =
        nodeWithTypeArguments.getTypeArguments().orElse(null);
  ...
  protected void printTypeParameters(final NodeList<TypeParameter> args,
                                     final Void arg) {
  ...
  protected <T extends Expression> void printArguments(final NodeList<T> args,
                                                       final Void arg) {
    printer.print("(");
    if (!isNullOrEmpty(args)) {
  ...
  protected void
  printPrePostFixOptionalList(final NodeList<? extends Visitable> args,
                              final Void arg, String prefix, String separator,
                              String postfix) {
    if (!args.isEmpty()) {
      printer.print(prefix);
      for (final Iterator<? extends Visitable> i = args.iterator();
           i.hasNext();) {
  ...
  protected void
  printPrePostFixRequiredList(final NodeList<? extends Visitable> args,
                              final Void arg, String prefix, String separator,
                              String postfix) {
    printer.print(prefix);
    if (!args.isEmpty()) {
  ...
  public void visit(final CompilationUnit n, final Void arg) {
    ...
    for (final Iterator<TypeDeclaration<?>> i = n.getTypes().iterator();
         i.hasNext();) {
  ...
  public void visit(RecordDeclaration n, Void arg) {
    ...
    if (!isNullOrEmpty(n.getParameters())) {
      for (final Iterator<Parameter> i = n.getParameters().iterator();
           i.hasNext();) {
  ...
  public void visit(final JavadocComment n, final Void arg) {
    ...
    if (getOption(ConfigOption.PRINT_COMMENTS).isPresent() &&
      ...
      boolean prependSpace = strippedLines.stream().anyMatch(
  ...
  public void visit(final FieldDeclaration n, final Void arg) {
    ...
    printer.print(" ");
    for (final Iterator<VariableDeclarator> i = n.getVariables().iterator();
         i.hasNext();) {
...
<<<<<<< /root/work/javaparser/javaparser/d3j/patched-000-0.java
      ...
      for (final Iterator<Expression> i = n.getValues().iterator();
           i.hasNext();) {
...
||||||| /root/work/javaparser/javaparser/d3j/base-000.java
      printer.print(" ");
      for (final Iterator<Expression> i = n.getValues().iterator();
           i.hasNext();) {
        final Expression expr = i.next();
...
>>>>>>> /root/work/javaparser/javaparser/d3j/patched-000-1.java
      }
<<<<<<< /root/work/javaparser/javaparser/d3j/patched-000-0.java
      if (multiLine) {
        printer.println();
...
<<<<<<< /root/work/javaparser/javaparser/d3j/patched-000-0.java
  private boolean doPrintAsArrayOfAnnotations(final ArrayInitializerExpr n) {
    return getOption(ConfigOption.INDENT_PRINT_ARRAYS_OF_ANNOTATIONS)
               .isPresent() &&
        n.getValues().stream().allMatch(s -> s instanceof AnnotationExpr);
  }
  private void printFormattedArray(final ArrayInitializerExpr n, final Void arg,
...
=======
  ...
  private void basicPrintArray(final ArrayInitializerExpr n, final Void arg,
                               boolean multiLIne) {
    for (final Iterator<Expression> i = n.getValues().iterator();
         i.hasNext();) {
      final Expression expr = i.next();
...
>>>>>>> /root/work/javaparser/javaparser/d3j/patched-000-1.java
  ...
  public void visit(final MethodCallExpr n, final Void arg) {
    ...
    if (getOption(ConfigOption.COLUMN_ALIGN_FIRST_METHOD_CHAIN).isPresent()) {
      if (n.findAncestor(Statement.class)
              .map(p
                   -> p.isReturnStmt() || p.isThrowStmt() || p.isAssertStmt() ||
                          p.isExpressionStmt())
              .orElse(false)) {
        Node c = n;
    ...
    if (columnAlignFirstMethodChain.get()) {
      ...
      while (
          s.filter(NodeWithTraversableScope.class ::isInstance).isPresent()) {
        Optional<Expression> parentScope =
            s.map(NodeWithTraversableScope.class ::cast)
                .flatMap(NodeWithTraversableScope::traverseScope);
        if (s.filter(MethodCallExpr.class ::isInstance).isPresent() &&
            parentScope.isPresent()) {
    ...
    printer.unindent();
    if (columnAlignFirstMethodChain.get() && methodCallWithScopeInScope.get() &&
  ...
  public void visit(final ConstructorDeclaration n, final Void arg) {
    ...
    if (!isNullOrEmpty(n.getThrownExceptions())) {
      ...
      for (final Iterator<ReferenceType> i = n.getThrownExceptions().iterator();
           i.hasNext();) {
  ...
  public void visit(final VariableDeclarationExpr n, final Void arg) {
    ...
    printComment(n.getComment(), arg);
    if (n.getParentNode()
            .map(ExpressionStmt.class ::isInstance)
            .orElse(false)) {
      printMemberAnnotations(n.getAnnotations(), arg);
    } else {
      printAnnotations(n.getAnnotations(), false, arg);
  ...
  public void visit(final SwitchEntry n, final Void arg) {
    ...
    final String separator =
        (n.getType() == SwitchEntry.Type.STATEMENT_GROUP) ? ":" : " ->";
    if (isNullOrEmpty(n.getLabels())) {
      printer.print("default" + separator);
    } else {
      printer.print("case ");
      for (final Iterator<Expression> i = n.getLabels().iterator();
           i.hasNext();) {
  ...
  public void visit(final EnumDeclaration n, final Void arg) {
    ...
    if (n.getEntries().isNonEmpty()) {
      ...
      printer.println();
      for (final Iterator<EnumConstantDeclaration> i =
               n.getEntries().iterator();
           i.hasNext();) {
  ...
  public void visit(final IfStmt n, final Void arg) {
    ...
    if (n.getElseStmt().isPresent()) {
      ...
      final boolean elseBlock =
          n.getElseStmt().orElse(null) instanceof BlockStmt;
      if (elseIf || elseBlock)
        printer.print("else ");
      else {
  ...
  public void visit(final ForStmt n, final Void arg) {
    ...
    if (n.getInitialization() != null) {
      for (final Iterator<Expression> i = n.getInitialization().iterator();
           i.hasNext();) {
    ...
    printer.print("; ");
    if (n.getUpdate() != null) {
      for (final Iterator<Expression> i = n.getUpdate().iterator();
           i.hasNext();) {
        final Expression e = i.next();
        e.accept(this, arg);
        if (i.hasNext()) {
  ...
  public void visit(final NormalAnnotationExpr n, final Void arg) {
    ...
    printer.print("(");
    if (n.getPairs() != null) {
      for (final Iterator<MemberValuePair> i = n.getPairs().iterator();
           i.hasNext();) {
  ...
  public void visit(final LineComment n, final Void arg) {
    ...
    printer.print(n.getHeader())
        .println(normalizeEolInTextBlock(
            RTRIM.matcher(n.getContent()).replaceAll(""), ""));
  }
  @Override
  public void visit(final BlockComment n, final Void arg) {
    ...
    for (int i = 0; i < (lines.length - 1); i++) {
      ...
      printer.print(
          getOption(ConfigOption.END_OF_LINE_CHARACTER).get().asValue());
    }
  ...
  private void printImports(NodeList<ImportDeclaration> imports, Void arg) {
    ...
    Optional<ConfigurationOption> optionalStrategy =
        getOption(ConfigOption.SORT_IMPORTS_STRATEGY);
    ...
    Optional<ConfigurationOption> orderImportsOption =
        getOption(ConfigOption.ORDER_IMPORTS);
    if (orderImportsOption.isPresent()) {
      strategy.setSortImportsAlphabetically(true);
    }
    List<NodeList<ImportDeclaration>> groupOrderedImports =
        strategy.sortImports(imports);
  ...
  private void printOrphanCommentsBeforeThisChildNode(final Node node) {
    ...
    for (int i = positionOfTheChild - 1;
         i >= 0 && positionOfPreviousChild == -1; i--) {
