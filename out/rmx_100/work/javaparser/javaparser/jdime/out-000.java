...
<<<<<<< commits-rmx_100/javaparser/javaparser/b196113c436b5f210e9e8000fd2cc3a87e8fd638/DefaultPrettyPrinterVisitor-47450cb.java
      final boolean multiLine = doPrintAsArrayOfAnnotations(n);
=======
      printFormattedArray(n, arg, doPrintAsArrayOfAnnotations(n));
>>>>>>> commits-rmx_100/javaparser/javaparser/283c17e03f209233a19b56bd6715c160a3b95544/DefaultPrettyPrinterVisitor-93f168f.java
...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Override public void visit(final TypePatternExpr n, final Void arg) {
    printModifiers(n.getModifiers());
    n.getType().accept(this, arg);
    printer.print(" ");
    n.getName().accept(this, arg);
  ...
  @Override public void visit(final RecordPatternExpr n, final Void arg) {
    printOrphanCommentsBeforeThisChildNode(n);
    printComment(n.getComment(), arg);
    n.getType().accept(this, arg);
  ...
  @Override public void visit(final CompactConstructorDeclaration n, final Void arg) {
    printOrphanCommentsBeforeThisChildNode(n);
    printComment(n.getComment(), arg);
    printMemberAnnotations(n.getAnnotations(), arg);
    printModifiers(n.getModifiers());
  ...
  @Override public void visit(final LocalRecordDeclarationStmt n, final Void arg) {
    printOrphanCommentsBeforeThisChildNode(n);
    printComment(n.getComment(), arg);
