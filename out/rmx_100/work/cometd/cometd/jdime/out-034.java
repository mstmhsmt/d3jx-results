...
public abstract class AbstractClientSession implements ClientSession, Dumpable {
  ...
  @Override public ClientSessionChannel getChannel(String channelName) {
  ...
  @Override public boolean endBatch() {
  ...
  @Override public void batch(Runnable batch) {
    startBatch();
    try {
      batch.run();
    }  finally {
  ...
  @Override public void remoteCall(String target, Object data, MessageListener callback) {
  ...
  protected abstract class AbstractSessionChannel implements ClientSessionChannel, Dumpable {
    ...
    @Override public void addListener(ClientSessionChannelListener listener) {
      throwIfReleased();
      _listeners.add(listener);
    }

    @Override public void removeListener(ClientSessionChannelListener listener) {
      throwIfReleased();
      _listeners.remove(listener);
    }

    @Override public List<ClientSessionChannelListener> getListeners() {
      return Collections.unmodifiableList(_listeners);
    }

    @Override public void publish(Object data) {
      publish(data, null);
    }

    @Override public void publish(Object data, MessageListener callback) {
      throwIfReleased();
      Message.Mutable message = newMessage();
      String messageId = newMessageId();
      message.setId(messageId);
    ...
    @Override public void subscribe(MessageListener listener) {
      subscribe(listener, null);
    }

    @Override public void subscribe(MessageListener listener, MessageListener callback) {
      throwIfReleased();
    ...
    @Override public void unsubscribe(MessageListener listener) {
      unsubscribe(listener, null);
    }

    @Override public void unsubscribe(MessageListener listener, MessageListener callback) {
    ...
    @Override public List<MessageListener> getSubscribers() {
    ...
    @Override public boolean isDeepWild() {
      return _id.isDeepWild();
    }

    @Override public boolean isMeta() {
      return _id.isMeta();
    }

    @Override public boolean isService() {
      return _id.isService();
    }

    @Override public boolean isBroadcast() {
      return !isMeta() && !isService();
    }

    @Override public boolean isWild() {
      return _id.isWild();
    }
