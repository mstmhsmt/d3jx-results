 ...
 */
public abstract class OortService<R extends java.lang.Object, C extends java.lang.Object> extends AbstractLifeCycle implements ServerChannel.MessageListener {
  ...
  private final ConcurrentMap<Long, Map<String, Object>> callbacks = new 
<<<<<<< commits-rmx_100/cometd/cometd/ec8df470d53e55d038560ed1521c7944f5bf46c1/OortService-3d9c975.java
  ConcurrentHashMap<>
=======
  ConcurrentHashMap<Long, Map<String, Object>>
...
>>>>>>> Unknown file: This is a bug in JDime.
      ...
      if (broadcastChannelName.equals(message.getChannel())) {
        onForwardMessage(message.getDataAsMap(), true);
      } else {
        if (resultChannelName.equals(message.getChannel())) {
  ...
  protected void onResultMessage(Map<String, Object> data) {
    ...
    if (ctx != null) {
      cancelTimeout(ctx);
      @SuppressWarnings(value = { "unchecked" }) C context = (C) ctx.get(CONTEXT_FIELD);
      boolean success = (Boolean) data.get(RESULT_FIELD);
      if (success) {
        @SuppressWarnings(value = { "unchecked" }) R result = (R) data.get(DATA_FIELD);
  ...
  public static class Result<U extends java.lang.Object> {
    ...
    /**
         ...
         */
    public static <S extends java.lang.Object> Result<S> success(S result) {
    ...
    /**
         ...
         */
    public static <S extends java.lang.Object> Result<S> failure(Object failure) {
    ...
    /**
         ...
         */
    public static <S extends java.lang.Object> Result<S> ignore(Object data) {
