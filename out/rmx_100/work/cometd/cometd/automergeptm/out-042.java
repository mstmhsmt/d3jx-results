...
public class AsyncJSONTransport extends AbstractHttpTransport {
  ...
  @Override public boolean accept(HttpServletRequest request) {
    return "POST".equalsIgnoreCase(request.getMethod());
  }

  @Override public void handle(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    ReadListener reader = "UTF-8".equals(charset.name()) ? new UTF8Reader(request, response, asyncContext) : new CharsetReader(request, response, asyncContext, charset);
  ...
  @Override protected void write(HttpServletRequest request, HttpServletResponse response, ServerSessionImpl session, boolean scheduleExpiration, List<ServerMessage> messages, ServerMessage.Mutable[] replies) {
    AsyncContext asyncContext = request.getAsyncContext();
    try {
  ...
  protected class UTF8Reader extends AbstractReader {
    ...
    @Override protected void append(byte[] buffer, int offset, int length) {
...
<<<<<<< commits-rmx_100/cometd/cometd/93cfd4f8a0c4268e07f03d4a698762431d103d5b/AsyncJSONTransport-321b59e.java
...
>>>>>>> commits-rmx_100/cometd/cometd/ed602f7e76bf25729bd83695f42d4198489c345f/AsyncJSONTransport-7540458.java
