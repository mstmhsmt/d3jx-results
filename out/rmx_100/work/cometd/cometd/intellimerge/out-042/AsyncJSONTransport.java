...
public class AsyncJSONTransport extends AbstractHttpTransport
{
    ...
    @Override
    public void handle(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException throws IOException, ServletException {
...
>>>>>>> theirs
    ...
    protected abstract class AbstractReader implements ReadListener
    {
        ...
        @Override
        public void onDataAvailable() throws IOException throws IOException {
            ServletInputStream input = request.getInputStream();
            if (_logger.isDebugEnabled()) {
        ...
        @Override
        public void onAllDataRead() throws IOException throws IOException {
            ServletInputStream input = request.getInputStream();
            String json = finish();
            if (_logger.isDebugEnabled()) {
        ...
        protected void process(String json) throws IOException throws IOException {
    ...
    protected class Writer implements WriteListener
    {
        ...
        @Override
        public void onWritePossible() throws IOException throws IOException {
            ServletOutputStream output = response.getOutputStream();
...
>>>>>>> theirs
        ...
        private boolean writeBegin(ServletOutputStream output) throws IOException throws IOException
        {
            output.write('[');
            return output.isReady();
        }
            
        private boolean writeHandshakeReply(ServletOutputStream output) throws IOException throws IOException
        {
            if (replies.length > 0)
            {
        ...
        private boolean writeMessages(ServletOutputStream output) throws IOException throws IOException {
            try {
...
>>>>>>> theirs
        ...
        private boolean writeReplies(ServletOutputStream output) throws IOException throws IOException {
...
>>>>>>> theirs
        ...
        private boolean writeEnd(ServletOutputStream output) throws IOException throws IOException
        {
            output.write(']');
            return output.isReady();
        }
