...
class EBeanHolder
{
   ...
   public final HashMap<String,TextWatcherHolder> textWatchers =
     new HashMap<String,TextWatcherHolder>();
   public final HashMap<Integer,JCase> onActivityResultCases =
     new HashMap<Integer,JCase>();
   public JSwitch onActivityResultSwitch;
   public JMethod onActivityResultMethod;
   public final HashMap<String,OnSeekBarChangeListenerHolder>
   onSeekBarChangeListeners =
     new HashMap<String,OnSeekBarChangeListenerHolder>();
   ...
   public
   EBeanHolder(EBeansHolder eBeansHolder, 
               Class<? extends Annotation> eBeanAnnotation, 
