...
public class NodeService extends AbstractComponent implements Closeable {
  ...
  @Inject public NodeService(Settings settings, ThreadPool threadPool, MonitorService monitorService, Discovery discovery, TransportService transportService, IndicesService indicesService, PluginsService pluginService, CircuitBreakerService circuitBreakerService, 
<<<<<<< commits-rmx_100/elasticsearch/elasticsearch/76ba10bab67c432b3ea3fddbaa897b0d3dad11f2/NodeService-103ee73.java
  ScriptService scriptService
=======
  HttpServer httpServer
>>>>>>> commits-rmx_100/elasticsearch/elasticsearch/a200292211f687c1ce6d04e25acdb62a8389ee67/NodeService-f3743a4.java
  ...
  public NodeInfo info() {
    return new NodeInfo(Version.CURRENT, Build.CURRENT, discovery.localNode(), settings, monitorService.osService().info(), monitorService.processService().info(), monitorService.jvmService().info(), threadPool.info(), transportService.info(), httpServer.info(), pluginService == null ? null : pluginService.info(), ingestService == null ? null : ingestService.info(), indicesService.getTotalIndexingBufferBytes());
  }
