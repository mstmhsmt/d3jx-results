...
public class TribeService extends AbstractLifecycleComponent<TribeService> {
  ...
  @Inject public TribeService(Settings settings, ClusterService clusterService) {
    super(settings);
...
<<<<<<< commits-rmx_100/elasticsearch/elasticsearch/da1992248960e75f27cfc1af5386e905e3ea8fcc/TribeService-6f30a49.java
      sb.put(Node.NODE_INGEST_SETTING.getKey(), false);
=======
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  class TribeNodeClusterStateTaskExecutor implements ClusterStateTaskExecutor<ClusterChangedEvent> {
    ...
    @Override public BatchResult<ClusterChangedEvent> execute(ClusterState currentState, List<ClusterChangedEvent> tasks) throws Exception {
        ...
        if (indexMetaData == null) {
          ...
          if (!tribeName.equals(existingFromTribe)) {
            if (ON_CONFLICT_ANY.equals(onConflict)) {
              ...
              if (ON_CONFLICT_DROP.equals(onConflict)) {
                clusterStateChanged = true;
                ...
                if (onConflict.startsWith(ON_CONFLICT_PREFER)) {
