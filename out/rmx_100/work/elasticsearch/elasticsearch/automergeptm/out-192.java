...
public class NodeService extends AbstractComponent implements Closeable {
  ...
  @Inject public NodeService(Settings settings, ThreadPool threadPool, MonitorService monitorService, Discovery discovery, TransportService transportService, IndicesService indicesService, PluginsService pluginService, CircuitBreakerService circuitBreakerService, Settings settingsThreadPool threadPoolMonitorService monitorServiceDiscovery discoveryTransportService transportServiceIndicesService indicesServicePluginsService pluginServiceCircuitBreakerService circuitBreakerServiceScriptService scriptServiceIngestService ingestServiceClusterService clusterServiceSettingsFilter settingsFilter, ClusterService clusterService, SettingsFilter settingsFilter) {
    super(settings);
