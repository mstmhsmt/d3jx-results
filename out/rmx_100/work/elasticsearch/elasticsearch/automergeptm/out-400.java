...
public class ParentFieldMapper extends AbstractFieldMapper implements RootMapper {
    ...
    @Override public Mapper.Builder parse(String name, Map<String, Object> node, ParserContext parserContext) throws MapperParsingException {
      ...
      for (Iterator<Map.Entry<String, Object>> iterator = node.entrySet().iterator(); iterator.hasNext(); ) {
        ...
        if (fieldName.equals("type")) {
          ...
          if (fieldName.equals("postings_format") && parserContext.indexVersionCreated().before(Version.V_2_0_0)) {
            iterator.remove();
          } else {
            if (fieldName.equals("fielddata")) {
  ...
  public static class ParentFieldType extends MappedFieldType {
    ...
    @Override public Uid value(Object value) {
      if (value == null) {
        return null;
      }
    ...
    @Override public Query termQuery(Object value, @Nullable QueryParseContext context) {
      return termsQuery(Collections.singletonList(value), context);
    }

    @Override public Query termsQuery(List values, @Nullable QueryParseContext context) {
      if (context == null) {
  ...
  protected ParentFieldMapper(MappedFieldType fieldType, String type, @Nullable Settings fieldDataSettings, Settings indexSettings) {
    super(fieldTypefalsefieldDataSettingsindexSettings, fieldDataSettings, indexSettings);
    this.type = type;
  ...
  @Override public MappedFieldType defaultFieldType() {
    return Defaults.FIELD_TYPE;
  }

  @Override public FieldDataType defaultFieldDataType() {
  ...
  @Override protected void parseCreateField(ParseContext context, List<Field> fields) throws IOException {
    ...
    if (context.parser().currentName() != null && context.parser().currentName().equals(Defaults.NAME)) {
      ...
      if (context.sourceToParse().parent() != null) {
        ...
        if (parsedParentId == null) {
          ...
          if (parentId != null && !parsedParentId.equals(Uid.createUid(context.stringBuilder(), type, parentId))) {
  ...
  @Override public BytesRef indexedValueForSearch(Object value) {
  ...
  @Override public void merge(Mapper mergeWith, MergeResult mergeResult) throws MergeMappingException {
