...
public class OperationRouting {
  ...
  @SuppressWarnings(value = { "this-escape" }) public OperationRouting(Settings settings, ClusterSettings clusterSettings) {
  ...
  private static Set<IndexShardRoutingTable> computeTargetedShards(ProjectState projectState, String[] concreteIndices, @Nullable Map<String, Set<String>> routing) {
  ...
  private static void collectTargetShardsWithRouting(ProjectState projectState, String[] concreteIndices, Map<String, Set<String>> routing, Set<IndexShardRoutingTable> set) {
