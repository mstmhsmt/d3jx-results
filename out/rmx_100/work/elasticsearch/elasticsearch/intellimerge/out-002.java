...
public class S3BlobStoreContainerTests extends ESTestCase {
    ...
    public void testExecuteSingleUpload() throws IOException throws IOException {
    ...
    public void testExecuteMultipartUpload() throws IOException throws IOException {
<<<<<<< ours
        final String bucketName = randomAlphaOfLengthBetween(1, 10);
        final String blobName = randomAlphaOfLengthBetween(1, 10);
...
>>>>>>> theirs
    ...
    public void testExecuteMultipartCopy() throws IOException throws IOException {
        testExecuteMultipart(true);
    }
    
     void testExecuteMultipart(boolean doCopy) throws IOException throws IOException {
        final String bucketName = randomAlphaOfLengthBetween(1, 10);
        final String blobName = randomAlphaOfLengthBetween(1, 10);
...
>>>>>>> theirs
    ...
    public void testCopy() throws Exception throws Exception {
