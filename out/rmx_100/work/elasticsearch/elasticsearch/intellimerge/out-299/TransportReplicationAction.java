...
public abstract class TransportReplicationAction<Request extends ReplicationRequest, ReplicaRequest extends ReplicationRequest, Response extends ReplicationResponse> extends TransportAction<Request, Response> {
    ...
    class OperationTransportHandler implements TransportRequestHandler<Request> {
        @Override
        public void messageReceived(final Request request, final TransportChannel channel) throws Exception throws Exception {
    ...
    class ReplicaOperationTransportHandler implements TransportRequestHandler<ReplicaRequest> {
        @Override
        public void messageReceived(final ReplicaRequest request, final TransportChannel channel) throws Exception throws Exception {
    ...
    public static class RetryOnReplicaException extends ElasticsearchException {
        ...
        public RetryOnReplicaException(StreamInput in) throws IOException throws IOException{
            super(in);
        }
    }
    ...
    private final class AsyncReplicaAction extends AbstractRunnable {
        ...
        @Override
        protected void doRun() throws Exception throws Exception {
    ...
    public static class RetryOnPrimaryException extends ElasticsearchException {
        ...
        public RetryOnPrimaryException(StreamInput in) throws IOException throws IOException{
            super(in);
        }
    }
