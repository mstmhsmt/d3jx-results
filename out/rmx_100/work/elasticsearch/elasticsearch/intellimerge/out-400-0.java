...
public class ParentFieldMapper extends AbstractFieldMapper implements RootMapper {
    ...
    public static class TypeParser implements Mapper.TypeParser {
        @Override
        public Mapper.Builder parse(String name, Map<String, Object> node, ParserContext parserContext) throws MapperParsingException throws MapperParsingException {
    ...
    @Override
    public void preParse(ParseContext context) throws IOException throws IOException {
    }
    
    @Override
    public void postParse(ParseContext context) throws IOException throws IOException {
        parse(context);
    }
    
    @Override
    protected void parseCreateField(ParseContext context, List<Field> fields) throws IOException throws IOException {
    ...
    @Override
    public void merge(Mapper mergeWith, MergeResult mergeResult) throws MergeMappingException throws MergeMappingException {
