...
>>>>>>> theirs
    ...
    // -- physical plan nodes
    static AggregateExec readAggregateExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeAggregateExec(PlanStreamOutput out, AggregateExec aggregateExec) throws IOException throws IOException {
    ...
    static DissectExec readDissectExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeDissectExec(PlanStreamOutput out, DissectExec dissectExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static EsQueryExec readEsQueryExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeEsQueryExec(PlanStreamOutput out, EsQueryExec esQueryExec) throws IOException throws IOException {
    ...
    static EsSourceExec readEsSourceExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeEsSourceExec(PlanStreamOutput out, EsSourceExec esSourceExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static IndexMode readIndexMode(StreamInput in) throws IOException throws IOException {
    ...
    static void writeIndexMode(StreamOutput out, IndexMode indexMode) throws IOException throws IOException {
    ...
    static EvalExec readEvalExec(PlanStreamInput in) throws IOException throws IOException {
        return new EvalExec(Source.readFrom(in), in.readPhysicalPlanNode(), in.readCollectionAsList(Alias::new));
    }
    
    static void writeEvalExec(PlanStreamOutput out, EvalExec evalExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writePhysicalPlanNode(evalExec.child());
        out.writeCollection(evalExec.fields());
    }
    
    static EnrichExec readEnrichExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeEnrichExec(PlanStreamOutput out, EnrichExec enrich) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static ExchangeExec readExchangeExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeExchangeExec(PlanStreamOutput out, ExchangeExec exchangeExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static ExchangeSinkExec readExchangeSinkExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeExchangeSinkExec(PlanStreamOutput out, ExchangeSinkExec exchangeSinkExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static ExchangeSourceExec readExchangeSourceExec(PlanStreamInput in) throws IOException throws IOException {
        return new ExchangeSourceExec(Source.readFrom(in), in.readNamedWriteableCollectionAsList(Attribute.class), in.readBoolean());
    }
    
    static void writeExchangeSourceExec(PlanStreamOutput out, ExchangeSourceExec exchangeSourceExec) throws IOException throws IOException {
        out.writeNamedWriteableCollection(exchangeSourceExec.output());
        out.writeBoolean(exchangeSourceExec.isIntermediateAgg());
    }
    
    static FieldExtractExec readFieldExtractExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeFieldExtractExec(PlanStreamOutput out, FieldExtractExec fieldExtractExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writePhysicalPlanNode(fieldExtractExec.child());
        out.writeNamedWriteableCollection(fieldExtractExec.attributesToExtract());
    }
    
    static FilterExec readFilterExec(PlanStreamInput in) throws IOException throws IOException {
        return new FilterExec(Source.readFrom(in), in.readPhysicalPlanNode(), in.readExpression());
    }
    
    static void writeFilterExec(PlanStreamOutput out, FilterExec filterExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writePhysicalPlanNode(filterExec.child());
        out.writeExpression(filterExec.condition());
    }
    
    static FragmentExec readFragmentExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeFragmentExec(PlanStreamOutput out, FragmentExec fragmentExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static GrokExec readGrokExec(PlanStreamInput in) throws IOException throws IOException {
        Source source;
        return new GrokExec(
    ...
    static void writeGrokExec(PlanStreamOutput out, GrokExec grokExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static LimitExec readLimitExec(PlanStreamInput in) throws IOException throws IOException {
        return new LimitExec(Source.readFrom(in), in.readPhysicalPlanNode(), in.readNamed(Expression.class));
    }
    
    static void writeLimitExec(PlanStreamOutput out, LimitExec limitExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writePhysicalPlanNode(limitExec.child());
        out.writeExpression(limitExec.limit());
    }
    
    static MvExpandExec readMvExpandExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeMvExpandExec(PlanStreamOutput out, MvExpandExec mvExpandExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static OrderExec readOrderExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeOrderExec(PlanStreamOutput out, OrderExec orderExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writePhysicalPlanNode(orderExec.child());
        out.writeCollection(orderExec.order());
    }
    
    static ProjectExec readProjectExec(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeProjectExec(PlanStreamOutput out, ProjectExec projectExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writePhysicalPlanNode(projectExec.child());
        out.writeNamedWriteableCollection(projectExec.projections());
    }
    
    static RowExec readRowExec(PlanStreamInput in) throws IOException throws IOException {
        return new RowExec(Source.readFrom(in), in.readCollectionAsList(Alias::new));
    }
    
    static void writeRowExec(PlanStreamOutput out, RowExec rowExec) throws IOException throws IOException {
    ...
    static ShowExec readShowExec(PlanStreamInput in) throws IOException throws IOException {
        return new ShowExec(
            Source.readFrom(in),
            in.readNamedWriteableCollectionAsList(Attribute.class),
    ...
    static void writeShowExec(PlanStreamOutput out, ShowExec showExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writeNamedWriteableCollection(showExec.output());
        out.writeGenericValue(showExec.values());
    }
    
    static TopNExec readTopNExec(PlanStreamInput in) throws IOException throws IOException {
        return new TopNExec(
            Source.readFrom(in),
            in.readPhysicalPlanNode(),
            in.readCollectionAsList(org.elasticsearch.xpack.esql.expression.Order::new),
    ...
    static void writeTopNExec(PlanStreamOutput out, TopNExec topNExec) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    // -- Logical plan nodes
    static Aggregate readAggregate(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeAggregate(PlanStreamOutput out, Aggregate aggregate) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static Dissect readDissect(PlanStreamInput in) throws IOException throws IOException {
        return new Dissect(
            Source.readFrom(in),
            in.readLogicalPlanNode(),
            in.readExpression(),
    ...
    static void writeDissect(PlanStreamOutput out, Dissect dissect) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static EsRelation readEsRelation(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeEsRelation(PlanStreamOutput out, EsRelation relation) throws IOException throws IOException {
    ...
    private static void readEsSourceOptions(PlanStreamInput in) throws IOException throws IOException {
        // allowNoIndices
    ...
    private static void writeEsSourceOptions(PlanStreamOutput out) throws IOException throws IOException {
        // allowNoIndices
    ...
    static Eval readEval(PlanStreamInput in) throws IOException throws IOException {
        return new Eval(Source.readFrom(in), in.readLogicalPlanNode(), in.readCollectionAsList(Alias::new));
    }
    
    static void writeEval(PlanStreamOutput out, Eval eval) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writeLogicalPlanNode(eval.child());
        out.writeCollection(eval.fields());
    }
    
    static Enrich readEnrich(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeEnrich(PlanStreamOutput out, Enrich enrich) throws IOException throws IOException {
        if (out.getTransportVersion().onOrAfter(TransportVersions.V_8_13_0)) {
            out.writeEnum(enrich.mode());
        }
    ...
    static EsqlProject readEsqlProject(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeEsqlProject(PlanStreamOutput out, EsqlProject project) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writeLogicalPlanNode(project.child());
        out.writeNamedWriteableCollection(project.projections());
    }
    
    static Filter readFilter(PlanStreamInput in) throws IOException throws IOException {
        return new Filter(Source.readFrom(in), in.readLogicalPlanNode(), in.readExpression());
    }
    
    static void writeFilter(PlanStreamOutput out, Filter filter) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writeLogicalPlanNode(filter.child());
        out.writeExpression(filter.condition());
    }
    
    static Grok readGrok(PlanStreamInput in) throws IOException throws IOException {
        Source source;
        return new Grok(
            source = Source.readFrom(in),
            in.readLogicalPlanNode(),
    ...
    static void writeGrok(PlanStreamOutput out, Grok grok) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static Limit readLimit(PlanStreamInput in) throws IOException throws IOException {
        return new Limit(Source.readFrom(in), in.readNamed(Expression.class), in.readLogicalPlanNode());
    }
    
    static void writeLimit(PlanStreamOutput out, Limit limit) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writeExpression(limit.limit());
        out.writeLogicalPlanNode(limit.child());
    }
    
    static MvExpand readMvExpand(PlanStreamInput in) throws IOException throws IOException {
        return new MvExpand(
            Source.readFrom(in),
            in.readLogicalPlanNode(),
            in.readNamedWriteable(NamedExpression.class),
    ...
    static void writeMvExpand(PlanStreamOutput out, MvExpand mvExpand) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static OrderBy readOrderBy(PlanStreamInput in) throws IOException throws IOException {
        return new OrderBy(
            Source.readFrom(in),
            in.readLogicalPlanNode(),
            in.readCollectionAsList(org.elasticsearch.xpack.esql.expression.Order::new)
    ...
    static void writeOrderBy(PlanStreamOutput out, OrderBy order) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writeLogicalPlanNode(order.child());
        out.writeCollection(order.order());
    }
    
    static Project readProject(PlanStreamInput in) throws IOException throws IOException {
        return new Project(Source.readFrom(in), in.readLogicalPlanNode(), in.readNamedWriteableCollectionAsList(NamedExpression.class));
    }
    
    static void writeProject(PlanStreamOutput out, Project project) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writeLogicalPlanNode(project.child());
        out.writeNamedWriteableCollection(project.projections());
    }
    
    static Rank readRank(PlanStreamInput in) throws IOException throws IOException {
        return new Rank(Source.readFrom(in), in.readLogicalPlanNode(), in.readExpression());
    }
    
    static void writeRank(PlanStreamOutput out, Rank rank) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
        out.writeLogicalPlanNode(rank.child());
        out.writeExpression(rank.query());
    }
    
    static TopN readTopN(PlanStreamInput in) throws IOException throws IOException {
        return new TopN(
            Source.readFrom(in),
            in.readLogicalPlanNode(),
            in.readCollectionAsList(org.elasticsearch.xpack.esql.expression.Order::new),
    ...
    static void writeTopN(PlanStreamOutput out, TopN topN) throws IOException throws IOException {
        Source.EMPTY.writeTo(out);
    ...
    static EsQueryExec.FieldSort readFieldSort(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeFieldSort(PlanStreamOutput out, EsQueryExec.FieldSort fieldSort) throws IOException throws IOException {
    ...
    @SuppressWarnings("unchecked")
    static EsIndex readEsIndex(PlanStreamInput in) throws IOException throws IOException {
        return new EsIndex(
            in.readString(),
    ...
    static void writeEsIndex(PlanStreamOutput out, EsIndex esIndex) throws IOException throws IOException {
    ...
    static Parser readDissectParser(PlanStreamInput in) throws IOException throws IOException {
    ...
    static void writeDissectParser(PlanStreamOutput out, Parser dissectParser) throws IOException throws IOException {
