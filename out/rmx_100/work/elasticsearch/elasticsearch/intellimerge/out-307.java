...
public class CommonTermsQueryBuilder extends AbstractQueryBuilder<CommonTermsQueryBuilder> {
    ...
    static Query parseQueryString(ExtendedCommonTermsQuery query, Object queryString, String field, Analyzer analyzer,
                                         String lowFreqMinimumShouldMatch, String highFreqMinimumShouldMatch) throws IOException throws IOException {
    ...
    @Override
    protected CommonTermsQueryBuilder doReadFrom(StreamInput in) throws IOException throws IOException {
