...
public class GeohashCellQuery {
     ...
     * <code>false</code>.
     */
    public static class Builder extends AbstractQueryBuilder<Builder> {        // we need to store the geohash rather than the corresponding point,
        ...
        @Override
        protected Query doToQuery(QueryShardContext context) throws IOException throws IOException {
        ...
        @Override
        protected void doXContent(XContentBuilder builder, Params params) throws IOException throws IOException {
        ...
        @Override
        protected Builder doReadFrom(StreamInput in) throws IOException throws IOException {
