...
public class OperationRouting {
    ...
    final private boolean isStateless;
    ...
    public List<ShardIterator> searchShards(ProjectState projectState, String[] concreteIndices, @Nullable Map<String, Set<String>> routing, @Nullable String preference) {
        return searchShards(projectState, concreteIndices, routing, preference, null, null);
    }

    public List<ShardIterator> searchShards(ProjectState projectState, String[] concreteIndices, @Nullable Map<String, Set<String>> routing, @Nullable String preference, @Nullable ResponseCollectorService collectorService, @Nullable Map<String, Long> nodeCounts) {
        ...
        for (IndexShardRoutingTable shard : shards) {
            ShardIterator iterator = preferenceActiveShardIterator(shard, nodes.getLocalNodeId(), nodes, preference, collectorService, nodeCounts);
            if (iterator != null) {
    ...
    static private Set<IndexShardRoutingTable> computeTargetedShards(ProjectState projectState, String[] concreteIndices, @Nullable Map<String, Set<String>> routing) {
    ...
    static private void collectTargetShardsWithRouting(ProjectState projectState, String[] concreteIndices, Map<String, Set<String>> routing, Set<IndexShardRoutingTable> set) {
    ...
    static private void collectTargetShardsNoRouting(RoutingTable routingTable, String[] concreteIndices, Set<IndexShardRoutingTable> set) {
        for (String index : concreteIndices) {
    ...
    static protected IndexRoutingTable indexRoutingTable(RoutingTable routingTable, String index) {
    ...
    static private IndexMetadata indexMetadata(ProjectMetadata project, String index) {
