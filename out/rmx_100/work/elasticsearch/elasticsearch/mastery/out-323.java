...
public class GeohashCellQuery {
    ...
    public static class Builder extends AbstractQueryBuilder<Builder> {
        ...
        static final private Builder PROTOTYPE = new Builder(null);
    ...
    public static class Parser extends BaseQueryParser<Builder> {
        ...
        @Override
        public Builder fromXContent(QueryParseContext parseContext) throws IOException, ParsingException {
...
<<<<<<< commits-rmx_100/elasticsearch/elasticsearch/197313c19be74f40222bf20f742071e1b266d5d0/GeohashCellQuery-c8a7158.java
