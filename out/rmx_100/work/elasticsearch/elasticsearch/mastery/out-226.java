...
public final class Definition {
    ...
    public enum Sort {
        ...
        Sort(final Class<?> clazz, final int size, final boolean primitive, final boolean bool, final boolean numeric, final boolean constant) {
            this.clazz = clazz;
            this.size = size;
            this.bool = bool;
    ...
    static public final class Type {
        ...
        private Type(final String name, final int dimensions, final Struct struct, final Class<?> clazz, final org.objectweb.asm.Type type, final Sort sort) {
            this.name = name;
    ...
    static public final class Constructor {
        ...
        private Constructor(final String name, final Struct owner, final List<Type> arguments, final org.objectweb.asm.commons.Method method, final java.lang.reflect.Constructor<?> reflect) {
            this.name = name;
            this.owner = owner;
    ...
    static public class Method {
        ...
        private Method(final String name, final Struct owner, final Type rtn, final List<Type> arguments, final org.objectweb.asm.commons.Method method, final java.lang.reflect.Method reflect, final MethodHandle handle) {
            this.name = name;
            this.owner = owner;
            this.rtn = rtn;
            this.arguments = Collections.unmodifiableList(arguments);
    ...
    static public final class Field {
        ...
        private Field(final String name, final Struct owner, final Type type, final java.lang.reflect.Field reflect, final MethodHandle getter, final MethodHandle setter) {
            this.name = name;
            this.owner = owner;
            this.type = type;
            this.reflect = reflect;
    ...
    static public final class Struct {
    ...
    static public class Cast {
        ...
        public Cast(final Type from, final Type to, final boolean explicit, final boolean unboxFrom, final boolean unboxTo, final boolean boxFrom, final boolean boxTo) {
            this.from = from;
            this.to = to;
            this.explicit = explicit;
    ...
    static public final class RuntimeClass {
        ...
        private RuntimeClass(final Map<MethodKey, Method> methods, final Map<String, MethodHandle> getters, final Map<String, MethodHandle> setters) {
...
<<<<<<< commits-rmx_100/elasticsearch/elasticsearch/ce9b36590aa884c9bcabe183a974175d41901314/Definition-9e665e8.java
final private Map<Cast, Cast> transformsMap;
=======

>>>>>>> commits-rmx_100/elasticsearch/elasticsearch/4e454439bb3d9b9a4e949dfed98736303a584e65/Definition-f20393f.java


    final private Map<Class<?>, RuntimeClass> runtimeMap;

    final private Map<String, Struct> structsMap;

    final private Map<String, Type> simpleTypesMap;
...
>>>>>>> commits-rmx_100/elasticsearch/elasticsearch/4e454439bb3d9b9a4e949dfed98736303a584e65/Definition-f20393f.java
    ...
    final private void addStruct(final String name, final Class<?> clazz) {
    ...
    final private void addConstructorInternal(final String struct, final String name, final Type[] args) {
    ...
    final private void addSignature(String className, String signature) {
    ...
    final private void addMethodInternal(final String struct, final String name, final String alias, final Type rtn, final Type[] args) {
        final Struct owner = structsMap.get(struct);
        if (owner == null) {
    ...
    final private void addFieldInternal(final String struct, final String name, final String alias, final Type type) {
        final Struct owner = structsMap.get(struct);
        if (owner == null) {
    ...
    final private void copyStruct(final String struct, List<String> children) {
        final Struct owner = structsMap.get(struct);
        if (owner == null) {
        ...
        for (int count = 0; count < children.size(); ++count) {
            ...
            for (final Field field : child.members.values()) {
                if (owner.members.get(field.name) == null) {
                    ...
                    owner.members.put(field.name, new Field(field.name, owner, field.type, reflect, getter, setter));
                }
            }
        }
    }
...
<<<<<<< commits-rmx_100/elasticsearch/elasticsearch/ce9b36590aa884c9bcabe183a974175d41901314/Definition-9e665e8.java
final private void addTransform(final Type from, final Type to, final String struct, final String name, final boolean statik, final boolean explicit) {
        final Struct owner = structsMap.get(struct);
        if (owner == null) {
...
>>>>>>> commits-rmx_100/elasticsearch/elasticsearch/4e454439bb3d9b9a4e949dfed98736303a584e65/Definition-f20393f.java
    ...
    static public Type getType(final String name) {
        return INSTANCE.getTypeInternal(name);
    }

    static public Type getType(final Struct struct, final int dimensions) {
        return INSTANCE.getTypeInternal(struct, dimensions);
    }

    static final private Definition INSTANCE = new Definition();

    static public final Type UTILITY_TYPE = getType("Utility");

    static public final Type EXCEPTION_TYPE = getType("Exception");

    static public final Type STRING_TYPE = getType("String");

    static public final Type DEF_UTIL_TYPE = getType("Def");

    static final private String DEFINITION_FILE = "definition.txt";

    static public final Type DEF_TYPE = getType("def");

    static public final Type OBJECT_TYPE = getType("Object");

    static public final Type CHAR_OBJ_TYPE = getType("Character");

    static public final Type CHAR_TYPE = getType("char");

    static public final Type DOUBLE_OBJ_TYPE = getType("Double");

    static public final Type DOUBLE_TYPE = getType("double");

    static public final Type FLOAT_OBJ_TYPE = getType("Float");

    static public final Type FLOAT_TYPE = getType("float");

    static public final Type LONG_OBJ_TYPE = getType("Long");

    static public final Type LONG_TYPE = getType("long");

    static public final Type INT_OBJ_TYPE = getType("Integer");

    static public final Type INT_TYPE = getType("int");

    static public final Type SHORT_OBJ_TYPE = getType("Short");

    static public final Type SHORT_TYPE = getType("short");

    static public final Type BYTE_OBJ_TYPE = getType("Byte");

    static public final Type BYTE_TYPE = getType("byte");

    static public final Type BOOLEAN_OBJ_TYPE = getType("Boolean");

    static public final Type BOOLEAN_TYPE = getType("boolean");

    static public final Type VOID_TYPE = getType("void");

    static public RuntimeClass getRuntimeClass(Class<?> clazz) {
        return INSTANCE.runtimeMap.get(clazz);
    }

    static public Cast getTransform(Cast cast) {
