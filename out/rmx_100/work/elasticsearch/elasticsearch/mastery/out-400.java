...
public class ParentFieldMapper extends AbstractFieldMapper implements RootMapper {
    ...
    final private BytesRef typeAsBytes;

    
<<<<<<< commits-rmx_100/elasticsearch/elasticsearch/1f2c42fd0be06e7a7ab9cf2c5e70d82988a11856/ParentFieldMapper-ea79136.java
...
protected ParentFieldMapper(String name, String indexName, String type, @Nullable Settings fieldDataSettings, Settings indexSettings) {
        super(new Names(name, indexName, indexName, name), Defaults.BOOST, new FieldType(Defaults.FIELD_TYPE), Version.indexCreated(indexSettings).onOrAfter(Version.V_2_0_0), Lucene.KEYWORD_ANALYZER, Lucene.KEYWORD_ANALYZER, null, null, fieldDataSettings, indexSettings);
        this.type = type;
        this.typeAsBytes = type == null ? null : new BytesRef(type);
    }
>>>>>>> commits-rmx_100/elasticsearch/elasticsearch/59d9f7e1579ca70973d14e94da0b8794e60f3b85/ParentFieldMapper-70109a0.java
