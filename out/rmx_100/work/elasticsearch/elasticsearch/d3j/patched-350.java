...
<<<<<<< /root/work/elasticsearch/elasticsearch/d3j/patched-350-0.java
    BytesRef type = null;
...
||||||| /root/work/elasticsearch/elasticsearch/d3j/base-350.java
...
=======
    ...
    if (!fieldName.equals("value")) {
      throw new ParsingException(
          parseContext,
          "[type] filter should have a value field, and the type name");
>>>>>>> /root/work/elasticsearch/elasticsearch/d3j/patched-350-1.java
    }
    if (type == null) {
      throw new ParsingException(
          parseContext,
