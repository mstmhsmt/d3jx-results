...
public class NodeService extends AbstractComponent implements Closeable {
  ...
  public NodeService(Settings settings, ThreadPool threadPool,
    ...
    this.ingestService =
        new IngestService(settings, threadPool, processorsRegistryBuilder);
  ...
  public void setScriptService(ScriptService scriptService) {
    ...
    this.ingestService.buildProcessorsFactoryRegistry(scriptService,
                                                      clusterService);
  }
  ...
  public Map<String, String> attributes() { return this.serviceAttributes; }
  public NodeInfo info() {
    return new NodeInfo(
        Version.CURRENT, Build.CURRENT, discovery.localNode(),
        serviceAttributes, settings, monitorService.osService().info(),
  ...
  public NodeStats stats() throws IOException {
    return new NodeStats(
        ...
        circuitBreakerService.stats(), scriptService.stats(), discovery.stats(),
