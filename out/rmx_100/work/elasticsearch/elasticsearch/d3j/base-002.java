...
public class S3BlobStoreContainerTests extends ESTestCase {
  ...
  public void testExecuteSingleUpload() throws IOException {
    ...
    final ArgumentCaptor<PutObjectRequest> argumentCaptor =
        ArgumentCaptor.forClass(PutObjectRequest.class);
    when(client.putObject(argumentCaptor.capture()))
    ...
    if (serverSideEncryption) {
      assertEquals(ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION,
                   request.getMetadata().getSSEAlgorithm());
    }
  }
  ...
  public void testExecuteMultipartUploadAborted() {
    ...
    if (stage == 0) {
      when(client.initiateMultipartUpload(
    ...
    assertEquals("Unable to upload object [" + blobName +
  ...
  public void testInitCannedACL() {
    String[] aclList = new String[] {"private",
                                     "public-read",
                                     "public-read-write",
                                     "authenticated-read",
                                     "log-delivery-write",
    ...
    assertThat(S3BlobStore.initCannedACL(null),
               equalTo(CannedAccessControlList.Private));
    assertThat(S3BlobStore.initCannedACL(""),
               equalTo(CannedAccessControlList.Private));
    ...
    for (CannedAccessControlList awsList : CannedAccessControlList.values()) {
      CannedAccessControlList acl =
          S3BlobStore.initCannedACL(awsList.toString());
  ...
  public void testInvalidStorageClass() {
    ...
    assertThat(ex.getMessage(),
               equalTo("`whatever` is not a valid S3 Storage Class."));
  }
