...
public class OperationRouting {
     ...
     */
    public ShardIterator getShards(ProjectState projectState, String index, String id, @Nullable
    String routing, @Nullable
    String preference) {
    ...
    public ShardIterator getShards(ProjectState projectState, String index, int shardId, @Nullable
    String preference) {
    ...
    public List<ShardIterator> searchShards(ProjectState projectState, String[] concreteIndices, @Nullable
    Map<String, Set<String>> routing, @Nullable
    String preference) {
    ...
    public List<ShardIterator> searchShards(ProjectState projectState, String[] concreteIndices, @Nullable
    Map<String, Set<String>> routing, @Nullable
    String preference, @Nullable
    ResponseCollectorService collectorService, @Nullable
    ...
    private static Set<IndexShardRoutingTable> computeTargetedShards(ProjectState projectState, String[] concreteIndices, @Nullable
    ...
    public static ShardId shardId(ProjectMetadata projectMetadata, String index, String id, @Nullable
    String routing) {
