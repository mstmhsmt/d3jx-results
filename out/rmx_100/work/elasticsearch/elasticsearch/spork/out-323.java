...
public class GeohashCellQuery {
     ...
     */
    public static Query create(QueryShardContext context, GeoPointFieldMapper.GeoPointFieldType fieldType, String geohash, @Nullable
...
ParsingException
>>>>>>> RIGHT
                (context, "failed to parse [{}] query. missing [{}] field [{}]", NAME, GeoPointFieldMapper.CONTENT_TYPE, fieldName);
            }
...
ParsingException
>>>>>>> RIGHT
                (context, "failed to parse [{}] query. field [{}] is not a geo_point field", NAME, fieldName);
            }
...
ParsingException
>>>>>>> RIGHT
                (context, "failed to parse [{}] query. [geohash_prefix] is not enabled for field [{}]", NAME, fieldName);
            }
            if (levels != null) {
