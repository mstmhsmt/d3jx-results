...
public class MySqlStatementParser extends SQLStatementParser {
  ...
  public SQLUpdateStatement parseUpdateStatement() throws ParserException {
    MySqlUpdateStatement stmt =
        (MySqlUpdateStatement)super.parseUpdateStatement();
  ...
  public MySqlDeleteStatement parseDeleteStatement() throws ParserException {
    ...
    if (lexer.token() == Token.DELETE) {
      ...
      if (lexer.token() == Token.IDENTIFIER) {
        deleteStatement.setTableSource(
  ...
  public SQLStatement parseCreateUser() throws ParserException {
    ...
    for (;;) {
      MySqlCreateUserStatement.UserSpecification userSpec =
          new MySqlCreateUserStatement.UserSpecification();
  ...
  public SQLStatement parseShow() throws ParserException {
    ...
    if (identifierEquals("COUNT")) {
      ...
      accept(Token.STAR);
      accept(Token.RPAREN);
<<<<<<< /root/work/alibaba/druid/d3j/patched-002-0.java
    ...
    if (identifierEquals("ERRORS")) {
      ...
      MySqlShowErrorsStatement stmt = new MySqlShowErrorsStatement();
      stmt.setLimit(parseLimit());
||||||| /root/work/alibaba/druid/d3j/base-002.java
      acceptIdentifier("WARNINGS");
      MySqlShowWarningsStatement stmt = new MySqlShowWarningsStatement();
      stmt.setCount(true);
=======
...
>>>>>>> /root/work/alibaba/druid/d3j/patched-002-1.java
      return stmt;
    }
    ...
    if (identifierEquals("CHARACTER")) {
      lexer.nextToken();
      accept(Token.SET);
      MySqlShowCharacterSetStatement stmt =
          new MySqlShowCharacterSetStatement();
    ...
    if (identifierEquals("BINLOG")) {
      ...
      MySqlShowBinLogEventsStatement stmt =
          new MySqlShowBinLogEventsStatement();
    ...
    if (lexer.token() == Token.CREATE) {
      ...
      if (identifierEquals("DATABASE")) {
        lexer.nextToken();
        MySqlShowCreateDatabaseStatement stmt =
            new MySqlShowCreateDatabaseStatement();
        stmt.setDatabase(this.exprParser.name());
        return stmt;
      }
      if (identifierEquals("EVENT")) {
        lexer.nextToken();
        MySqlShowCreateEventStatement stmt =
      ...
      if (identifierEquals("FUNCTION")) {
        lexer.nextToken();
        MySqlShowCreateFunctionStatement stmt =
            new MySqlShowCreateFunctionStatement();
        stmt.setName(this.exprParser.name());
        return stmt;
      }
      if (identifierEquals("PROCEDURE")) {
        lexer.nextToken();
        MySqlShowCreateProcedureStatement stmt =
            new MySqlShowCreateProcedureStatement();
        stmt.setName(this.exprParser.name());
        return stmt;
      }
      if (lexer.token() == Token.TABLE) {
        lexer.nextToken();
        MySqlShowCreateTableStatement stmt =
            new MySqlShowCreateTableStatement();
        stmt.setName(this.exprParser.name());
        return stmt;
      }
      ...
      if (identifierEquals("TRIGGER")) {
        lexer.nextToken();
        MySqlShowCreateTriggerStatement stmt =
            new MySqlShowCreateTriggerStatement();
        stmt.setName(this.exprParser.name());
        return stmt;
      }
    ...
    if (identifierEquals("ENGINE")) {
      ...
      stmt.setName(this.exprParser.name());
      stmt.setOption(MySqlShowEngineStatement.Option.valueOf(
          lexer.stringVal().toUpperCase()));
      lexer.nextToken();
      return stmt;
    }
    ...
    if (identifierEquals("FUNCTION")) {
      ...
      if (identifierEquals("CODE")) {
        lexer.nextToken();
        MySqlShowFunctionCodeStatement stmt =
            new MySqlShowFunctionCodeStatement();
        stmt.setName(this.exprParser.name());
        return stmt;
      }
      acceptIdentifier("STATUS");
      MySqlShowFunctionStatusStatement stmt =
          new MySqlShowFunctionStatusStatement();
      if (lexer.token() == Token.LIKE) {
        lexer.nextToken();
        stmt.setLike(this.exprParser.expr());
      }
    ...
    if (lexer.token() == Token.VALUES || identifierEquals("VALUE")) {
      ...
      for (;;) {
        ...
        SQLInsertStatement.ValuesClause values =
            new SQLInsertStatement.ValuesClause();
  ...
  public SQLStatement parseSet() throws ParserException {
    ...
    if (identifierEquals("TRANSACTION")) {
      ...
      MySqlSetTransactionIsolationLevelStatement stmt =
          new MySqlSetTransactionIsolationLevelStatement();
      ...
      if (identifierEquals("READ")) {
        ...
        if (identifierEquals("UNCOMMITTED")) {
          ...
          throw new ParserException("UNKOWN TRANSACTION LEVEL : " +
                                    lexer.stringVal());
        }
      ...
      if (global != null && global.booleanValue()) {
        SQLVariantRefExpr varRef =
            (SQLVariantRefExpr)stmt.getItems().get(0).getTarget();
