...
<<<<<<< commits-rmx_100/alibaba/druid/ed2e06ef672b0f2a7bef940c0f7ae3011ee63a88/MySqlStatementParser-e32af84.java
      stmt.setLimit(parseLimit());
=======
...
>>>>>>> commits-rmx_100/alibaba/druid/836d8946f8a35f048404aea027653b78ae83f466/MySqlStatementParser-575f67d.java
  ...
  public SQLStatement parseSet() throws ParserException {
    ...
    if (identifierEquals("TRANSACTION")) {
      ...
      if (identifierEquals("READ")) {
        ...
        if (identifierEquals("SERIALIZABLE")) {
          stmt.setLevel("SERIALIZABLE");
          lexer.nextToken();
        } else {
          if (identifierEquals("REPEATABLE")) {
            lexer.nextToken();
            if (identifierEquals("READ")) {
