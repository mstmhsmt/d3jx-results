...
class CardViewApi21 implements CardViewImpl
{
   ...
   void updatePadding(CardViewDelegate cardView) {
     ...
     int hPadding =
       (int)Math.ceil(RoundRectDrawableWithShadow.calculateHorizontalPadding(elevation,
                        radius, cardView.getPreventCornerOverlap()));
     int vPadding =
       (int)Math.ceil(RoundRectDrawableWithShadow.calculateVerticalPadding(elevation,
                        radius, cardView.getPreventCornerOverlap()));
   ...
   @Override
   public
   void setBackgroundColor(CardViewDelegate cardView, 
