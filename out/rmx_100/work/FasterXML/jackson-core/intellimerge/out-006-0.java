    ...
    extends JsonParserBase
{
    ...
    @Override
    public int releaseBuffered(OutputStream out) throws JacksonException throws JacksonException
    {
    ...
    protected final boolean _loadMore() throws JacksonException throws JacksonException
    {
    ...
    @Override
    public String getText() throws JacksonException throws JacksonException
    {
    ...
    @Override
    public int getText(Writer writer) throws JacksonException throws JacksonException
    {
        try {
    ...
    @Override
    public String getValueAsString() throws JacksonException throws JacksonException
    {
        if (_currToken == JsonToken.VALUE_STRING) {
            if (_tokenIncomplete) {
                _tokenIncomplete = false;
    ...
    @Override
    public String getValueAsString(String defValue) throws JacksonException throws JacksonException
    {
        if (_currToken == JsonToken.VALUE_STRING) {
            if (_tokenIncomplete) {
                _tokenIncomplete = false;
    ...
    // since 2.6
    @Override
    public int getValueAsInt() throws JacksonException throws JacksonException
    {
        JsonToken t = _currToken;
    ...
    // since 2.6
    @Override
    public int getValueAsInt(int defValue) throws JacksonException throws JacksonException
    {
        JsonToken t = _currToken;
        if ((t == JsonToken.VALUE_NUMBER_INT) || (t == JsonToken.VALUE_NUMBER_FLOAT)) {
            // inlined 'getIntValue()'
    ...
    @Override
    public char[] getTextCharacters() throws JacksonException throws JacksonException
    {
    ...
    @Override
    public int getTextLength() throws JacksonException throws JacksonException
    {
        if (_currToken != null) { // null only before/after document
            switch (_currToken.id()) {
    ...
    @Override
    public int getTextOffset() throws JacksonException throws JacksonException
    {
    ...
    @Override
    public byte[] getBinaryValue(Base64Variant b64variant) throws JacksonException throws JacksonException
    {
        if (_currToken != JsonToken.VALUE_STRING &&
    ...
    @Override
    public int readBinaryValue(Base64Variant b64variant, OutputStream out) throws JacksonException throws JacksonException
    {
    ...
    protected int _readBinary(Base64Variant b64variant, OutputStream out,
            byte[] buffer) throws IOException throws IOException
    {
        int outputPtr = 0;
     ...
     */
    @Override
    public JsonToken nextToken() throws JacksonException throws JacksonException
    {
    ...
    private final JsonToken _nextTokenNotInObject(int i) throws JacksonException throws JacksonException
    {
        if (i == INT_QUOTE) {
            _tokenIncomplete = true;
    ...
    @Override
    public void finishToken() throws JacksonException throws JacksonException {
        if (_tokenIncomplete) {
            _tokenIncomplete = false;
            _finishString(); // only strings can be incomplete
        }
    ...
    @Override
    public boolean nextName(SerializableString str) throws JacksonException throws JacksonException
    {
    ...
    @Override
    public int nextNameMatch(PropertyNameMatcher matcher) throws JacksonException throws JacksonException
    {
    ...
    @Override
    public String nextName() throws JacksonException throws JacksonException
    {
        // // // Note: this is almost a verbatim copy of nextToken()
    ...
    private final int _skipColonFast(int ptr) throws JacksonException throws JacksonException
    {
    ...
    private final void _isNextTokenNameYes(int i) throws JacksonException throws JacksonException
    {
        _currToken = JsonToken.PROPERTY_NAME;
        _updateLocation();
    ...
    private final boolean _isNextTokenNameMaybe(int i, SerializableString str) throws JacksonException throws JacksonException
    {
    ...
    protected final int _matchName(PropertyNameMatcher matcher, int i) throws JacksonException throws JacksonException
    {
        if (i != INT_QUOTE) {
            return -1;
        }
    ...
    protected final int _matchMediumName(PropertyNameMatcher matcher, int qptr, int q2) throws JacksonException throws JacksonException
    {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
    ...
    protected final int _matchMediumName2(PropertyNameMatcher matcher, int qptr,
            int q3, final int q2) throws JacksonException throws JacksonException
    {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
    ...
    protected final int _matchLongName(PropertyNameMatcher matcher, int qptr,
            int q) throws JacksonException throws JacksonException
    {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
        int qlen = 3;
    ...
    */
    ...
    @Override
    public String nextTextValue() throws JacksonException throws JacksonException
    {
    ...
    @Override
    public int nextIntValue(int defaultValue) throws JacksonException throws JacksonException
    {
        // two distinct cases; either got name and we know next type, or 'other'
        if (_currToken == JsonToken.PROPERTY_NAME) { // mostly copied from '_nextAfterName'
            _nameCopied = false;
    ...
    @Override
    public long nextLongValue(long defaultValue) throws JacksonException throws JacksonException
    {
        // two distinct cases; either got name and we know next type, or 'other'
        if (_currToken == JsonToken.PROPERTY_NAME) { // mostly copied from '_nextAfterName'
            _nameCopied = false;
    ...
    @Override
    public Boolean nextBooleanValue() throws JacksonException throws JacksonException
    {
        // two distinct cases; either got name and we know next type, or 'other'
        if (_currToken == JsonToken.PROPERTY_NAME) { // mostly copied from '_nextAfterName'
            _nameCopied = false;
    ...
    protected final JsonToken _parseFloatThatStartsWithPeriod() throws JacksonException throws JacksonException
    {
     ...
     */
    protected JsonToken _parsePosNumber(int c) throws JacksonException throws JacksonException
    {
    ...
    private final JsonToken _parseNumber2(char[] outBuf, int outPtr, boolean negative,
            int intPartLength) throws JacksonException throws JacksonException
    {
        // Ok, parse the rest
        while (true) {
    ...
    private final int _verifyNoLeadingZeroes() throws JacksonException throws JacksonException
    {
        // Ok to have plain "0"
        if (_inputPtr >= _inputEnd && !_loadMore()) {
            return INT_0;
    ...
    private final JsonToken _parseFloat(char[] outBuf, int outPtr, int c,
            boolean negative, int integerPartLength) throws JacksonException throws JacksonException
    {
        int fractLen = 0;
        boolean eof = false;
     ...
     */
    private final void _verifyRootSpace(int ch) throws JacksonException throws JacksonException
    {
    ...
    protected final String _parseName(int i) throws JacksonException throws JacksonException
    {
        if (i != INT_QUOTE) {
    ...
    protected final String parseMediumName(int q2) throws JacksonException throws JacksonException
    {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
    ...
    protected final String parseMediumName2(int q3, final int q2) throws JacksonException throws JacksonException
    {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
    ...
    protected final String parseLongName(int q, final int q2, int q3) throws JacksonException throws JacksonException
    {
        _quadBuffer[0] = _quad1;
        _quadBuffer[1] = q2;
        _quadBuffer[2] = q3;
    ...
    protected String slowParseName() throws JacksonException throws JacksonException
    {
        if (_inputPtr >= _inputEnd) {
            if (!_loadMore()) {
    ...
    private final String parseName(int q1, int ch, int lastQuadBytes) throws JacksonException throws JacksonException {
        return parseEscapedName(_quadBuffer, 0, q1, ch, lastQuadBytes);
    }
    
    private final String parseName(int q1, int q2, int ch, int lastQuadBytes) throws JacksonException throws JacksonException {
        _quadBuffer[0] = q1;
        return parseEscapedName(_quadBuffer, 1, q2, ch, lastQuadBytes);
    }
    
    private final String parseName(int q1, int q2, int q3, int ch, int lastQuadBytes) throws JacksonException throws JacksonException {
        _quadBuffer[0] = q1;
        _quadBuffer[1] = q2;
    ...
    protected final String parseEscapedName(int[] quads, int qlen, int currQuad, int ch,
            int currQuadBytes) throws JacksonException throws JacksonException
    {
     ...
     */
    protected String _handleOddName(int ch) throws JacksonException throws JacksonException
    {
    ...
    protected String _parseAposName() throws JacksonException throws JacksonException
    {
        if (_inputPtr >= _inputEnd) {
            if (!_loadMore()) {
    ...
    private final String findName(int q1, int lastQuadBytes) throws StreamReadException throws StreamReadException
    {
    ...
    private final String findName(int q1, int q2, int lastQuadBytes) throws StreamReadException throws StreamReadException
    {
    ...
    private final String findName(int q1, int q2, int q3, int lastQuadBytes) throws StreamReadException throws StreamReadException
    {
    ...
    protected void _loadMoreGuaranteed() throws JacksonException throws JacksonException {
        if (!_loadMore()) { _reportInvalidEOF(); }
    }
    
    @Override
    protected void _finishString() throws JacksonException throws JacksonException
    {
    ...
    protected String _finishAndReturnString() throws JacksonException throws JacksonException
    {
        // First, single tight loop for ASCII content, not split across input buffer boundary:        
        int ptr = _inputPtr;
        if (ptr >= _inputEnd) {
     ...
     */
    protected void _skipString() throws JacksonException throws JacksonException
    {
        _tokenIncomplete = false;
     ...
     * @throws StreamReadException for decoding problems
     */
    protected JsonToken _handleUnexpectedValue(int c) throws JacksonException throws JacksonException
    {
    ...
    protected JsonToken _handleApos() throws JacksonException throws JacksonException
    {
        int c = 0;
    ...
    protected JsonToken _handleInvalidNumberStart(int ch, final boolean neg, final boolean hasSign) throws IOException throws IOException
    {
        while (ch == 'I') {
            if (_inputPtr >= _inputEnd) {
                if (!_loadMore()) {
    ...
    protected final void _matchTrue() throws JacksonException throws JacksonException
    {
        int ptr = _inputPtr;
        if ((ptr + 3) < _inputEnd) {
            byte[] buf = _inputBuffer;
    ...
    protected final void _matchFalse() throws JacksonException throws JacksonException
    {
        int ptr = _inputPtr;
        if ((ptr + 4) < _inputEnd) {
            byte[] buf = _inputBuffer;
    ...
    protected final void _matchNull() throws JacksonException throws JacksonException
    {
        int ptr = _inputPtr;
        if ((ptr + 3) < _inputEnd) {
            byte[] buf = _inputBuffer;
    ...
    protected final void _matchToken(String matchStr, int i) throws JacksonException throws JacksonException
    {
    ...
    private final void _matchToken2(String matchStr, int i) throws JacksonException throws JacksonException
    {
        final int len = matchStr.length();
        do {
            if (((_inputPtr >= _inputEnd) && !_loadMore())
    ...
    private final void _checkMatchEnd(String matchStr, int i, int ch) throws JacksonException throws JacksonException {
    ...
    private final int _skipWS() throws JacksonException throws JacksonException
    {
    ...
    private final int _skipWS2() throws JacksonException throws JacksonException
    {
        while (_inputPtr < _inputEnd || _loadMore()) {
            int i = _inputBuffer[_inputPtr++] & 0xFF;
            if (i > INT_SPACE) {
    ...
    private final int _skipWSOrEnd() throws JacksonException throws JacksonException
    {
    ...
    private final int _skipWSOrEnd2() throws JacksonException throws JacksonException
    {
        while ((_inputPtr < _inputEnd) || _loadMore()) {
            int i = _inputBuffer[_inputPtr++] & 0xFF;
            if (i > INT_SPACE) {
    ...
    private final int _skipColon() throws JacksonException throws JacksonException
    {
    ...
    private final int _skipColon2(boolean gotColon) throws JacksonException throws JacksonException
    {
        while (_inputPtr < _inputEnd || _loadMore()) {
            int i = _inputBuffer[_inputPtr++] & 0xFF;
    ...
    private final void _skipComment() throws JacksonException throws JacksonException
    {
    ...
    private final void _skipCComment() throws JacksonException throws JacksonException
    {
    ...
    private final boolean _skipYAMLComment() throws JacksonException throws JacksonException
    {
    ...
    private final void _skipLine() throws JacksonException throws JacksonException
    {
    ...
    @Override
    protected char _decodeEscaped() throws JacksonException throws JacksonException
    {
        if (_inputPtr >= _inputEnd) {
            if (!_loadMore()) {
    ...
    protected int _decodeCharForError(int firstByte) throws JacksonException throws JacksonException
    {
    ...
    private final int _decodeUtf8_2(int c) throws JacksonException throws JacksonException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    private final int _decodeUtf8_3(int c1) throws JacksonException throws JacksonException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    private final int _decodeUtf8_3fast(int c1) throws JacksonException throws JacksonException
    {
        c1 &= 0x0F;
        int d = (int) _inputBuffer[_inputPtr++];
        if ((d & 0xC0) != 0x080) {
    ...
    private final int _decodeUtf8_4(int c) throws JacksonException throws JacksonException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    private final void _skipUtf8_2() throws JacksonException throws JacksonException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
     ...
     * do validity checks...
     */
    private final void _skipUtf8_3() throws JacksonException throws JacksonException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    private final void _skipUtf8_4(int c) throws JacksonException throws JacksonException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    // (to see if we have \n following \r).
    protected final void _skipCR() throws JacksonException throws JacksonException
    {
        if (_inputPtr < _inputEnd || _loadMore()) {
    ...
    private int nextByte() throws JacksonException throws JacksonException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    protected void _reportInvalidToken(String matchedPart, int ptr) throws JacksonException throws JacksonException {
        _inputPtr = ptr;
        _reportInvalidToken(matchedPart, _validJsonTokenList());
    }
    
    protected void _reportInvalidToken(String matchedPart) throws JacksonException throws JacksonException {
        _reportInvalidToken(matchedPart, _validJsonTokenList());
    }
    
    protected void _reportInvalidToken(String matchedPart, String msg) throws JacksonException throws JacksonException
    {
    ...
    protected void _reportInvalidChar(int c) throws StreamReadException throws StreamReadException
    {
    ...
    protected void _reportInvalidInitial(int mask) throws StreamReadException throws StreamReadException {
        _reportError("Invalid UTF-8 start byte 0x"+Integer.toHexString(mask));
    }
    
    protected void _reportInvalidOther(int mask) throws StreamReadException throws StreamReadException {
        _reportError("Invalid UTF-8 middle byte 0x"+Integer.toHexString(mask));
    }
    
    protected void _reportInvalidOther(int mask, int ptr) throws StreamReadException throws StreamReadException
    {
        _inputPtr = ptr;
     ...
     */
    @SuppressWarnings("resource")
    protected final byte[] _decodeBase64(Base64Variant b64variant) throws JacksonException throws JacksonException
    {
        ByteArrayBuilder builder = _getByteArrayBuilder();
    ...
    private final JsonToken _closeScope(int i) throws StreamReadException throws StreamReadException {
        if (i == INT_RCURLY) {
            _closeObjectScope();
            return (_currToken = JsonToken.END_OBJECT);
        }
    ...
    private final void _closeArrayScope() throws StreamReadException throws StreamReadException {
        _updateLocation();
        if (!_streamReadContext.inArray()) {
    ...
    private final void _closeObjectScope() throws StreamReadException throws StreamReadException {
        _updateLocation();
        if (!_streamReadContext.inObject()) {
            _reportMismatchedEndMarker('}', ']');
        }
