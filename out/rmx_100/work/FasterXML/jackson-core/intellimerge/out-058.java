...
>>>>>>> theirs
    ...
    @Override
    public int releaseBuffered(OutputStream out) throws IOException throws IOException
    {
    ...
    protected final boolean _loadMore() throws IOException throws IOException
    {
    ...
    @Override
    protected void _closeInput() throws IOException throws IOException
    {
     ...
     */
    @Override
    protected void _releaseBuffers() throws IOException throws IOException
    {
    ...
    @Override
    public String getText() throws IOException throws IOException
    {
    ...
    @Override
    public int getText(Writer writer) throws IOException throws IOException
    {
    ...
    @Override
    public String getValueAsString() throws IOException throws IOException
    {
        if (_currToken == JsonToken.VALUE_STRING) {
            if (_tokenIncomplete) {
                _tokenIncomplete = false;
    ...
    @Override
    public String getValueAsString(String defValue) throws IOException throws IOException
    {
        if (_currToken == JsonToken.VALUE_STRING) {
            if (_tokenIncomplete) {
                _tokenIncomplete = false;
    ...
    // since 2.6
    @Override
    public int getValueAsInt() throws IOException throws IOException
    {
        JsonToken t = _currToken;
    ...
    // since 2.6
    @Override
    public int getValueAsInt(int defValue) throws IOException throws IOException
    {
        JsonToken t = _currToken;
        if ((t == JsonToken.VALUE_NUMBER_INT) || (t == JsonToken.VALUE_NUMBER_FLOAT)) {
            // inlined 'getIntValue()'
    ...
    @Override
    public char[] getTextCharacters() throws IOException throws IOException
    {
    ...
    @Override
    public int getTextLength() throws IOException throws IOException
    {
        if (_currToken != null) { // null only before/after document
            switch (_currToken.id()) {
    ...
    @Override
    public int getTextOffset() throws IOException throws IOException
    {
    ...
    @Override
    public byte[] getBinaryValue(Base64Variant b64variant) throws IOException throws IOException
    {
        if (_currToken != JsonToken.VALUE_STRING &&
    ...
    @Override
    public int readBinaryValue(Base64Variant b64variant, OutputStream out) throws IOException throws IOException
    {
     ...
     */
    @Override
    public JsonToken nextToken() throws IOException throws IOException
    {
    ...
    private final JsonToken _nextTokenNotInObject(int i) throws IOException throws IOException
    {
        if (i == INT_QUOTE) {
            _tokenIncomplete = true;
    ...
    @Override
    public void finishToken() throws IOException throws IOException {
        if (_tokenIncomplete) {
            _tokenIncomplete = false;
            _finishString(); // only strings can be incomplete
        }
    ...
    @Override
    public boolean nextFieldName(SerializableString str) throws IOException throws IOException
    {
    ...
    @Override
    public int nextFieldName(FieldNameMatcher matcher) throws IOException throws IOException
    {
    ...
    @Override
    public String nextFieldName() throws IOException throws IOException
    {
        // // // Note: this is almost a verbatim copy of nextToken()
    ...
    private final int _skipColonFast(int ptr) throws IOException throws IOException
    {
    ...
    private final void _isNextTokenNameYes(int i) throws IOException throws IOException
    {
        _currToken = JsonToken.FIELD_NAME;
        _updateLocation();
    ...
    private final boolean _isNextTokenNameMaybe(int i, SerializableString str) throws IOException throws IOException
    {
    ...
    protected final int _matchName(FieldNameMatcher matcher, int i) throws IOException throws IOException
    {
        if (i != INT_QUOTE) {
            return -1;
        }
    ...
    protected final int _matchMediumName(FieldNameMatcher matcher, int qptr, int q2) throws IOException throws IOException
    {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
    ...
    protected final int _matchMediumName2(FieldNameMatcher matcher, int qptr,
            int q3, final int q2) throws IOException throws IOException
    {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
    ...
    protected final int _matchLongName(FieldNameMatcher matcher, int qptr,
            int q) throws IOException throws IOException
    {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
        int qlen = 3;
    ...
    */
    ...
    @Override
    public String nextTextValue() throws IOException throws IOException
    {
    ...
    @Override
    public int nextIntValue(int defaultValue) throws IOException throws IOException
    {
        // two distinct cases; either got name and we know next type, or 'other'
        if (_currToken == JsonToken.FIELD_NAME) { // mostly copied from '_nextAfterName'
            _nameCopied = false;
    ...
    @Override
    public long nextLongValue(long defaultValue) throws IOException throws IOException
    {
        // two distinct cases; either got name and we know next type, or 'other'
        if (_currToken == JsonToken.FIELD_NAME) { // mostly copied from '_nextAfterName'
            _nameCopied = false;
    ...
    @Override
    public Boolean nextBooleanValue() throws IOException throws IOException
    {
        // two distinct cases; either got name and we know next type, or 'other'
        if (_currToken == JsonToken.FIELD_NAME) { // mostly copied from '_nextAfterName'
            _nameCopied = false;
     ...
     * part of processing.
     */
    protected JsonToken _parsePosNumber(int c) throws IOException throws IOException
    {
    ...
    protected JsonToken _parseNegNumber() throws IOException throws IOException
    {
        char[] outBuf = _textBuffer.emptyAndGetCurrentSegment();
        int outPtr = 0;
    ...
    private final JsonToken _parseNumber2(char[] outBuf, int outPtr, boolean negative,
            int intPartLength) throws IOException throws IOException
    {
        // Ok, parse the rest
        while (true) {
     ...
     */
    private final int _verifyNoLeadingZeroes() throws IOException throws IOException
    {
        // Ok to have plain "0"
        if (_inputPtr >= _inputEnd && !_loadMore()) {
            return INT_0;
    ...
    private final JsonToken _parseFloat(char[] outBuf, int outPtr, int c,
            boolean negative, int integerPartLength) throws IOException throws IOException
    {
        int fractLen = 0;
        boolean eof = false;
     ...
     */
    private final void _verifyRootSpace(int ch) throws IOException throws IOException
    {
    ...
    protected final String _parseName(int i) throws IOException throws IOException
    {
        if (i != INT_QUOTE) {
    ...
    protected final String parseMediumName(int q2) throws IOException throws IOException
    {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
    ...
    protected final String parseMediumName2(int q3, final int q2) throws IOException throws IOException
    {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
    ...
    protected final String parseLongName(int q, final int q2, int q3) throws IOException throws IOException
    {
        _quadBuffer[0] = _quad1;
        _quadBuffer[1] = q2;
        _quadBuffer[2] = q3;
     ...
     */
    protected String slowParseName() throws IOException throws IOException
    {
        if (_inputPtr >= _inputEnd) {
            if (!_loadMore()) {
    ...
    private final String parseName(int q1, int ch, int lastQuadBytes) throws IOException throws IOException {
        return parseEscapedName(_quadBuffer, 0, q1, ch, lastQuadBytes);
    }
    
    private final String parseName(int q1, int q2, int ch, int lastQuadBytes) throws IOException throws IOException {
        _quadBuffer[0] = q1;
        return parseEscapedName(_quadBuffer, 1, q2, ch, lastQuadBytes);
    }
    
    private final String parseName(int q1, int q2, int q3, int ch, int lastQuadBytes) throws IOException throws IOException {
        _quadBuffer[0] = q1;
        _quadBuffer[1] = q2;
    ...
    protected final String parseEscapedName(int[] quads, int qlen, int currQuad, int ch,
            int currQuadBytes) throws IOException throws IOException
    {
     ...
     */
    protected String _handleOddName(int ch) throws IOException throws IOException
    {
     ...
     */
    protected String _parseAposName() throws IOException throws IOException
    {
        if (_inputPtr >= _inputEnd) {
            if (!_loadMore()) {
    ...
    private final String findName(int q1, int lastQuadBytes) throws JsonParseException throws JsonParseException
    {
    ...
    private final String findName(int q1, int q2, int lastQuadBytes) throws JsonParseException throws JsonParseException
    {
    ...
    private final String findName(int q1, int q2, int q3, int lastQuadBytes) throws JsonParseException throws JsonParseException
    {
    ...
    private final String findName(int[] quads, int qlen, int lastQuad, int lastQuadBytes) throws JsonParseException throws JsonParseException
    {
        if (qlen >= quads.length) {
            _quadBuffer = quads = growArrayBy(quads, quads.length);
        }
     ...
     */
    private final String addName(int[] quads, int qlen, int lastQuadBytes) throws JsonParseException throws JsonParseException
    {
    ...
    protected void _loadMoreGuaranteed() throws IOException throws IOException {
        if (!_loadMore()) { _reportInvalidEOF(); }
    }
    
    @Override
    protected void _finishString() throws IOException throws IOException
    {
    ...
    protected String _finishAndReturnString() throws IOException throws IOException
    {
        // First, single tight loop for ASCII content, not split across input buffer boundary:        
        int ptr = _inputPtr;
        if (ptr >= _inputEnd) {
     ...
     */
    protected void _skipString() throws IOException throws IOException
    {
        _tokenIncomplete = false;
     ...
     */
    protected JsonToken _handleUnexpectedValue(int c) throws IOException throws IOException
    {
    ...
    protected JsonToken _handleApos() throws IOException throws IOException
    {
        int c = 0;
     ...
     * look like a number
     */
    protected JsonToken _handleInvalidNumberStart(int ch, boolean neg) throws IOException throws IOException
    {
        while (ch == 'I') {
            if (_inputPtr >= _inputEnd) {
                if (!_loadMore()) {
    ...
    protected final void _matchTrue() throws IOException throws IOException
    {
        int ptr = _inputPtr;
        if ((ptr + 3) < _inputEnd) {
            byte[] buf = _inputBuffer;
    ...
    protected final void _matchFalse() throws IOException throws IOException
    {
        int ptr = _inputPtr;
        if ((ptr + 4) < _inputEnd) {
            byte[] buf = _inputBuffer;
    ...
    protected final void _matchNull() throws IOException throws IOException
    {
        int ptr = _inputPtr;
        if ((ptr + 3) < _inputEnd) {
            byte[] buf = _inputBuffer;
    ...
    protected final void _matchToken(String matchStr, int i) throws IOException throws IOException
    {
    ...
    private final void _matchToken2(String matchStr, int i) throws IOException throws IOException
    {
        final int len = matchStr.length();
        do {
            if (((_inputPtr >= _inputEnd) && !_loadMore())
    ...
    private final void _checkMatchEnd(String matchStr, int i, int ch) throws IOException throws IOException {
    ...
    private final int _skipWS() throws IOException throws IOException
    {
    ...
    private final int _skipWS2() throws IOException throws IOException
    {
        while (_inputPtr < _inputEnd || _loadMore()) {
            int i = _inputBuffer[_inputPtr++] & 0xFF;
            if (i > INT_SPACE) {
    ...
    private final int _skipWSOrEnd() throws IOException throws IOException
    {
    ...
    private final int _skipWSOrEnd2() throws IOException throws IOException
    {
        while ((_inputPtr < _inputEnd) || _loadMore()) {
            int i = _inputBuffer[_inputPtr++] & 0xFF;
            if (i > INT_SPACE) {
    ...
    private final int _skipColon() throws IOException throws IOException
    {
    ...
    private final int _skipColon2(boolean gotColon) throws IOException throws IOException
    {
        while (_inputPtr < _inputEnd || _loadMore()) {
            int i = _inputBuffer[_inputPtr++] & 0xFF;
    ...
    private final void _skipComment() throws IOException throws IOException
    {
    ...
    private final void _skipCComment() throws IOException throws IOException
    {
    ...
    private final boolean _skipYAMLComment() throws IOException throws IOException
    {
     ...
     */
    private final void _skipLine() throws IOException throws IOException
    {
    ...
    @Override
    protected char _decodeEscaped() throws IOException throws IOException
    {
        if (_inputPtr >= _inputEnd) {
            if (!_loadMore()) {
    ...
    protected int _decodeCharForError(int firstByte) throws IOException throws IOException
    {
    ...
    private final int _decodeUtf8_2(int c) throws IOException throws IOException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    private final int _decodeUtf8_3(int c1) throws IOException throws IOException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    private final int _decodeUtf8_3fast(int c1) throws IOException throws IOException
    {
        c1 &= 0x0F;
        int d = (int) _inputBuffer[_inputPtr++];
        if ((d & 0xC0) != 0x080) {
     ...
     */
    private final int _decodeUtf8_4(int c) throws IOException throws IOException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    private final void _skipUtf8_2() throws IOException throws IOException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
     ...
     * do validity checks...
     */
    private final void _skipUtf8_3() throws IOException throws IOException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    private final void _skipUtf8_4(int c) throws IOException throws IOException
    {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
     ...
     * (to see if we have \n following \r).
     */
    protected final void _skipCR() throws IOException throws IOException
    {
        if (_inputPtr < _inputEnd || _loadMore()) {
        ...
        private int nextByte() throws IOException throws IOException
            {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    protected void _reportInvalidToken(String matchedPart, int ptr) throws IOException throws IOException {
        _inputPtr = ptr;
        _reportInvalidToken(matchedPart, "'null', 'true', 'false' or NaN");
    }
    
    protected void _reportInvalidToken(String matchedPart) throws IOException throws IOException {
        _reportInvalidToken(matchedPart, "'null', 'true', 'false' or NaN");
    }
    
    protected void _reportInvalidToken(String matchedPart, String msg) throws IOException throws IOException
    {
    ...
    protected void _reportInvalidChar(int c) throws JsonParseException throws JsonParseException
    {
    ...
    protected void _reportInvalidInitial(int mask) throws JsonParseException throws JsonParseException {
        _reportError("Invalid UTF-8 start byte 0x"+Integer.toHexString(mask));
    }
    
    protected void _reportInvalidOther(int mask) throws JsonParseException throws JsonParseException {
     ...
     */
    @SuppressWarnings("resource")
    protected final byte[] _decodeBase64(Base64Variant b64variant) throws IOException throws IOException
    {
        ByteArrayBuilder builder = _getByteArrayBuilder();
    ...
    private final JsonToken _closeScope(int i) throws JsonParseException throws JsonParseException {
        if (i == INT_RCURLY) {
            _closeObjectScope();
            return (_currToken = JsonToken.END_OBJECT);
        }
    ...
    private final void _closeArrayScope() throws JsonParseException throws JsonParseException {
        _updateLocation();
        if (!_parsingContext.inArray()) {
    ...
    private final void _closeObjectScope() throws JsonParseException throws JsonParseException {
        _updateLocation();
        if (!_parsingContext.inObject()) {
            _reportMismatchedEndMarker('}', ']');
        }
