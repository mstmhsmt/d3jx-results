...
public final class JsonStringEncoder {
  ...
  outer:
    ...
    tight_loop:
      ...
      int length =
          (escCode < 0) ? _appendNumeric(d, qbuf) : _appendNamed(escCode, qbuf);
<<<<<<< /root/work/FasterXML/jackson-core/d3j/patched-052-0.java
||||||| /root/work/FasterXML/jackson-core/d3j/base-052.java
      ;
  ...
  outer:
    ...
    tight_loop:
      ...
      int length =
          (escCode < 0) ? _appendNumeric(d, qbuf) : _appendNamed(escCode, qbuf);
      ;
>>>>>>> /root/work/FasterXML/jackson-core/d3j/patched-052-1.java
      if ((outPtr + length) > outputBuffer.length) {
        int first = outputBuffer.length - outPtr;
        if (first > 0) {
          System.arraycopy(qbuf, 0, outputBuffer, outPtr, first);
  ...
  private static int _convert(int p1, int p2) {
    if (p2 < SURR2_FIRST || p2 > SURR2_LAST) {
      throw new IllegalArgumentException(
          "Broken surrogate pair: first char 0x" + Integer.toHexString(p1) +
