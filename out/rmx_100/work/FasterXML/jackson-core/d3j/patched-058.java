...
<<<<<<< /root/work/FasterXML/jackson-core/d3j/patched-058-0.java
...
||||||| /root/work/FasterXML/jackson-core/d3j/base-058.java
...
=======
  ...
  public UTF8StreamJsonParser(IOContext ctxt, int features, InputStream in,
                              ObjectCodec codec, ByteQuadsCanonicalizer sym,
>>>>>>> /root/work/FasterXML/jackson-core/d3j/patched-058-1.java
                              byte[] inputBuffer, int start, int end,
                              boolean bufferRecyclable) {
<<<<<<< /root/work/FasterXML/jackson-core/d3j/patched-058-0.java
    this(readCtxt, ctxt, stdFeatures, formatReadFeatures, in, sym, inputBuffer,
         start, end, 0, bufferRecyclable);
  }
  public UTF8StreamJsonParser(ObjectReadContext readCtxt, IOContext ctxt,
                              int stdFeatures, int formatReadFeatures,
                              InputStream in, ByteQuadsCanonicalizer sym,
...
||||||| /root/work/FasterXML/jackson-core/d3j/base-058.java
    super(ctxt, features);
=======
    this(ctxt, features, in, codec, sym, inputBuffer, start, end, 0,
         bufferRecyclable);
  }
  public UTF8StreamJsonParser(ObjectReadContext readCtxt, IOContext ctxt,
                              int stdFeatures, int formatReadFeatures,
...
>>>>>>> /root/work/FasterXML/jackson-core/d3j/patched-058-1.java
    ...
    if (_parsingContext.expectComma()) {
      if (i != INT_COMMA) {
        _reportUnexpectedChar(i, "was expecting comma to separate " +
                                     _parsingContext.typeDesc() + " entries");
      }
      i = _skipWS();
    ...
    if (_parsingContext.expectComma()) {
      ...
      if ((_formatReadFeatures & FEAT_MASK_TRAILING_COMMA) != 0) {
        ...
        if (isEndObject || (i == INT_RBRACKET)) {
          _closeScope(i);
          return isEndObject ? FieldNameMatcher.MATCH_END_OBJECT
                             : FieldNameMatcher.MATCH_ODD_TOKEN;
        }
      }
    }
    if (!_parsingContext.inObject()) {
  ...
  protected final int _matchName(FieldNameMatcher matcher, int i)
      throws IOException {
    if (i != INT_QUOTE) {
      return -1;
    }
  ...
  protected final int _matchMediumName(FieldNameMatcher matcher, int qptr,
  ...
  protected final int _matchLongName(FieldNameMatcher matcher, int qptr, int q)
      throws IOException {
    final byte[] input = _inputBuffer;
    final int[] codes = _icLatin1;
    int qlen = 3;
  ...
  private final String parseName(int q1, int q2, int q3, int ch,
                                 int lastQuadBytes) throws IOException {
    _quadBuffer[0] = q1;
    _quadBuffer[1] = q2;
  ...
  protected String _parseAposName() throws IOException {
    if (_inputPtr >= _inputEnd) {
      if (!_loadMore()) {
        _reportInvalidEOF(": was expecting closing '\'' for field name",
                          JsonToken.FIELD_NAME);
      }
    }
    int ch = _inputBuffer[_inputPtr++] & 0xFF;
  ...
  protected JsonToken _handleUnexpectedValue(int c) throws IOException {
    ...
    _reportUnexpectedChar(c, "expected a valid value (number, String, array, " +
  ...
  private final int _skipColon2(boolean gotColon) throws IOException {
    while (_inputPtr < _inputEnd || _loadMore()) {
      ...
      if (i > INT_SPACE) {
        ...
        if (i != INT_COLON) {
          _reportUnexpectedChar(
              i, "was expecting a colon to separate field name and value");
        }
        gotColon = true;
      } else if (i != INT_SPACE) {
        if (i == INT_LF) {
    ...
    _reportInvalidEOF(
        " within/between " + _parsingContext.typeDesc() + " entries", null);
    return -1;
  }
  ...
  public JsonLocation getTokenLocation() {
    if (_currToken == JsonToken.FIELD_NAME) {
      ...
      return new JsonLocation(_getSourceReference(), total, -1L, _nameStartRow,
                              _nameStartCol);
    }
    return new JsonLocation(_getSourceReference(), _tokenInputTotal - 1, -1L,
                            _tokenInputRow, _tokenInputCol);
  }
  @Override
