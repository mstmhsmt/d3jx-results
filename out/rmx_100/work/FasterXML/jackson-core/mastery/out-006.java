...
public class UTF8StreamJsonParser extends JsonParserBase {
    ...
    final static private int[] _icUTF8 = CharTypes.getInputCodeUtf8();

    final static protected int[] _icLatin1 = CharTypes.getInputCodeLatin1();
    ...
    final protected boolean _loadMore() throws JacksonException {
    ...
    final protected String _getText2(JsonToken t) {
        if (t == null) {
            return null;
        }
        switch(t.id()) {
    ...
    final private JsonToken _nextTokenNotInObject(int i) throws JacksonException {
        if (i == INT_QUOTE) {
            _tokenIncomplete = true;
    ...
    final private JsonToken _nextAfterName() {
        _nameCopied = false;
    ...
    final private int _skipColonFast(int ptr) throws JacksonException {
    ...
    final private void _isNextTokenNameYes(int i) throws JacksonException {
        _currToken = JsonToken.PROPERTY_NAME;
        _updateLocation();
        switch(i) {
            case '"':
    ...
    final private boolean _isNextTokenNameMaybe(int i, SerializableString str) throws JacksonException {
        String n = _parseName(i);
        _streamReadContext.setCurrentName(n);
    ...
    final protected JsonToken _parseFloatThatStartsWithPeriod() throws JacksonException {
    ...
    final private JsonToken _parseSignedNumber(boolean negative) throws JacksonException {
        char[] outBuf = _textBuffer.emptyAndGetCurrentSegment();
        int outPtr = 0;
        if (negative) {
            outBuf[outPtr++] = '-';
    ...
    final private JsonToken _parseNumber2(char[] outBuf, int outPtr, boolean negative, int intPartLength) throws JacksonException {
        while (true) {
    ...
    final private int _verifyNoLeadingZeroes() throws JacksonException {
        if (_inputPtr >= _inputEnd && !_loadMore()) {
            return INT_0;
        }
    ...
    final private JsonToken _parseFloat(char[] outBuf, int outPtr, int c, boolean negative, int integerPartLength) throws JacksonException {
        int fractLen = 0;
        boolean eof = false;
        if (c == INT_PERIOD) {
            if (outPtr >= outBuf.length) {
    ...
    final private void _verifyRootSpace(int ch) throws JacksonException {
        ++_inputPtr;
        switch(ch) {
            case ' ':
            case '\t':
    ...
    final protected String _parseName(int i) throws JacksonException {
        if (i != INT_QUOTE) {
    ...
    final protected String parseMediumName(int q2) throws JacksonException {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
    ...
    final protected String parseMediumName2(int q3, final int q2) throws JacksonException {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
        int i = input[_inputPtr++] & 0xFF;
        if (codes[i] != 0) {
    ...
    final protected String parseLongName(int q, final int q2, int q3) throws JacksonException {
    ...
    final private String parseName(int q1, int ch, int lastQuadBytes) throws JacksonException {
        return parseEscapedName(_quadBuffer, 0, q1, ch, lastQuadBytes);
    }

    final private String parseName(int q1, int q2, int ch, int lastQuadBytes) throws JacksonException {
        _quadBuffer[0] = q1;
        return parseEscapedName(_quadBuffer, 1, q2, ch, lastQuadBytes);
    }

    final private String parseName(int q1, int q2, int q3, int ch, int lastQuadBytes) throws JacksonException {
        _quadBuffer[0] = q1;
        _quadBuffer[1] = q2;
        return parseEscapedName(_quadBuffer, 2, q3, ch, lastQuadBytes);
    }

    final protected String parseEscapedName(int[] quads, int qlen, int currQuad, int ch, int currQuadBytes) throws JacksonException {
        final int[] codes = _icLatin1;
        while (true) {
            if (codes[ch] != 0) {
                if (ch == INT_QUOTE) {
    ...
    final private String findName(int q1, int lastQuadBytes) throws StreamReadException {
    ...
    final private String findName(int q1, int q2, int lastQuadBytes) throws StreamReadException {
    ...
    final private String findName(int q1, int q2, int q3, int lastQuadBytes) throws StreamReadException {
    ...
    final private String findName(int[] quads, int qlen, int lastQuad, int lastQuadBytes) throws StreamReadException {
        if (qlen >= quads.length) {
            _quadBuffer = quads = growArrayBy(quads, quads.length);
        }
    ...
    final private String addName(int[] quads, int qlen, int lastQuadBytes) throws StreamReadException {
    ...
    final static private int _padLastQuad(int q, int bytes) {
    ...
    final private void _finishString2(char[] outBuf, int outPtr) throws JacksonException {
        int c;
        final int[] codes = _icUTF8;
        final byte[] inputBuffer = _inputBuffer;
    ...
    final protected void _matchTrue() throws JacksonException {
        int ptr = _inputPtr;
        if ((ptr + 3) < _inputEnd) {
            byte[] buf = _inputBuffer;
    ...
    final protected void _matchFalse() throws JacksonException {
        int ptr = _inputPtr;
        if ((ptr + 4) < _inputEnd) {
            byte[] buf = _inputBuffer;
    ...
    final protected void _matchNull() throws JacksonException {
        int ptr = _inputPtr;
        if ((ptr + 3) < _inputEnd) {
            byte[] buf = _inputBuffer;
    ...
    final protected void _matchToken(String matchStr, int i) throws JacksonException {
    ...
    final private void _matchToken2(String matchStr, int i) throws JacksonException {
        final int len = matchStr.length();
        do {
    ...
    final private void _checkMatchEnd(String matchStr, int i, int ch) throws JacksonException {
        char c = (char) _decodeCharForError(ch);
    ...
    final private int _skipWS() throws JacksonException {
    ...
    final private int _skipWS2() throws JacksonException {
        while (_inputPtr < _inputEnd || _loadMore()) {
            int i = _inputBuffer[_inputPtr++] & 0xFF;
            if (i > INT_SPACE) {
                if (i == INT_SLASH) {
    ...
    final private int _skipWSOrEnd() throws JacksonException {
        if (_inputPtr >= _inputEnd) {
            if (!_loadMore()) {
    ...
    final private int _skipWSOrEnd2() throws JacksonException {
        while ((_inputPtr < _inputEnd) || _loadMore()) {
            int i = _inputBuffer[_inputPtr++] & 0xFF;
            if (i > INT_SPACE) {
                if (i == INT_SLASH) {
    ...
    final private int _skipColon() throws JacksonException {
    ...
    final private int _skipColon2(boolean gotColon) throws JacksonException {
        while (_inputPtr < _inputEnd || _loadMore()) {
            int i = _inputBuffer[_inputPtr++] & 0xFF;
            if (i > INT_SPACE) {
                if (i == INT_SLASH) {
    ...
    final private void _skipComment() throws JacksonException {
    ...
    final private void _skipCComment() throws JacksonException {
    ...
    final private boolean _skipYAMLComment() throws JacksonException {
    ...
    final private void _skipLine() throws JacksonException {
        final int[] codes = CharTypes.getInputCodeComment();
        while ((_inputPtr < _inputEnd) || _loadMore()) {
            int i = (int) _inputBuffer[_inputPtr++] & 0xFF;
            int code = codes[i];
    ...
    final private int _decodeUtf8_2(int c) throws JacksonException {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
    ...
    final private int _decodeUtf8_3(int c1) throws JacksonException {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
        c1 &= 0x0F;
    ...
    final private int _decodeUtf8_3fast(int c1) throws JacksonException {
        c1 &= 0x0F;
        int d = (int) _inputBuffer[_inputPtr++];
        if ((d & 0xC0) != 0x080) {
            _reportInvalidOther(d & 0xFF, _inputPtr);
    ...
    final private int _decodeUtf8_4(int c) throws JacksonException {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
        int d = (int) _inputBuffer[_inputPtr++];
    ...
    final private void _skipUtf8_2() throws JacksonException {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
        int c = (int) _inputBuffer[_inputPtr++];
    ...
    final private void _skipUtf8_3() throws JacksonException {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
        int c = (int) _inputBuffer[_inputPtr++];
    ...
    final private void _skipUtf8_4(int c) throws JacksonException {
        if (_inputPtr >= _inputEnd) {
            _loadMoreGuaranteed();
        }
        int d = (int) _inputBuffer[_inputPtr++];
    ...
    final protected void _skipCR() throws JacksonException {
        if (_inputPtr < _inputEnd || _loadMore()) {
    ...
    @SuppressWarnings("resource")
    final protected byte[] _decodeBase64(Base64Variant b64variant) throws JacksonException {
        ByteArrayBuilder builder = _getByteArrayBuilder();
        while (true) {
            int ch;
            do {
    ...
    final private void _updateLocation() {
    ...
    final private void _updateNameLocation() {
    ...
    final private JsonToken _closeScope(int i) throws StreamReadException {
        if (i == INT_RCURLY) {
            _closeObjectScope();
            return (_currToken = JsonToken.END_OBJECT);
        }
    ...
    final private void _closeArrayScope() throws StreamReadException {
        _updateLocation();
        if (!_streamReadContext.inArray()) {
    ...
    final private void _closeObjectScope() throws StreamReadException {
        _updateLocation();
        if (!_streamReadContext.inObject()) {
            _reportMismatchedEndMarker('}', ']');
        }
    ...
    final protected int _matchLongName(PropertyNameMatcher matcher, int qptr, int q) throws JacksonException {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
        int qlen = 3;
    ...
    final static private int FEAT_MASK_ALLOW_MISSING = JsonReadFeature.ALLOW_MISSING_VALUES.getMask();

    private int _quadPtr;

    final protected int _matchMediumName2(PropertyNameMatcher matcher, int qptr, int q3, final int q2) throws JacksonException {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
        int i = input[qptr++] & 0xFF;
        if (codes[i] != 0) {
    ...
    final static private int FEAT_MASK_TRAILING_COMMA = JsonReadFeature.ALLOW_TRAILING_COMMA.getMask();
    ...
    final protected int _matchMediumName(PropertyNameMatcher matcher, int qptr, int q2) throws JacksonException {
        final byte[] input = _inputBuffer;
        final int[] codes = _icLatin1;
        int i = input[qptr++] & 0xFF;
        if (codes[i] != 0) {
    ...
    final protected int _matchName(PropertyNameMatcher matcher, int i) throws JacksonException {
        if (i != INT_QUOTE) {
            return -1;
        }
        int qptr = _inputPtr;
