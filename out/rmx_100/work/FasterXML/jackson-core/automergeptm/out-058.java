...
public class UTF8StreamJsonParser extends JsonParserBase {
  ...
  public @Deprecated UTF8StreamJsonParser(ObjectReadContext readCtxt, IOContext ctxt, ObjectReadContext readCtxtIOContext ctxtint stdFeaturesint formatReadFeaturesInputStream inByteQuadsCanonicalizer symbyte[] inputBufferint startint endboolean bufferRecyclable, InputStream in, ObjectCodec codec, ByteQuadsCanonicalizer sym, byte[] inputBuffer, int start, int end, boolean bufferRecyclable) {
    this(readCtxt, ctxt, readCtxtctxtstdFeaturesformatReadFeaturesinsyminputBufferstartend0bufferRecyclable, in, codec, sym, inputBuffer, start, end, 0, bufferRecyclable);
  }
