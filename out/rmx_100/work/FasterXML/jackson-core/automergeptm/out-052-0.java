...
public final class JsonStringEncoder {
  ...
  final static private int INITIAL_CHAR_BUFFER_SIZE = 120;
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "resource" }) public byte[] quoteAsUTF8(CharSequence text) {
    int inputPtr = 0;
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "resource" }) public byte[] encodeAsUTF8(CharSequence text) {
    int inputPtr = 0;
    int inputEnd = text.length();
    int outputPtr = 0;
    byte[] outputBuffer = new byte[INITIAL_BYTE_BUFFER_SIZE];
