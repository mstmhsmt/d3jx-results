...
public abstract class PredictionContext {
  ...
  public static final PredictionContext EMPTY_LOCAL =
      EmptyPredictionContext.LOCAL_CONTEXT;
  @NotNull
  public static final PredictionContext EMPTY_FULL =
      EmptyPredictionContext.FULL_CONTEXT;
  ...
  protected static int calculateEmptyParentHashCode() { return INITIAL_HASH; }
...
<<<<<<< /root/work/antlr/antlr4/d3j/patched-058-0.java
  ...
  protected static int calculateReturnStatesHashCode(int[] returnStates) {
    ...
    return hashCode;
||||||| /root/work/antlr/antlr4/d3j/base-058.java
...
=======
  ...
  public int compareTo(PredictionContext o) {
    return id - o.id;
>>>>>>> /root/work/antlr/antlr4/d3j/patched-058-1.java
  }
<<<<<<< /root/work/antlr/antlr4/d3j/patched-058-0.java
...
<<<<<<< /root/work/antlr/antlr4/d3j/patched-058-0.java
  protected static int calculateHashCode(PredictionContext parent,
                                         int returnState) {
    int hash = MurmurHash.initialize(INITIAL_HASH);
    hash = MurmurHash.update(hash, parent);
    hash = MurmurHash.update(hash, returnStateHashCode);
    hash = MurmurHash.finish(hash, 2);
    return (INITIAL_HASH * HASH_MULTIPLIER ^ parentHashCode) * HASH_MULTIPLIER ^
        returnStateHashCode;
||||||| /root/work/antlr/antlr4/d3j/base-058.java
...
<<<<<<< /root/work/antlr/antlr4/d3j/patched-058-0.java
  protected static int calculateHashCode(PredictionContext[] parents,
                                         int[] returnStates) {
    int hash = MurmurHash.initialize(INITIAL_HASH);
...
>>>>>>> /root/work/antlr/antlr4/d3j/patched-058-1.java
  ...
  public static PredictionContext
  fromRuleContext(@NotNull ATN atn, @NotNull RuleContext<?> outerContext) {
  ...
  removeEmptyContext(PredictionContext context) {
    return context.removeEmptyContext();
  }
  public static PredictionContext join(PredictionContext context0,
  ...
  static PredictionContext join(@NotNull final PredictionContext context0,
    ...
    if (context0size == 1 && context1size == 1 &&
        context0.getReturnState(0) == context1.getReturnState(0)) {
      PredictionContext merged =
          contextCache.join(context0.getParent(0), context1.getParent(0));
    ...
    int count = 0;
    PredictionContext[] parentsList =
        new PredictionContext[context0size + context1size];
    ...
    while (leftIndex < context0size && rightIndex < context1size) {
      if (context0.getReturnState(leftIndex) ==
          context1.getReturnState(rightIndex)) {
        parentsList[count] = contextCache.join(context0.getParent(leftIndex),
                                               context1.getParent(rightIndex));
        returnStatesList[count] = context0.getReturnState(leftIndex);
        canReturnLeft = canReturnLeft &&
                        parentsList[count] == context0.getParent(leftIndex);
        canReturnRight = canReturnRight &&
                         parentsList[count] == context1.getParent(rightIndex);
        leftIndex++;
        rightIndex++;
      } else if (context0.getReturnState(leftIndex) <
                 context1.getReturnState(rightIndex)) {
        parentsList[count] = context0.getParent(leftIndex);
        returnStatesList[count] = context0.getReturnState(leftIndex);
        ...
        assert context1.getReturnState(rightIndex) <
    ...
    if (parentsList.length == 0) {
      ...
      return new SingletonPredictionContext(parentsList[0],
                                            returnStatesList[0]);
    } else {
  ...
  public static PredictionContext getCachedContext(
    ...
    if (parents.length == 1) {
      updated =
          new SingletonPredictionContext(parents[0], context.getReturnState(0));
    } else {
      ArrayPredictionContext arrayPredictionContext =
          (ArrayPredictionContext)context;
      updated = new ArrayPredictionContext(
          parents, arrayPredictionContext.returnStates, context.cachedHashCode);
    }
...
<<<<<<< /root/work/antlr/antlr4/d3j/patched-058-0.java
  public PredictionContext appendContext(int returnContext,
                                         PredictionContextCache contextCache) {
    return appendContext(PredictionContext.EMPTY_FULL.getChild(returnContext),
                         contextCache);
  }
  public abstract PredictionContext
  appendContext(PredictionContext suffix, PredictionContextCache contextCache);
...
>>>>>>> /root/work/antlr/antlr4/d3j/patched-058-1.java
  ...
  public static final class IdentityHashMap
    ...
    public IdentityHashMap() { super(IdentityEqualityComparator.INSTANCE); }
  }
  public static final class IdentityEqualityComparator
      extends AbstractEqualityComparator<PredictionContext> {
    public static final IdentityEqualityComparator INSTANCE =
        new IdentityEqualityComparator();
