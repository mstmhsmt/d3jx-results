...
public abstract class Target {
  ...
  public CodeGenerator getCodeGenerator() { return gen; }
  ...
  public STGroup getTemplates() {
    if (templates == null) {
      ...
      if (version == null ||
          !RuntimeMetaData.getMajorMinorVersion(version).equals(
              RuntimeMetaData.getMajorMinorVersion(Tool.VERSION))) {
        gen.tool.errMgr.toolError(ErrorType.INCOMPATIBLE_TOOL_AND_TEMPLATES,
                                  version, Tool.VERSION, language);
      }
  ...
  protected void genRecognizerHeaderFile(Grammar g, ST headerFileST,
                                         String extName) {}
  ...
  public String getTargetStringLiteralFromString(String s, boolean quoted) {
    ...
    for (int i = 0; i < s.length(); i++) {
      int c = s.charAt(i);
      if (c != '\'' && c < targetCharValueEscape.length &&
  ...
  public String encodeIntAsCharEscape(int v) {
    if (v < Character.MIN_VALUE || v > Character.MAX_VALUE) {
      throw new IllegalArgumentException(
          String.format("Cannot encode the specified value: %d", v));
    }
  ...
  public String getRuleFunctionContextStructName(Rule r) {
    ...
    return Utils.capitalize(r.name) +
        getTemplates().getInstanceOf("RuleContextNameSuffix").render();
  }
  ...
  public int getSerializedATNSegmentLimit() { return Integer.MAX_VALUE; }
  ...
  public boolean templatesExist() {
    String groupFileName = CodeGenerator.TEMPLATE_ROOT + "/" + getLanguage() +
                           "/" + getLanguage() + STGroup.GROUP_FILE_EXTENSION;
    STGroup result = null;
    try {
  ...
  protected STGroup loadTemplates() {
    ...
    try {
      ...
      gen.tool.errMgr.toolError(ErrorType.MISSING_CODE_GEN_TEMPLATES, iae,
                                language);
    }
    if (result == null)
      return null;
    ...
    result.setListener(new STErrorListener() {
      ...
      private void reportError(STMessage msg) {
        getCodeGenerator().tool.errMgr.toolError(
            ErrorType.STRING_TEMPLATE_WARNING, msg.cause, msg.toString());
      }
    });
    return result;
  }
  public boolean wantsBaseListener() { return true; }
  public boolean wantsBaseVisitor() { return true; }
  public boolean supportsOverloadedMethods() { return true; }
}