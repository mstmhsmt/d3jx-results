...
<<<<<<< /root/work/antlr/antlr4/d3j/patched-015-0.java
...
||||||| /root/work/antlr/antlr4/d3j/base-015.java
    return Utils.capitalize(r.name) +
=======
    String baseName = r.getBaseContext();
    int lfIndex = baseName.indexOf(ATNSimulator.RULE_VARIANT_DELIMITER);
    return Utils.capitalize(baseName) +
>>>>>>> /root/work/antlr/antlr4/d3j/patched-015-1.java
...
>>>>>>> /root/work/antlr/antlr4/d3j/patched-015-1.java
  ...
  protected STGroup loadTemplates() {
    STGroup result =
        new STGroupFile(CodeGenerator.TEMPLATE_ROOT + "/" + getLanguage() +
