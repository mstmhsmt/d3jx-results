...
public abstract class PredictionContext {
  @NotNull public static final PredictionContext EMPTY_LOCAL = EmptyPredictionContext.LOCAL_CONTEXT;

  @NotNull public static final PredictionContext EMPTY_FULL = EmptyPredictionContext.FULL_CONTEXT;
...
<<<<<<< commits-rmx_100/antlr/antlr4/0f7d498ebb83af6bd5bb25f2feb61de45723e7de/PredictionContext-fc38fc1.java
    (INITIAL_HASH * HASH_MULTIPLIER ^ parentHashCode) * HASH_MULTIPLIER ^ returnStateHashCode
=======
    hash
>>>>>>> commits-rmx_100/antlr/antlr4/ac7cc7daaf58905689a96f20ad28e9b38f530f98/PredictionContext-c93088b.java
  ...
  @NotNull public abstract PredictionContext getParent(int index);
    ...
    for (int perm = 0; ; perm++) {
      ...
      while (!p.isEmpty() && p != stop) {
        ...
        if (recognizer != null) {
          ...
          if (p.getReturnState(index) != EMPTY_FULL_STATE_KEY) {
            if (!p.isEmpty()) {
              if (localBuffer.length() > 1) {
                localBuffer.append(' ');
              }
  ...
  public static final class IdentityEqualityComparator extends AbstractEqualityComparator<PredictionContext> {
    ...
    @Override public int hashCode(PredictionContext obj) {
      return obj.hashCode();
    }

    @Override public boolean equals(PredictionContext a, PredictionContext b) {
      return a == b;
    }
  }
