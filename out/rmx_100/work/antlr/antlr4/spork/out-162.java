 ...
 */
public abstract interface ParseListener<Symbol extends Token> {
	public abstract <T extends Symbol> void visitTerminal(ParserRuleContext<T> parent, T token);

	/** Enter all but left-recursive rules */
	public abstract void enterNonLRRule(ParserRuleContext<? extends Symbol> ctx);

	public abstract void exitEveryRule(ParserRuleContext<? extends Symbol> ctx);
}
