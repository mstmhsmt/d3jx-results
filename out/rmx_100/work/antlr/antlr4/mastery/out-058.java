...
<<<<<<< commits-rmx_100/antlr/antlr4/0f7d498ebb83af6bd5bb25f2feb61de45723e7de/PredictionContext-fc38fc1.java
static protected int calculateHashCode(int parentHashCode, int returnStateHashCode) {
        return (INITIAL_HASH * HASH_MULTIPLIER ^ parentHashCode) * HASH_MULTIPLIER ^ returnStateHashCode;
    }
=======

>>>>>>> commits-rmx_100/antlr/antlr4/ac7cc7daaf58905689a96f20ad28e9b38f530f98/PredictionContext-c93088b.java


    public static PredictionContext getCachedContext(@NotNull PredictionContext context, @NotNull ConcurrentMap<PredictionContext, PredictionContext> contextCache, @NotNull PredictionContext.IdentityHashMap visited) {
        if (context.isEmpty()) {
            return context;
        }
    ...
    static protected int calculateParentHashCode(PredictionContext parent) {
    ...
    static protected int calculateReturnStateHashCode(int returnState) {
        return INITIAL_HASH * HASH_MULTIPLIER ^ returnState;
    }

    static protected int calculateHashCode(PredictionContext parent, int returnState) {
    ...
    static protected int calculateHashCode(PredictionContext[] parents, int[] returnStates) {
        int hash = MurmurHash.initialize(INITIAL_HASH);
    ...
    static final private int HASH_MULTIPLIER = 31;

    static protected int calculateEmptyHashCode() {
        int hash = MurmurHash.initialize(INITIAL_HASH);
        hash = MurmurHash.finish(hash, 0);
        return hash;
    }

    static final private int INITIAL_HASH = 1;

    static protected int calculateReturnStatesHashCode(int[] returnStates) {
    ...
    static private PredictionContext addEmptyContext(PredictionContext context) {
    ...
    static private PredictionContext removeEmptyContext(PredictionContext context) {
        return context.removeEmptyContext();
    }

    static protected int calculateEmptyReturnStateHashCode() {
        return INITIAL_HASH;
    }

    static protected int calculateEmptyParentHashCode() {
        return INITIAL_HASH;
    }
    ...
    static protected int calculateParentHashCode(PredictionContext[] parents) {
        int hashCode = INITIAL_HASH;
