...
<<<<<<< commits-mn5_100/nasa/mct/3d41ee6180e43e3c2c430c1db843557c764aea94/TestLegendEntryPopup-bc24615.java
...
>>>>>>> commits-mn5_100/nasa/mct/c07a2d235b353a36a66d6d0befefb495ce0b22b6/TestLegendEntryPopup-0fc03af.java
  ...
  @BeforeTest public void setupTest() {
    ...
    Mockito.when(mockPolicyManager.execute(Mockito.anyString(), Mockito.<PolicyContext>any())).thenReturn(new ExecutionResult(null, false, null));
    ...
    Mockito.when(mockLegendEntry.
<<<<<<< commits-mn5_100/nasa/mct/3d41ee6180e43e3c2c430c1db843557c764aea94/TestLegendEntryPopup-bc24615.java
    getLineSettings()
=======
    getNumberRegressionPoints()
>>>>>>> commits-mn5_100/nasa/mct/c07a2d235b353a36a66d6d0befefb495ce0b22b6/TestLegendEntryPopup-0fc03af.java
    ).thenReturn(new LineSettings());
  }
  ...
  @Test public void testLegendEntryTriggersPopup() {
  ...
  @Test public void testLegendEntryTriggersPopupAtLocation() {
    int x = 100;
    int y = 120;
    LegendEntry entry = new LegendEntry(Color.WHITE, Color.BLACK, new JLabel().getFont(), mockLabelingAlgorithm);
    entry.setPopup(mockPopupManager);
  ...
  @Test public void testLegendEntryIgnoresNonPopupTriggers() {
    LegendEntry entry = new LegendEntry(Color.WHITE, Color.BLACK, new JLabel().getFont(), mockLabelingAlgorithm);
    entry.setPopup(mockPopupManager);
  ...
  @Test public void testLegendEntryPopupMenuSize() {
    Mockito.when(mockPolicyManager.execute(Mockito.anyString(), Mockito.<PolicyContext>any())).thenReturn(new ExecutionResult(null, false, null));
  ...
  @Test public void testLegendEntryPopupMenuColors() {
    Mockito.when(mockPolicyManager.execute(Mockito.anyString(), Mockito.<PolicyContext>any())).thenReturn(new ExecutionResult(null, false, null));
    LegendEntryPopupMenuFactory manager = new LegendEntryPopupMenuFactory(mockPlotViewManifestation);
    JPopupMenu menu = getSubMenu(manager.getPopup(mockLegendEntry), COLOR_SUBMENU);
  ...
  @Test public void testLegendEntryPopupMenuSelection() {
    Mockito.when(mockPolicyManager.execute(Mockito.anyString(), Mockito.<PolicyContext>any())).thenReturn(new ExecutionResult(null, false, null));
    LegendEntryPopupMenuFactory manager = new LegendEntryPopupMenuFactory(mockPlotViewManifestation);
    for (int i = 0; i < PlotConstants.MAX_NUMBER_OF_DATA_ITEMS_ON_A_PLOT; i++) {
  ...
  @Test public void testLegendEntryPopupMenuThicknesses() {
    Mockito.when(mockPolicyManager.execute(Mockito.anyString(), Mockito.<PolicyContext>any())).thenReturn(new ExecutionResult(null, false, null));
    LegendEntryPopupMenuFactory manager = new LegendEntryPopupMenuFactory(mockPlotViewManifestation);
  ...
  @Test public void testLegendEntryPopupMenuThicknessSelection() {
    Mockito.when(mockPolicyManager.execute(Mockito.anyString(), Mockito.<PolicyContext>any())).thenReturn(new ExecutionResult(null, false, null));
    LegendEntryPopupMenuFactory manager = new LegendEntryPopupMenuFactory(mockPlotViewManifestation);
  ...
  @Test public void testLegendEntryRegressionMenu() {
    Mockito.when(mockPolicyManager.execute(Mockito.anyString(), Mockito.<PolicyContext>any())).thenReturn(new ExecutionResult(null, false, null));
