...
class TestPanAndZoomManager
{
   ...
   void setup() {
     ...
     PlotAbstraction testPlotTimeX =
       new PlotView.Builder(PlotterPlot.class).plotSettings(settings).timeVariableAxisMinValue(now).timeVariableAxisMaxValue(now + 300000L).nonTimeAxisMinSubsequentSetting(PlotConstants.NonTimeAxisSubsequentBoundsSetting.FIXED).nonTimeAxisMaxSubsequentSetting(PlotConstants.NonTimeAxisSubsequentBoundsSetting.FIXED).build();
   ...
   @Test
   public
   void TestEnteringPanMode() {
     plotTimeOnX.setPlotDisplayState(PlotDisplayState.DISPLAY_ONLY);
     panAndZoomManagerTimeOnX.enteredPanMode();
     Assert.assertEquals(plotTimeOnX.getPlotDisplayState(),
       PlotDisplayState.USER_INTERACTION);
     Assert.assertEquals(plotTimeOnX.getNonTimeMaxAlarmState(),
       LimitAlarmState.NO_ALARM);
     panAndZoomManagerTimeOnX.exitedPanMode();
   }
   @Test
   public
   void TestEnteringZoomMode() {
     plotTimeOnX.setPlotDisplayState(PlotDisplayState.DISPLAY_ONLY);
   ...
   @Test
   public
   void TestPanningActionsTimeOnX() {
   ...
   @Test
   public
   void TestPanningActionsTimeOnY() {
   ...
   @Test
   public
   void TestOutOfBoundsArrowsWithPanAndZoomActionsFixedNonTime() {
     ...
     Assert.assertEquals(plotTimeOnX.getNonTimeMaxAlarmState(),
       LimitAlarmState.NO_ALARM);
     Assert.assertEquals(plotTimeOnX.getNonTimeMinAlarmState(),
       LimitAlarmState.NO_ALARM);
     panAndZoomManagerTimeOnX.panAction(PanDirection.PAN_HIGHER_X_AXIS);
     Assert.assertEquals(plotTimeOnX.getNonTimeMaxAlarmState(),
       LimitAlarmState.NO_ALARM);
     ...
     plotTimeOnX.addDataSet("DataSet1", Color.RED);
     long time2 =
       (plotTimeOnX.getCurrentTimeAxisMinAsLong() + plotTimeOnX.getCurrentTimeAxisMaxAsLong()) / 2L;
   ...
   @Test
   public
   void TestOutOfBoundsArrowsWithPanAndZoomActionsAutoNonTime() {
     now = System.currentTimeMillis();
     PlotAbstraction testPlotTimeX =
