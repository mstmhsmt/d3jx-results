...
<<<<<<< /root/work/nasa/mct/d3j/patched-023-0.java
    Mockito.when(mockLegendEntry.getLineSettings())
        .thenReturn(new LineSettings());
||||||| /root/work/nasa/mct/d3j/base-023.java
=======
    Mockito.when(mockLegendEntry.getNumberRegressionPoints()).thenReturn(15);
>>>>>>> /root/work/nasa/mct/d3j/patched-023-1.java
  }
  ...
  public void testLegendEntryPopupMenuSize() {
    ...
    LegendEntryPopupMenuFactory manager =
        new LegendEntryPopupMenuFactory(mockPlotViewManifestation);
    JPopupMenu menu =
        getSubMenu(manager.getPopup(mockLegendEntry), COLOR_SUBMENU);
  ...
  public void testLegendEntryRegressionMenu() {
    ...
    JMenuItem regressionLineCheckbox =
        ((JMenuItem)manager.getPopup(mockLegendEntry).getComponent(2));
    Assert.assertEquals(regressionLineCheckbox.getText(),
                        BUNDLE.getString("RegressionLineLabel"));
    Assert.assertFalse(regressionLineCheckbox.isSelected());
    JMenu regressionPointsMenu =
        ((JMenu)manager.getPopup(mockLegendEntry).getComponent(3));
    Assert.assertEquals(regressionPointsMenu.getText(),
                        BUNDLE.getString("RegressionPointsLabel"));
    JSpinner regressionPointsSpinner =
        (JSpinner)regressionPointsMenu.getMenuComponent(0);
    Assert.assertEquals(regressionPointsSpinner.getModel().getValue(),
                        mockLegendEntry.getNumberRegressionPoints());
  }
  @Test
  ...
  public void testLegendEntryPopupMenuThicknesses() {
    ...
    LegendEntryPopupMenuFactory manager =
        new LegendEntryPopupMenuFactory(mockPlotViewManifestation);
    JPopupMenu menu =
        getSubMenu(manager.getPopup(mockLegendEntry), THICKNESS_SUBMENU);
    Assert.assertEquals(menu.getComponentCount(),
                        PlotConstants.MAX_LINE_THICKNESS);
