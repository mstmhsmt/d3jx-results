...
public
class LegendEntry extends JPanel implements MouseListener
{
   private final static Logger logger =
     LoggerFactory.getLogger(LegendEntry.class);
   private static final int LEFT_PADDING = 5;
   private static final Border PANEL_PADDING =
     BorderFactory.createEmptyBorder(0, LEFT_PADDING, 0, 0);
   private static final Border EMPTY_BORDER =
     BorderFactory.createEmptyBorder(1, 1, 1, 1);
   private Border focusBorder =
     BorderFactory.createLineBorder(LafColor.TEXT_HIGHLIGHT);
   ...
   private int numberRegressionPoints =
     PlotConstants.NUMBER_REGRESSION_POINTS;
   LegendEntry(Color theBackgroundColor, Color theForegroundColor, Font font, 
               AbbreviatingPlotLabelingAlgorithm thisPlotLabelingAlgorithm) {
     ...
     originalFont = font;
     originalFont =
     originalFont.deriveFont((float)(originalFont.getSize() - 1));
   ...
   private
   List<String> getPanelOrWindowContextTitleList() {
   ...
   public
   void setBaseDisplayName(String theBaseDisplayName) {
     ...
     String[] strings =
       baseDisplayName.split(PlotConstants.LEGEND_NEWLINE_CHARACTER);
     if (strings.length <= 1) {
       ...
       baseDisplayName =
       plotLabelingAlgorithm.computeLabel(baseDisplayNameList,
         getPanelOrWindowContextTitleList());
     ...
     thisBaseDisplayName =
     theBaseDisplayName.replaceAll(PlotConstants.WORD_DELIMITERS, " ");
     currentToolTipTxt =
     "<HTML>" + thisBaseDisplayName.replaceAll(PlotConstants.LEGEND_NEWLINE_CHARACTER,
                  "<BR>") + "<BR>" + valueString + "<HTML>";
   ...
   void setData(FeedProvider.RenderingInfo info) {
     ...
     if (!"".equals(valueText)) {
       valueString =
       PlotConstants.DECIMAL_FORMAT.format(Double.parseDouble(valueText));
     }
     updateLabelFont();
     updateLabelText();
     thisBaseDisplayName =
     thisBaseDisplayName.replaceAll(PlotConstants.WORD_DELIMITERS, " ");
     currentToolTipTxt =
     "<HTML>" + thisBaseDisplayName.replaceAll(PlotConstants.LEGEND_NEWLINE_CHARACTER,
                  "<BR>") + "<BR>" + valueString + "<HTML>";
     this.setToolTipText(currentToolTipTxt);
   ...
   void updateLabelText() {
     String statusText =
       renderingInfo == null ? null : renderingInfo.getStatusText();
     if (statusText == null) {
       statusText = "";
     }
   ...
   void mouseEntered(MouseEvent e) {
     ...
     if (originalPlotLineStroke == null) {
       ...
       linePlot.setStroke(new BasicStroke(stroke.getLineWidth() * PlotConstants.SELECTED_LINE_THICKNESS,
   ...
   public
   String getBaseDisplayNameLabel() {
     return baseDisplayNameLabel.getText();
   }
   public
   String getFullBaseDisplayName() {
     return thisBaseDisplayName;
   }
   public
   String getComputedBaseDisplayName() {
     return computedBaseDisplayName;
   }
   public
   String getTruncatedBaseDisplayName() {
     return baseDisplayName;
   }
   public
   void setPlotLabelingAlgorithm(AbbreviatingPlotLabelingAlgorithm plotLabelingAlgorithm) {
   ...
   public
   LegendEntryPopupMenuFactory getPopup() {
     return popupManager;
   }
   public
   void setPopup(LegendEntryPopupMenuFactory popup) {
     this.popupManager = popup;
   }
   public
   boolean hasRegressionLine() {
   ...
   public
   void setHasRegressionLine(boolean regressionLine) {
   ...
   public
   int getNumberRegressionPoints() {
     return numberRegressionPoints;
   }
   private
   void updateLinePlotFromSettings() {
     ...
     if (linePlot.getPointIcon() != null) {
       ...
       if (shape != null) {
         ...
         baseDisplayNameLabel.setIcon(new PlotMarkerIcon(shape, false, 12,
                                        12));
       }
     }
     linePlot.repaint();
   ...
   public
   void setNumberRegressionPoints(int numberRegressionPoints) {
   ...
   public
   LinearXYPlotLine getRegressionLine() {
     return regressionLine;
   }
   public
   void setRegressionLine(LinearXYPlotLine regressionLine) {
