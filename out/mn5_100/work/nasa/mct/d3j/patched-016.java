...
<<<<<<< /root/work/nasa/mct/d3j/patched-016-0.java
...
||||||| /root/work/nasa/mct/d3j/base-016.java
=======
import javax.swing.JSpinner;
import javax.swing.JTextField;
import javax.swing.JSpinner.NumberEditor;
...
import javax.swing.event.MenuKeyListener;
import javax.swing.text.DocumentFilter;
>>>>>>> /root/work/nasa/mct/d3j/patched-016-1.java
...
<<<<<<< /root/work/nasa/mct/d3j/patched-016-0.java
        ...
        for (int i = 1; i <= PlotConstants.MAX_LINE_THICKNESS; i++) {
          JMenuItem item =
              new JRadioButtonMenuItem("" + i, (settings.getThickness() == i));
...
<<<<<<< /root/work/nasa/mct/d3j/patched-016-0.java
        ...
        if (manifestation.getPlot() != null &&
          ...
          JMenuItem other = new JRadioButtonMenuItem(
              BUNDLE.getString("SelectCharacter.label"),
              settings.getUseCharacter());
          if (!settings.getCharacter().isEmpty()) {
            FontRenderContext frc = ((Graphics2D)manifestation.getGraphics())
