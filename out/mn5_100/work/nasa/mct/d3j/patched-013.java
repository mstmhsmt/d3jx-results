...
public
class PlotSettingsControlContainer extends JPanel
{
   private static final long serialVersionUID = 8930533587430928800L;
   private PlotViewManifestation managedView;
   public
   PlotSettingsControlContainer(PlotViewManifestation managedView) {
     this.managedView = managedView;
     final PlotSettingsSubPanel panel =
       new PlotSettingsControlArea(managedView);
     ...
     paddableOverallPanel.add(createApplyButtonPanel(panel),
       PlotControlsLayout.LOWER);
     add(paddableOverallPanel);
   }
   private
   JPanel createApplyButtonPanel(final PlotSettingsSubPanel panel) {
     ...
     JPanel okButtonPadded =
       new JPanel(new FlowLayout(FlowLayout.CENTER, 10, 7));
