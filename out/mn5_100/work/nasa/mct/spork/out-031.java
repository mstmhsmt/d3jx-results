...
public class PlotSettings extends GenericSettings implements PlotConfiguration {
	...
	private void createDefaults() {
		...
		this.create(PlotConstants.TIME_SYSTEM_SETTING, "", java.lang.String.class);
		this.create(PlotConstants.FEED_TYPE_SETTING, "", java.lang.String.class);
		this.create(PlotConstants.TIME_FORMAT_SETTING, PlotConstants.DEFAULT_TIME_FORMAT, java.lang.String.class);
		...
		this.create(PlotConstants.TIME_MAX, now, java.lang.Long.class);
		this.create(PlotConstants.TIME_MIN, now - PlotConstants.DEFAULT_PLOT_SPAN, java.lang.Long.class);
		this.create(PlotConstants.NON_TIME_MAX, PlotConstants.DEFAULT_NON_TIME_AXIS_MAX_VALUE, java.lang.Double.class);
		this.create(PlotConstants.NON_TIME_MIN, PlotConstants.DEFAULT_NON_TIME_AXIS_MIN_VALUE, java.lang.Double.class);
		this.create(PlotConstants.DEPENDENT_MAX, PlotConstants.DEFAULT_NON_TIME_AXIS_MAX_VALUE, java.lang.Double.class);
		this.create(PlotConstants.DEPENDENT_MIN, PlotConstants.DEFAULT_NON_TIME_AXIS_MIN_VALUE, java.lang.Double.class);
		this.create(PlotConstants.TIME_PADDING, PlotConstants.DEFAULT_TIME_AXIS_PADDING, java.lang.Double.class);
		this.create(PlotConstants.NON_TIME_MAX_PADDING, PlotConstants.DEFAULT_NON_TIME_AXIS_PADDING_MAX, java.lang.Double.class);
		this.create(PlotConstants.NON_TIME_MIN_PADDING, PlotConstants.DEFAULT_NON_TIME_AXIS_PADDING_MIN, java.lang.Double.class);
		this.create(PlotConstants.GROUP_BY_ORDINAL_POSITION, true, java.lang.Boolean.class);
		this.create(PlotConstants.PIN_TIME_AXIS, false, java.lang.Boolean.class);
		this.create(PlotConstants.DRAW_LINES, PlotConstants.DEFAULT_PLOT_LINE_DRAW.drawLine(), java.lang.Boolean.class);
		this.create(PlotConstants.DRAW_MARKERS, PlotConstants.DEFAULT_PLOT_LINE_DRAW.drawMarkers(), java.lang.Boolean.class);
		...
		this.create(PlotConstants.FILTER_ENABLED, Boolean.FALSE, java.lang.Boolean.class);
		this.create(PlotConstants.FILTER_VALUE, "", java.lang.String.class);
		// adjust default plot values according to plot.properties
		Properties properties = getPlotDefaultProperties();
		if (properties != null) {
			// if there is no plot.properties, does nothing
			for (String propertyName : properties.stringPropertyNames()) {
				String value = properties.getProperty(propertyName);
				if (propertyName.equals("DefaultPlotSpan")) {
					// change default plot span
					this.create(PlotConstants.TIME_MIN, now - Long.parseLong(value), java.lang.Long.class);
				} else if (propertyName.equals("NonTimeMax")) {
					// change default non-time axis max value
					this.create(PlotConstants.NON_TIME_MAX, Double.parseDouble(value), java.lang.Double.class);
				} else if (propertyName.equals("NonTimeMin")) {
					// change default non-time axis min value
					this.create(PlotConstants.NON_TIME_MIN, Double.parseDouble(value), java.lang.Double.class);
				} else if (propertyName.equals("DependentMax")) {
					// change default dependent max value
					this.create(PlotConstants.DEPENDENT_MAX, Double.parseDouble(value), java.lang.Double.class);
				} else if (propertyName.equals("DependentMin")) {
					// change default dependent min value
					this.create(PlotConstants.DEPENDENT_MIN, Double.parseDouble(value), java.lang.Double.class);
				} else if (propertyName.equals("TimePadding")) {
					// change time axis padding value
					this.create(PlotConstants.TIME_PADDING, Double.parseDouble(value), java.lang.Double.class);
				} else if (propertyName.equals("NonTimeMinPadding")) {
					// change default non time max padding
					this.create(PlotConstants.NON_TIME_MAX_PADDING, Double.parseDouble(value), java.lang.Double.class);
				} else if (propertyName.equals("NonTimeMaxPadding")) {
					// change default non time min padding
					this.create(PlotConstants.NON_TIME_MIN_PADDING, Double.parseDouble(value), java.lang.Double.class);
				}
			}
		}
	}
