...
public class TestPanAndZoomManager {
	...
	public void setup() {
		...
		PlotAbstraction testPlotTimeX = new PlotView.Builder(PlotterPlot.class).plotSettings(settings).build();
		...
		settings.setMaxNonTime(100);
		settings.setMinNonTime(0);
		PlotAbstraction testPlotTimeY = new PlotView.Builder(PlotterPlot.class).plotSettings(settings2).build();
