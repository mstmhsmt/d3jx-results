...
public class PlotterPlot implements AbstractPlottingPackage {
    ...
    final static int PLOT_PREFERED_HEIGHT = 100;

    final static int PLOT_PREFERED_WIDTH = PlotConstants.MINIMUM_PLOT_WIDTH;
    ...
    static public NumberFormat getNumberFormatter(double value) {
