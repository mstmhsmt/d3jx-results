...
public class PlotSettings extends GenericSettings implements PlotConfiguration {
    ...
    @Override
    public void setNonTimeAxisSubsequentMinSetting(NonTimeAxisSubsequentBoundsSetting nonTimeAxisSubsequentMinSetting) {
    ...
    @Override
    public void setNonTimeAxisSubsequentMaxSetting(NonTimeAxisSubsequentBoundsSetting nonTimeAxisSubsequentMaxSetting) {
    ...
    @Override
    public void setOrdinalPositionForStackedPlots(boolean ordinalPositionForStackedPlots) {
