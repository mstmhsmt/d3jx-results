...
public class PlotSettings extends GenericSettings implements PlotConfiguration {
  ...
  public PlotSettings(PlotConfiguration configuration) {
    this(configuration.getAxisOrientationSetting(), configuration.getTimeSystemSetting(), configuration.getTimeFormatSetting(), configuration.getXAxisMaximumLocation(), configuration.getYAxisMaximumLocation(), configuration.getTimeAxisSubsequentSetting(), configuration.getNonTimeAxisSubsequentMinSetting(), configuration.getNonTimeAxisSubsequentMaxSetting(), configuration.getMaxTime(), configuration.getMinTime(), configuration.getMaxNonTime(), configuration.getMinNonTime(), configuration.getTimePadding(), configuration.getNonTimeMaxPadding(), configuration.getNonTimeMinPadding(), configuration.getOrdinalPositionForStackedPlots(), configuration.getPinTimeAxis(), configuration.getPlotLineDraw(), configuration.getPlotLineConnectionType());
  }

  public PlotSettings(AxisOrientationSetting timeAxisSetting, String timeSystemSetting, String timeFormatSetting, XAxisMaximumLocationSetting xAxisMaximumLocation, YAxisMaximumLocationSetting yAxisMaximumLocation, TimeAxisSubsequentBoundsSetting timeAxisSubsequent, NonTimeAxisSubsequentBoundsSetting nonTimeAxisSubsequentMinSetting, NonTimeAxisSubsequentBoundsSetting nonTimeAxisSubsequentMaxSetting, long maxTime, long minTime, double maxNonTime, double minNonTime, double timePadding, double nonTimeMaxPadding, double nonTimeMinPadding, boolean ordinalPositionForStackedPlots, boolean pinTimeAxis, PlotLineDrawingFlags plotLineDraw, PlotLineConnectionType plotLineConnectionType) {
    createDefaults();
  ...
  public boolean matches(PlotConfiguration settings) {
    return settings.getAxisOrientationSetting() == getAxisOrientationSetting() && settings.getTimeSystemSetting() == getTimeSystemSetting() && settings.getTimeFormatSetting() == getTimeFormatSetting() && settings.getXAxisMaximumLocation() == getXAxisMaximumLocation() && settings.getYAxisMaximumLocation() == getYAxisMaximumLocation() && settings.getTimeAxisSubsequentSetting() == getTimeAxisSubsequentSetting() && settings.getNonTimeAxisSubsequentMinSetting() == getNonTimeAxisSubsequentMinSetting() && settings.getNonTimeAxisSubsequentMaxSetting() == getNonTimeAxisSubsequentMaxSetting() && settings.getMaxTime() == getMaxTime() && settings.getMinTime() == getMinTime() && settings.getMaxNonTime() == getMaxNonTime() && settings.getMinNonTime() == getMinNonTime() && settings.getTimePadding() == getTimePadding() && settings.getNonTimeMaxPadding() == getNonTimeMaxPadding() && settings.getNonTimeMinPadding() == getNonTimeMinPadding() && settings.getOrdinalPositionForStackedPlots() == getOrdinalPositionForStackedPlots() && settings.getPinTimeAxis() == getPinTimeAxis() && settings.getPlotLineDraw() == getPlotLineDraw() && settings.getPlotLineConnectionType() == getPlotLineConnectionType();
  }

  @Override public void loadFrom(View v) {
    super.loadFrom(v);
  ...
  @Override public void setAxisOrientationSetting(AxisOrientationSetting timeAxisSetting) {
  ...
  @Override public void setTimeSystemSetting(String timeSystemSetting) {
  ...
  @Override public void setTimeFormatSetting(String timeFormatSetting) {
    this.set(PlotConstants.TIME_FORMAT_SETTING, timeFormatSetting);
  }

  @Override public String getTimeFormatSetting() {
    return this.get(PlotConstants.TIME_FORMAT_SETTING, String.class);
  }

  @Override public void setXAxisMaximumLocation(XAxisMaximumLocationSetting xAxisMaximumLocation) {
  ...
  @Override public void setYAxisMaximumLocation(YAxisMaximumLocationSetting yAxisMaximumLocation) {
  ...
  @Override public void setTimeAxisSubsequentSetting(TimeAxisSubsequentBoundsSetting timeAxisSubsequent) {
  ...
  @Override public void setNonTimeAxisSubsequentMinSetting(NonTimeAxisSubsequentBoundsSetting nonTimeAxisSubsequentMinSetting) {
  ...
  @Override public void setNonTimeAxisSubsequentMaxSetting(NonTimeAxisSubsequentBoundsSetting nonTimeAxisSubsequentMaxSetting) {
  ...
  @Override public void setMaxTime(long maxTime) {
  ...
  @Override public void setMinTime(long minTime) {
  ...
  @Override public void setNonTimeMaxPadding(double nonTimeMaxPadding) {
  ...
  @Override public void setNonTimeMinPadding(double nonTimeMinPadding) {
  ...
  @Override public void setOrdinalPositionForStackedPlots(boolean ordinalPositionForStackedPlots) {
    this.set(PlotConstants.GROUP_BY_ORDINAL_POSITION, (Boolean) ordinalPositionForStackedPlots);
  }

  @Override public boolean getOrdinalPositionForStackedPlots() {
    return this.get(PlotConstants.GROUP_BY_ORDINAL_POSITION, Boolean.class);
  }

  @Override public void setPinTimeAxis(boolean pinTimeAxis) {
    this.set(PlotConstants.PIN_TIME_AXIS, (Boolean) pinTimeAxis);
  }

  @Override public boolean getPinTimeAxis() {
    return this.get(PlotConstants.PIN_TIME_AXIS, Boolean.class);
  }

  @Override public void setPlotLineDraw(PlotLineDrawingFlags plotLineDraw) {
    this.set(PlotConstants.DRAW_LINES, plotLineDraw.drawLine());
    this.set(PlotConstants.DRAW_MARKERS, plotLineDraw.drawMarkers());
  }

  @Override public PlotLineDrawingFlags getPlotLineDraw() {
    return new PlotLineDrawingFlags(this.get(PlotConstants.DRAW_LINES, Boolean.class), this.get(PlotConstants.DRAW_MARKERS, Boolean.class));
  }

  @Override public void setPlotLineConnectionType(PlotLineConnectionType plotLineConnectionType) {
    this.set(PlotConstants.CONNECTION_TYPE, plotLineConnectionType);
  }

  @Override public PlotLineConnectionType getPlotLineConnectionType() {
    return this.get(PlotConstants.CONNECTION_TYPE, PlotLineConnectionType.class);
  }

  @Override public <T extends java.lang.Object> T getExtension(String key, Class<T> extensionClass) {
    return super.get(key, extensionClass);
  }

  @Override public void setFeedTypeSetting(String feedType) {
    this.set(PlotConstants.FEED_TYPE_SETTING, feedType);
  }

  @Override public <T extends java.lang.Object> void setExtension(String key, T value) {
    super.set(key, value);
  }

  @Override public String getFeedTypeSetting() {
