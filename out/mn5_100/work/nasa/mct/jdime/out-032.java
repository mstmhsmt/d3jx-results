 ...
 */
@SuppressWarnings(value = { "serial" }) public class PlotViewManifestation extends FeedView implements RenderingCallback {
  ...
  /**
	 ...
	 */
  @Override public FeedProvider getFeedProvider(AbstractComponent component) {
  ...
  @Override protected void handleNamingContextChange() {
    updateMonitoredGUI();
  }
  ...
  @Override protected JComponent initializeControlManifestation() {
  ...
  @Override public void updateMonitoredGUI() {
    setLabelingContext(plotLabelingAlgorithm, getNamingContext());
    if (thePlot != null) {
  ...
  @Override public void updateMonitoredGUI(PropertyChangeEvent evt) {
    updateMonitoredGUI();
  }

  @Override public void updateMonitoredGUI(AddChildEvent event) {
    setLabelingContext(plotLabelingAlgorithm, getNamingContext());
    respondToChildChangeEvent();
  }

  @Override public void updateMonitoredGUI(RemoveChildEvent event) {
    setLabelingContext(plotLabelingAlgorithm, getNamingContext());
    respondToChildChangeEvent();
  }
  ...
  private DataTransformation getTransformation() {
    return new DataTransformation() {
      @Override public void transform(Map<String, List<Map<String, String>>> data, long startTime, long endTime) {
  ...
  public void requestPredictiveData(GregorianCalendar startTime, GregorianCalendar endTime) {
    ...
    currentPredictionRequest = this.requestData(plotDataAssigner.getPredictiveFeedProviders(), startTime.getTimeInMillis(), endTime.getTimeInMillis(), getTransformation(), new RenderingCallback() {
      @Override public void render(Map<String, List<Map<String, String>>> data) {
  ...
  @Override protected void synchronizationDone() {
    thePlot.removeTimeSyncLine();
  }

  @Override public void clear(Collection<FeedProvider> feedProviders) {
    updateMonitoredGUI();
  }
  ...
  private void enforceBackgroundColor(final Color bg) {
    ...
    ComponentTraverser.traverse(theView, new ComponentTraverser.ComponentProcedure() {
      @Override public void run(Component c) {
