...
public class SwitcherView extends View {
  ...
  @SuppressWarnings(value = { "rawtypes" }) private JComboBox comboBox;
  ...
  /**
     ...
     */
  public static final ViewInfo VIEW_INFO = new ViewInfo(SwitcherView.class, "Switcher", ViewType.VIEW_SWITCHER);

  @SuppressWarnings(value = { "rawtypes", "unchecked" }) public SwitcherView(AbstractComponent ac, ViewInfo vi) {
  ...
  @Override public <T extends java.lang.Object> void addMonitoredGUI(T gui) {
  ...
  @SuppressWarnings(value = { "rawtypes" }) private static final ListCellRenderer viewInfoRenderer = new ListCellRenderer() {
  ...
  private static class SwitcherComboBoxUI extends BasicComboBoxUI {
    ...
    @Override public Dimension getDisplaySize() {
