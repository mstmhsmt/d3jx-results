...
public class ParserATNSimulator extends ATNSimulator {
  ...
  @NotNull private PredictionMode mode = PredictionMode.LL;
  ...
  /**
	 ...
	 * returns {@link #ERROR}.
	 */
  @NotNull protected DFAState computeTargetState(@NotNull DFA dfa, @NotNull DFAState previousD, int t) {
  ...
  @NotNull protected ATNConfigSet computeStartState(@NotNull ATNState p, @Nullable RuleContext ctx, boolean fullCtx) {
