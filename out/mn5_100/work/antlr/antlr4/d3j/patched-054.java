...
class LL1Analyzer
{
   ...
   public
   LL1Analyzer(@NotNull ATN atn) {
     this.atn = atn;
   }
   @Nullable
   public
   IntervalSet[] getDecisionLookahead(@Nullable ATNState s) {
     if (s == null) {
       return null;
     }
   ...
   @NotNull
   public
   IntervalSet LOOK(@NotNull ATNState s, @Nullable RuleContext ctx) {
     return LOOK(s, null, ctx);
   }
   @NotNull
   public
   IntervalSet LOOK(@NotNull ATNState s, @Nullable ATNState stopState, 
     ...
     _LOOK(s, stopState, lookContext, r, new HashSet<ATNConfig>(),
       new BitSet(), seeThruPreds, true);
     return r;
   }
   protected
   void _LOOK(@NotNull ATNState s, @Nullable ATNState stopState, 
              @Nullable PredictionContext ctx, @NotNull IntervalSet look, 
              @NotNull Set<ATNConfig> lookBusy, 
              @NotNull BitSet calledRuleStack, boolean seeThruPreds, 
              boolean addEOF) {
       ...
       if (t.getClass() == RuleTransition.class) {
         ...
         if (set != null) {
           if (t instanceof NotSetTransition) {
             set =
             set.complement(IntervalSet.of(Token.MIN_USER_TOKEN_TYPE,
                              atn.maxTokenType));
           }
           look.addAll(set);
         }
