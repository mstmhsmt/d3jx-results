...
class BaseTest
{
   ...
   protected
   org.antlr.v4.Tool newTool(String[] args) {
   ...
   protected
   void semanticProcess(Grammar g) {
   ...
   public
   DFA createDFA(Grammar g, DecisionState s) {
     return null;
   }
   ...
   public
   IntegerList getTokenTypesViaATN(String input, LexerATNSimulator lexerATN) {
   ...
   public
   List<String> getTokenTypes(LexerGrammar lg, ATN atn, CharStream input, 
                              boolean adaptive) {
     ...
     do {
       ...
       int t = input.LA(1);
       if (adaptive)
         ttype = interp.match(input, Lexer.DEFAULT_MODE); else
   ...
   List<ANTLRMessage> checkRuleDFA(String gtext, String ruleName, 
                                   String expecting)
     throws Exception {
   ...
   List<ANTLRMessage> checkRuleDFA(String gtext, int decision, 
                                   String expecting)
     throws Exception {
     ErrorQueue equeue = new ErrorQueue();
     Grammar g = new Grammar(gtext, equeue);
   ...
   List<ANTLRMessage> checkLexerDFA(String gtext, String modeName, 
                                    String expecting)
     throws Exception {
     ErrorQueue equeue = new ErrorQueue();
   ...
   protected
   boolean compile(String... fileNames) {
   ...
   protected
   boolean antlr(String fileName, String grammarFileName, String grammarStr, 
   ...
   protected
   String execLexer(String grammarFileName, String grammarStr, 
   ...
   String execLexer(String grammarFileName, String grammarStr, 
     ...
     boolean success =
       rawGenerateAndBuildRecognizer(grammarFileName, grammarStr, null,
         lexerName);
     assertTrue(success);
   ...
   protected
   String execParser(String grammarFileName, String grammarStr, 
                     String parserName, String lexerName, 
                     String startRuleName, String input, boolean debug) {
     boolean success =
       rawGenerateAndBuildRecognizer(grammarFileName, grammarStr, parserName,
         lexerName, "-parse-listener", "-visitor");
     assertTrue(success);
     writeFile(tmpdir, "input", input);
     return rawExecRecognizer(parserName, lexerName, startRuleName, debug);
   }
   protected
   boolean rawGenerateAndBuildRecognizer(String grammarFileName, 
                                         String grammarStr, 
   ...
   boolean rawGenerateAndBuildRecognizer(String grammarFileName, 
                                         ...
                                         String... extraOptions) {
     boolean allIsWell =
       antlr(grammarFileName, grammarFileName, grammarStr, defaultListener,
         extraOptions);
     if (!allIsWell) {
       return false;
     }
     ...
     if (parserName != null) {
       ...
       Set<String> optionsSet =
         new HashSet<String>(Arrays.asList(extraOptions));
       if (!optionsSet.contains("-no-listener")) {
         files.add(grammarFileName.substring(0,
                     grammarFileName.lastIndexOf('.')) + "BaseListener.java");
       }
       if (optionsSet.contains("-visitor")) {
         files.add(grammarFileName.substring(0,
                     grammarFileName.lastIndexOf('.')) + "BaseVisitor.java");
       }
       if (optionsSet.contains("-parse-listener")) {
         files.add(grammarFileName.substring(0,
                     grammarFileName.lastIndexOf('.')) + "BaseParseListener.java");
       }
     }
   ...
   protected
   String rawExecRecognizer(String parserName, String lexerName, 
   ...
   public
   String execRecognizer() {
     return execClass("Test");
   }
   public
   String execClass(String className) {
     if (TEST_IN_SAME_PROCESS) {
       ...
       try {
         ...
         Logger.getLogger(BaseTest.class.getName()).log(Level.SEVERE, null,
           ex);
     ...
     try {
       ...
       tmpdir + pathSep + CLASSPATH, className,
       new File(tmpdir, "input").getAbsolutePath() };
       Process process =
         Runtime.getRuntime().exec(args, null, new File(tmpdir));
       StreamVacuum stdoutVacuum =
         new StreamVacuum(process.getInputStream());
       StreamVacuum stderrVacuum =
         new StreamVacuum(process.getErrorStream());
       stdoutVacuum.start();
       stderrVacuum.start();
       process.waitFor();
       stdoutVacuum.join();
   ...
   public
   void testErrors(String[] pairs, boolean printTree) {
   ...
   public
   String getFilenameFromFirstLineOfGrammar(String line) {
   ...
   public
   void testActions(String templates, String actionName, String action, 
                    String expected)
   ...
   public
   static
   class StreamVacuum implements Runnable
   {
   ...
   protected
   void checkGrammarSemanticsError(ErrorQueue equeue, 
     ...
     assertNotNull("no error; " + expectedMessage.errorType + " expected",
       foundMsg);
     assertTrue("error is not a GrammarSemanticsMessage",
       foundMsg instanceof GrammarSemanticsMessage);
     assertEquals(Arrays.toString(expectedMessage.args),
       Arrays.toString(foundMsg.args));
     if (equeue.size() != 1) {
       System.err.println(equeue);
     }
   }
   protected
   void checkGrammarSemanticsWarning(ErrorQueue equeue, 
                                     GrammarSemanticsMessage expectedMessage)
     throws Exception {
     ANTLRMessage foundMsg = null;
     for (int i = 0; i < equeue.warnings.size(); i++) {
   ...
   protected
   void checkError(ErrorQueue equeue, ANTLRMessage expectedMessage)
     throws Exception {
     ANTLRMessage foundMsg = null;
     for (int i = 0; i < equeue.errors.size(); i++) {
       ANTLRMessage m = equeue.errors.get(i);
     ...
     assertTrue("no error; " + expectedMessage.errorType + " expected",
       !equeue.errors.isEmpty());
     assertTrue("too many errors; " + equeue.errors,
       equeue.errors.size() <= 1);
     assertNotNull("couldn't find expected error: " + expectedMessage.errorType,
       foundMsg);
     assertTrue(Arrays.equals(expectedMessage.args, foundMsg.args));
   }
   public
   static
   class FilteringTokenStream extends CommonTokenStream
   {
      public
   ...
   protected
   void writeLexerTestFile(String lexerName, boolean showDFA) {
     ST outputFileST =
   ...
   public
   void writeRecognizerAndCompile(String parserName, String lexerName, 
                                  String parserStartRuleName, boolean debug) {
     if (parserName == null) {
   ...
   protected
   void eraseFiles(final String filesEndingWith) {
   ...
   public
   String getFirstLineOfException() {
   ...
   public
   <K,V> String sortMapToString(Map<K,V> m) {
     if (m == null) {
       return null;
     }
   ...
   public
   List<String> realElements(List<String> elements) {
   ...
   public
   static
   class IntTokenStream implements TokenStream
   {
      IntegerList types;
      int p = 0;
      public
      IntTokenStream(IntegerList types) {
        this.types = types;
      }
      @Override
      public
      ...
      Token LT(int i) {
        ...
        if (rawIndex >= types.size())
          t = new CommonToken(Token.EOF); else
