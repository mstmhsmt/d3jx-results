...
public
class TestATNParserPrediction extends BaseTest
{
   @Test
   public
   void testAorB() throws Exception {
     LexerGrammar lg =
       new LexerGrammar("lexer grammar L;\n" + "A : 'a' ;\n" + "B : 'b' ;\n" + "C : 'c' ;\n");
   ...
   @Test
   public
   void testAmbigDef() throws Exception {
     LexerGrammar lg =
       new LexerGrammar("lexer grammar L;\n" + "ID : 'a'..'z' ;\n" + "SEMI : ';' ;\n" + "INT : '0'..'9'+ ;\n");
     Grammar g =
       new Grammar("parser grammar T;\n" + "tokens {ID;SEMI;INT;}\n" + "a : (ID | ID ID?) SEMI ;");
   ...
   public
   void checkPredictedAlt(LexerGrammar lg, Grammar g, int decision, 
   ...
   public
   synchronized
   DFA getDFA(LexerGrammar lg, Grammar g, String ruleName, 
     ...
     ParserATNSimulator<Token> interp =
       new ParserATNSimulator<Token>(atn,
         new DFA[atn.getNumberOfDecisions()], null);
     IntegerList types = getTokenTypesViaATN(inputString, lexInterp);
     System.out.println(types);
     TokenStream input = new IntTokenStream(types);
     try {
   ...
   public
   void checkDFAConstruction(LexerGrammar lg, Grammar g, int decision, 
