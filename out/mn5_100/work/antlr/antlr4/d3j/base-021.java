...
public class ParserATNSimulator<Symbol extends Token> extends ATNSimulator {
  ...
  public ParserATNSimulator(@NotNull ATN atn) { this(null, atn); }
      ...
      if (s.isCtxSensitive) {
        ...
        ATNConfigSet s0_closure =
            computeStartState(dfa.atnStartState, outerContext, greedy,
                              loopsSimulateTailRecursion);
        ATNConfigSet fullCtxSet = execATNWithFullContext(
            dfa, s, s0_closure, input, startIndex, outerContext,
            decState.getNumberOfTransitions(), greedy);
          ...
          if (greedy) {
            ...
            if (outerContext == ParserRuleContext.EMPTY ||
              ...
              ATNConfigSet s0_closure =
                  computeStartState(dfa.atnStartState, outerContext, greedy,
                                    loopsSimulateTailRecursion);
              fullCtxSet = execATNWithFullContext(
        ...
        if (predictedAlt != ATN.INVALID_ALT_NUMBER &&
          ...
          if (debug)
            System.out.println("nongreedy loop but unique alt " +
                               D.configset.uniqueAlt + " at " + reach);
          D.isAcceptState = true;
          D.prediction = predictedAlt = exitAlt;
        } else {
  ...
  public ATNConfigSet execATNWithFullContext(DFA dfa, DFAState D,
  ...
  predicateDFAState(DFAState D, ATNConfigSet configs, RuleContext outerContext,
                    int nalts) {
  ...
  @Nullable
  public ATNConfig
  getEpsilonTarget(@NotNull ATNConfig config, @NotNull Transition t,
  ...
  @Nullable
  public ATNConfig
  predTransition(@NotNull ATNConfig config, @NotNull PredicateTransition pt,
                 boolean collectPredicates, boolean inContext) {
    if (debug) {
  ...
  protected int resolveToMinAlt(@NotNull DFAState D,
                                IntervalSet conflictingAlts) {
  ...
  @NotNull
  protected DFAState addDFAEdge(@NotNull DFA dfa, @NotNull ATNConfigSet p,
                                int t, @NotNull ATNConfigSet q) {
  ...
  @NotNull
  protected DFAState addDFAState(@NotNull DFA dfa,
                                 @NotNull ATNConfigSet configs) {
