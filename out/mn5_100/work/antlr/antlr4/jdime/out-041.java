...
public class LeftRecursiveRuleAnalyzer extends LeftRecursiveRuleWalker {
  ...
  @Override public void setReturnValues(GrammarAST t) {
    retvals = t;
  }

  @Override public void setAltAssoc(AltAST t, int alt) {
    ...
    if (t.getOptions() != null) {
      ...
      if (a != null) {
        if (a.equals(ASSOC.right.toString())) {
          ...
          if (a.equals(ASSOC.left.toString())) {
            assoc = ASSOC.left;
          } else {
  ...
  @Override public void binaryAlt(AltAST originalAltTree, int alt) {
  ...
  @Override public void prefixAlt(AltAST originalAltTree, int alt) {
    AltAST altTree = (AltAST) originalAltTree.dupTree();
    stripAltLabel(altTree);
  ...
  @Override public void suffixAlt(AltAST originalAltTree, int alt) {
    AltAST altTree = (AltAST) originalAltTree.dupTree();
    String altLabel = altTree.altLabel != null ? altTree.altLabel.getText() : null;
    GrammarAST lrlabel = stripLeftRecursion(altTree);
    String label = lrlabel != null ? lrlabel.getText() : null;
  ...
  @Override public void otherAlt(AltAST originalAltTree, int alt) {
    AltAST altTree = (AltAST) originalAltTree.dupTree();
    stripAltLabel(altTree);
    String altText = text(altTree);
    String altLabel = altTree.altLabel != null ? altTree.altLabel.getText() : null;
...
<<<<<<< commits-mn5_100/antlr/antlr4/05b0f645ef1359d787df472036b7068314da535a/LeftRecursiveRuleAnalyzer-ec73337.java
