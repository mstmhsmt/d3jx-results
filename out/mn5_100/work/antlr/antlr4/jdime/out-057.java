...
public abstract class BaseTest {
  ...
  protected String execParser(String grammarFileName, String grammarStr, String parserName, String lexerName, String startRuleName, String input, boolean debug) {
    boolean success = rawGenerateAndBuildRecognizer(grammarFileName, grammarStr, parserName, lexerName, "-parse-listener", "-visitor");
    assertTrue(success);
    writeFile(tmpdir, "input", input);
  ...
  protected boolean rawGenerateAndBuildRecognizer(String grammarFileName, String grammarStr, @Nullable String parserName, String lexerName, boolean defaultListener, String... extraOptions) {
    boolean allIsWell = antlr(grammarFileName, grammarFileName, grammarStr, defaultListener, extraOptions);
    if (!allIsWell) {
      return false;
    }
  ...
  public static class FilteringTokenStream extends CommonTokenStream {
    ...
    @Override protected void sync(int i) {
      super.sync(i);
      Token t = get(i);
  ...
  public static class IntTokenStream implements TokenStream {
    ...
    @Override public String getText(RuleContext ctx) {
      throw new UnsupportedOperationException("can\'t give strings");
    }

    @Override public String getText(Token start, Token stop) {
      return null;
    }
  }
}