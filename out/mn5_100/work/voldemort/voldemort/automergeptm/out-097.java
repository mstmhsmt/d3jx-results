...
public abstract class AbstractFailureDetector implements FailureDetector {
  ...
  @JmxGetter(name = "availableNodes", description = "The available nodes") public String getAvailableNodes() {
  ...
  @JmxGetter(name = "unavailableNodes", description = "The unavailable nodes") public String getUnavailableNodes() {
    List<String> list = new ArrayList<String>();
    for (Node node : getConfig().getNodes()) {
      if (!isAvailable(node)) {
        list.add(String.valueOf(node.getId()));
  ...
  @JmxGetter(name = "availableNodeCount", description = "The number of available nodes") public int getAvailableNodeCount() {
    int available = 0;
    for (Node node : getConfig().getNodes()) {
      if (isAvailable(node)) {
        available++;
  ...
  @JmxGetter(name = "nodeCount", description = "The number of total nodes") public int getNodeCount() {
