...
public class ServerTestUtils {
  ...
  public static AbstractSocketService getSocketService(String clusterXml, String storesXml, String storeName, int port, RequestFormatType type) {
  ...
  public static List<StoreDefinition> getStoreDefs(int numStores) {
    ...
    for (int i = 0; i < numStores; i++) {
      defs.add(new StoreDefinition("test" + i, InMemoryStorageConfiguration.TYPE_NAME, serDef, serDef, RoutingTier.SERVER, RoutingStrategyType.CONSISTENT_STRATEGY, 2, 1, 1, 1, 1, 1));
    }
    return defs;
  }
...
=======
  public static SocketServer getSocketServer(String clusterXml, String storesXml, String storeName, int port) {
    RequestHandlerFactory factory = new RequestHandlerFactory(getStores(storeName, clusterXml, storesXml), null, null);
