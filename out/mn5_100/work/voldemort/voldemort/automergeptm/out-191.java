...
public class ReadOnlyStorageEngine implements StorageEngine<ByteArray, byte[]> {
  ...
  /**
     ...
     */
  @JmxOperation(description = "swapFiles(newStoreDirectory) changes this store " + " to use the new data directory.") public void swapFiles(String newStoreDirectory) {
  ...
  /**
     ...
     */
  @JmxOperation(description = "Rollback to a previous version") public void rollback(File rollbackToDir) {
...
<<<<<<< commits-mn5_100/voldemort/voldemort/61f4d167b2675fbf5aad29d0e8d6f94871c2986b/ReadOnlyStorageEngine-a95f002.java
...
>>>>>>> Unknown file: This is a bug in JDime.
    ...
    byte[] 
<<<<<<< commits-mn5_100/voldemort/voldemort/61f4d167b2675fbf5aad29d0e8d6f94871c2986b/ReadOnlyStorageEngine-a95f002.java
    location = searchStrategy.indexOf(fileSet.indexFileFor(chunk), ByteUtils.md5(key.get()), fileSet.getIndexFileSize(chunk))
=======
>>>>>>> Unknown file: This is a bug in JDime.
    ;
    try {
  ...
  @JmxGetter(name = "name", description = "The name of the store.") public String getName() {
    return name;
  }
