...
public class PerformSerialRequests<V extends java.lang.Object, PD extends BasicPipelineData<V>> extends AbstractKeyBasedAction<ByteArray, V, PD> {
  ...
  public PerformSerialRequests(PD pipelineData, Event completeEvent, ByteArray key, FailureDetector failureDetector, Map<Integer, Store<ByteArray, byte[], byte[]>> stores, int preferred, int required, StoreRequest<V> storeRequest, Event insufficientSuccessesEvent) {
