...
public class StoreUtils {
  ...
  public static <K extends java.lang.Object> void assertValidKey(K key) {
    if (key == null) {
  ...
  /**
     ...
     */
  public static <K extends java.lang.Object, V extends java.lang.Object> List<Versioned<V>> get(Store<K, V> storageEngine, K key) {
  ...
  /**
     ...
     */
  public static <K extends java.lang.Object, V extends java.lang.Object> Map<K, List<Versioned<V>>> getAll(Store<K, V> storageEngine, Iterable<K> keys) {
  ...
  /**
     ...
     * returned.
     */
  public static <K extends java.lang.Object, V extends java.lang.Object> HashMap<K, V> newEmptyHashMap(Iterable<?> iterable) {
  ...
  public static void assertValidMetadata(ByteArray key, RoutingStrategy routingStrategy, int currentNodeId) {
  ...
  public static <V extends java.lang.Object> List<Version> getVersions(List<Versioned<V>> versioneds) {
  ...
  public static <K extends java.lang.Object, V extends java.lang.Object> ClosableIterator<K> keys(final ClosableIterator<Pair<K, V>> values) {
  ...
  /**
     ...
     */
  @SuppressWarnings(value = { "unchecked" }) public static <T extends java.lang.Object> Serializer<T> unsafeGetSerializer(SerializerFactory serializerFactory, SerializerDefinition serializerDefinition) {
