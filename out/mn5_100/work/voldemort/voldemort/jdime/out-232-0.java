...
public class SocketStoreClientFactory extends AbstractStoreClientFactory {
  ...
  @Override public <K extends java.lang.Object, V extends java.lang.Object> StoreClient<K, V> getStoreClient(final String storeName, final InconsistencyResolver<Versioned<V>> resolver) {
  ...
  private <K extends java.lang.Object, V extends java.lang.Object> StoreClient<K, V> getParentStoreClient(String storeName, InconsistencyResolver<Versioned<V>> resolver) {
    return super.getStoreClient(storeName, resolver);
  }

  @Override protected List<Versioned<String>> getRemoteMetadata(String key, URI url) {
    try {
  ...
  @Override protected Store<ByteArray, byte[], byte[]> getStore(String storeName, String host, int port, RequestFormatType type) {
    return storeFactory.create(storeName, host, port, type, requestRoutingType);
  }

  @Override protected FailureDetector initFailureDetector(final ClientConfig config, final Collection<Node> nodes) {
  ...
  @Override protected int getPort(Node node) {
    return node.getSocketPort();
  }

  @Override protected void validateUrl(URI url) {
