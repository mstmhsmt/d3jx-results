...
public final class VAdminProto {
  ...
  .google.protobuf.ProtocolMessageEnum {
    GET_METADATA(0, 0), UPDATE_METADATA(1, 1), UPDATE_PARTITION_ENTRIES(2, 2),
        ...
        REPAIR_JOB(23, 25), INITIATE_REBALANCE_NODE_ON_DONOR(23, 25),
  ...
  public static final class VoldemortAdminRequest
    ...
    public int getSerializedSize() {
      ...
      if (hasInitiateRebalanceNodeOnDonor()) {
        size += com.google.protobuf.CodedOutputStream.computeMessageSize(
            27, getInitiateRebalanceNodeOnDonor());
      }
      if (hasDeleteStoreRebalanceState()) {
        size += com.google.protobuf.CodedOutputStream.computeMessageSize(
            28, getDeleteStoreRebalanceState());
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSerializedSize = size;
      return size;
  ...
  static {
    java.lang.String[] descriptorData = {
        ...
        "InfoMap\022\026\n\016cluster_string\030\002 \002(\t\022\017\n\007swap_"
            ...
            + "nse\022\037\n\005error\030\001 " +
              "\001(\0132\020.voldemort.Error\"G\n "
