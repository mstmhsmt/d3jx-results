...
class VoldemortConfig implements Serializable
{
   ...
   VoldemortConfig(Props props) {
     ...
     props.getBytes("bdb.max.logfile.size", 1024 * 1024 * 1024);
     ...
     this.readOnlyFileWaitTimeoutMs =
     props.getLong("readonly.file.wait.timeout.ms", 4000L);
     ...
     this.clientMaxTotalConnections =
     props.getInt("client.max.total.connections", 100);
   ...
   public
   int getClientMaxTotalConnections() {
     return clientMaxTotalConnections;
   }
   public
   void setClientMaxTotalConnections(int maxTotalConnections) {
   ...
   public
   int getReadOnlyStorageFileHandles() {
     return readOnlyFileHandles;
   }
   public
   void setReadOnlyFileHandles(int readOnlyFileHandles) {
     this.readOnlyFileHandles = readOnlyFileHandles;
   }
   public
   long getReadOnlyFileWaitTimeoutMs() {
     return readOnlyFileWaitTimeoutMs;
   }
   public
   void setReadOnlyFileWaitTimeoutMs(long timeoutMs) {
