...
class VoldemortConfig implements Serializable
{
   ...
   VoldemortConfig(Props props) {
     ...
     this.fsStorageDirs =
     props.getList("fs.storage.dirs",
       Collections.singletonList(this.dataDirectory + File.separator + "fs"));
     ...
     this.fsStorageNumLockStripes =
     props.getInt("fs.storage.lock.stripes", 200);
     this.slopStoreType =
     ...
     props.getInt("admin.client.socket.timeout.ms", 5 * 60 * 1000);
     this.adminSocketTimeout =
     props.getInt("admin.client.socket.timeout.ms", 10000);
     this.streamMaxReadBytesPerSec =
     props.getInt("stream.read.byte.per.sec", 1 * 1000 * 1000);
     this.streamMaxWriteBytesPerSec =
     props.getInt("stream.write.byte.per.sec", 1 * 1000 * 1000);
   ...
   public
   int getFsStorageDirFanOut() {
     return fsStorageDirFanOut;
   }
   public
   void setFsStorageDirDepth(int fsStorageDirDepth) {
     this.fsStorageDirDepth = fsStorageDirDepth;
   }
   public
   int getFsStorageDirDepth() {
   ...
   public
   List<String> getFsStorageDirs() {
     return fsStorageDirs;
   }
   public
   void setFsStorageDirs(List<String> fsStorageDirs) {
     this.fsStorageDirs = fsStorageDirs;
   }
   public
   void setFsStorageDirFanOut(int fsStorageDirFanOut) {
     this.fsStorageDirFanOut = fsStorageDirFanOut;
   }
   public
   int getFsStorageNumLockStripes() {
     return fsStorageNumLockStripes;
   }
   public
   void setFsStorageNumLockStripes(int fsStorageNumLockStripes) {
