...
class VoldemortConfig implements Serializable
{
   ...
   VoldemortConfig(Props props) {
     ...
     props.getInt("admin.client.connection.timeout.sec", 60);
     this.adminSocketTimeout =
     props.getInt("admin.client.socket.timeout.sec", 24 * 60 * 60);
     this.streamMaxReadBytesPerSec =
     props.getBytes("stream.read.byte.per.sec", 10 * 1000 * 1000);
     this.streamMaxWriteBytesPerSec =
     props.getBytes("stream.write.byte.per.sec", 10 * 1000 * 1000);
     ...
     props.getInt("nio.admin.connector.selectors",
       Math.max(8, Runtime.getRuntime().availableProcessors()));
     ...
     this.enablePipelineRoutedStore =
     props.getBoolean("enable.pipeline.routed.store", false);
     ...
     props.getInt("max.parallel.stores.rebalancing", 3);
