  ...
  extends AbstractKeyBasedAction<ByteArray,V,PD>
{
   ...
   public
   PerformSerialRequests(PD pipelineData, Event completeEvent, ByteArray key, 
                         FailureDetector failureDetector, 
                         Map<Integer,Store<ByteArray,byte[],byte[]>> stores, 
                         int preferred, int required, 
   ...
   void execute(Pipeline pipeline) {
     ...
     while (pipelineData.getSuccesses() < preferred && pipelineData.getNodeIndex() < 
     nodes.size()) {
       ...
       try {
         ...
         Response<ByteArray,V> response =
           new Response<ByteArray,V>(node, key, result,
