...
public class JsonTypeDefinition implements Serializable {
  ...
  public final static JsonTypeDefinition INT8 =
      JsonTypeDefinition.fromJson("\"int8\"");
  public final static JsonTypeDefinition INT16 =
      JsonTypeDefinition.fromJson("\"int16\"");
  public final static JsonTypeDefinition INT32 =
      JsonTypeDefinition.fromJson("\"int32\"");
  public final static JsonTypeDefinition INT64 =
      JsonTypeDefinition.fromJson("\"int64\"");
  public final static JsonTypeDefinition FLOAT32 =
      JsonTypeDefinition.fromJson("\"float32\"");
  public final static JsonTypeDefinition FLOAT64 =
      JsonTypeDefinition.fromJson("\"float64\"");
  public final static JsonTypeDefinition STRING =
      JsonTypeDefinition.fromJson("\"string\"");
  public final static JsonTypeDefinition DATE =
      JsonTypeDefinition.fromJson("\"date\"");
  public final static JsonTypeDefinition BOOLEAN =
      JsonTypeDefinition.fromJson("\"boolean\"");
  private Object type;
<<<<<<< /root/work/voldemort/voldemort/d3j/patched-183-0.java
  public JsonTypeDefinition(Object type) { this.type = validate(type); }
||||||| /root/work/voldemort/voldemort/d3j/base-183.java
  public JsonTypeDefinition(Object type) {
    this.type = type;
    validate(type);
  }
=======
  public JsonTypeDefinition(Object type) { this.type = createValidType(type); }
>>>>>>> /root/work/voldemort/voldemort/d3j/patched-183-1.java
  public static JsonTypeDefinition fromJson(String typeSig) {
    if (typeSig == null)
      throw new IllegalArgumentException(
          "The type signiture for a JsonTypeDefinition cannot be null!");
    ...
    if (o instanceof Map) {
      ...
      if (l.size() != 1)
        throw new SerializationException(
            "List type must have a single entry specifying entry type.");
      ...
      throw new SerializationException(
          o + " is not a string, an array, or an object, "
  ...
  public JsonTypeDefinition projectionType(String... properties) {
    if (this.getType() instanceof Map<?, ?>) {
      ...
      throw new IllegalArgumentException(
          "Cannot take the projection of a type that is not a Map.");
    }
  }
  ...
  public static String format(Object type) {
    ...
    if (type instanceof JsonTypes) {
      ...
      throw new SerializationException("Current type is " + type +
                                       " of class " + type.getClass() +
                                       " which is not allowed.");
    }
    return b.toString();
  }
  public void validate() { createValidType(getType()); }
  private Object createValidType(Object type) {
    if (type == null) {
      ...
      if (l.size() != 1)
        throw new IllegalArgumentException(
            "Lists in type definition must have length exactly one.");
<<<<<<< /root/work/voldemort/voldemort/d3j/patched-183-0.java
...
>>>>>>> /root/work/voldemort/voldemort/d3j/patched-183-1.java
      ...
      throw new IllegalArgumentException(
          "Unknown type in json type definition: " + type + " of class " +
