...
public class SocketServer extends Thread {
    ...
    final private CountDownLatch isStarted = new CountDownLatch(1);

    final private int socketBufferSize;

    final private RequestHandlerFactory handlerFactory;

    final private int maxThreads;

    final private StatusManager statusManager;

    final private AtomicLong sessionIdSequence;

    final private ConcurrentMap<Long, SocketServerSession> activeSessions;
    ...
    final private RejectedExecutionHandler rejectedExecutionHandler = new RejectedExecutionHandler() {
    ...
    @JmxGetter(description = "The number of additional threads that can be allocated before reaching the maximum.", name = "remainingThreadCapacity")
