...
<<<<<<< commits-mn5_100/voldemort/voldemort/f77be6f063214d91daf3a4b465546068fd1420e9/RoutedStore-e4772a5.java
...
>>>>>>> commits-mn5_100/voldemort/voldemort/7763aabd2c880c29c8647efa72edfebd74f83a12/RoutedStore-56403d6.java
    ...
    private List<Node> availableNodes(List<Node> list) {
        ...
        for (Node node : list) if (failureDetector.isAvailable(node))
            available.add(node);
        return available;
    }
