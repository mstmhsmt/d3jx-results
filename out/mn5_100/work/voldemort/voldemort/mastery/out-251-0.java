...
if (hasInitiateRebalanceNodeOnDonor()) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(27, getInitiateRebalanceNodeOnDonor());
            }
...
internal_static_voldemort_ROStoreVersionDirMap_descriptor = getDescriptor().getMessageTypes().get(39);
                ...
                internal_static_voldemort_ROStoreVersionDirMap_descriptor = getDescriptor().getMessageTypes().get(40);
