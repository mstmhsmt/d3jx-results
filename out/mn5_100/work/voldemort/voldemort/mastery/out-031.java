...
public class ServerTestUtils {
    ...
    public static AbstractSocketService getSocketService(String clusterXml, String storesXml, String storeName, int port) {
        RequestHandlerFactory factory = new RequestHandlerFactory(getStores(storeName, clusterXml, storesXml), null, null);
        
<<<<<<< commits-mn5_100/voldemort/voldemort/f946d4aefe0c639621f7f3ce98a7b0d803d08152/ServerTestUtils-f73c66e.java
...
>>>>>>> commits-mn5_100/voldemort/voldemort/bbd884ae3a5437927871285ac28c4adef56b3134/ServerTestUtils-4a1ce3a.java
    ...
    public static List<StoreDefinition> getStoreDefs(int numStores) {
        ...
        for (int i = 0; i < numStores; i++) defs.add(new StoreDefinition("test" + i, InMemoryStorageConfiguration.TYPE_NAME, serDef, serDef, RoutingTier.SERVER, RoutingStrategyType.CONSISTENT_STRATEGY, 2, 1, 1, 1, 1, 1));
        return defs;
    }
    ...
    public static StoreDefinition getStoreDef(String storeName, int replicationFactor, int preads, int rreads, int pwrites, int rwrites, String strategyType) {
        SerializerDefinition serDef = new SerializerDefinition("string");
        return new StoreDefinition(storeName, InMemoryStorageConfiguration.TYPE_NAME, serDef, serDef, RoutingTier.SERVER, strategyType, replicationFactor, preads, rreads, pwrites, rwrites, 1);
    }
    ...
    public static AbstractSocketService getSocketService(RequestHandler requestHandler, int port, int coreConnections, int maxConnections, int bufferSize) {
        ...
        if (true) {
            ...
            socketService = new SocketService(requestHandler, port, coreConnections, maxConnections, bufferSize, "client-request-service");
        }
