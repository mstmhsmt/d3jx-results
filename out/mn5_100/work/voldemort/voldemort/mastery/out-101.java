...
public class VoldemortConfig implements Serializable {
    ...
    static final public String VOLDEMORT_HOME_VAR_NAME = "VOLDEMORT_HOME";

    private static final String VOLDEMORT_NODE_ID_VAR_NAME = "VOLDEMORT_NODE_ID";

    static public int VOLDEMORT_DEFAULT_ADMIN_PORT = 6660;
    ...
    public VoldemortConfig(Props props) {
        ...
        this.failureDetectorRequestLengthThreshold = props.getLong("failuredetector.request.length.threshold", clientRoutingTimeoutMs / 10);
    ...
    static public VoldemortConfig loadFromEnvironmentVariable() {
    ...
    static public VoldemortConfig loadFromVoldemortHome(String voldemortHome) {
    ...
    final public void setBdbCleanerMinFileUtilization(int minFileUtilization) {
    ...
    final public void setBdbCleanerMinUtilization(int minUtilization) {
