...
public class ServerTestUtils {
    ...
    public static AbstractSocketService getSocketService(String clusterXml, String storesXml, String storeName, int port) {
        RequestHandlerFactory factory = new RequestHandlerFactory(getStores(storeName, clusterXml, storesXml), null, getVoldemortConfig());
    ...
    public static AbstractSocketService getSocketService(RequestHandlerFactory requestHandlerFactory, int port, int coreConnections, int maxConnections, int bufferSize) {
    ...
    public static SocketStore getSocketStore(String storeName, int port, int timeout) {
        ...
        return new SocketStore(storeName, "localhost", port, socketPool, RequestFormatType.VOLDEMORT, false);
    }
