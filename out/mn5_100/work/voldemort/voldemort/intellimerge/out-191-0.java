...
public class ReadOnlyStorageEngine implements StorageEngine<ByteArray, byte[]> {
     ...
     * Close the store.
     */
    public void close() throws VoldemortException throws VoldemortException {
     ...
     */
    @JmxOperation(description = "swapFiles(newStoreDirectory) changes this store " + " to use the new data directory.")
