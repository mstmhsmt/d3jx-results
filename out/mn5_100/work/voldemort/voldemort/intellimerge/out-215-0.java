...
public class AdminServiceFailureTest extends TestCase {
    ...
    private enum StreamOperations {        FETCH_ENTRIES,        FETCH_KEYS,        DELETE_PARTITIONS,        UPDATE_ENTRIES,        TRUNCATE_ENTRIES}
    ...
    @Override
    @After
    public void tearDown() throws IOException throws IOException {
        try {
            adminServer.stop();
            adminClient.stop();
        } catch(Exception e) {
