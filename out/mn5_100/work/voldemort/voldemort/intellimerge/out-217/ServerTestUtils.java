...
public class ServerTestUtils {
    ...
    public static Context getJettyServer(String clusterXml,
                                         ...
                                         int port) throws Exception throws Exception {
    ...
    public static VoldemortConfig createServerConfig(boolean useNio,
                                                     ...
                                                     String clusterFile,
                                                     String storeFile,
                                                     Properties properties) throws IOException throws IOException {
    ...
    public static void stopVoldemortServer(VoldemortServer server) throws IOException throws IOException {
        try {
            server.stop();
        } finally {
