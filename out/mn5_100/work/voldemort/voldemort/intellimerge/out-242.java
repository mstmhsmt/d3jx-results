...
public class StoreUtils {
     ...
     */
    public static public static <K, V> List<Versioned<V>> get(Store<K, V> storageEngine, K key) {
     ...
     */
    public static public static <K, V> Map<K, List<Versioned<V>>> getAll(Store<K, V> storageEngine,
                                                           Iterable<K> keys) {
     ...
     * returned.
     */
    public static public static <K, V> HashMap<K, V> newEmptyHashMap(Iterable<?> iterable) {
    ...
    public static public static <K, V> ClosableIterator<K> keys(final ClosableIterator<Pair<K, V>> values) {
