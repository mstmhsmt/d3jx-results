...
public class AdminClient {
    ...
    private void initiateFetchRequest(DataOutputStream outputStream,
                                      ...
                                      VoldemortFilter filter,
                                      boolean fetchValues) throws IOException throws IOException {
    ...
    private VAdminProto.VoldemortFilter encodeFilter(VoldemortFilter filter) throws IOException throws IOException {
     ...
     * @throws VoldemortException
     */
    public Versioned<Cluster> getRemoteCluster(int nodeId) throws VoldemortException throws VoldemortException {
