...
public class RoutedStore implements Store<ByteArray, byte[]> {
    ...
    public boolean delete(final ByteArray key, final Version version) throws VoldemortException throws VoldemortException {
    ...
    private final class GetCallable<R> implements Callable<GetResult<R>> {
        ...
        public GetResult<R> call() throws Exception throws Exception {
