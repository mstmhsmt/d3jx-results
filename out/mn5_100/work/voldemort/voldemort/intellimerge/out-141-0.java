...
public class BdbStorageEngine implements StorageEngine<ByteArray, byte[]> {
    ...
    public List<Versioned<byte[]>> get(ByteArray key) throws PersistenceFailureException throws PersistenceFailureException {
    ...
    private static <T> List<T> get(Cursor cursor,
                                   ByteArray key,
                                   LockMode lockMode,
                                   Serializer<T> serializer) throws DatabaseException throws DatabaseException {
        StoreUtils.assertValidKey(key);
    ...
    public void put(ByteArray key, Versioned<byte[]> value) throws PersistenceFailureException throws PersistenceFailureException {
        StoreUtils.assertValidKey(key);
    ...
    public boolean delete(ByteArray key, Version version) throws PersistenceFailureException throws PersistenceFailureException {
        StoreUtils.assertValidKey(key);
    ...
    public void close() throws PersistenceFailureException throws PersistenceFailureException {
        try {
