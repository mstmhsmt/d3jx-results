...
public class RoutedStoreTest extends AbstractByteArrayStoreTest {
    ...
    @Override
    public Store<ByteArray, byte[], byte[]> getStore() throws Exception throws Exception {
    ...
    private RoutedStore getStore(Cluster cluster,
                                 ...
                                 int sleepy,
                                 String strategy,
                                 VoldemortException throws Exception {
    ...
    @Test
    public void testBasicOperationsSingleThreaded() throws Exception throws Exception {
        testBasicOperations(cluster.getNumberOfNodes(), cluster.getNumberOfNodes(), 0, 1);
    }
    
    @Test
    public void testBasicOperationsMultiThreaded() throws Exception throws Exception {
        testBasicOperations(cluster.getNumberOfNodes(), cluster.getNumberOfNodes(), 0, 4);
    }
    
    @Test
    public void testBasicOperationsMultiThreadedWithFailures() throws Exception throws Exception {
    ...
    @Test
    public void testBasicOperationFailureMultiThreaded() throws Exception throws Exception {
    ...
    @Test
    public void testPutIncrementsVersion() throws Exception throws Exception {
    ...
    @Test
    public void testOnlyNodeFailuresDisableNode() throws Exception throws Exception {
        // test put
        cluster = getNineNodeCluster();
    ...
    @Test
    public void testGetVersions2() throws Exception throws Exception {
     ...
     */
    @Test
    public void testGetAllWithNodeDown() throws Exception throws Exception {
    ...
    @Test
    public void testGetAllWithFailingStore() throws Exception throws Exception {
        cluster = VoldemortTestConstants.getTwoNodeCluster();
     ...
     */
    @Test
    public void testGetAllWithMorePreferredReadsThanNodes() throws Exception throws Exception {
        cluster = VoldemortTestConstants.getTwoNodeCluster();
     ...
     */
    @Test
    public void testReadRepairWithFailures() throws Exception throws Exception {
        cluster = getNineNodeCluster();
     ...
     */
    @Test
    public void testPutWithOneNodeDownAndOneNodeSlow() throws Exception throws Exception {
    ...
    @Test
    public void testPutTimeout() throws Exception throws Exception {
        int timeout = 50;
     ...
     */
    @Test
    public void testNoReadRepair() throws Exception throws Exception {
        cluster = VoldemortTestConstants.getThreeNodeCluster();
        StoreDefinition storeDef = ServerTestUtils.getStoreDef("test",
                                                               3,
                                                               2,
