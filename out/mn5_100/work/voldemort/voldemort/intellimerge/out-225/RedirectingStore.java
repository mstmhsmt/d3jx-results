...
public class RedirectingStore extends DelegatingStore<ByteArray, byte[]> {
    ...
    @Override
    public void put(ByteArray key, Versioned<byte[]> value) throws VoldemortException throws VoldemortException {
    ...
    @Override
    public List<Versioned<byte[]>> get(ByteArray key) throws VoldemortException throws VoldemortException {
        RebalancePartitionsInfo stealInfo = redirectingKey(key);
     ...
     */
    @Override
    public boolean delete(ByteArray key, Version version) throws VoldemortException throws VoldemortException {
     ...
     */
    private void proxyGetAndLocalPut(ByteArray key, int donorId) throws VoldemortException throws VoldemortException {
     ...
     */
    private void proxyGetAllAndLocalPut(List<ByteArray> keys, List<RebalancePartitionsInfo> stealInfoList) throws VoldemortException throws VoldemortException {
