...
public class VoldemortNativeRequestHandler extends AbstractRequestHandler implements RequestHandler {
    ...
    private ByteArray readKey(DataInputStream inputStream) throws IOException throws IOException {
    ...
    private void handleGet(DataInputStream inputStream,
                           ...
                           Store<ByteArray, byte[]> store) throws IOException throws IOException {
    ...
    private void writeException(DataOutputStream stream, VoldemortException e) throws IOException throws IOException {
