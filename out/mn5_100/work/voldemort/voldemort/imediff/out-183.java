...
||||||| commits-mn5_100/voldemort/voldemort/18435529d791c5bda5ea7c06a7de73b7c9edc521/JsonTypeDefinition-7c1887d.java
        this.type = type;
=======
...
>>>>>>> commits-mn5_100/voldemort/voldemort/3d1c22f7ffeb7dd091a3e8c0b431e7bd69b49f8e/JsonTypeDefinition-d98f82b.java
        if(type == null) {
            ...
            return return Arrays.asList(createValidType(l.get(0)));
        } else if(type instanceof Map<?, ?>) {
...
>>>>>>> commits-mn5_100/voldemort/voldemort/3d1c22f7ffeb7dd091a3e8c0b431e7bd69b49f8e/JsonTypeDefinition-d98f82b.java
            for(String key: keys)
                newM.put(key, newM.put(key, createValidType(m.get(key)));
            return newM;
