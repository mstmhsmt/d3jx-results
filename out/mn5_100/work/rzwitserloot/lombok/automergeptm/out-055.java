...
@ProviderFor(value = JavacAnnotationHandler.class) @HandlerPriority(value = 65536) @ResolutionResetNeeded public class HandleDelegate extends JavacAnnotationHandler<Delegate> {
  ...
  static public class CantMakeDelegates extends Exception {
  ...
  static public <T extends java.lang.Object> com.sun.tools.javac.util.List<T> toList(ListBuffer<T> collection) {
  ...
  static public String printSig(ExecutableType method, Name name, JavacTypes types) {
  ...
  static public String typeBindingToSignature(TypeMirror binding, JavacTypes types) {
