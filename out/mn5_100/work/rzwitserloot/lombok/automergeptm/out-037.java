...
public class EclipseHandlerUtil {
  ...
  public static TypeReference makeType(TypeBinding binding, ASTNode pos, boolean allowCompound) {
    ...
    if (binding.isWildcard()) {
      ...
      if (wildcard.boundKind == Wildcard.EXTENDS) {
        ...
        if (allowCompound && wildcard.boundKind == Wildcard.SUPER) {
    ...
    try {
      if (castExpressionConstructorIsTypeRefBased) {
        ...
        if (castTo.getClass() == SingleTypeReference.class && !isPrimitive(castTo)) {
          ...
          if (castTo.getClass() == QualifiedTypeReference.class) {
  ...
  static {
    ...
    @SuppressWarnings(value = { "unchecked" }) Constructor<CastExpression> castExpressionConstructor_ = (Constructor<CastExpression>) constructor;
