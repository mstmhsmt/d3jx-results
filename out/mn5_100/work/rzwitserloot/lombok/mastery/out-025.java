...
public class EclipseHandlerUtil {
    ...
    static void registerCreatedLazyGetter(FieldDeclaration field, char[] methodName, TypeReference returnType) {
        if (!nameEquals(returnType.getTypeName(), "boolean") || returnType.dimensions() > 0)
            return;
    ...
    static public boolean filterField(FieldDeclaration declaration) {
        ...
        if (declaration.name.length > 0 && declaration.name[0] == '$')
            return false;
        if ((declaration.modifiers & ClassFileConstants.AccStatic) != 0)
            return false;
        return true;
    }
    ...
    static public void injectFieldSuppressWarnings(EclipseNode type, FieldDeclaration field) {
        field.annotations = createSuppressWarningsAll(field, field.annotations);
        injectField(type, field);
    }

    static public void injectField(EclipseNode type, FieldDeclaration field) {
    ...
    static public void injectMethod(EclipseNode type, AbstractMethodDeclaration method) {
