...
public class EclipseHandlerUtil {
    ...
    static public void error(CompilationUnitDeclaration cud, String message, Throwable error) {
        error(cud, message, null, error);
    }

    static public void error(CompilationUnitDeclaration cud, String message, String bundleName, Throwable error) {
        if (bundleName == null)
    ...
    static public void warning(String message, Throwable error) {
        warning(message, null, error);
    }

    static public void warning(String message, String bundleName, Throwable error) {
        if (bundleName == null)
            bundleName = DEFAULT_BUNDLE;
        try {
    ...
    static public ASTNode getGeneratedBy(ASTNode node) {
        return generatedNodes.get(node);
    }

    static public boolean isGenerated(ASTNode node) {
        return getGeneratedBy(node) != null;
    }

    static public ASTNode setGeneratedBy(ASTNode node, ASTNode source) {
        generatedNodes.set(node, source);
        return node;
    }

    static public MarkerAnnotation generateDeprecatedAnnotation(ASTNode source) {
    ...
    static public boolean isFieldDeprecated(EclipseNode fieldNode) {
    ...
    static public boolean typeMatches(Class<?> type, EclipseNode node, TypeReference typeRef) {
    ...
    static public void sanityCheckForMethodGeneratingAnnotationsOnBuilderClass(EclipseNode typeNode, EclipseNode errorNode) {
    ...
    static public Annotation copyAnnotation(Annotation annotation, ASTNode source) {
    ...
    static public TypeParameter[] copyTypeParams(TypeParameter[] params, ASTNode source) {
        if (params == null)
            return null;
    ...
    static public TypeReference namePlusTypeParamsToTypeReference(char[] typeName, TypeParameter[] params, long p) {
    ...
    static public TypeReference[] copyTypes(TypeReference[] refs, ASTNode source) {
        if (refs == null)
            return null;
    ...
    static public TypeReference copyType(TypeReference ref, ASTNode source) {
    ...
    static public Annotation[] copyAnnotations(ASTNode source, Annotation[]... allAnnotations) {
    ...
    static public boolean hasAnnotation(Class<? extends java.lang.annotation.Annotation> type, EclipseNode node) {
        if (node == null)
            return false;
        if (type == null)
            return false;
    ...
    static public boolean annotationTypeMatches(Class<? extends java.lang.annotation.Annotation> type, EclipseNode node) {
        if (node.getKind() != Kind.ANNOTATION)
            return false;
        return typeMatches(type, node, ((Annotation) node.get()).type);
    }

    static public TypeReference cloneSelfType(EclipseNode context, ASTNode source) {
        int pS = source.sourceStart, pE = source.sourceEnd;
    ...
    static public TypeReference makeType(TypeBinding binding, ASTNode pos, boolean allowCompound) {
    ...
    static public <A extends java.lang.annotation.Annotation> AnnotationValues<A> createAnnotation(Class<A> type, final EclipseNode annotationNode) {
        ...
        for (Method m : type.getDeclaredMethods()) {
            ...
            if (isExplicit) {
                if (fullExpression instanceof ArrayInitializer) {
                    ...
                    expressions = new Expression[] { fullExpression };
                if (expressions != null)
    ...
    static public int toEclipseModifier(AccessLevel value) {
        switch(value) {
            case MODULE:
            case PACKAGE:
                return 0;
    ...
    static public boolean isBoolean(TypeReference typeReference) {
    ...
    static public boolean filterField(FieldDeclaration declaration) {
        return filterField(declaration, true);
    }

    static public boolean filterField(FieldDeclaration declaration, boolean skipStatic) {
    ...
    static public char[] removePrefixFromField(EclipseNode field) {
    ...
    static public AnnotationValues<Accessors> getAccessorsForField(EclipseNode field) {
        for (EclipseNode node : field.down()) {
            if (annotationTypeMatches(Accessors.class, node)) {
    ...
    static public MemberExistsResult fieldExists(String fieldName, EclipseNode node) {
    ...
    static public MemberExistsResult methodExists(String methodName, EclipseNode node, int params) {
        return methodExists(methodName, node, true, params);
    }

    static public MemberExistsResult methodExists(String methodName, EclipseNode node, boolean caseSensitive, int params) {
        while (node != null && !(node.get() instanceof TypeDeclaration)) {
            node = node.up();
        }
        if (node != null && node.get() instanceof TypeDeclaration) {
    ...
    static public MemberExistsResult constructorExists(EclipseNode node) {
        while (node != null && !(node.get() instanceof TypeDeclaration)) {
            node = node.up();
        }
        if (node != null && node.get() instanceof TypeDeclaration) {
    ...
    static public EclipseNode injectFieldSuppressWarnings(EclipseNode type, FieldDeclaration field) {
        field.annotations = createSuppressWarningsAll(field, field.annotations);
        return injectField(type, field);
    }

    static public EclipseNode injectField(EclipseNode type, FieldDeclaration field) {
    ...
    static public boolean isEnumConstant(final FieldDeclaration field) {
        return ((field.initialization instanceof AllocationExpression) && (((AllocationExpression) field.initialization).enumConstant == field));
    }

    static public EclipseNode injectMethod(EclipseNode type, AbstractMethodDeclaration method) {
    ...
    static public EclipseNode injectType(final EclipseNode typeNode, final TypeDeclaration type) {
    ...
    static public Annotation[] createSuppressWarningsAll(ASTNode source, Annotation[] originalAnnotationArray) {
        if (originalAnnotationArray != null)
            for (Annotation ann : originalAnnotationArray) {
                ...
                if (lastToken != null && new String(lastToken).equals("SuppressWarnings"))
    ...
    static public Statement generateNullCheck(AbstractVariableDeclaration variable, ASTNode source) {
        int pS = source.sourceStart, pE = source.sourceEnd;
        long p = (long) pS << 32 | pE;
    ...
    static public MarkerAnnotation makeMarkerAnnotation(char[][] name, ASTNode source) {
    ...
    static public List<Integer> createListOfNonExistentFields(List<String> list, EclipseNode type, boolean excludeStandard, boolean excludeTransient) {
    ...
    static public CastExpression makeCastExpression(Expression ref, TypeReference castTo, ASTNode source) {
    ...
    static public IntLiteral makeIntLiteral(char[] token, ASTNode source) {
        int pS = source.sourceStart, pE = source.sourceEnd;
        IntLiteral result;
        try {
    ...
    private static boolean isAllValidOnXCharacters(char[] in) {
        if (in == null || in.length == 0)
            return false;
        for (char c : in) if (c != '_' && c != 'X' && c != 'x' && c != '$')
            return false;
        return true;
    }

    static public List<Annotation> unboxAndRemoveAnnotationParameter(Annotation annotation, String annotationName, String errorName, EclipseNode errorNode) {
        ...
        for (int i = 0; i < pairs.length; i++) {
            if (pairs[i].name == null || !Arrays.equals(nameAsCharArray, pairs[i].name))
                continue;
    ...
    static public NameReference createNameReference(String name, Annotation source) {
        int pS = source.sourceStart, pE = source.sourceEnd;
        long p = (long) pS << 32 | pE;
