...
class Javac
{
   ...
   private static final Pattern PRIMITIVE_TYPE_NAME_PATTERN =
     Pattern.compile("^(boolean|byte|short|int|long|float|double|char)$");
   private static final Pattern VERSION_PARSER =
     Pattern.compile("^(\\d{1,6})\\.(\\d{1,6}).*$");
   public
   static
   int getJavaCompilerVersion() {
   ...
   Object calculateGuess(JCExpression expr) {
     if (expr instanceof JCLiteral) {
       ...
       if (x.endsWith(".class"))
         x = x.substring(0, x.length() - 6); else {
   ...
   public
   static
   boolean compareCTC(Object ctc1, Object ctc2) {
     return Objects.equals(ctc1, ctc2);
   }
   public
   static
   Object getTypeTag(String identifier) {
     try {
   ...
   public
   static
   Object getTreeTag(String identifier) {
     try {
       if (JavaCompiler.version().startsWith("1.8")) {
   ...
   public
   static
   Object getTreeTypeTag(JCPrimitiveTypeTree tree) {
     return tree.typetag;
   }
   private static final Method JCTREE_GETTAG;
   public
   static
   Object getTreeTypeTag(JCLiteral tree) {
     return tree.typetag;
   }
   static 
   {
   ...
   public
   static
   JCExpression makeTypeIdent(TreeMaker maker, Object ctc) {
     try {
       Method createIdent;
       if (JavaCompiler.version().startsWith("1.8")) {
         createIdent =
         TreeMaker.class.getMethod("TypeIdent",
   ...
   public
   static
   JCLiteral makeLiteral(TreeMaker maker, Object ctc, Object argument) {
     try {
       Method createLiteral;
       if (JavaCompiler.version().startsWith("1.8")) {
         createLiteral =
         TreeMaker.class.getMethod("Literal",
           Class.forName("com.sun.tools.javac.code.TypeTag"), Object.class);
       } else {
         createLiteral =
         TreeMaker.class.getMethod("Literal", Integer.TYPE, Object.class);
       }
   ...
   public
   static
   JCUnary makeUnary(TreeMaker maker, Object ctc, JCExpression argument) {
     try {
       Method createUnary;
       if (JavaCompiler.version().startsWith("1.8")) {
         createUnary =
         TreeMaker.class.getMethod("Unary",
           Class.forName("com.sun.tools.javac.code.TypeTag"),
           JCExpression.class);
       } else {
         createUnary =
         TreeMaker.class.getMethod("Unary", Integer.TYPE, JCExpression.class);
       }
   ...
   public
   static
   JCClassDecl ClassDef(TreeMaker maker, JCModifiers mods, Name name, 
     ...
     if (method == null)
       try {
       method =
       TreeMaker.class.getDeclaredMethod("ClassDef", JCModifiers.class,
         Name.class, List.class, JCExpression.class, List.class, List.class);
     } catch (NoSuchMethodException ignore) {} 
     if (method == null)
       try {
       method =
       TreeMaker.class.getDeclaredMethod("ClassDef", JCModifiers.class,
         Name.class, List.class, JCTree.class, List.class, List.class);
     } catch (NoSuchMethodException ignore) {} 
     if (method == null)
     ...
     try {
       return (JCClassDecl)method.invoke(maker, mods, name, typarams,
   ...
   public
   static
   JCBinary makeBinary(TreeMaker maker, Object ctc, JCExpression rhsArgument, 
                       JCExpression lhsArgument) {
     try {
       Method createUnary;
       if (JavaCompiler.version().startsWith("1.8")) {
         createUnary =
         TreeMaker.class.getMethod("Binary",
           Class.forName("com.sun.tools.javac.code.TypeTag"),
           JCExpression.class, JCExpression.class);
       } else {
         createUnary =
         TreeMaker.class.getMethod("Binary", Integer.TYPE,
           JCExpression.class, JCExpression.class);
       }
   ...
   private
   static
   RuntimeException sneakyThrow(Throwable t) {
     if (t == null)
