 ...
 */
@ProviderFor(value = EclipseAnnotationHandler.class) @DeferUntilPostDiet @HandlerPriority(value = 1024) public class HandleSneakyThrows extends EclipseAnnotationHandler<SneakyThrows> {
