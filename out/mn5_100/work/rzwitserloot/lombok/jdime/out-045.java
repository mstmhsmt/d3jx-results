 ...
 */
@ProviderFor(value = JavacAnnotationHandler.class) public class HandleSetter implements JavacAnnotationHandler<Setter> {
  ...
  private boolean createSetterForFields(AccessLevel level, Collection<JavacNode> fieldNodes, JavacNode errorNode, boolean whineIfExists, List<JCExpression> onMethod, List<JCExpression> onParam) {
  ...
  private boolean createSetterForField(AccessLevel level, JavacNode fieldNode, JavacNode errorNode, boolean whineIfExists, List<JCExpression> onMethod, List<JCExpression> onParam) {
  ...
  private JCMethodDecl createSetter(long access, JavacNode field, TreeMaker treeMaker, List<JCExpression> onMethod, List<JCExpression> onParam) {
    ...
    return treeMaker.MethodDef(treeMaker.Modifiers(access, copyAnnotations(onMethod)), methodName, methodType, methodGenericParams, parameters, throwsClauses, methodBody, annotationMethodDefaultValue);
  }
  ...
  private static class JCNoType extends Type implements NoType {
    ...
    @Override public <R extends java.lang.Object, P extends java.lang.Object> R accept(TypeVisitor<R, P> v, P p) {
