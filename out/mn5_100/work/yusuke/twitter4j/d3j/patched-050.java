...
interface FriendsFollowersResources
{
   ...
   Relationship showFriendship(String sourceScreenName, 
     ...
     throws TwitterException;
   PagableResponseList<User> getFriendsList(long userId, long cursor)
     throws TwitterException;
   PagableResponseList<User> getFriendsList(long userId, long cursor, 
                                            int count)
     throws TwitterException;
   PagableResponseList<User> getFriendsList(String screenName, long cursor)
     throws TwitterException;
   PagableResponseList<User> getFriendsList(String screenName, long cursor, 
                                            int count)
     throws TwitterException;
   ...
   PagableResponseList<User> getFriendsList(String screenName, long cursor, 
                                            ...
                                            boolean includeUserEntities)
     throws TwitterException;
   PagableResponseList<User> getFollowersList(long userId, long cursor)
     throws TwitterException;
   PagableResponseList<User> getFollowersList(String screenName, long cursor)
     throws TwitterException;
   PagableResponseList<User> getFollowersList(long userId, long cursor, 
                                              int count)
     throws TwitterException;
