...
class TwitterImpl extends TwitterBaseImpl implements Twitter {
  ...
  TwitterImpl(Configuration conf, Authorization auth) {
    ...
    if (implicitParams == null) {
      ...
      implicitParamsStr =
          "include_entities=" + includeEntities + "&include_rts=" + includeRTs +
  ...
  public ResponseList<Friendship> lookupFriendships(long[] ids)
    ...
    return factory.createFriendshipList(
        get(conf.getRestBaseURL() + "friendships/lookup.json?user_id=" +
  ...
  public PagableResponseList<User> getFollowersList(long userId, long cursor)
      throws TwitterException {
<<<<<<< /root/work/yusuke/twitter4j/d3j/patched-049-0.java
  ...
  public PagableResponseList<User> getFollowersList(long userId, long cursor,
                                                    int count)
      throws TwitterException {
||||||| /root/work/yusuke/twitter4j/d3j/base-049.java
=======
    return getFollowersList(userId, cursor, 20);
  }
  @Override
...
>>>>>>> /root/work/yusuke/twitter4j/d3j/patched-049-1.java
    return factory.createPagableUserList(
    ...
    return factory.createUserList(
        get(conf.getRestBaseURL() + "users/lookup.json",
            new HttpParameter[] {new HttpParameter(
                "user_id", z_T4JInternalStringUtil.join(ids))}));
  }
  @Override
  public ResponseList<User> lookupUsers(String[] screenNames)
    ...
    return factory.createUserList(
        get(conf.getRestBaseURL() + "users/lookup.json",
            new HttpParameter[] {new HttpParameter(
                "screen_name", z_T4JInternalStringUtil.join(screenNames))}));
  }
  @Override
  ...
  @Override
  public UserList destroyUserListMember(int listId, String screenName)
      throws TwitterException {
  ...
  @Override
  public UserList destroyUserListMembers(int listId, String[] screenNames)
      throws TwitterException {
    return factory.createAUserList(post(
  ...
  @Override
  public UserList destroyUserListMembers(int listId, long[] userIds)
      throws TwitterException {
    return factory.createAUserList(
  ...
  public SimilarPlaces getSimilarPlaces(GeoLocation location, String name,
    ...
    return factory.createSimilarPlaces(
  ...
  public Place createPlace(String name, String containedWithin, String token,
                           GeoLocation location, String streetAddress)
      throws TwitterException {
    List<HttpParameter> params = new ArrayList<HttpParameter>(3);
    params.add(new HttpParameter("name", name));
    params.add(new HttpParameter("contained_within", containedWithin));
    ...
    return factory.createPlace(
        post(conf.getRestBaseURL() + "geo/place.json",
             params.toArray(new HttpParameter[params.size()])));
  }
  @Override
  ...
  public Map<String, RateLimitStatus> getRateLimitStatus(String... resources)
    ...
    return factory.createRateLimitStatuses(
        get(conf.getRestBaseURL() +
            ...
            z_T4JInternalStringUtil.join(resources)));
  }
  @Override
