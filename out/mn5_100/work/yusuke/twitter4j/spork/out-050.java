...
public abstract interface FriendsFollowersResources {
     ...
     */
    public abstract PagableResponseList<User> getFriendsList(long userId, long cursor, int count, boolean skipStatus, boolean includeUserEntities) throws TwitterException;
     ...
     * @since Twitter4J 4.0.2
     */
    public abstract PagableResponseList<User> getFriendsList(String screenName, long cursor, int count, boolean skipStatus, boolean includeUserEntities) throws TwitterException;
     ...
     * @since Twitter4J 3.0.2
     */
    public abstract PagableResponseList<User> getFollowersList(long userId, long cursor) throws TwitterException;
     ...
     * @since Twitter4J 3.0.2
     */
    public abstract PagableResponseList<User> getFollowersList(String screenName, long cursor) throws TwitterException;
     ...
     */
    public abstract PagableResponseList<User> getFollowersList(long userId, long cursor, int count) throws TwitterException;
     ...
     * @since Twitter4J 3.0.6
     */
    public abstract PagableResponseList<User> getFollowersList(String screenName, long cursor, int count) throws TwitterException;
     ...
     * @since Twitter4J 4.0.2
     */
    public abstract PagableResponseList<User> getFriendsList(long userId, long cursor, int count) throws TwitterException;
     ...
     * @since Twitter4J 4.0.2
     */
    public abstract PagableResponseList<User> getFriendsList(String screenName, long cursor, int count) throws TwitterException;
}
