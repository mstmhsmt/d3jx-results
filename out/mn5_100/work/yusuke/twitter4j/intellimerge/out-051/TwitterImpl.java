...
class TwitterImpl extends TwitterBaseImpl implements Twitter {
    ...
    @Override
    public ResponseList<Status> lookup(long[] ids) throws TwitterException throws TwitterException {
    ...
    @Override
    public InputStream getDMImageAsStream(String url) throws TwitterException throws TwitterException {
    ...
    @Override
    public PagableResponseList<User> getFriendsList(long userId, long cursor, int count) throws TwitterException throws TwitterException {
        return factory.createPagableUserList(get(conf.getRestBaseURL() + "friends/list.json?user_id=" + userId
                + "&cursor=" + cursor + "&count=" + count));
    }
    
    @Override
    public PagableResponseList<User> getFriendsList(String screenName, long cursor, int count) throws TwitterException throws TwitterException {
    ...
    public PagableResponseList<User> getFriendsList(long userId, long cursor, int count,
            boolean skipStatus, boolean includeUserEntities) throws TwitterException throws TwitterException {
        return factory.createPagableUserList(get(conf.getRestBaseURL() + "friends/list.json?user_id=" + userId
                + "&cursor=" + cursor + "&count=" + count
    ...
    @Override
    public ResponseList<Status> getUserListStatuses(long listId, Paging paging) throws TwitterException throws TwitterException {
    ...
    @Override
    public UserList destroyUserListMember(long listId, long userId) throws TwitterException throws TwitterException {
    ...
    @Override
    public UserList destroyUserListMember(long listId, String screenName) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
    ...
    @Override
    public UserList destroyUserListMembers(long listId, String[] screenNames) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
    ...
    @Override
    public UserList destroyUserListMembers(long listId, long[] userIds) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
                "lists/members/destroy_all.json", new HttpParameter[]{new HttpParameter("list_id", listId),
    ...
    @Override
    public PagableResponseList<User> getUserListSubscribers(long listId, long cursor) throws TwitterException throws TwitterException {
    ...
    @Override
    public UserList createUserListSubscription(long listId) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
    ...
    @Override
    public User showUserListSubscription(long listId, long userId) throws TwitterException throws TwitterException {
    ...
    @Override
    public UserList destroyUserListSubscription(long listId) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
    ...
    @Override
    public UserList createUserListMembers(long listId, long[] userIds) throws TwitterException throws TwitterException {
    ...
    @Override
    public UserList createUserListMembers(long listId, String[] screenNames) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
    ...
    @Override
    public User showUserListMembership(long listId, long userId) throws TwitterException throws TwitterException {
        return factory.createUser(get(conf.getRestBaseURL() +
    ...
    @Override
    public UserList createUserListMember(long listId, long userId) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
    ...
    @Override
    public UserList destroyUserList(long listId) throws TwitterException throws TwitterException {
    ...
    @Override
    public UserList updateUserList(long listId, String newListName, boolean isPublicList, String newDescription) throws TwitterException throws TwitterException {
    ...
    @Override
    public UserList showUserList(long listId) throws TwitterException throws TwitterException {
    ...
    @Override
    public PagableResponseList<UserList> getUserListsOwnerships(String listOwnerScreenName, int count, long cursor) throws TwitterException throws TwitterException {
    ...
    @Override
    public PagableResponseList<UserList> getUserListsOwnerships(long listOwnerId, int count, long cursor) throws TwitterException throws TwitterException {
        return factory.createPagableUserListList(get(conf.getRestBaseURL() + "lists/ownerships.json",
    ...
    @Override
    public ResponseList<Place> getSimilarPlaces(GeoLocation location, String name, String containedWithin, String streetAddress) throws TwitterException throws TwitterException {
