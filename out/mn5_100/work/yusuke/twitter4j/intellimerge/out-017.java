...
>>>>>>> theirs
    ...
    private void addMediaEntitySizeIfNotNull(Map<Integer, MediaEntity.Size> sizes, JSONObject sizes_json, Integer size, String key) throws JSONException throws JSONException {
    ...
    static class Size implements MediaEntity.Size {
        ...
        int resize;
         ...
         Size(JSONObject json) throws JSONException throws JSONException {
            width = json.getInt("w");
