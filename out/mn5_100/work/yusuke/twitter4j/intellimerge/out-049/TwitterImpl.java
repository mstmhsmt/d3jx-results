...
class TwitterImpl extends TwitterBaseImpl implements Twitter {
     ...
     */
    @Override
    public ResponseList<Status> getMentions() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Status> getMentionsTimeline() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Status> getMentions(Paging paging) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Status> getMentionsTimeline(Paging paging) throws TwitterException throws TwitterException {
     ...
     * {@inheritDoc}
     */
    public ResponseList<Status> getRetweetsOfMe() throws TwitterException throws TwitterException {
        return factory.createStatusList(get(conf.getRestBaseURL()
     ...
     * {@inheritDoc}
     */
    public ResponseList<Status> getRetweetsOfMe(Paging paging) throws TwitterException throws TwitterException {
        return factory.createStatusList(get(conf.getRestBaseURL()
     ...
     */
    @Override
    public ResponseList<Status> getUserTimeline(String screenName) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Status> getUserTimeline(long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Status> getRetweets(long statusId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public IDs getRetweeterIds(long statusId, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public IDs getRetweeterIds(long statusId, int count, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public Status showStatus(long id) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public Status destroyStatus(long statusId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public Status updateStatus(String status) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public Status updateStatus(StatusUpdate status) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public Status retweetStatus(long statusId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public OEmbed getOEmbed(OEmbedRequest req) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public QueryResult search(Query query) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<DirectMessage> getDirectMessages() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<DirectMessage> getDirectMessages(Paging paging) throws TwitterException throws TwitterException {
        return factory.createDirectMessageList(get(conf.getRestBaseURL() + "direct_messages.json"
                , paging.asPostParameterArray()));
    }
     ...
     */
    @Override
    public DirectMessage showDirectMessage(long id) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public DirectMessage sendDirectMessage(String screenName, String text) throws TwitterException throws TwitterException {
        return factory.createDirectMessage(post(conf.getRestBaseURL() + "direct_messages/new.json",
     ...
     */
    @Override
    public IDs getFriendsIDs(long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public IDs getFriendsIDs(long userId, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public IDs getFriendsIDs(String screenName, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public IDs getFollowersIDs(long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public IDs getFollowersIDs(long userId, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public IDs getFollowersIDs(String screenName, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Friendship> lookupFriendships(long[] ids) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Friendship> lookupFriendships(String[] screenNames) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public IDs getIncomingFriendships(long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public IDs getOutgoingFriendships(long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User createFriendship(long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User createFriendship(String screenName) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User createFriendship(long userId, boolean follow) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User createFriendship(String screenName, boolean follow) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User destroyFriendship(long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User destroyFriendship(String screenName) throws TwitterException throws TwitterException {
    ...
    public Relationship updateFriendship(long userId, boolean enableDeviceNotification
            , boolean retweets) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public Relationship showFriendship(long sourceId, long targetId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public Relationship showFriendship(String sourceScreenName, String targetScreenName) throws TwitterException throws TwitterException {
        return factory.createRelationship(get(conf.getRestBaseURL() + "friendships/show.json",
     ...
     */
    @Override
    public PagableResponseList<User> getFriendsList(long userId, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<User> getFriendsList(String screenName, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<User> getFollowersList(long userId, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<User> getFollowersList(String screenName, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<User> getFollowersList(long userId, long cursor, int count) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<User> getFollowersList(String screenName, long cursor, int count) throws TwitterException throws TwitterException {
        count = (count>0 && count <= 200) ? count : 20;
     ...
     */
    @Override
    public AccountSettings getAccountSettings() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User verifyCredentials() throws TwitterException throws TwitterException {
    ...
    public User updateProfile(String name, String url
            , String location, String description) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User updateProfileImage(File image) throws TwitterException throws TwitterException {
        checkFileValidity(image);
        return factory.createUser(post(conf.getRestBaseURL()
     ...
     */
    @Override
    public User updateProfileImage(InputStream image) throws TwitterException throws TwitterException {
        return factory.createUser(post(conf.getRestBaseURL()
                + "account/update_profile_image.json"
     ...
     */
    private void checkFileValidity(File image) throws TwitterException throws TwitterException {
        if (!image.exists()) {
     ...
     */
    @Override
    public IDs getBlocksIDs() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public IDs getBlocksIDs(long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User createBlock(long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User createBlock(String screenName) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User destroyBlock(long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User destroyBlock(String screen_name) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<User> lookupUsers(long[] ids) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<User> lookupUsers(String[] screenNames) throws TwitterException throws TwitterException {
        return factory.createUserList(get(conf.getRestBaseURL() + "users/lookup.json"
     ...
     */
    @Override
    public User showUser(long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User showUser(String screenName) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<User> searchUsers(String query, int page) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<User> getContributees(long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<User> getContributees(String screenName) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<User> getContributors(long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<User> getContributors(String screenName) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public void removeProfileBanner() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public void updateProfileBanner(File image) throws TwitterException throws TwitterException {
        checkFileValidity(image);
        post(conf.getRestBaseURL()
     ...
     */
    @Override
    public void updateProfileBanner(InputStream image) throws TwitterException throws TwitterException {
        post(conf.getRestBaseURL()
                + "account/update_profile_banner.json"
     ...
     */
    @Override
    public ResponseList<User> getUserSuggestions(String categorySlug) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Category> getSuggestedUserCategories() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<User> getMemberSuggestions(String categorySlug) throws TwitterException throws TwitterException {
        HttpResponse res = null;
        try {
     ...
     */
    @Override
    public ResponseList<Status> getFavorites() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Status> getFavorites(long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Status> getFavorites(String screenName) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Status> getFavorites(Paging paging) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Status> getFavorites(long userId, Paging paging) throws TwitterException throws TwitterException {
        return factory.createStatusList(get(conf.getRestBaseURL() + "favorites/list.json",
                mergeParameters(new HttpParameter[]{new HttpParameter("user_id", userId)}
                        , paging.asPostParameterArray())));
    }
     ...
     */
    @Override
    public ResponseList<Status> getFavorites(String screenName, Paging paging) throws TwitterException throws TwitterException {
        return factory.createStatusList(get(conf.getRestBaseURL() + "favorites/list.json",
                mergeParameters(new HttpParameter[]{new HttpParameter("screen_name", screenName)}
                        , paging.asPostParameterArray())));
    }
     ...
     */
    @Override
    public Status destroyFavorite(long id) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public Status createFavorite(long id) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<UserList> getUserLists(String listOwnerScreenName) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<UserList> getUserLists(long listOwnerUserId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Status> getUserListStatuses(int listId, Paging paging) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Status> getUserListStatuses(long ownerId, String slug, Paging paging) throws TwitterException throws TwitterException {
        return factory.createStatusList(get(conf.getRestBaseURL() + "lists/statuses.json"
                , mergeParameters(paging.asPostParameterArray(Paging.SMCP, Paging.COUNT)
    ...
    public ResponseList<Status> getUserListStatuses(String ownerScreenName,
                                                    String slug, Paging paging) throws TwitterException throws TwitterException {
        return factory.createStatusList(get(conf.getRestBaseURL() + "lists/statuses.json"
                , mergeParameters(paging.asPostParameterArray(Paging.SMCP, Paging.COUNT)
     ...
     */
    @Override
    public UserList destroyUserListMember(int listId, long userId) throws TwitterException throws TwitterException {
    ...
    @Override
    public UserList deleteUserListMember(int listId, long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList destroyUserListMember(long ownerId, String slug, long userId) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
     ...
     */
    @Override
    public UserList destroyUserListMember(int listId, String screenName) throws TwitterException throws TwitterException {
      return factory.createAUserList(post(conf.getRestBaseURL() +
    ...
    public UserList destroyUserListMember(String ownerScreenName, String slug,
                                          long userId) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
    ...
    @Override
    public UserList deleteUserListMember(long ownerId, String slug, long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList destroyUserListMembers(int listId, String[] screenNames) throws TwitterException throws TwitterException {
      return factory.createAUserList(post(conf.getRestBaseURL() +
     ...
     */
    @Override
    public UserList destroyUserListMembers(int listId, long[] userIds) throws TwitterException throws TwitterException {
      return factory.createAUserList(post(conf.getRestBaseURL() +
          "lists/members/destroy_all.json", new HttpParameter[]{new HttpParameter("list_id", listId), 
     ...
     */
    @Override
    public UserList destroyUserListMembers(String ownerScreenName, String slug, String[] screenNames) throws TwitterException throws TwitterException {
      return factory.createAUserList(post(conf.getRestBaseURL() +
     ...
     */
    @Override
    public UserList destroyUserListMembers(String ownerScreenName, String slug, long[] userIds) throws TwitterException throws TwitterException {
      return factory.createAUserList(post(conf.getRestBaseURL() +
          "lists/members/destroy_all.json", new HttpParameter[]{new HttpParameter("owner_screen_name", ownerScreenName),
        new HttpParameter("slug", slug),
        new HttpParameter("user_id", z_T4JInternalStringUtil.join(userIds))}));
     ...
     */
    @Override
    public PagableResponseList<UserList> getUserListMemberships(long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<UserList> getUserListMemberships(String listMemberScreenName, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<UserList> getUserListMemberships(long listMemberId, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<UserList> getUserListMemberships(long listMemberId, long cursor, boolean filterToOwnedLists) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<UserList> getUserListMemberships(String listMemberScreenName, long cursor, boolean filterToOwnedLists) throws TwitterException throws TwitterException {
        return factory.createPagableUserListList(get(conf.getRestBaseURL()
     ...
     */
    @Override
    public PagableResponseList<User> getUserListSubscribers(int listId, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<User> getUserListSubscribers(long ownerId, String slug, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList createUserListSubscription(int listId) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
     ...
     */
    @Override
    public UserList createUserListSubscription(long ownerId, String slug) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
    ...
    public UserList createUserListSubscription(String ownerScreenName,
                                               String slug) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
     ...
     */
    @Override
    public User showUserListSubscription(int listId, long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User showUserListSubscription(long ownerId, String slug, long userId) throws TwitterException throws TwitterException {
        return factory.createUser(get(conf.getRestBaseURL() +
     ...
     */
    @Override
    public UserList destroyUserListSubscription(int listId) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
     ...
     */
    @Override
    public UserList destroyUserListSubscription(long ownerId, String slug) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList createUserListMembers(int listId, long[] userIds) throws TwitterException throws TwitterException {
    ...
    @Override
    public UserList addUserListMembers(int listId, long[] userIds) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList createUserListMembers(long ownerId, String slug, long[] userIds) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() + "lists/members/create_all.json",
                new HttpParameter[]{new HttpParameter("owner_id", ownerId), new HttpParameter("slug", slug)
                        , new HttpParameter("user_id", z_T4JInternalStringUtil.join(userIds))}));
    }
    ...
    public UserList createUserListMembers(String ownerScreenName, String slug,
                                          long[] userIds) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() + "lists/members/create_all.json",
                new HttpParameter[]{new HttpParameter("owner_screen_name", ownerScreenName), new HttpParameter("slug", slug)
                        , new HttpParameter("user_id", z_T4JInternalStringUtil.join(userIds))}));
    }
    ...
    @Override
    public UserList addUserListMembers(long ownerId, String slug, long[] userIds) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList createUserListMembers(int listId, String[] screenNames) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
    ...
    @Override
    public UserList addUserListMembers(int listId, String[] screenNames) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList createUserListMembers(long ownerId, String slug, String[] screenNames) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
                "lists/members/create_all.json",
                new HttpParameter[]{new HttpParameter("owner_id", ownerId), new HttpParameter("slug", slug)
                        , new HttpParameter("screen_name", z_T4JInternalStringUtil.join(screenNames))}));
    ...
    @Override
    public UserList createUserListMembers(String ownerScreenName, String slug,
                                          String[] screenNames) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
                "lists/members/create_all.json",
                new HttpParameter[]{new HttpParameter("owner_screen_name", ownerScreenName), new HttpParameter("slug", slug)
                        , new HttpParameter("screen_name", z_T4JInternalStringUtil.join(screenNames))}));
    ...
    @Override
    public UserList addUserListMembers(long ownerId, String slug, String[] screenNames) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User showUserListMembership(int listId, long userId) throws TwitterException throws TwitterException {
        return factory.createUser(get(conf.getRestBaseURL() +
     ...
     */
    @Override
    public User showUserListMembership(long ownerId, String slug, long userId) throws TwitterException throws TwitterException {
        return factory.createUser(get(conf.getRestBaseURL() +
    ...
    public PagableResponseList<User> getUserListMembers(int listId
            , long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<User> getUserListMembers(long ownerId, String slug, long cursor) throws TwitterException throws TwitterException {
        return factory.createPagableUserList(get(conf.getRestBaseURL() +
    ...
    public PagableResponseList<User> getUserListMembers(String ownerScreenName,
                                                        String slug, long cursor) throws TwitterException throws TwitterException {
        return factory.createPagableUserList(get(conf.getRestBaseURL() +
     ...
     */
    @Override
    public UserList createUserListMember(int listId, long userId) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
    ...
    @Override
    public UserList addUserListMember(int listId, long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList createUserListMember(long ownerId, String slug, long userId) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() +
                "lists/members/create.json", new HttpParameter[]{new HttpParameter("user_id", userId)
    ...
    @Override
    public UserList addUserListMember(long ownerId, String slug, long userId) throws TwitterException throws TwitterException {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
     ...
     */
    @Override
    public UserList destroyUserList(int listId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList destroyUserList(long ownerId, String slug) throws TwitterException throws TwitterException {
        return factory.createAUserList(post(conf.getRestBaseURL() + "lists/destroy.json",
                new HttpParameter[]{new HttpParameter("owner_id", ownerId)
                        , new HttpParameter("slug", slug)}));
    }
     ...
     */
    @Override
    public UserList updateUserList(int listId, String newListName, boolean isPublicList, String newDescription) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList updateUserList(long ownerId, String slug, String newListName, boolean isPublicList, String newDescription) throws TwitterException throws TwitterException {
    ...
    private UserList updateUserList(String newListName, boolean isPublicList, String newDescription, HttpParameter... params) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList createUserList(String listName, boolean isPublicList, String description) throws TwitterException throws TwitterException {
        List<HttpParameter> httpParams = new ArrayList<HttpParameter>();
     ...
     */
    @Override
    public UserList showUserList(int listId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public UserList showUserList(long ownerId, String slug) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public PagableResponseList<UserList> getUserListSubscriptions(String listOwnerScreenName, long cursor) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<SavedSearch> getSavedSearches() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public SavedSearch showSavedSearch(int id) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public SavedSearch createSavedSearch(String query) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public SavedSearch destroySavedSearch(int id) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public Place getGeoDetails(String placeId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Place> reverseGeoCode(GeoQuery query) throws TwitterException throws TwitterException {
        try {
     ...
     */
    @Override
    public ResponseList<Place> searchPlaces(GeoQuery query) throws TwitterException throws TwitterException {
        return factory.createPlaceList(get(conf.getRestBaseURL()
     ...
     */
    @Override
    public SimilarPlaces getSimilarPlaces(GeoLocation location, String name, String containedWithin, String streetAddress) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public Place createPlace(String name, String containedWithin, String token, GeoLocation location, String streetAddress) throws TwitterException throws TwitterException {
        List<HttpParameter> params = new ArrayList<HttpParameter>(3);
        params.add(new HttpParameter("name", name));
        params.add(new HttpParameter("contained_within", containedWithin));
     ...
     */
    @Override
    public Trends getLocationTrends(int woeid) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public Trends getPlaceTrends(int woeid) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Location> getAvailableTrends() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Location> getAvailableTrends(GeoLocation location) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Location> getClosestTrends(GeoLocation location) throws TwitterException throws TwitterException {
        return factory.createLocationList(get(conf.getRestBaseURL()
                + "trends/closest.json",
     ...
     */
    @Override
    public User reportSpam(long userId) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public User reportSpam(String screenName) throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public TwitterAPIConfiguration getAPIConfiguration() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public ResponseList<Language> getLanguages() throws TwitterException throws TwitterException {
     ...
     */
    @Override
    public String getPrivacyPolicy() throws TwitterException throws TwitterException {
        try {
     ...
     */
    @Override
    public String getTermsOfService() throws TwitterException throws TwitterException {
        try {
     ...
     */
    @Override
    public Map<String, RateLimitStatus> getRateLimitStatus() throws TwitterException throws TwitterException {
        return factory.createRateLimitStatuses(get(conf.getRestBaseURL() + "application/rate_limit_status.json"));
    }
    
    @Override
    public Map<String, RateLimitStatus> getRateLimitStatus(String... resources) throws TwitterException throws TwitterException {
    ...
    private HttpResponse get(String url) throws TwitterException throws TwitterException {
    ...
    private HttpResponse get(String url, HttpParameter[] params) throws TwitterException throws TwitterException {
        ensureAuthorizationEnabled();
        if (!conf.isMBeanEnabled()) {
    ...
    private HttpResponse post(String url) throws TwitterException throws TwitterException {
        ensureAuthorizationEnabled();
        if (!conf.isMBeanEnabled()) {
    ...
    private HttpResponse post(String url, HttpParameter[] params) throws TwitterException throws TwitterException {
        ensureAuthorizationEnabled();
        if (!conf.isMBeanEnabled()) {
