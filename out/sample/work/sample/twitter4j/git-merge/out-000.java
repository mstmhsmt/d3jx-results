...
class TwitterImpl extends TwitterBaseImpl implements Twitter {
  ...
  @Override
  public PagableResponseList<User>
<<<<<<< commits-sample/sample/twitter4j/A/TwitterImpl.java
    getFriendsList(long userId, long cursor, int count)
    throws TwitterException
  {
    return
  ...
  public PagableResponseList<User>
    getFriendsList(String screenName, long cursor)
||||||| commits-sample/sample/twitter4j/O/TwitterImpl.java
    getFriendsList(String screenName, long cursor)
=======
    getFriendsList(String screenName, long cursor, int count)
>>>>>>> commits-sample/sample/twitter4j/B/TwitterImpl.java
    throws TwitterException
  {
    return
      factory.createPagableUserList(get(conf.getRestBaseURL() +
